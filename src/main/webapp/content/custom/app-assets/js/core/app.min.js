...
(window.colors = {
  ...
  (function (a, e, t) {
    ...
    var s = t('html'),
      ...
      r = '../../../app-assets/';
    if (
      ('laravel' === t('body').attr('data-framework') && (r = t('body').attr('data-asset-path')),
      t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, { sFilterInput: 'form-control', sLengthSelect: 'custom-select form-control' }),
      t(a).on('load', function () {
        ...
        !1 === t.app.nav.initialized && t.app.nav.init({ speed: 300 }),
          ...
          t('a[data-action="collapse"]').on('click', function (a) {
            a.preventDefault(),
              t(this).closest('.card').children('.card-content').collapse('toggle'),
              t(this).closest('.card').find('[data-action="collapse"]').toggleClass('rotate');
          }),
          ...
          t('.card .heading-elements a[data-action="collapse"]').on('click', function () {
            ...
            parseInt(e[0].style.height, 10) > 0
              ? ((a = e.css('height')), e.css('height', '').attr('data-height', a))
              : e.data('height') && ((a = e.data('height')), e.css('height', a).attr('data-height', ''));
          }),
          t('input:disabled, textarea:disabled').closest('.input-group').addClass('disabled'),
          t('.main-menu-content').find('li.active').parents('li').addClass('sidebar-group-active');
        var i = n.data('menu');
        'horizontal-menu' != i && !1 === r && t('.main-menu-content').find('li.active').parents('li').addClass('open'),
          'horizontal-menu' == i &&
            (t('.main-menu-content').find('li.active').parents('li:not(.nav-item)').addClass('open'),
            t('.main-menu-content').find('li.active').closest('li.nav-item').addClass('sidebar-group-active open'));
        var l = t('.chartjs'),
        ...
        t('.custom-file-input').on('change', function (a) {
          ...
          t('.char-textarea').on('keyup', function (e) {
            !(function (e, s) {
              ...
              t('.char-count').html(e.value.length),
                e.value.length > n
                  ? (r.css('background-color', a.colors.solid.danger), i.css('color', a.colors.solid.danger), i.addClass('max-limit'))
                  : (r.css('background-color', a.colors.solid.primary), i.css('color', o), i.removeClass('max-limit'));
            })(this, e),
          ...
          t('.content-overlay').on('click', function () {
            ...
            a.hasClass('open') && (a.removeClass('open'), y.val(''), y.blur(), w.removeClass('show')),
      ...
      setTimeout(function () {
        ...
        t(s).length > 0 &&
          ((a = new Hammer(s)).get('pan').set({ direction: Hammer.DIRECTION_ALL, threshold: 250 }),
          a.on(d, function (a) {
    ...
    if (
      ...
      i18next
        ...
        .init({ debug: !1, fallbackLng: 'en', backend: { loadPath: r + 'data/locales/{{lng}}.json' }, returnObjects: !0 }, function (a, e) {
    ...
    if (
      ...
      C.on('click', function () {
        t(this);
        t(this).parent('.nav-search').find('.search-input').addClass('open'), y.focus(), w.find('li').remove(), b.removeClass('show');
      }),
      ...
      var I = new PerfectScrollbar('.search-list-main', { wheelPropagation: !1 });
    if (t('.search-list-bookmark').length) new PerfectScrollbar('.search-list-bookmark', { wheelPropagation: !1 });
    function z() {
    ...
    t('.search-list-main').mouseenter(function () {
      ...
      y.on('keyup', function (a) {
        if ((t(this).closest('.search-list').addClass('show'), 38 !== a.keyCode && 40 !== a.keyCode && 13 !== a.keyCode)) {
          27 == a.keyCode &&
            ...
            y.blur(),
            k.removeClass('open'),
            k.hasClass('show') && (t(this).removeClass('show'), k.removeClass('show')));
          ...
          if ((t('ul.search-list li').remove(), t(this).parent().hasClass('bookmark-input') && (n = !0), '' != e)) {
            x.addClass('show-overlay'),
              b.focus() ? S.addClass('show') : (w.addClass('show'), S.removeClass('show')),
            ...
            t.getJSON(r + 'data/' + p + '.json', function (a) {
              for (var m = 0; m < a.listItems.length; m++) {
                if (('laravel' === t('body').attr('data-framework') && (a.listItems[m].url = r + a.listItems[m].url), !0 === n)) {
                  ...
                  h = feather.icons.star.toSvg({ class: 'bookmark-icon float-right' + s });
                }
                0 == a.listItems[m].name.toLowerCase().indexOf(e) &&
                  ...
                  ((o +=
                    ...
                    a.listItems[m].url +
                    '><div class="d-flex justify-content-start align-items-center">' +
                    feather.icons[a.listItems[m].icon].toSvg({ class: 'mr-75 ' }) +
                    '<span>' +
                    a.listItems[m].name +
                    '</span></div>' +
                    h +
              ...
              (u = t('.main-search-list-defaultlist').html()),
                '' == o && '' == i && (i = t('.main-search-list-defaultlist-other-list').html()),
                (l = d.concat(o, i, u)),
      ...
      t('html').on('click', function (a) {
        t(a.target).hasClass('bookmark-icon') ||
          (S.hasClass('show') && S.removeClass('show'), b.hasClass('show') && (b.removeClass('show'), x.removeClass('show-overlay')));
      }),
      ...
      t(e).on('click', '.bookmark-input .search-list .bookmark-icon', function (a) {
        if ((a.stopPropagation(), t(this).hasClass('text-warning'))) {
          ...
          if (t(t(this).parent()[0].firstChild.firstChild).hasClass('feather'))
            i = t(this).parent()[0].firstChild.firstChild.getAttribute('class').split('feather-')[1].split(' ')[0];
          (n =
      ...
      t(a).on('keydown', function (e) {
        ...
        if (
          (40 === e.keyCode
            ? ((s = o.next()), o.removeClass('current_item'), (o = s.addClass('current_item')))
            : 38 === e.keyCode && ((n = o.prev()), o.removeClass('current_item'), (o = n.addClass('current_item'))),
      ...
      t('.form-password-toggle .input-group-text').on('click', function (a) {
        ...
        var e = t(this),
          ...
          o = s.find('input');
        'text' === o.attr('type')
          ? (o.attr('type', 'password'), feather && n.find('svg').replaceWith(feather.icons.eye.toSvg({ class: 'font-small-4' })))
          : 'password' === o.attr('type') &&
            (o.attr('type', 'text'), feather && n.find('svg').replaceWith(feather.icons['eye-off'].toSvg({ class: 'font-small-4' })));
      }),
      t(a).on('scroll', function () {
        (t(this).scrollTop() > 400 ? t('.scroll-top').fadeIn() : t('.scroll-top').fadeOut(), n.hasClass('navbar-static')) &&
          (t(a).scrollTop() > 65
            ? (t('html:not(.dark-layout) .horizontal-menu .header-navbar.navbar-fixed').css({
                background: '#fff',
              ...
              t('html:not(.dark-layout) .horizontal-menu .horizontal-menu-wrapper.header-navbar').css('background', '#fff'),
              t('.dark-layout .horizontal-menu .horizontal-menu-wrapper.header-navbar').css('background', '#161d31'))
            : (t('html:not(.dark-layout) .horizontal-menu .header-navbar.navbar-fixed').css({
                background: '#f8f8f8',
                'box-shadow': 'none',
              }),
              t('.dark-layout .horizontal-menu .header-navbar.navbar-fixed').css({ background: '#161d31', 'box-shadow': 'none' }),
              t('html:not(.dark-layout) .horizontal-menu .horizontal-menu-wrapper.header-navbar').css('background', '#fff'),
              t('.dark-layout .horizontal-menu .horizontal-menu-wrapper.header-navbar').css('background', '#161d31')));
      }),
    ...
    t('.nav-link-style').on('click', function () {
      ...
      (e = 'dark-layout' !== a ? 'dark-layout' : a === n ? 'light-layout' : n || 'light-layout'),
          ...
          s.removeClass('semi-dark-layout dark-layout bordered-layout'),
            'dark-layout' === i
              ? (s.addClass('dark-layout'),
                ...
                e.find('.ficon').replaceWith(feather.icons.sun.toSvg({ class: 'ficon' })))
              : 'bordered-layout' === i
              ? (s.addClass('bordered-layout'),
                o.removeClass('menu-dark').addClass('menu-light'),
                r.removeClass('navbar-dark').addClass('navbar-light'),
                e.find('.ficon').replaceWith(feather.icons.moon.toSvg({ class: 'ficon' })))
              : 'semi-dark-layout' === i
        ...
        t('.horizontal-menu .header-navbar.navbar-fixed').css({ background: 'inherit', 'box-shadow': 'inherit' }),
  ...
  'function' == typeof jQuery.validator &&
    jQuery.validator.setDefaults({
      ...
      errorPlacement: function (a, e) {
        e.parent().hasClass('input-group') || e.hasClass('select2') || 'checkbox' === e.attr('type')
          ? a.insertAfter(e.parent())
          : e.hasClass('custom-control-input')
          ? a.insertAfter(e.parent().siblings(':last'))
          : a.insertAfter(e),
          e.parent().hasClass('input-group') && e.parent().addClass('is-invalid');
      },
