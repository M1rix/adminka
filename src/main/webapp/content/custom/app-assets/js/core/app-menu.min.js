  ...
  (a.app.menu = {
    ...
    manualScroller: {
        ...
        if (!0 === a('.main-menu').data('scroll-to-active')) {
          ...
          if (
            ...
            i.hasClass('menu-collapsed') &&
              ...
              (e = n.querySelector('.main-menu-content li.sidebar-group-active')),
            e && (s = e.getBoundingClientRect().top + t.scrollTop),
            s > parseInt((2 * t.clientHeight) / 3))
          )
            var o = s - t.scrollTop - parseInt(t.clientHeight / 2);
          setTimeout(function () {
            a.app.menu.container.stop().animate({ scrollTop: o }, 300), a('.main-menu').data('scroll-to-active', 'false');
          }, 300);
        }
      },
      enable: function () {
      ...
      updateHeight: function () {
        ('vertical-menu' != i.data('menu') && 'vertical-menu-modern' != i.data('menu') && 'vertical-overlay-menu' != i.data('menu')) ||
          !a('.main-menu').hasClass('menu-fixed') ||
          (a('.main-menu-content').css(
            'height',
            a(e).height() - a('.header-navbar').height() - a('.main-menu-header').outerHeight() - a('.main-menu-footer').outerHeight()
          ),
          this.update());
      },
    },
    ...
    change: function (n) {
      ...
      ('vertical-menu' !== s && 'vertical-menu-modern' !== s) || this.toOverlayMenu(t.name, s),
        ...
        'sm' == t.name || 'xs' == t.name
          ? a('.header-navbar[data-nav=brand-center]').removeClass('navbar-brand-center')
          : a('.header-navbar[data-nav=brand-center]').addClass('navbar-brand-center'),
        'xl' == t.name &&
          'horizontal-menu' == s &&
          a('.main-menu-content').find('li.active').parents('li').addClass('sidebar-group-active active'),
        'xl' !== t.name && 'horizontal-menu' == s && a('#navbar-type').toggleClass('d-none d-xl-block'),
          ...
          (a('li.dropdown-submenu').on('mouseenter', function () {
            ...
            if (n) {
              ...
              if (t - i - n.height() - 28 < 1) {
                ...
                a(this)
                  .find('.dropdown-menu')
                  .css({ 'max-height': l + 'px', 'overflow-y': 'auto', 'overflow-x': 'hidden' });
        ...
        i.hasClass('vertical-layout') &&
          (i.hasClass('menu-open') || i.hasClass('menu-expanded')
            ? (a('.menu-toggle').addClass('is-active'),
              'vertical-menu' === i.data('menu') && a('.main-menu-header') && a('.main-menu-header').show())
            : (a('.menu-toggle').removeClass('is-active'),
              'vertical-menu' === i.data('menu') && a('.main-menu-header') && a('.main-menu-header').hide())),
        setTimeout(function () {
      ...
      this.transit(
        function () {
          i.removeClass('menu-hide menu-collapsed').addClass('menu-open'),
            (this.hidden = !1),
            (this.expanded = !0),
            i.hasClass('vertical-overlay-menu') && a('.sidenav-overlay').addClass('show');
        },
        function () {
          !a('.main-menu').hasClass('menu-native-scroll') &&
            ...
            i.hasClass('vertical-overlay-menu') || a('.sidenav-overlay').removeClass('show');
        }
      );
    },
    hide: function () {
    ...
    expand: function () {
      !1 === this.expanded &&
        ...
        this.transit(
          ...
          function () {
            a('.main-menu').hasClass('menu-native-scroll') || 'horizontal-menu' == i.data('menu')
              ? this.manualScroller.disable()
              : a('.main-menu').hasClass('menu-fixed') && this.manualScroller.enable(),
              ('vertical-menu' != i.data('menu') && 'vertical-menu-modern' != i.data('menu')) ||
                !a('.main-menu').hasClass('menu-fixed') ||
                a('.main-menu-content').css(
                  'height',
                  a(e).height() - a('.header-navbar').height() - a('.main-menu-header').outerHeight() - a('.main-menu-footer').outerHeight()
    ...
    collapse: function () {
      !1 === this.collapsed &&
        ('vertical-menu-modern' == i.data('menu') &&
          a('.modern-nav-toggle')
            .find('.collapse-toggle-icon')
            .replaceWith(feather.icons.circle.toSvg({ class: 'd-none d-xl-block collapse-toggle-icon primary font-medium-4' })),
        this.transit(
          function () {
          ...
          function () {
            'horizontal-menu' == i.data('menu') &&
              ...
              ('vertical-menu' != i.data('menu') && 'vertical-menu-modern' != i.data('menu')) ||
                !a('.main-menu').hasClass('menu-fixed') ||
                a('.main-menu-content').css('height', a(e).height() - a('.header-navbar').height()),
    ...
    toOverlayMenu: function (e, n) {
      ...
      'vertical-menu-modern' == n
        ? 'lg' == e || 'md' == e || 'sm' == e || 'xs' == e
          ...
          : i.hasClass('vertical-overlay-menu') && i.removeClass('vertical-overlay-menu').addClass(a)
        : 'sm' == e || 'xs' == e
        ? i.hasClass(a) && i.removeClass(a).addClass('vertical-overlay-menu')
        : i.hasClass('vertical-overlay-menu') && i.removeClass('vertical-overlay-menu').addClass(a);
    },
    changeMenu: function (e) {
      ...
      'xl' === e
        ? (i.removeClass('vertical-layout vertical-overlay-menu fixed-navbar').addClass(i.data('menu')),
        ...
        : (i.removeClass(i.data('menu')).addClass('vertical-layout vertical-overlay-menu fixed-navbar'),
          ...
          a('.main-menu-content').find('li.active').parents('li').addClass('sidebar-group-active'),
          a('.main-menu-content').find('li.active').closest('li.nav-item').addClass('open')),
    ...
    toggle: function () {
      ...
      switch (e.name) {
        ...
        case 'lg':
          !0 === n
            ? 'vertical-overlay-menu' == t || 'vertical-menu-modern' == t || 'horizontal-menu' == t
              ? this.hide()
              : this.collapse()
            : 'vertical-overlay-menu' == t || 'vertical-menu-modern' == t || 'horizontal-menu' == t
            ? this.open()
      ...
      bind_events: function () {
        ...
        a('.navigation-main')
          .on('mouseenter.app.menu', 'li', function () {
            ...
            if (i.hasClass('menu-collapsed') && 'vertical-menu-modern' != i.data('menu')) {
              ...
              e.hasClass('has-sub') ||
                ...
                '' !== n && ((o = a('<a>')).attr('href', t), o.attr('title', n), o.text(n), o.addClass('menu-title'))),
                (s = e.css('border-top') ? e.position().top + parseInt(e.css('border-top'), 10) : e.position().top),
                'vertical-compact-menu' !== i.data('menu') && o.appendTo('.main-menu-content').css({ position: 'fixed', top: s });
            }
          })
          ...
          .on('click.app.menu', 'li', function (e) {
            var n = a(this);
            n.is('.disabled') || (i.hasClass('menu-collapsed') && 'vertical-menu-modern' != i.data('menu'))
              ? e.preventDefault()
              : n.has('ul').length
              ? n.is('.open')
          ...
          a('.navbar-header, .main-menu')
            .on('mouseenter', function () {
              if (
                'vertical-menu-modern' == i.data('menu') &&
                (a('.main-menu, .navbar-header').addClass('expanded'), i.hasClass('menu-collapsed'))
              ) {
              ...
              i.hasClass('menu-collapsed') &&
                ...
                setTimeout(function () {
                  if (
                    ...
                    (a('.main-menu, .navbar-header').removeClass('expanded'), i.hasClass('menu-collapsed'))
                  ) {
