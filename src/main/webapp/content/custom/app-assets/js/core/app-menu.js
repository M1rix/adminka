      ...
      updateHeight: function () {
        if (
          ...
          $('.main-menu-content').css(
            'height',
            $(window).height() - $('.header-navbar').height() - $('.main-menu-header').outerHeight() - $('.main-menu-footer').outerHeight()
          );
          this.update();
        }
      },
      ...
      if (this.expanded === false) {
        if ($body.data('menu') == 'vertical-menu-modern') {
          $('.modern-nav-toggle')
            ...
            .replaceWith(feather.icons['disc'].toSvg({ class: 'd-none d-xl-block collapse-toggle-icon primary font-medium-4' }));
        }
        this.transit(
          function () {
