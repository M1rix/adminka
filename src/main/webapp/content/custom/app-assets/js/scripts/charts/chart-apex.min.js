$(function () {
  ...
  var e = $('.flat-picker'),
    ...
    o = { series1: '#ffe700', series2: '#00d4bd', series3: '#826bf8', series4: '#2b9bf4', series5: '#FFA1A1' },
  ...
  var l = document.querySelector('#column-chart'),
    d = {
      ...
      plotOptions: {
        bar: { columnWidth: '15%', colors: { backgroundBarColors: [a.bg, a.bg, a.bg, a.bg, a.bg], backgroundBarRadius: 10 } },
      },
      dataLabels: { enabled: !1 },
      legend: { show: !0, position: 'top', horizontalAlign: 'start' },
  ...
  var g = document.querySelector('#candlestick-chart'),
    u = {
      ...
      plotOptions: {
        candlestick: { colors: { upward: window.colors.solid.success, downward: window.colors.solid.danger } },
        bar: { columnWidth: '40%' },
      },
    };
        ...
        heatmap: {
          ...
          colorScale: {
            ranges: [
              ...
              { from: 51, to: 60, name: '50-60', color: '#b23a3a' },
            ],
          },
        },
      },
      ...
      responsive: [
        { breakpoint: 992, options: { chart: { height: 380 } } },
        {
          ...
          options: {
            ...
            plotOptions: {
              pie: {
                donut: { labels: { show: !0, name: { fontSize: '1.5rem' }, value: { fontSize: '1rem' }, total: { fontSize: '1.5rem' } } },
              },
            },
          },
        },
