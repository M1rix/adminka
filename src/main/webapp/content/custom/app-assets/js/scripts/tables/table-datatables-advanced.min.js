  ...
  if (e.length) {
    $('.dt-column-search thead tr').clone(!0).appendTo('.dt-column-search thead'),
      $('.dt-column-search thead tr:eq(1) th').each(function (a) {
        var e = $(this).text();
        $(this).html('<input type="text" class="form-control form-control-sm" placeholder="Search ' + e + '" />'),
      ...
      columnDefs: [
        { className: 'control', orderable: !1, targets: 0 },
        {
          ...
          render: function (a, e, t, l) {
            ...
            return void 0 === s[n] ? a : '<span class="badge badge-pill ' + s[n].class + '">' + s[n].title + '</span>';
          },
        },
      ],
      dom: '<"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
