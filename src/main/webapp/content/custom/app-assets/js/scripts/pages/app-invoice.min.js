$(function () {
  ...
  r.length &&
    ...
    d.length && d.flatpickr({ defaultDate: new Date(i.getFullYear(), i.getMonth(), i.getDate() + 5) }),
    m.length && m.select2({ placeholder: 'Select country', dropdownParent: m.parent() }),
    $(document).on('click', '.add-new-customer', function () {
      p.select2('close');
    }),
    p.length &&
      (p.select2({ placeholder: 'Select Customer', dropdownParent: $('.invoice-customer') }),
