$(function () {
  ...
  'laravel' === $('body').attr('data-framework') &&
    ((n = $('body').attr('data-asset-path')), (l = n + 'app/user/view'), (r = n + 'app/user/edit')),
    e.length &&
      e.DataTable({
        ...
        columnDefs: [
          { className: 'control', orderable: !1, responsivePriority: 2, targets: 0 },
          {
            targets: 1,
            ...
            render: function (e, t, a, s) {
              var r = a.full_name,
                i = a.username,
                o = a.avatar;
              if (o) var c = '<img src="' + n + 'images/avatars/' + o + '" alt="Avatar" height="32" width="32">';
              else {
                var d = ['success', 'danger', 'warning', 'info', 'dark', 'primary', 'secondary'][Math.floor(6 * Math.random()) + 1],
                  u = (r = a.full_name).match(/\b\w/g) || [];
                c = '<span class="avatar-content">' + (u = ((u.shift() || '') + (u.pop() || '')).toUpperCase()) + '</span>';
              }
              return (
          ...
          },
          {
            ...
            render: function (e, t, a, n) {
              var l = a.status;
              return '<span class="badge badge-pill ' + s[l].class + '" text-capitalized>' + s[l].title + '</span>';
            },
          },
          {
            targets: -1,
            ...
            this.api()
              ...
              .every(function () {
                ...
                e.data()
                  ...
                  .sort()
                  .each(function (e, a) {
                    t.append('<option value="' + s[e].title + '" class="text-capitalize">' + s[e].title + '</option>');
                  });
              });
        },
      }),
    a.length &&
      (a.validate({
        errorClass: 'error',
        rules: { 'user-fullname': { required: !0 }, 'user-name': { required: !0 }, 'user-email': { required: !0 } },
      }),
