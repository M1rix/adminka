...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (eventLabel.length) {
    function renderBullets(option) {
      ...
      var $bullet = "<span class='bullet bullet-" + $(option.element).data('label') + " bullet-sm mr-50'> " + '</span>' + option.text;
  ...
  function eventClick(info) {
    ...
    eventToUpdate.extendedProps.guests !== undefined ? calendarEditor.val(eventToUpdate.extendedProps.description) : null;
