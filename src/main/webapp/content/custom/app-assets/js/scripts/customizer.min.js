!(function (a, n, e) {
  ...
  e('.layout-name').on('click', function () {
    ...
    s.removeClass('dark-layout bordered-layout semi-dark-layout').addClass(a),
      '' === a
        ? (t.removeClass('menu-dark').addClass('menu-light'), d.removeClass('navbar-dark').addClass('navbar-light'))
        : 'dark-layout' === a
        ? (t.removeClass('menu-light').addClass('menu-dark'), d.removeClass('navbar-light').addClass('navbar-dark'))
        : 'semi-dark-layout' === a
        ? (t.removeClass('menu-light').addClass('menu-dark'), d.removeClass('navbar-dark').addClass('navbar-light'))
        : (t.removeClass('menu-dark').addClass('menu-light'), d.removeClass('navbar-dark').addClass('navbar-light'));
  });
  var f = s.data('layout');
  e(".layout-name[data-layout='" + f + "']").prop('checked', !0),
    ...
    e('#customizer-navbar-colors .color-box').on('click', function () {
      ...
      n
        ...
        : o.find(d).removeClass('bg-primary bg-secondary bg-success bg-danger bg-info bg-warning bg-dark navbar-dark'),
    ...
    o.hasClass('horizontal-menu') &&
      ...
      e('.customizer-menu').attr('style', 'display: none !important').next('hr').hide(),
    ...
    e('#nav-type-static').on('click', function () {
      o.hasClass('horizontal-layout')
        ? (i.removeClass('d-none floating-nav fixed-top navbar-fixed container-xxl'),
          o.removeClass('navbar-hidden navbar-floating navbar-sticky').addClass('navbar-static'))
        : (c.addClass('d-none'),
          'horizontal-menu' === r
            ? i.removeClass('d-none floating-nav fixed-top container-xxl').addClass('navbar-static-top')
            : d.removeClass('d-none floating-nav fixed-top container-xxl').addClass('navbar-static-top'),
          o.removeClass('navbar-hidden navbar-floating navbar-sticky').addClass('navbar-static'));
    }),
    e('#nav-type-floating').on('click', function () {
      var a;
      o.hasClass('horizontal-layout')
        ? ((a = e('#layout-width-full').prop('checked') ? 'floating-nav' : 'floating-nav container-xxl'),
        ...
        : ((a = e('#layout-width-full').prop('checked') ? 'floating-nav' : 'floating-nav container-xxl p-0'),
    ...
    e('#nav-type-sticky').on('click', function () {
      o.hasClass('horizontal-layout')
        ? (i.removeClass('d-none floating-nav navbar-static-top navbar-fixed container-xxl').addClass('fixed-top'),
          o.removeClass('navbar-static navbar-floating navbar-hidden').addClass('navbar-sticky'))
        : (c.addClass('d-none'),
          'horizontal-menu' === r
            ? i.removeClass('d-none floating-nav navbar-static-top').addClass('fixed-top')
            : d.removeClass('d-none floating-nav navbar-static-top container-xxl').addClass('fixed-top'),
          o.removeClass('navbar-static navbar-floating navbar-hidden').addClass('navbar-sticky'));
    }),
    ...
    e('#layout-width-boxed').on('click', function () {
      C.addClass('container-xxl p-0'),
        ...
        d.hasClass('floating-nav') && e('.floating-nav').addClass('container-xxl p-0');
    }),
