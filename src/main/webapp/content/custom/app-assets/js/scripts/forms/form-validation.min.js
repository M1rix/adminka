$(function () {
  ...
  $('.select2').each(function () {
    ...
    e.wrap('<div class="position-relative"></div>'),
      e.select2({ placeholder: 'Select value', dropdownParent: e.parent() }).change(function () {
        $(this).valid();
      });
  }),
    i.length &&
      i.flatpickr({
        ...
        onReady: function (e, t, i) {
          i.isMobile && $(i.mobileInput).attr('step', null);
        },
      }),
    a.length &&
      a.flatpickr({
    ...
    e.length &&
      Array.prototype.filter.call(e, function (e) {
        e.addEventListener('submit', function (t) {
          !1 === e.checkValidity() && e.classList.add('invalid'), e.classList.add('was-validated'), t.preventDefault();
        });
      }),
    t.length &&
      t.validate({
        rules: {
          ...
          'confirm-password': { required: !0, equalTo: '#basic-default-password' },
