!(function (e, t, s) {
  ...
  i.each(function () {
    ...
    o.select2({ placeholder: 'Select an option', minimumResultsForSearch: 1 / 0 });
  n.wrap('<div class="position-relative"></div>').select2({
    ...
    l.each(function () {
      var e = s(this);
      e.wrap('<div class="position-relative"></div>'),
        e.select2({ dropdownAutoWidth: !0, dropdownParent: e.parent(), width: '100%', containerCssClass: 'select-lg' });
    }),
    d.each(function () {
      var e = s(this);
      e.wrap('<div class="position-relative"></div>'),
        e.select2({ dropdownAutoWidth: !0, dropdownParent: e.parent(), width: '100%', containerCssClass: 'select-sm' });
    }),
