...
$(function () {
  var s = $('.chat-application .chat-user-list-wrapper'),
    ...
    n = $('.chat-application .sidebar-profile-toggle'),
    t = $('.chat-application .user-profile-toggle'),
    l = $('.user-profile-sidebar'),
    ...
    d = $('.contact-list'),
    f = $('.sidebar-content'),
    v = $('.chat-application .close-icon'),
    u = $('.chat-application .sidebar-close-icon'),
    w = $('.chat-application .menu-toggle'),
    p = $('.speech-to-text'),
    C = $('.chat-application #chat-search');
  if ($.app.menu.is_touch_device())
    s.css('overflow', 'scroll'),
      l.find('.user-profile-sidebar-area').css('overflow', 'scroll'),
    ...
    s.find('ul li').length &&
      s.find('ul li').on('click', function () {
        var e = $(this),
          a = $('.start-chat-area'),
          o = $('.active-chat');
        s.find('ul li').hasClass('active') && s.find('ul li').removeClass('active'),
          e.addClass('active'),
          e.find('.badge').remove(),
      ...
      C.on('keyup', function () {
        ...
        if ('' !== e) {
          ...
          0 == a
            ...
            : h.find('.no-results').hasClass('show') && h.find('.no-results').removeClass('show'),
            0 == o
              ? d.find('.no-results').addClass('show')
              : d.find('.no-results').hasClass('show') && d.find('.no-results').removeClass('show');
  ...
  $(window).on('resize', function () {
    $(window).width() > 992 &&
      ...
      ($('.app-content .sidebar-left').removeClass('show'), $('.chat-application .body-content-overlay').removeClass('show')),
      $(window).width() < 991 &&
        (onClickFn(),
        ($('.chat-application .chat-profile-sidebar').hasClass('show') && $('.chat-application .sidebar-content').hasClass('show')) ||
          ($('.sidebar-content').removeClass('show'), $('.body-content-overlay').removeClass('show')));
  }),
