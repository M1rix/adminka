  ...
  t.length &&
    ...
    e.length &&
      e.on('keyup', function () {
        ...
        $('.icon-card').filter(function () {
          var e = $(this);
          e.text().toLowerCase().indexOf(t) < !1 ? e.css('display', 'none') : e.css('display', 'block');
        });
      }),
    $(document).on('click', '.icon-card', function () {
      ...
      a.find('.icon-card.active').removeClass('active'),
        ...
        e.select(),
        toastr.success(e.value.split("'")[1], 'Icon Name Copied! 📋', { closeButton: !0, tapToDismiss: !1, rtl: c }),
