$(function () {
  ...
  if (
    ($('.data-submit').on('click', function () {
      ...
      '' != e &&
        (o.row.add({ responsive_id: null, id: n, full_name: e, post: a, email: t, start_date: s, salary: '$' + l, status: 5 }).draw(),
        n++,
        $('.modal').modal('hide'));
    }),
  ...
  if (l.length)
    l.DataTable({
      ...
      language: { url: '//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/German.json', paginate: { previous: '&nbsp;', next: '&nbsp;' } },
      dom: '<"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
      displayLength: 7,
      lengthMenu: [7, 10, 25, 50, 75, 100],
      responsive: {
