$(function () {
  ...
  if (
    ('laravel' === $('body').attr('data-framework') &&
      ((t = $('body').attr('data-asset-path')), (e = t + 'app/invoice/preview'), (n = t + 'app/invoice/add'), (s = t + 'app/invoice/edit')),
      ...
      columnDefs: [
        { className: 'control', responsivePriority: 2, targets: 0 },
        {
          ...
          render: function (a, t, n, s) {
            var i = n.invoice_id;
            return '<a class="font-weight-bold" href="' + e + '"> #' + i + '</a>';
          },
        },
        {
          targets: 2,
        ...
        },
        {
          ...
          render: function (a, e, n, s) {
            var i = n.client_name,
              o = n.email,
              l = n.avatar,
              r = ['success', 'danger', 'warning', 'info', 'primary', 'secondary'][Math.floor(6 * Math.random())],
              c = (i = n.client_name).match(/\b\w/g) || [];
            if (((c = ((c.shift() || '') + (c.pop() || '')).toUpperCase()), l))
              var d = '<img src="' + t + 'images/avatars/' + l + '" alt="Avatar" width="32" height="32">';
            ...
            return (
              ...
              'mr-50">' +
              d +
              '</div></div><div class="d-flex flex-column"><span class="user-name font-weight-bold text-truncate">' +
              i +
        ...
        },
        {
          ...
          render: function (a, t, e, n) {
            var s = e.balance;
            if (0 === s) {
              return '<span class="badge badge-pill badge-light-success" text-capitalized> Paid </span>';
            }
            return '<span class="d-none">' + s + '</span>' + s;
          },
        },
        { targets: 7, visible: !1 },
        {
          ...
          width: '80px',
          orderable: !1,
          render: function (a, t, n, i) {
            return (
              '<div class="d-flex align-items-center col-actions"><a class="mr-1" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Send Mail">' +
              ...
              '</a><div class="dropdown"><a class="btn btn-sm btn-icon px-0" data-toggle="dropdown">' +
              feather.icons['more-vertical'].toSvg({ class: 'font-medium-1' }) +
              '</a><div class="dropdown-menu dropdown-menu-right"><a href="javascript:void(0);" class="dropdown-item">' +
              feather.icons.download.toSvg({ class: 'font-small-4 mr-50' }) +
              'Download</a><a href="' +
              s +
              '" class="dropdown-item">' +
              feather.icons.edit.toSvg({ class: 'font-small-4 mr-50' }) +
              'Edit</a><a href="javascript:void(0);" class="dropdown-item">' +
              feather.icons.trash.toSvg({ class: 'font-small-4 mr-50' }) +
              'Delete</a><a href="javascript:void(0);" class="dropdown-item">' +
      ...
      initComplete: function () {
        $(document).find('[data-toggle="tooltip"]').tooltip(),
          this.api()
            ...
            .every(function () {
              var a = this,
                t = $('<select id="UserRole" class="form-control ml-50 text-capitalize"><option value=""> Select Status </option></select>')
