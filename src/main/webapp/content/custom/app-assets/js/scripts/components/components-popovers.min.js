!(function (o, e, p) {
  ...
  p('[data-toggle="popover"]').popover(),
    ...
    p('#show-method').on('click', function () {
      p(this).popover('show');
    }),
    p('#hide-method').on('mouseenter', function () {
      p(this).popover('show');
    }),
    p('#hide-method').on('click', function () {
      p(this).popover('hide');
    }),
    p('#toggle-method').on('click', function () {
      p(this).popover('toggle');
    }),
    p('#dispose').on('click', function () {
      p('#dispose-method').popover('dispose');
    }),
    p('.manual').on('click', function () {
      p(this).popover('show');
    }),
    p('.manual').on('mouseout', function () {
      p(this).popover('hide');
    }),
