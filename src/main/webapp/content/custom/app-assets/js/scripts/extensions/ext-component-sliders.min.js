$(function () {
  ...
  void 0 !== typeof t && null !== t && noUiSlider.create(t, { start: [4e3, 8e3], direction: e, range: { min: [2e3], max: [1e4] } }),
    void 0 !== typeof n &&
      null !== n &&
      noUiSlider.create(n, {
        start: [0, 500],
        ...
        snap: !0,
        connect: !0,
        range: { min: 0, '10%': 50, '20%': 100, '30%': 150, '40%': 500, '50%': 800, max: 1e3 },
      }),
    void 0 !== typeof i &&
      null !== i &&
      noUiSlider.create(i, { start: [20, 40], direction: e, behaviour: 'tap', connect: !0, range: { min: 10, max: 50 } }),
    void 0 !== typeof o &&
      null !== o &&
      noUiSlider.create(o, { start: [40, 60], direction: e, behaviour: 'drag', connect: !0, range: { min: 20, max: 80 } }),
    void 0 !== typeof r &&
      null !== r &&
      noUiSlider.create(r, { start: [40, 60], direction: e, behaviour: 'drag-fixed', connect: !0, range: { min: 20, max: 80 } }),
    void 0 !== typeof d &&
      null !== d &&
      (noUiSlider.create(d, { start: 20, direction: e, behaviour: 'hover-snap', range: { min: 0, max: 100 } }),
      d.noUiSlider.on('hover', function (e) {
        l.innerHTML = e;
      })),
    void 0 !== typeof a &&
      null !== a &&
      noUiSlider.create(a, { start: [40, 60], direction: e, behaviour: 'drag-tap', connect: !0, range: { min: 20, max: 80 } }),
    void 0 !== typeof c &&
      null !== c &&
      noUiSlider.create(c, {
        start: 10,
  ...
  void 0 !== typeof f &&
    null !== f &&
    ((f.style.height = '200px'), noUiSlider.create(f, { start: 20, direction: e, orientation: 'vertical', range: { min: 0, max: 100 } })),
    void 0 !== typeof h &&
      null !== h &&
      ((h.style.height = '200px'),
      noUiSlider.create(h, { start: 30, direction: e, orientation: 'vertical', connect: 'upper', range: { min: 0, max: 100 } })),
    void 0 !== typeof E &&
      null !== E &&
  ...
  if (
    (void 0 !== typeof x &&
      null !== x &&
      (noUiSlider.create(x, { start: [10, 30], direction: e, connect: !0, range: { min: -20, max: 40 } }),
