$(function () {
  ...
  if (('laravel' === $('body').attr('data-framework') && (e = $('body').attr('data-asset-path')), $('#basic-map').length)) {
  ...
  if ($('#shape-map').length) {
    ...
    L.marker([51.5, -0.09]).addTo(r),
      L.circle([51.508, -0.11], { color: 'red', fillColor: '#f03', fillOpacity: 0.5, radius: 500 }).addTo(r),
      L.polygon([
        [51.509, -0.08],
        [51.503, -0.06],
        [51.51, -0.047],
  ...
  if ($('#drag-map').length) {
    ...
    L.marker([48.817152, 2.455], { draggable: 'true' }).addTo(a).bindPopup("<b>You're here!</b>").openPopup(),
      L.tileLayer('https://{s}.tile.osm.org/{z}/{x}/{y}.png', {
        attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
        maxZoom: 18,
      }).addTo(a);
  ...
  if ($('#layer-control').length) {
    var m = L.marker([39.61, -105.02]).bindPopup('This is Littleton, CO.'),
      ...
      F = L.map('layer-control', { center: [39.73, -104.99], zoom: 10, layers: [h, u] }),
