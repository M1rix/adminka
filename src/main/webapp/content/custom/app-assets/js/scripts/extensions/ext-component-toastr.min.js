$(function () {
  ...
  n.on('click', function () {
    ...
    i.on('click', function () {
      toastr.info('👋 Chupa chups biscuit brownie gummi sugar plum caramels.', 'Info!', { closeButton: !0, tapToDismiss: !1, rtl: o });
    }),
    s.on('click', function () {
    ...
    p.on('click', function () {
      t ||
        (t = toastr.info(
          ...
          'Family Trip',
          { closeButton: !0, timeOut: 0, extendedTimeOut: 0, tapToDismiss: !1, rtl: o }
        )),
        t.find('.clear').length &&
