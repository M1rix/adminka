  ...
  (function (e, t) {
      ...
      ee = t(function (e) {
        ...
        (e.exports = function (e, t, a, o) {
          var s = !!o && !!o.unsafe,
            ...
            c = !!o && !!o.noTargetGet;
          'function' == typeof a &&
            ('string' != typeof t || b(a, 'name') || O(a, 'name', t), (n(a).source = r.join('string' == typeof t ? t : ''))),
            e !== i ? (s ? !c && e[t] && (l = !0) : delete e[t], l ? (e[t] = a) : O(e, t, a)) : l ? (e[t] = a) : I(t, a);
      ...
      Ie = function (e, t) {
        ...
        if ((n = c ? i : u ? i[l] || I(l, {}) : (i[l] || {}).prototype))
          for (r in t) {
            if (
              ((o = t[r]),
              (a = e.noTargetGet ? (s = Oe(n, r)) && s.value : n[r]),
              !Ce(c ? r : l + (u ? '.' : '#') + r, e.forced) && void 0 !== a)
            ) {
    ...
    var Be =
        ...
        function (e, t) {
          var n;
          return (
            null !== e ? ((Fe.prototype = P(e)), (n = new Fe()), (Fe.prototype = null), (n[De] = e)) : (n = He()),
            void 0 === t ? n : _e(n, t)
          );
        },
      Ve = ye.f,
      ...
      ot = function (e, t) {
        ...
        return (
          Ne(e) &&
            ('function' != typeof (n = e.constructor) || (n !== Array && !Ne(n.prototype))
      ...
      lt = function (e) {
        ...
        return function (s, l, c, u) {
          for (
            var h, f, p = Re(s), m = d(p), g = rt(l, c, 3), v = le(m.length), y = 0, b = u || ot, w = t ? b(s, v) : n ? b(s, 0) : void 0;
            v > y;
            y++
          )
      ...
      It = function (e, t) {
        ...
        return dt(n, { type: 'Symbol', tag: e, description: t }), a || (n.description = t), n;
      },
      Lt = je
        ? function (e) {
      ...
      jt = function (e, t, n) {
        ...
        return (
          ...
          b(Tt, i)
            ? (n.enumerable
                ? (b(e, ht) && e[ht][i] && (e[ht][i] = !1), (n = Be(n, { enumerable: c(0, !1) })))
    ...
    if (
      (Le ||
        ...
        a &&
          ...
          ee(mt, 'propertyIsEnumerable', Rt, { unsafe: !0 }))),
      Ie({ global: !0, wrap: !0, forced: !Le, sham: !Le }, { Symbol: gt }),
      ut(Me(Pt), function (e) {
        Ze(e);
      }),
      Ie(
      ...
      Ie({ target: 'Object', stat: !0, forced: !Le }, { getOwnPropertyNames: _t, getOwnPropertySymbols: Ut }),
      Ie(
        {
          target: 'Object',
          stat: !0,
      ...
      var Dt =
        ...
        r(function () {
          var e = gt();
          return '[null]' != vt([e]) || '{}' != vt({ a: e }) || '{}' != vt(Object(e));
        });
      Ie(
          ...
          stringify: function (e, t, n) {
            ...
            if (((i = t), (g(t) || void 0 !== e) && !Lt(e)))
              return (
                Ne(t) ||
                  (t = function (e, t) {
                    if (('function' == typeof i && (t = i.call(this, e, t)), !Lt(t))) return t;
                  }),
                (r[1] = t),
                vt.apply(null, r)
              );
    ...
    gt.prototype[ft] || O(gt.prototype, ft, gt.prototype.valueOf), nt(gt, 'Symbol'), (W[ht] = !0);
    var Ft = C.f,
      qt = i.Symbol;
      ...
      Qt = function (e, t) {
        ...
        return (Gt[e] =
          ...
          !r(function () {
            if (i && !a) return !0;
            var e = { length: -1 };
            i ? Yt(e, 1, { enumerable: !0, get: Xt }) : (e[1] = 1), n.call(e, o, s);
          }));
      },
      Jt = ct.forEach,
      Zt = $t('forEach'),
    ...
    Ie({ target: 'Array', proto: !0, forced: [].forEach != tn }, { forEach: tn });
    var nn = de.indexOf,
      rn = [].indexOf,
    ...
    var ln = Xe('unscopables'),
      cn = Array.prototype;
    null == cn[ln] && C.f(cn, ln, { configurable: !0, value: Be(null) });
    var un,
      hn,
      fn,
      dn = function (e) {
      ...
      bn = Xe('iterator'),
      wn = !1;
    [].keys && ('next' in (fn = [].keys()) ? (hn = yn(yn(fn))) !== Object.prototype && (un = hn) : (wn = !0)),
      null == un && (un = {}),
      b(un, bn) ||
        O(un, bn, function () {
          return this;
    ...
    var kn = { IteratorPrototype: un, BUGGY_SAFARI_ITERATORS: wn },
      ...
      En = function (e, t, n) {
        var i = t + ' Iterator';
        return (e.prototype = Be(Tn, { next: c(1, n) })), nt(e, i, !1), (pn[i] = Sn), e;
      },
      An =
      ...
      In = function (e, t, n, i, r, a, o) {
        ...
        if (
          (g &&
            ...
            Pn !== Object.prototype &&
              s.next &&
              (yn(s) !== Pn && (An ? An(s, Pn) : 'function' != typeof s[Cn] && O(s, Cn, On)), nt(s, h, !0))),
          'values' == r &&
            p &&
            'values' !== p.name &&
            ((f = !0),
          ...
          if (((l = { values: u('values'), keys: a ? m : u('keys'), entries: u('entries') }), o))
            for (c in l) (xn || f || !(c in d)) && ee(d, c, l[c]);
          else Ie({ target: t, proto: !0, forced: xn || f }, l);
        return l;
      },
      Ln = Z.set,
    ...
    var Rn = [].join,
      ...
      _n = $t('join', ',');
    Ie(
      { target: 'Array', proto: !0, forced: Mn || !_n },
      {
        join: function (e) {
    ...
    var Un,
      ...
      Vn = Bn && Bn.v8;
    Vn
      ? (Dn = (Un = Vn.split('.'))[0] + Un[1])
      : qn && (!(Un = qn.match(/Edge\/(\d+)/)) || Un[1] >= 74) && (Un = qn.match(/Chrome\/(\d+)/)) && (Dn = Un[1]);
    var zn = Dn && +Dn,
      Wn = Xe('species'),
      Kn = function (e) {
        return (
    ...
    Ie(
      { target: 'Array', proto: !0, forced: !$n || !Yn },
      {
        slice: function (e, t) {
          ...
          if (
            Ne(a) &&
            ('function' != typeof (n = a.constructor) || (n !== Array && !Ne(n.prototype))
    ...
    (ui || fi || hi) &&
      (ci = function (e) {
        ...
        return (
          ...
          o
            ? i
              ? ((i.input = i.input.slice(c)), (i[0] = i[0].slice(c)), (i.index = a.lastIndex), (a.lastIndex += i[0].length))
              : (a.lastIndex = 0)
    ...
    var di = ci;
    Ie({ target: 'RegExp', proto: !0, forced: /./.exec !== di }, { exec: di });
    ...
    In(
      ...
      function () {
        var e,
          ...
          n = t.string,
          i = t.index;
        return i >= n.length ? { value: void 0, done: !0 } : ((e = wi(n, i)), (t.index += e.length), { value: e, done: !1 });
      }
    );
    var Si = Xe('species'),
      Ei = !r(function () {
              ...
              ? function (e, n) {
                  ...
                  for (
                    ...
                    !(
                      ...
                      a.length > 1 && a.index < i.length && Vi.apply(l, a.slice(1)),
                      (s = a[0].length),
                      (u = o),
                      l.length >= r)
                    );
          ...
          [
            ...
            function (e, r) {
              ...
              for (var d = 0, p = 0, m = []; p < s.length; ) {
                ...
                if (null === v || (g = zi(le(h.lastIndex + (Wi ? 0 : p)), s.length)) === d) p = Li(s, p, c);
                else {
    ...
    var ir = Xe('iterator'),
      ...
      mr = function (e) {
        var t,
          ...
          f = pr(s),
          d = 0;
        if ((h && (u = rt(u, c > 2 ? arguments[2] : void 0, 2)), null == f || (l == Array && fr(f))))
          for (n = new l((t = le(s.length))); t > d; d++) (o = h ? u(s[d], d) : s[d]), Fn(n, d, o);
        else
          for (a = (r = f.call(s)).next, n = new l(); !(i = a.call(r)).done; d++)
      ...
      Wr = function () {
        ...
        var e,
          ...
          u = this,
          h = [];
        if ((Or(u, { type: 'URLSearchParams', entries: h, updateURL: function () {}, updateSearchParams: Br }), void 0 !== c))
          if (g(c))
            if ('function' == typeof (e = pr(c)))
              for (n = (t = e.call(c)).next; !(i = n.call(t)).done; ) {
                if ((o = (a = (r = Ar(P(i.value))).next).call(r)).done || (s = a.call(r)).done || !a.call(r).done)
    ...
    Er(
      ...
      Ie({ global: !0, forced: !rr }, { URLSearchParams: Wr }),
      rr ||
        'function' != typeof Pr ||
        'function' != typeof xr ||
        Ie(
                ...
                arguments.length > 1 &&
                  ...
                  g(t) &&
                    ...
                    'URLSearchParams' === ni(n) &&
                      ((i = t.headers ? new xr(t.headers) : new xr()).has('content-type') ||
                        i.set('content-type', 'application/x-www-form-urlencoded;charset=UTF-8'),
                      (t = Be(t, { body: c(0, String(n)), headers: c(0, i) })))),
                  r.push(t)),
                Pr.apply(this, r)
              );
            },
    ...
    var $r,
      ...
      ma = function (e) {
        ...
        for (n = [], i = 0; i < t; i++) {
          if ('' == (r = l[i])) return e;
          if (((a = 10), r.length > 1 && '0' == r.charAt(0) && ((a = oa.test(r) ? 16 : 8), (r = r.slice(8 == a ? 1 : 2))), '' === r)) o = 0;
          else {
      ...
      va = function (e) {
        ...
        if ('object' == typeof e) {
          for (
            ...
            (r && 0 === e[n]) ||
              (r && (r = !1), i === n ? ((t += n ? ':' : '::'), (r = !0)) : ((t += e[n].toString(16)), n < 7 && (t += ':')));
          return '[' + t + ']';
        }
        return e;
      },
        ...
        for (
          ...
          switch (((a = r[u]), c)) {
            case La:
              ...
              break;
            case ja:
              if (a && (ra.test(a) || '+' == a || '-' == a || '.' == a)) h += a.toLowerCase();
              else {
                if (':' != a) {
                  if (n) return 'Invalid scheme';
                  (h = ''), (c = Na), (u = 0);
            ...
            case za:
              if (((e.scheme = 'file'), '/' == a || '\\' == a)) c = Wa;
                ...
                else if ('?' == a) (e.host = i.host), (e.path = i.path.slice()), (e.query = ''), (c = Xa);
                else {
                  if ('#' != a) {
            ...
            case Wa:
              ...
              i && 'file' == i.scheme && !Ca(r.slice(u).join('')) && (xa(i.path[0], !0) ? e.path.push(i.path[0]) : (e.host = i.host)),
                (c = Ya);
              continue;
            case Ka:
              if (a == $r || '/' == a || '\\' == a || '?' == a || '#' == a) {
              ...
              if (a == $r || '/' == a || ('\\' == a && Ea(e)) || (!n && ('?' == a || '#' == a))) {
                if (
                  ('..' === (l = (l = h).toLowerCase()) || '%2e.' === l || '.%2e' === l || '%2e%2e' === l
                    ? (Oa(e), '/' == a || ('\\' == a && Ea(e)) || e.path.push(''))
                    : Ia(h)
                    ? '/' == a || ('\\' == a && Ea(e)) || e.path.push('')
                    : ('file' == e.scheme && !e.path.length && xa(h) && (e.host && (e.host = ''), (h = h.charAt(0) + ':')), e.path.push(h)),
                  (h = ''),
            ...
            case Xa:
              n || '#' != a
                ? a != $r && ("'" == a && Ea(e) ? (e.query += '%27') : (e.query += '#' == a ? '%23' : Ta(a, ya)))
                : ((e.fragment = ''), (c = Qa));
              break;
            case Qa:
      ...
      to = function () {
        ...
        return (
          null !== r
            ? ((c += '//'), Aa(e) && (c += n + (i ? ':' + i : '') + '@'), (c += va(r)), null !== a && (c += ':' + a))
            : 'file' == t && (c += '//'),
      ...
      (a &&
        _e(eo, {
          ...
          search: po(uo, function (e) {
            var t = ea(this);
            '' == (e = String(e)) ? (t.query = null) : ('?' == e.charAt(0) && (e = e.slice(1)), (t.query = ''), Ja(t, e, Xa)),
              Jr(t.searchParams).updateSearchParams(t.query);
          }),
          searchParams: po(ho),
    ...
    nt(Za, 'URL'),
      Ie({ global: !0, forced: !rr, sham: !a }, { URL: Za }),
      (function (e) {
        var t = (function () {
            try {
            ...
            (function () {
              var t = e.URL,
                n = function (t, n) {
                  ...
                  if (((a.href = t), i && (r.body.appendChild(a), (a.href = a.href)), ':' === a.protocol || !/:/.test(a.href)))
    ...
    Ie(
      { target: 'Array', proto: !0, forced: !Io || !Lo },
      {
        concat: function (e) {
          var t,
            n,
    ...
    'find' in [] &&
      ...
      Ie(
        { target: 'Array', proto: !0, forced: Uo || !Do },
        {
          find: function (e) {
    ...
    Ie({ target: 'Array', stat: !0, forced: zo }, { from: mr });
    var Wo = de.includes,
      Ko = Qt('indexOf', { ACCESSORS: !0, 1: 0 });
    Ie(
    ...
    var $o = ct.map,
      ...
      Go = Qt('map');
    Ie(
      { target: 'Array', proto: !0, forced: !Yo || !Go },
      {
        map: function (e) {
    ...
    var Xo = function (e, t, n) {
      ...
      us = function (e) {
        ...
        if ('string' == typeof c && c.length > 2)
          if (43 === (t = (c = os(c)).charCodeAt(0)) || 45 === t) {
    ...
    Ie(
      { target: 'Object', stat: !0, forced: ms },
      {
        keys: function (e) {
          return Me(Re(e));
        },
    ...
    Ie(
      { target: 'String', proto: !0, forced: !ys('includes') },
      {
        includes: function (e) {
      ...
      ks =
        ...
        t(function (e) {
          ...
          (e.exports = function (e, n, i, r, a) {
            ...
            for (h = o.next; !(f = h.call(o)).done; ) if ('object' == typeof (u = cr(o, d, f.value, r)) && u && u instanceof t) return u;
            return new t(!1);
          }).stop = function (e) {
            return new t(!0, e);
          };
          ...
          var t,
            ...
            l = (e.exports = (function (e, t, n) {
              ...
              if (
                ...
                (u = n.getConstructor(t, e, a, s)), (ws.REQUIRED = !0);
              else if (Ce(e, !0)) {
                var d = new u(),
                  p = d[s](o ? {} : -0, 1) != d,
                  m = r(function () {
    ...
    Ie(
      ...
      Ie({ target: 'Object', stat: !0, forced: Object.assign !== lr }, { assign: lr });
    var Ms = ns.trim;
    Ie(
      {
        target: 'String',
    ...
    var _s = ct.some,
      ...
      Ds = Qt('some');
    Ie(
      { target: 'Array', proto: !0, forced: !Us || !Ds },
      {
        some: function (e) {
    ...
    Ie(
      { target: 'Number', proto: !0, forced: Vs },
      {
        toFixed: function (e) {
          var t,
            n,
            ...
            c = '0',
            u = function (e, t) {
              for (var n = -1, i = t; ++n < 6; ) (i += e * s[n]), (s[n] = i % 1e7), (i = Hs(i / 1e7));
            },
            f = function (e) {
              for (var t = 6, n = 0; --t >= 0; ) (n += s[t]), (s[t] = Hs(n / e)), (n = (n % e) * 1e7);
            },
            d = function () {
              for (var e = 6, t = ''; --e >= 0; )
                if ('' !== t || 0 === e || 0 !== s[e]) {
          ...
          if ((a < 0 && ((l = '-'), (a = -a)), a > 1e-21))
            if (
              ...
              for (u(Bs(10, i, 1), 0), i = t - 1; i >= 23; ) f(1 << 23), (i -= 23);
              f(1 << i), u(1, 1), f(2), (c = d());
            } else u(0, n), u(1 << -t, 0), (c = d() + Fs.call('0', o));
          return (c =
            o > 0 ? l + ((r = c.length) <= o ? '0.' + Fs.call('0', o - r) + c : c.slice(0, r - o) + '.' + c.slice(r - o)) : l + c);
        },
      }
    );
    var zs = l.f,
    ...
    Ie(
      { target: 'Object', stat: !0, forced: !a || Xs, sham: !a },
      {
    ...
    var tl = { addCSS: !0, thumbWidth: 15, watch: !0 };
    function nl(e, t) {
      return function () {
      ...
      wl = (function () {
        function e(t, n) {
          (function (e, t) {
            ...
            dl(t) ? (this.element = t) : ul(t) && (this.element = document.querySelector(t)),
            dl(this.element) && ml(this.element.rangeTouch) && ((this.config = el({}, tl, {}, n)), this.init());
        }
        return (
          (function (e, t, n) {
            ...
            [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    0 > (n = (100 / l.width) * (r.clientX - l.left)) ? (n = 0) : 100 < n && (n = 100),
            ...
            [
              {
                ...
                value: function (t) {
                  ...
                  if (
                    (ml(t) || ul(t)
                      ? (i = Array.from(document.querySelectorAll(ul(t) ? t : 'input[type="range"]')))
                      : dl(t)
                      ? (i = [t])
                      : fl(t)
                      ? (i = Array.from(t))
    ...
    (Pl && xl) ||
      ...
      'process' == h(Cl)
        ...
        : Ol && !El
        ? ((bl = (yl = new Ol()).port2), (yl.port1.onmessage = Ml), (vl = rt(bl.postMessage, bl, 1)))
        : !i.addEventListener || 'function' != typeof postMessage || i.importScripts || r(_l) || 'file:' === Al.protocol
        ? (vl =
    ...
    Zl ||
      ...
      Ql
        ...
        : Yl && !El
        ? ((Hl = !0),
          (Bl = document.createTextNode('')),
          new Yl(Ul).observe(Bl, { characterData: !0 }),
          (ql = function () {
            Bl.data = Hl = !Hl;
          }))
        : Xl && Xl.resolve
        ? ((Vl = Xl.resolve(void 0)),
          (zl = Vl.then),
          (ql = function () {
            zl.call(Vl, Ul);
          }))
    ...
    var ec,
      ...
      Ec = Ce(hc, function () {
        ...
        if (zn >= 51 && /native code/.test(mc)) return !1;
        var e = mc.resolve(1),
          t = function (e) {
            e(
              function () {},
        ...
        if (!t.notified) {
          ...
          rc(function () {
            for (var r = t.value, a = 1 == t.state, o = 0; i.length > o; ) {
              ...
              try {
                h
                  ? (a || (2 === t.rejection && Lc(e, t), (t.rejection = 1)),
                    !0 === h ? (s = r) : (p && p.enter(), (s = h(r)), p && (p.exit(), (c = !0))),
                    s === u.promise ? d(gc('Promise-chain cycle')) : (l = Pc(s)) ? l.call(s, f, d) : f(s))
                  : d(r);
              } catch (e) {
                p && !c && p.exit(), d(e);
              }
      ...
      Cc = function (e, t, n) {
        var r, a;
        Sc
          ? (((r = vc.createEvent('Event')).promise = t), (r.reason = n), r.initEvent(e, !1, !0), i.dispatchEvent(r))
    ...
    Ec &&
      ((mc = function (e) {
        ar(this, mc, hc), it(e), ec.call(this);
        var t = fc(this);
        try {
      ...
      ((ec = function (e) {
        ...
        then: function (e, t) {
          ...
          return (
            ...
            (i.domain = Tc ? yc.domain : void 0),
            (n.parent = !0),
            n.reactions.push(i),
            0 != n.state && xc(this, n, !1),
            i.promise
          );
        },
        catch: function (e) {
      ...
      (oc.f = wc =
        function (e) {
          return e === mc || e === nc ? new tc(e) : kc(e);
        }),
      'function' == typeof kl &&
        ((ic = kl.prototype.then),
        ee(
          kl.prototype,
          'then',
          function (e, t) {
            var n = this;
            return new mc(function (e, t) {
              ic.call(n, e, t);
            }).then(e, t);
          },
          { unsafe: !0 }
        ...
        'function' == typeof bc &&
          Ie(
            ...
            {
              fetch: function (e) {
                return sc(mc, bc.apply(i, arguments));
              },
            }
          ))),
      Ie({ global: !0, wrap: !0, forced: Ec }, { Promise: mc }),
      nt(mc, hc, !1),
      Sl(hc),
      (nc = ie(hc)),
      Ie(
        { target: hc, stat: !0, forced: Ec },
        {
          reject: function (e) {
            var t = wc(this);
    ...
    Ie(
      { target: 'String', proto: !0, forced: !qc && !Fc },
      {
    ...
    function Cu(e) {
      if (su(e)) for (var t = e.childNodes.length; t > 0; ) e.removeChild(e.lastChild), (t -= 1);
    }
    function Ou(e, t) {
    ...
    function Uu() {
      ...
      su(e) && (e.focus({ preventScroll: !0 }), t && ju(e, this.config.classNames.tabFocus));
    }
    Ie(
      { target: 'Array', proto: !0, forced: !bu || !wu },
      {
        reduce: function (e) {
      ...
      qu = {
        ...
        check: function (e, t, n) {
          var i = gu.isIPhone && n && qu.playsinline,
            r = qu[e] || 'html5' !== t;
          return { api: r, ui: r && qu.rangeInput && ('video' !== e || !gu.isIPhone || i) };
        },
        pip: !(
          gu.isIPhone ||
          (!ru(Au('video').webkitSetPresentationMode) && (!document.pictureInPictureEnabled || Au('video').disablePictureInPicture))
        ),
    ...
    function Bu(e, t, n) {
      ...
      if (e && 'addEventListener' in e && !du(t) && ru(n)) {
        var s = t.split(' '),
          l = o;
        Hu && (l = { passive: a, capture: o }),
          s.forEach(function (t) {
            i && i.eventListeners && r && i.eventListeners.push({ element: e, type: t, callback: n, options: l }),
    ...
    function Ku(e) {
      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '',
        ...
        i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
      if (su(e) && !du(t)) {
        var r = new CustomEvent(t, { bubbles: n, detail: So(So({}, i), {}, { plyr: this }) });
        e.dispatchEvent(r);
      }
    }
    function $u() {
    ...
    function Ju(e) {
      ...
      if (
        ...
        null === n && !du(this.embed) && au(this.embed.ratio) && (n = this.embed.ratio),
        null === n && this.isHTML5)
      ) {
        var i = this.media;
      ...
      setup: function () {
        if (this.isHTML5) {
          ...
          (e.options.speed = e.config.speed.options),
            du(this.config.ratio) || Zu.call(e),
            Object.defineProperty(e.media, 'quality', {
              ...
              set: function (t) {
                if (e.quality !== t) {
                  if (e.config.quality.forced && ru(e.config.quality.onChange)) e.config.quality.onChange(t);
                  else {
    ...
    if (
      ...
      for (
        var fh = function (e, t) {
            ...
            uh ? r && !a && (e = e.source) : e instanceof fh && (a && (t = ri.call(e)), (e = e.source)),
              hh && (n = !!t && t.indexOf('y') > -1) && (t = t.replace(/y/g, ''));
            var o = Xo(uh ? new oh(e, t) : oh(e, t), i ? this : sh, fh);
            return hh && n && rh(o, { sticky: n }), o;
          },
          dh = function (e) {
            (e in fh) ||
              nh(fh, e, {
    ...
    var jh = {
      ...
      findElements: function () {
        try {
          return (
            (this.elements.controls = _u.call(this, this.config.selectors.controls.wrapper)),
            ...
            (this.elements.progress = _u.call(this, this.config.selectors.progress)),
      ...
      createIcon: function (e, t) {
        ...
        Eu(r, Tu(t, { 'aria-hidden': 'true', focusable: 'false' }));
      ...
      createLabel: function (e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          n = Th(e, this.config),
          i = So(So({}, t), {}, { class: [t.class, this.config.classNames.hidden].filter(Boolean).join(' ') });
        return Au('span', i, n);
      },
      createBadge: function (e) {
        if (du(e)) return null;
        var t = Au('span', { class: this.config.classNames.menu.value });
        return t.appendChild(Au('span', { class: this.config.classNames.menu.badge }, e)), t;
      },
      createButton: function (e, t) {
        ...
        switch (
          ...
          Object.keys(i).includes('class')
            ? i.class.split(' ').some(function (e) {
              ...
              }) || Tu(i, { class: ''.concat(i.class, ' ').concat(this.config.classNames.control) })
        ...
        return (
          a.toggle
            ? (o.appendChild(jh.createIcon.call(this, a.iconPressed, { class: 'icon--pressed' })),
              o.appendChild(jh.createIcon.call(this, a.icon, { class: 'icon--not-pressed' })),
              o.appendChild(jh.createLabel.call(this, a.labelPressed, { class: 'label--pressed' })),
              o.appendChild(jh.createLabel.call(this, a.label, { class: 'label--not-pressed' })))
            : (o.appendChild(jh.createIcon.call(this, a.icon)), o.appendChild(jh.createLabel.call(this, a.label))),
          Tu(i, Iu(this.config.selectors.buttons[r], i)),
          Eu(o, i),
          'play' === r
            ? (au(this.elements.buttons[r]) || (this.elements.buttons[r] = []), this.elements.buttons[r].push(o))
      ...
      createRange: function (e, t) {
        var n = Au(
          'input',
          Tu(
            Iu(this.config.selectors.inputs[e]),
            {
              type: 'range',
              min: 0,
              max: 100,
      ...
      createProgress: function (e, t) {
        var n = Au(
          'progress',
          Tu(Iu(this.config.selectors.display[e]), { min: 0, max: 100, value: 0, role: 'progressbar', 'aria-hidden': !0 }, t)
        );
        if ('volume' !== e) {
        ...
        Vu.call(
          ...
          function (i) {
            if ([32, 38, 39, 40].includes(i.which) && (i.preventDefault(), i.stopPropagation(), 'keydown' !== i.type)) {
              ...
              if (!a && [32, 39].includes(i.which)) jh.showMenuPanel.call(n, t, !0);
              else
                32 !== i.which &&
                  (40 === i.which || (a && 39 === i.which)
                    ? ((r = e.nextElementSibling), su(r) || (r = e.parentNode.firstElementChild))
                    : ((r = e.previousElementSibling), su(r) || (r = e.parentNode.lastElementChild)),
                  Uu.call(n, r, !0));
            }
          },
          !1
        ),
          Vu.call(this, e, 'keyup', function (e) {
      ...
      createMenuItem: function (e) {
        ...
        (f.innerHTML = a),
          ...
          jh.bindMenuItemShortcuts.call(this, h, r),
          i.appendChild(h);
      },
      formatTime: function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
      ...
      updateVolume: function () {
        this.supported.ui &&
          (su(this.elements.inputs.volume) && jh.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
          su(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume));
      },
      setRange: function (e) {
            ...
            switch (e.type) {
              ...
              case 'seeked':
                (n = (function (e, t) {
                  ...
                  'timeupdate' === e.type && jh.setRange.call(this, this.elements.inputs.seek, n);
                break;
              case 'playing':
              case 'progress':
                !(function (e, n) {
      ...
      updateSeekTooltip: function (e) {
        ...
        if (this.config.tooltips.seek && su(this.elements.inputs.seek) && su(this.elements.display.seekTooltip) && 0 !== this.duration) {
          ...
          if (this.touch) i(!1);
            ...
            if (lu(e)) r = (100 / a.width) * (e.pageX - a.left);
            else {
              if (!Nu(this.elements.display.seekTooltip, n)) return;
              r = parseFloat(this.elements.display.seekTooltip.style.left, 10);
            }
            r < 0 ? (r = 0) : r > 100 && (r = 100),
              jh.updateTimeDisplay.call(this, this.elements.display.seekTooltip, (this.duration / 100) * r),
              (this.elements.display.seekTooltip.style.left = ''.concat(r, '%')),
              lu(e) && ['mouseenter', 'mouseleave'].includes(e.type) && i('mouseenter' === e.type);
          }
        }
      },
      timeUpdate: function (e) {
        var t = !su(this.elements.display.duration) && this.config.invertTime;
        jh.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
          (e && 'timeupdate' === e.type && this.media.seeking) || jh.updateProgress.call(this, e);
      },
      durationUpdate: function () {
        if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
          ...
          !e &&
            ...
            this.paused &&
            jh.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
            e && jh.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
            jh.updateSeekTooltip.call(this);
        }
      },
      ...
      updateSetting: function (e, t, n) {
        ...
        if ('captions' === e) r = this.currentTrack;
          ...
          if (((r = du(n) ? this[e] : n), du(r) && (r = this.config[e].default), !du(this.options[e]) && !this.options[e].includes(r)))
        ...
        if ((su(a) || (a = i && i.querySelector('[role="menu"]')), su(a))) {
          this.elements.settings.buttons[e].querySelector('.'.concat(this.config.classNames.menu.value)).innerHTML = jh.getLabel.call(
            this,
            e,
            r
          );
      ...
      setQualityMenu: function (e) {
        ...
        if (su(this.elements.settings.panels.quality)) {
          ...
          au(e) &&
            (this.options.quality = th(e).filter(function (e) {
      ...
      setCaptionsMenu: function () {
        ...
        if (su(this.elements.settings.panels.captions)) {
          ...
          if ((jh.toggleMenuButton.call(this, 'captions', i), Cu(t), jh.checkMenu.call(this), i)) {
            ...
            r.unshift({ value: -1, checked: !this.captions.toggled, title: Th('disabled', this.config), list: t, type: 'language' }),
              r.forEach(jh.createMenuItem.bind(this)),
              jh.updateSetting.call(this, 'captions', t);
          }
        }
      },
      setSpeedMenu: function () {
        ...
        if (su(this.elements.settings.panels.speed)) {
          ...
          jh.toggleMenuButton.call(this, 'speed', n),
            Cu(t),
            jh.checkMenu.call(this),
            n &&
      ...
      toggleMenu: function (e) {
        ...
        if (su(t) && su(n)) {
          ...
          n.setAttribute('aria-expanded', r),
            Lu(t, !r),
            ju(this.elements.container, this.config.classNames.menu.open, r),
            r && cu(e) ? jh.focusFirstMenuItem.call(this, null, !0) : r || i || Uu.call(this, n, cu(e));
        }
      },
            ...
            var o = jh.getMenuSize.call(this, i),
              s = function t(n) {
                n.target === r &&
                  ...
                  ((r.style.width = ''), (r.style.height = ''), zu.call(e, r, pu, t));
              };
      ...
      create: function (e) {
        ...
        return (
          th(au(this.config.controls) ? this.config.controls : []).forEach(function (s) {
            if (
            ...
            if (
              ...
              if (
                ((su(p) && u.contains(p)) ||
                  ((p = Au('div', Tu({}, h, { class: ''.concat(h.class, ' plyr__volume').trim() }))),
                  (t.elements.volume = p),
                  u.appendChild(p)),
                ...
                p.appendChild(a.call(t, 'volume', Tu(m, { id: 'plyr-volume-'.concat(e.id) })));
              }
            }
            if (('captions' === s && u.appendChild(i.call(t, 'captions', h)), 'settings' === s && !du(t.config.settings))) {
              var g = Au('div', Tu({}, h, { class: ''.concat(h.class, ' plyr__menu').trim(), hidden: '' }));
              g.appendChild(
                i.call(t, 'settings', { 'aria-haspopup': !0, 'aria-controls': 'plyr-settings-'.concat(e.id), 'aria-expanded': !1 })
              );
              var v = Au('div', { class: 'plyr__menu__container', id: 'plyr-settings-'.concat(e.id), hidden: '' }),
                y = Au('div'),
              ...
              b.appendChild(w),
                ...
                t.config.settings.forEach(function (i) {
                  var r = Au(
                    'button',
                    Tu(Iu(t.config.selectors.buttons.settings), {
                      type: 'button',
                  ...
                  n.call(t, r, i),
                    Vu.call(t, r, 'click', function () {
                      c.call(t, i, !1);
                    });
                  var a = Au('span', null, Th(i, t.config)),
                    o = Au('span', { class: t.config.classNames.menu.value });
                  (o.innerHTML = e[i]), a.appendChild(o), r.appendChild(a), w.appendChild(r);
                  var s = Au('div', { id: 'plyr-settings-'.concat(e.id, '-').concat(i), hidden: '' }),
                    l = Au('button', {
                      type: 'button',
                      class: ''.concat(t.config.classNames.control, ' ').concat(t.config.classNames.control, '--back'),
                    });
                  l.appendChild(Au('span', { 'aria-hidden': !0 }, Th(i, t.config))),
                    l.appendChild(Au('span', { class: t.config.classNames.hidden }, Th('menuBack', t.config))),
                    Vu.call(
                      t,
                      s,
                      'keydown',
                    ...
                    Vu.call(t, l, 'click', function () {
                      c.call(t, 'home', !1);
                    }),
                    s.appendChild(l),
                    s.appendChild(Au('div', { role: 'menu' })),
                    y.appendChild(s),
            ...
            if (
              ('pip' === s && qu.pip && u.appendChild(i.call(t, 'pip', h)),
              'airplay' === s && qu.airplay && u.appendChild(i.call(t, 'airplay', h)),
              'download' === s)
            ) {
              var k = Tu({}, h, { element: 'a', href: t.download, target: '_blank' });
              t.isHTML5 && (k.download = '');
              var T = t.config.urls.download;
              !fu(T) && t.isEmbed && Tu(k, { icon: 'logo-'.concat(t.provider), label: t.provider }),
                u.appendChild(i.call(t, 'download', k));
            }
            'fullscreen' === s && u.appendChild(i.call(t, 'fullscreen', h));
          }),
          this.isHTML5 && s.call(this, eh.getQualityOptions.call(this)),
          l.call(this),
          u
        );
      },
      inject: function () {
        ...
        var i = { id: this.id, seektime: this.config.seekTime, title: this.config.title },
          r = !0;
        ru(this.config.controls) && (this.config.controls = this.config.controls.call(this, i)),
          this.config.controls || (this.config.controls = []),
          su(this.config.controls) || nu(this.config.controls)
            ? (n = this.config.controls)
            : ((n = jh.create.call(this, {
                id: this.id,
        ...
        if (
          (r &&
            ...
            (n = a)),
          nu(this.config.selectors.controls.container) && (o = document.querySelector(this.config.selectors.controls.container)),
          su(o) || (o = this.elements.container),
          o[su(n) ? 'insertAdjacentElement' : 'insertAdjacentHTML']('afterbegin', n),
          su(this.elements.controls) || jh.findElements.call(this),
          !du(this.elements.buttons))
        ) {
          var s = function (t) {
    ...
    var Mh = {
        setup: function () {
          if (this.supported.ui)
            if (!this.isVideo || this.isYouTube || (this.isHTML5 && !qu.textTracks))
              au(this.config.controls) &&
                this.config.controls.includes('settings') &&
                this.config.settings.includes('captions') &&
                jh.setCaptionsMenu.call(this);
            else {
              if (
                (su(this.elements.captions) ||
                  ((this.elements.captions = Au('div', Iu(this.config.selectors.captions))),
                  (function (e, t) {
              ...
              if (
                (iu(i) || (i = this.config.captions.active),
            ...
            t
              ...
              .forEach(function (t) {
                e.debug.log('Track added', t),
                  ...
                  Vu.call(e, t, 'cuechange', function () {
                    return Mh.updateCues.call(e);
                  });
              }),
            ((s && this.language !== r) || !t.includes(o)) && (Mh.setLanguage.call(this, r), Mh.toggle.call(this, i && s)),
            ju(this.elements.container, this.config.classNames.captions.enabled, !du(t)),
            au(this.config.controls) &&
              this.config.controls.includes('settings') &&
              this.config.settings.includes('captions') &&
              jh.setCaptionsMenu.call(this);
          ...
          if (this.supported.ui) {
            ...
            if (a !== i) {
              ...
              this.elements.buttons.captions && (this.elements.buttons.captions.pressed = a),
                ju(this.elements.container, r, a),
                (this.captions.toggled = a),
                jh.updateSetting.call(this, 'captions'),
                Ku.call(this, this.media, a ? 'captionsenabled' : 'captionsdisabled');
            }
            setTimeout(function () {
              ...
              if (e in n) {
                if (this.captions.currentTrack !== e) {
                  ...
                  (this.captions.currentTrackNode = i),
                    ...
                    Ku.call(this, this.media, 'languagechange');
                }
        ...
        getLabel: function (e) {
          var t = e;
          return (
            !uu(t) && qu.textTracks && this.captions.toggled && (t = Mh.getCurrentTrack.call(this)),
            uu(t)
              ? du(t.label)
                ? du(t.language)
                  ? Th('enabled', this.config)
                  : e.language.toUpperCase()
                : t.label
              : Th('disabled', this.config)
          );
        },
        updateCues: function (e) {
          if (this.supported.ui)
            if (su(this.elements.captions))
            ...
            [
              {
                ...
                value: function () {
                  if (this.enabled) {
                    ...
                    su(e) && (e.pressed = this.active),
                      Ku.call(this.player, this.target, this.active ? 'enterfullscreen' : 'exitfullscreen', !0);
                  }
                },
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    ju(this.target, this.player.config.classNames.fullscreen.fallback, e),
                    gu.isIos)
                  ) {
              ...
              },
              {
                ...
                value: function () {
                  var t;
                  this.enabled
                    ? ((t = this.forceFallback ? 'Fallback (forced)' : e.native ? 'Native' : 'Fallback'),
              ...
              },
              {
                ...
                value: function () {
                  this.enabled &&
                    (gu.isIos && this.player.config.fullscreen.iosNative
                      ? this.target.webkitEnterFullscreen()
                      : !e.native || this.forceFallback
                      ? this.toggleFallback(!0)
                      : this.prefix
                      ? du(this.prefix) || this.target[''.concat(this.prefix, 'Request').concat(this.property)]()
              ...
              },
              {
                ...
                value: function () {
                  if (this.enabled)
                    if (gu.isIos && this.player.config.fullscreen.iosNative) this.target.webkitExitFullscreen(), Gu(this.player.play());
              ...
              },
              {
                key: 'target',
                get: function () {
                  return gu.isIos && this.player.config.fullscreen.iosNative
                    ? this.player.media
                ...
                get: function () {
                  ...
                  return (
                    ['webkit', 'moz', 'ms'].some(function (t) {
                      return (
                        !(!ru(document[''.concat(t, 'ExitFullscreen')]) && !ru(document[''.concat(t, 'CancelFullScreen')])) && ((e = t), !0)
                      );
                    }),
                    e
                  );
    ...
    Ie({ target: 'Math', stat: !0 }, { sign: Wh });
    var $h = {
        addStyleHook: function () {
          ju(this.elements.container, this.config.selectors.container.replace('.', ''), !0),
            ju(this.elements.container, this.config.classNames.uiSupported, this.supported.ui);
        },
        ...
        build: function () {
          ...
          if ((this.listeners.media(), !this.supported.ui))
            return (
              ...
              void $h.toggleNativeControls.call(this, !0)
            );
          su(this.elements.controls) || (jh.inject.call(this), this.listeners.controls()),
            $h.toggleNativeControls.call(this),
            this.isHTML5 && Mh.setup.call(this),
            (this.volume = null),
            (this.muted = null),
            (this.loop = null),
            (this.quality = null),
            (this.speed = null),
            jh.updateVolume.call(this),
            jh.timeUpdate.call(this),
            $h.checkPlaying.call(this),
            ju(this.elements.container, this.config.classNames.pip.supported, qu.pip && this.isHTML5 && this.isVideo),
            ju(this.elements.container, this.config.classNames.airplay.supported, qu.airplay && this.isHTML5),
            ju(this.elements.container, this.config.classNames.isIos, gu.isIos),
            ju(this.elements.container, this.config.classNames.isTouch, this.touch),
            (this.ready = !0),
            setTimeout(function () {
              Ku.call(e, e.media, 'ready');
            }, 0),
            $h.setTitle.call(this),
            this.poster && $h.setPoster.call(this, this.poster, !1).catch(function () {}),
            this.config.duration && jh.durationUpdate.call(this);
        },
        setTitle: function () {
          var e = Th('play', this.config);
          if (
            (nu(this.config.title) && !du(this.config.title) && (e += ', '.concat(this.config.title)),
          ...
          return n && this.poster
            ...
            : (this.media.setAttribute('data-poster', e),
              Yu.call(this)
                ...
                .then(function () {
                  return (
                    Object.assign(t.elements.poster.style, { backgroundImage: "url('".concat(e, "')"), backgroundSize: '' }),
                    $h.togglePoster.call(t, !0),
                    e
                  );
                }));
        },
        checkPlaying: function (e) {
          var t = this;
          ju(this.elements.container, this.config.classNames.playing, this.playing),
            ju(this.elements.container, this.config.classNames.paused, this.paused),
            ju(this.elements.container, this.config.classNames.stopped, this.stopped),
        ...
        migrateStyles: function () {
          var e = this;
          Object.values(So({}, this.media.style))
            .filter(function (e) {
          ...
          wo(e, [
            ...
            },
            {
              ...
              value: function () {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
                  t = this.player;
                t.config.keyboard.global && Bu.call(t, window, 'keydown keyup', this.handleKey, e, !1),
                  Bu.call(t, document.body, 'click', this.toggleMenu, e),
                  Wu.call(t, document.body, 'touchstart', this.firstTouch),
                  Bu.call(t, document.body, 'keydown focus blur focusout', this.setTabFocus, e, !1, !0);
              },
            },
            {
              key: 'container',
              value: function () {
                var e = this.player,
                  ...
                  n = e.elements,
                  i = e.timers;
                !t.keyboard.global && t.keyboard.focused && Vu.call(e, n.container, 'keydown keyup', this.handleKey, !1),
                  Vu.call(e, n.container, 'mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen', function (t) {
                    var r = n.controls;
                    r && 'enterfullscreen' === t.type && ((r.pressed = !1), (r.hover = !1));
                    var a = 0;
                    ['touchstart', 'touchmove', 'mousemove'].includes(t.type) && ($h.toggleControls.call(e, !0), (a = e.touch ? 3e3 : 2e3)),
                ...
                Vu.call(e, n.container, 'enterfullscreen exitfullscreen', function (t) {
                  ...
                  if (o === n.container && (e.isEmbed || !du(e.config.ratio))) {
                    ...
                    !(function (t, n, i) {
                      ...
                      s || (l ? Vu.call(e, window, 'resize', a) : zu.call(e, window, 'resize', a));
                  }
                });
              },
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  n = t.elements;
                if (
                  (Vu.call(t, t.media, 'timeupdate seeking seeked', function (e) {
                  ...
                  Vu.call(t, n.container, 'click', function (r) {
                    ([n.container, i].includes(r.target) || i.contains(r.target)) &&
                ...
                t.supported.ui &&
                  ...
                  Vu.call(t, t.media, 'volumechange', function () {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  this.bind(
                    ...
                    function (e) {
                      ...
                      [13, 32].includes(n) &&
                        (13 !== n
                          ? (e.preventDefault(), e.stopPropagation(), jh.toggleMenu.call(t, e))
                          : jh.focusFirstMenuItem.call(t, null, !0));
                    },
                    null,
                    !1
                  ),
                  ...
                  this.bind(n.inputs.seek, 'mousedown mouseup keydown keyup touchstart touchend', function (e) {
                    ...
                    if (!cu(e) || 39 === i || 37 === i) {
                      ...
                      r && a
                        ? (n.removeAttribute('play-on-seeked'), Gu(t.play()))
                        : !a && t.playing && (n.setAttribute('play-on-seeked', ''), t.pause());
                    }
                  }),
                  gu.isIos)
                ) {
                ...
                this.bind(
                  ...
                  gu.isWebkit &&
                    Array.from(Mu.call(t, 'input[type="range"]')).forEach(function (n) {
                      e.bind(n, 'input', function (e) {
                        return jh.updateRangeFill.call(t, e.target);
                      });
                    }),
                  t.config.toggleInvert &&
                    !su(n.display.duration) &&
                  ...
                  this.bind(n.controls, 'focusin', function () {
                    var i = t.config,
                      r = t.timers;
                    ju(n.controls, i.classNames.noTransition, !0),
                      $h.toggleControls.call(t, !0),
                      setTimeout(function () {
      ...
      Jh = Math.min;
    Ie(
      { target: 'Array', proto: !0, forced: !Gh || !Xh },
      {
        splice: function (e, t) {
          var n,
            i,
            ...
            h = arguments.length;
          if (
            (0 === h ? (n = i = 0) : 1 === h ? ((n = 0), (i = c - u)) : ((n = h - 2), (i = Jh(Qh(oe(t), 0), c - u))),
          ...
          (r = r || 0),
            /(^css!|\.css$)/.test(f)
              ? (((s = l.createElement('link')).rel = 'stylesheet'),
                (s.href = d),
                (a = 'hideFocus' in s) && s.relList && ((a = 0), (s.rel = 'preload'), (s.as = 'style')))
              : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(f)
              ? ((s = l.createElement('img')).src = d)
              : (((s = l.createElement('script')).src = t), (s.async = void 0 === c || c)),
            (s.onload =
              s.onerror =
              s.onbeforeload =
                function (e) {
    ...
    function tf(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e && ((this.media.paused = !e), Ku.call(this, this.media, e ? 'play' : 'pause'));
    }
    var nf = {
      setup: function () {
        var e = this;
        ju(e.elements.wrapper, e.config.classNames.embed, !0),
          (e.options.speed = e.config.speed.options),
          Zu.call(e),
          eu(window.Vimeo)
            ? nf.ready.call(e)
            : ef(e.config.urls.vimeo.sdk)
                .then(function () {
                  nf.ready.call(e);
                })
                .catch(function (t) {
      ...
      ready: function () {
        ...
        i && Object.assign(a, { controls: !1, sidedock: !1 });
        var o = Rh(
            So(
              {
        ...
        u.setAttribute('src', h),
          ...
          du(r) || u.setAttribute('referrerPolicy', r);
        var f = t.poster;
        if (i) u.setAttribute('data-poster', f), (t.media = Ou(u, t.media));
        else {
          var d = Au('div', { class: t.config.classNames.embedContainer, 'data-poster': f });
        ...
        Eh(gh(t.config.urls.vimeo.api, c), 'json').then(function (e) {
          ...
          (t.embed = new window.Vimeo.Player(u, { autopause: t.config.autopause, muted: t.muted })),
          (t.media.paused = !0),
        ...
        Object.defineProperty(t.media, 'loop', {
          ...
          t.embed.on('progress', function (e) {
            (t.media.buffered = e.percent),
              Ku.call(t, t.media, 'progress'),
              1 === parseInt(e.percent, 10) && Ku.call(t, t.media, 'canplaythrough'),
              t.embed.getDuration().then(function (e) {
    ...
    var of = {
        setup: function () {
          var e = this;
          if ((ju(this.elements.wrapper, this.config.classNames.embed, !0), eu(window.YT) && ru(window.YT.Player))) of.ready.call(this);
          else {
        ...
        getTitle: function (e) {
          var t = this;
          Eh(gh(this.config.urls.youtube.api, e))
            .then(function (e) {
              if (eu(e)) {
                var n = e.title,
                  i = e.height,
        ...
        ready: function () {
          ...
          if (du(t) || !t.startsWith('youtube-')) {
            ...
            var i,
              ...
              s = Au('div', { id: o, 'data-poster': e.poster });
              ...
              events: {
                onError: function (t) {
                  if (!e.media.error) {
                    ...
                    (e.media.error = { code: n, message: i }), Ku.call(e, e.media, 'error');
                  }
                },
                ...
                onReady: function (t) {
                  if (!ru(e.media.play)) {
                    ...
                    (e.options.speed = o.filter(function (t) {
                      ...
                      Ku.call(e, e.media, 'durationchange'),
                      clearInterval(e.timers.buffering),
                      (e.timers.buffering = setInterval(function () {
                        (e.media.buffered = n.getVideoLoadedFraction()),
                          (null === e.media.lastBuffered || e.media.lastBuffered < e.media.buffered) && Ku.call(e, e.media, 'progress'),
                          (e.media.lastBuffered = e.media.buffered),
                          1 === e.media.buffered && (clearInterval(e.timers.buffering), Ku.call(e, e.media, 'canplaythrough'));
                      }, 200)),
                      setTimeout(function () {
                ...
                onStateChange: function (t) {
                  ...
                  switch (
                    ...
                    e.media.seeking && [1, 2].includes(t.data) && ((e.media.seeking = !1), Ku.call(e, e.media, 'seeked')),
                    t.data)
                  ) {
                    case -1:
                    ...
                    case 1:
                      e.config.autoplay || !e.media.paused || e.embed.hasPlayed
                        ? (rf.call(e, !0),
                          Ku.call(e, e.media, 'playing'),
                          (e.timers.playing = setInterval(function () {
                            Ku.call(e, e.media, 'timeupdate');
                          }, 50)),
                          e.media.duration !== n.getDuration() &&
                            ((e.media.duration = n.getDuration()), Ku.call(e, e.media, 'durationchange')))
                        : e.media.pause();
                      break;
                    case 2:
                  ...
                  Ku.call(e, e.elements.container, 'statechange', !1, { code: t.data });
                },
              },
            });
          }
      ...
      sf = {
        setup: function () {
          this.media
            ? (ju(this.elements.container, this.config.classNames.type.replace('{0}', this.type), !0),
              ju(this.elements.container, this.config.classNames.provider.replace('{0}', this.provider), !0),
              this.isEmbed && ju(this.elements.container, this.config.classNames.type.replace('{0}', 'video'), !0),
              this.isVideo &&
                ((this.elements.wrapper = Au('div', { class: this.config.classNames.video })),
                Su(this.media, this.elements.wrapper),
                (this.elements.poster = Au('div', { class: this.config.classNames.poster })),
                this.elements.wrapper.appendChild(this.elements.poster)),
              this.isHTML5 ? eh.setup.call(this) : this.isYouTube ? of.setup.call(this) : this.isVimeo && nf.setup.call(this))
          ...
          wo(e, [
            {
              ...
              value: function () {
                var e = this;
                this.enabled &&
                  (eu(window.google) && eu(window.google.ima)
                    ? this.ready()
                    : ef(this.player.config.urls.googleIMA.sdk)
                        .then(function () {
                          e.ready();
                        })
                        .catch(function () {
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                (this.elements.container = Au('div', { class: this.player.config.classNames.ads })),
                    ...
                    if (0 !== t && -1 !== t && t < e.player.duration) {
                      ...
                      if (su(n)) {
                        var i = (100 / e.player.duration) * t,
                          r = Au('span', { class: e.player.config.classNames.cues });
    ...
    'findIndex' in [] &&
      ...
      Ie(
        { target: 'Array', proto: !0, forced: uf || !hf },
        {
    ...
    var ff = Math.min,
      ...
      vf =
        pf || !mf || !gf
          ...
          : df;
    Ie({ target: 'Array', proto: !0, forced: vf !== [].lastIndexOf }, { lastIndexOf: vf });
    var yf = function (e, t) {
        var n = {};
        return (
          e > t.width / t.height
        ...
        return (
          wo(e, [
                          ...
                          r.split(/\r\n\r\n|\n\n|\r\r/).forEach(function (e) {
                            ...
                            e.split(/\r\n|\n|\r/).forEach(function (e) {
                              if (tu(t.startTime)) {
                                ...
                                a &&
                                  ((t.startTime =
                                    60 * Number(a[1] || 0) * 60 + 60 * Number(a[2]) + Number(a[3]) + Number('0.'.concat(a[4]))),
                ...
                if (this.loaded && lu(e) && ['touchmove', 'mousemove'].includes(e.type) && this.player.media.duration) {
                  if ('touchmove' === e.type) this.seekTime = this.player.media.duration * (this.player.elements.inputs.seek.value / 100);
                    ...
                    (this.seekTime = this.player.media.duration * (n / 100)),
                      ...
                      (this.elements.thumb.time.innerText = Lh(this.seekTime));
                  }
            ...
            },
            {
              key: 'startScrubbing',
              value: function (e) {
                (Zc(e.button) || !1 === e.button || 0 === e.button) &&
                  ((this.mouseDown = !0),
              ...
              value: function () {
                ...
                (this.mouseDown = !1),
                  Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime)
                    ...
                    : Wu.call(this.player, this.player.media, 'timeupdate', function () {
            ...
            },
            {
              key: 'render',
              value: function () {
                (this.elements.thumb.container = Au('div', { class: this.player.config.classNames.previewThumbnails.thumbContainer })),
                ...
                (this.elements.thumb.time = Au('span', {}, '00:00')),
                  e.appendChild(this.elements.thumb.time),
                  this.elements.thumb.container.appendChild(e),
                  su(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container),
                  (this.elements.scrubbing.container = Au('div', {
                    ...
                    a < this.thumbContainerHeight &&
                      setTimeout(function () {
                        r.showingThumbFilename === i &&
                          (r.player.debug.log('Showing higher quality thumb for: '.concat(i)), r.loadImage(e + 1));
                      }, 300);
                }
              },
            },
            ...
            },
            {
              ...
              get: function () {
                return this.mouseDown
                  ? yf(this.thumbAspectRatio, { width: this.player.media.clientWidth, height: this.player.media.clientHeight }).height
              ...
              this.destroy.call(
                ...
                function () {
                  (t.options.quality = []),
                    xu(t.media),
                    (t.media = null),
                    su(t.elements.container) && t.elements.container.removeAttribute('class');
                  var n = e.sources,
                    i = e.type,
                    r = Ao(n, 1)[0],
                    a = r.provider,
                    ...
                    l = 'html5' === o ? i : 'div',
                    c = 'html5' === o ? {} : { src: s };
                  Object.assign(t, { provider: o, type: i, supported: qu.check(i, o, t.config.playsinline), media: Au(l, c) }),
                    t.elements.container.appendChild(t.media),
                    iu(e.autoplay) && (t.config.autoplay = e.autoplay),
                    t.isHTML5 &&
                      (t.config.crossorigin && t.media.setAttribute('crossorigin', ''),
                      t.config.autoplay && t.media.setAttribute('autoplay', ''),
                      du(e.poster) || (t.poster = e.poster),
                    ...
                    $h.addStyleHook.call(t),
                    t.isHTML5 && wf.insertElements.call(t, 'source', n),
                    (t.config.title = e.title),
                    sf.setup.call(t),
                    t.isHTML5 && Object.keys(e).includes('tracks') && wf.insertElements.call(t, 'track', e.tracks),
                    (t.isHTML5 || (t.isEmbed && !t.supported.ui)) && $h.build.call(t),
                    t.isHTML5 && t.media.load(),
                    du(e.previewThumbnails) ||
                      ...
                      t.config.previewThumbnails.enabled && (t.previewThumbnails = new bf(t))),
                    t.fullscreen.update();
                },
                !0
              ))
      ...
      Tf = (function () {
        function e(t, n) {
          ...
          if (
            ...
            (this.touch = qu.touch),
            (this.media = t),
            nu(this.media) && (this.media = document.querySelectorAll(this.media)),
            ((window.jQuery && this.media instanceof jQuery) || ou(this.media) || au(this.media)) && (this.media = this.media[0]),
            (this.config = Tu(
              {},
              _h,
              e.defaults,
            ...
            (this.debug = new Vh(this.config.debug)),
            this.debug.log('Config', this.config),
            this.debug.log('Support', qu),
            !Zc(this.media) && su(this.media))
          )
              ...
              if (qu.check().api) {
                ...
                switch (a) {
                  case 'div':
                    if (((o = this.media.querySelector('iframe')), su(o))) {
                      if (
                        ...
                        l.includes(s.searchParams.get('autoplay')) && (this.config.autoplay = !0),
                          ...
                          this.isYouTube
                            ? ((this.config.playsinline = l.includes(s.searchParams.get('playsinline'))),
                    ...
                    if (du(this.provider) || !Object.keys(Fh).includes(this.provider))
                ...
                (this.supported = qu.check(this.type, this.provider, this.config.playsinline)),
                  this.supported.api
                    ? ((this.eventListeners = []),
                      (this.listeners = new Yh(this)),
                      (this.storage = new Sh(this)),
                      (this.media.plyr = this),
                      su(this.elements.container) ||
                        ((this.elements.container = Au('div', { tabindex: 0 })), Su(this.media, this.elements.container)),
                      $h.migrateStyles.call(this),
                      $h.addStyleHook.call(this),
                      sf.setup.call(this),
                      this.config.debug &&
                        Vu.call(this, this.elements.container, this.config.events.join(' '), function (e) {
                          i.debug.log('event: '.concat(e.type));
                        }),
                      (this.fullscreen = new zh(this)),
                      (this.isHTML5 || (this.isEmbed && !this.supported.ui)) && $h.build.call(this),
                      this.listeners.container(),
                      this.listeners.global(),
                      this.config.ads.enabled && (this.ads = new lf(this)),
                      this.isHTML5 &&
                      ...
                      (this.lastSeekTime = 0),
                      this.config.previewThumbnails.enabled && (this.previewThumbnails = new bf(this)))
            ...
            [
                  ...
                  if (this.supported.ui && !this.isAudio) {
                    ...
                    if (
                      (i &&
                        au(this.config.controls) &&
                        this.config.controls.includes('settings') &&
                        !du(this.config.settings) &&
                        jh.toggleMenu.call(this, !1),
                      i !== t)
                    ) {
                ...
                value: function (e) {
                  ...
                  if (this.ready) {
                      ...
                      (document.body.style.overflow = ''),
                        ...
                        n
                          ? (Object.keys(t.elements).length &&
                              (xu(t.elements.buttons.play),
                              xu(t.elements.captions),
                              xu(t.elements.controls),
                              xu(t.elements.wrapper),
                            ...
                            ru(e) && e())
                          : ($u.call(t),
                            Ou(t.elements.original, t.elements.container),
                            Ku.call(t, t.elements.original, 'destroyed', !0),
                            ru(e) && e.call(t.elements.original),
                            (t.ready = !1),
                            setTimeout(function () {
                    ...
                    this.stop(),
                      ...
                      this.isHTML5
                        ? ($h.toggleNativeControls.call(this, !0), i())
                        : this.isYouTube
                        ? (clearInterval(this.timers.buffering),
                          clearInterval(this.timers.playing),
                          null !== this.embed && ru(this.embed.destroy) && this.embed.destroy(),
                          i())
              ...
              },
              {
                ...
                set: function (e) {
                  var t = e;
                  nu(t) && (t = Number(t)),
                    tu(t) || (t = this.storage.get('volume')),
                    tu(t) || (t = this.config.volume),
                    t > 1 && (t = 1),
                    t < 0 && (t = 0),
                    (this.config.volume = t),
                    (this.media.volume = t),
                    !du(e) && this.muted && t > 0 && (this.muted = !1);
                },
                get: function () {
              ...
              },
              {
                ...
                set: function (e) {
                  var t = e;
                  iu(t) || (t = this.storage.get('muted')),
                    iu(t) || (t = this.config.muted),
                    (this.config.muted = t),
                    (this.media.muted = t);
                },
                get: function () {
              ...
              },
              {
                key: 'minimumSpeed',
                get: function () {
                  return this.isYouTube ? Math.min.apply(Math, Po(this.options.speed)) : this.isVimeo ? 0.5 : 0.0625;
                },
              },
              {
                key: 'maximumSpeed',
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? nu(e) && Xu(e)
                      ? ((this.config.ratio = e), Zu.call(this))
              ...
              },
              {
                ...
                set: function (e) {
                  if (qu.pip) {
                    ...
                    ru(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? Uh : Dh),
                      ru(this.media.requestPictureInPicture) &&
                        (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture());
                  }
                },
                get: function () {
                  return qu.pip
                    ? du(this.media.webkitPresentationMode)
                      ? this.media === document.pictureInPictureElement
                      : this.media.webkitPresentationMode === Uh
                    : null;
                },
              },
            ],
              ...
              },
              {
                ...
                value: function (t) {
                  var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    i = null;
                  return (
                    nu(t) ? (i = Array.from(document.querySelectorAll(t))) : ou(t) ? (i = Array.from(t)) : au(t) && (i = t.filter(su)),
                    du(i)
                      ? null
                      : i.map(function (t) {
                          return new e(t, n);
