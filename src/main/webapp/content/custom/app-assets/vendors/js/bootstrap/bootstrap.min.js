    ...
    w = (function () {
      ...
      return (
        ...
        (e._getItemIndex = function (t) {
          return (
            (this._items = t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll('.carousel-item')) : []), this._items.indexOf(t)
          );
        }),
        ...
        (t._dataApiKeydownHandler = function (e) {
          if (
            !(/input|textarea/i.test(e.target.tagName)
              ? 32 === e.which ||
                (27 !== e.which && ((40 !== e.which && 38 !== e.which) || o.default(e.target).closest('.dropdown-menu').length))
              : !I.test(e.which)) &&
            !this.disabled &&
      ...
      return (
        ...
        (e._enter = function (t, e) {
          ...
          (e = e || o.default(t.currentTarget).data(n)) ||
            ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), o.default(t.currentTarget).data(n, e)),
        ...
        (e._fixTransition = function () {
          ...
          null === t.getAttribute('x-placement') &&
            (o.default(t).removeClass('fade'), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
        }),
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            var n = o.default(this),
    ...
    ft = (function () {
      ...
      return (
        ...
        (e._activate = function (t, e, n) {
          var i = this,
            a = (
              !e || ('UL' !== e.nodeName && 'OL' !== e.nodeName) ? o.default(e).children('.active') : o.default(e).find('> li > .active')
            )[0],
