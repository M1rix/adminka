    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? P(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
...
*/
  var nn = { 51: ['PE'] },
    tn = {
      PE: [
        null,
        [null, null, '(?:[14-8]|9\\d)\\d{7}', null, null, null, null, null, null, [8, 9], [6, 7]],
        [null, null, '(?:1\\d|4[1-4]|5[1-46]|6[1-7]|7[2-46]|8[2-4])\\d{6}', null, null, null, '11234567', null, null, [8], [6, 7]],
