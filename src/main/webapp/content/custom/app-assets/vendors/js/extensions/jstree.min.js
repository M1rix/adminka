      ...
      (a.jstree.core.prototype = {
        ...
        _kbevent_to_func: function (a) {
          ...
          for (e in d)
            if (
              ...
              '-' !== f &&
                '+' !== f &&
                ((f = f.replace('--', '-MINUS').replace('+-', '-MINUS').replace('++', '-PLUS').replace('-+', '-PLUS')),
        ...
        get_node: function (b, c) {
          ...
          try {
            if (this._model.data[b]) b = this._model.data[b];
              ...
              'string' == typeof b &&
              (d = a('#' + b.replace(a.jstree.idregex, '\\$&'), this.element)).length &&
            ...
            ? a.isFunction(d)
              ? d.call(
                  ...
                  a.proxy(function (d) {
                    d === !1
                      ? c.call(this, !1)
                      : this['string' == typeof d ? '_append_html_data' : '_append_json_data'](
                          b,
              ...
              i = function (a, b) {
                ...
                var c = a.dat,
                  ...
                  s = function (a, c, d) {
                    ...
                    for (
                      a && a.children && a.children === !0 && ((m.state.loaded = !1), (m.children = []), (m.children_d = [])),
                        l[m.id] = m,
                        f = 0,
                        h = m.children.length;
                      h > f;
                ...
                if (c.length && c[0].id !== b && c[0].parent !== b) {
                  for (p = 0, q = c.length; q > p; p++)
                    c[p].children || (c[p].children = []), c[p].state || (c[p].state = {}), (l[c[p].id.toString()] = c[p]);
                  for (p = 0, q = c.length; q > p; p++)
                    l[c[p].parent.toString()]
                      ? (l[c[p].parent.toString()].children.push(c[p].id.toString()), m.children_d.push(c[p].id.toString()))
                      : 'undefined' != typeof h &&
                  ...
                  for (p = 0, q = m.children.length; q > p; p++)
                    (o = s(l[m.children[p]], d, m.parents.concat())), f.push(o), l[o].children_d.length && (f = f.concat(l[o].children_d));
                  ...
                  for (p = 0, q = c.length; q > p; p++)
                    (o = t(c[p], d, m.parents.concat())),
                      o && (e.push(o), f.push(o), l[o].children_d.length && (f = f.concat(l[o].children_d)));
                  for (m.children = e, m.children_d = f, p = 0, q = m.parents.length; q > p; p++)
              ...
              try {
                null === this._wrk &&
                  (this._wrk = window.URL.createObjectURL(
                    new window.Blob(['self.onmessage = ' + i.toString()], { type: 'text/javascript' })
                  )),
        ...
        _redraw: function () {
          ...
          this._model.force_full_redraw &&
            ((c.className = this.get_container_ul()[0].className), c.setAttribute('role', 'group'), this.element.empty().append(c)),
            null !== g &&
              this.settings.core.restore_focus &&
              ((d = this.get_node(g, !0)),
              d && d.length && d.children('.jstree-anchor')[0] !== i.activeElement
        ...
        draw_children: function (b) {
          ...
          if ((b.children('.jstree-children').remove(), (b = b[0]), c.children.length && c.state.loaded)) {
            for (
              f = g.createElement('UL'), f.setAttribute('role', 'group'), f.className = 'jstree-children', d = 0, e = c.children.length;
              e > d;
              d++
            )
        ...
        redraw_node: function (b, c, d, e) {
          ...
          if (
            ...
            if (
              ((g = f.parent !== a.jstree.root ? a('#' + f.parent.replace(a.jstree.idregex, '\\$&'), this.element)[0] : null),
          ...
          for (
            f.a_attr.id || (f.a_attr.id = f.id + '_anchor'),
              ...
              this.settings.core.compute_elements_positions &&
                (b.childNodes[1].setAttribute('aria-setsize', p[f.parent].children.length),
                b.childNodes[1].setAttribute('aria-posinset', p[f.parent].children.indexOf(f.id) + 1)),
              f.state.disabled && b.childNodes[1].setAttribute('aria-disabled', !0),
              k = 0,
              l = f.children.length;
            l > k;
            k++
          ...
          f.state.hidden && (n += ' jstree-hidden'),
            ...
            f.state.loaded && !v
              ? (n += ' jstree-leaf')
              : ((n += f.state.opened && f.state.loaded ? ' jstree-open' : ' jstree-closed'),
                b.childNodes[1].setAttribute('aria-expanded', f.state.opened && f.state.loaded)),
          ...
          if (
            ...
            for (
              m = o.createElement('UL'), m.setAttribute('role', 'group'), m.className = 'jstree-children', k = 0, l = f.children.length;
              l > k;
              k++
            )
                      ...
                      h.length &&
                        ...
                        e
                          ...
                          : (this.trigger('before_open', { node: c }),
                            ...
                            h[0].childNodes[1].setAttribute('aria-expanded', !0))),
                      (c.state.opened = !0),
                      d && d.call(this, c, !0),
        ...
        hide_node: function (b, c) {
          ...
          return (
            ...
            b && b.id !== a.jstree.root
              ? void (
                  b.state.hidden ||
                  ((b.state.hidden = !0), this._node_changed(b.parent), c || this.redraw(), this.trigger('hide_node', { node: b }))
                )
              : !1
          );
        },
        show_node: function (b, c) {
          ...
          return (
            ...
            b && b.id !== a.jstree.root
              ? void (
                  b.state.hidden &&
                  ((b.state.hidden = !1), this._node_changed(b.parent), c || this.redraw(), this.trigger('show_node', { node: b }))
                )
              : !1
          );
        },
        ...
        activate_node: function (a, c) {
          ...
          if (
            ...
            (this._data.core.last_clicked =
              this._data.core.last_clicked && this._data.core.last_clicked.id !== b
            ...
            this.settings.core.multiple &&
              ...
              (!c.shiftKey ||
                (this._data.core.last_clicked && this.get_parent(a) && this.get_parent(a) === this._data.core.last_clicked.parent)))
          )
            if (c.shiftKey) {
            ...
            b && b.id !== a.jstree.root
              ? ((f = this.get_node(b, !0)),
                void (
                  ...
                  d || (f = this._open_to(b)),
                  f && f.length && f.children('.jstree-anchor').addClass('jstree-clicked').attr('aria-selected', !0),
            ...
            b && b.id !== a.jstree.root
              ? ((g = this.get_node(b, !0)),
                void (
                  ...
                  g.length && g.children('.jstree-anchor').removeClass('jstree-clicked').attr('aria-selected', !1),
        ...
        select_all: function (b) {
          var c = this._data.core.selected.concat([]),
            ...
            e;
          for (
            this._data.core.selected = this._model.data[a.jstree.root].children_d.concat(), d = 0, e = this._data.core.selected.length;
            e > d;
            d++
          )
          ...
          this.redraw(!0),
            ...
            b || this.trigger('changed', { action: 'select_all', selected: this._data.core.selected, old_selection: c });
        },
        ...
        get_state: function () {
          var b = {
              core: { open: [], loaded: [], scroll: { left: this.element.scrollLeft(), top: this.element.scrollTop() }, selected: [] },
            },
            c;
          for (c in this._model.data)
            this._model.data.hasOwnProperty(c) &&
              c !== a.jstree.root &&
              (this._model.data[c].state.loaded && this.settings.core.loaded_state && b.core.loaded.push(c),
          ...
          if (c) {
            if (
              (c.core &&
                ...
                (c.core.initial_selection = this._data.core.selected.concat([]).sort().join(',')),
              c.core)
            ) {
              var e, f, g, h, i;
              if (c.core.loaded)
        ...
        create_node: function (c, d, e, f, g) {
          ...
          return (
            ...
            this.trigger('create_node', { node: this.get_node(d), parent: c.id, position: e }),
        ...
        check: function (b, c, d, e, f) {
          ...
          if ('move_node' === b || 'copy_node' === b) {
            ...
            if (
              !(
                (f && f.is_multi) ||
                (c.id !== d.id && ('move_node' !== b || a.inArray(c.id, d.children) !== e) && -1 === a.inArray(d.id, c.children_d))
              )
            )
              return (
                (this._data.core.last_error = {
        ...
        move_node: function (c, d, e, f, g, h, i) {
          ...
          if (c.parent === n.id) {
            ...
            for (
              o._model.data[l].children = a.vakata.array_remove_item(o._model.data[l].children, c.id), s = 0, t = n.parents.length;
              t > s;
              s++
            )
        ...
        copy_node: function (c, d, e, f, g, h, i) {
          ...
          return (
            ...
            this.trigger('copy_node', {
              ...
              old_parent: q,
              old_position:
                s && s._id && q && s._model.data[q] && s._model.data[q].children ? a.inArray(c.id, s._model.data[q].children) : -1,
              is_multi: s && s._id && s._id !== this._id,
              is_foreign: !s || !s._id,
              old_instance: s,
              new_instance: this,
        ...
        paste: function (a, b) {
          return (
            ...
            a && e && e.match(/^(copy_node|move_node)$/) && d
              ? (this[e](d, a, b, !1, !1, !1, f) && this.trigger('paste', { parent: a.id, node: d, mode: e }),
                (d = !1),
                (e = !1),
                void (f = !1))
              : !1
          ...
          return (b = this.get_node(b))
            ? this.check('edit', b, this.get_parent(b))
              ? ((n = b),
                ...
                (j = c),
                (k = a('<div></div>', {
                  css: { position: 'absolute', top: '-200px', left: e ? '0px' : '-1000px', visibility: 'hidden' },
                }).appendTo(i.body)),
                (l = a('<input />', {
                  value: j,
        ...
        return (
          b &&
            ...
            a.each(b.attributes, function (b, e) {
              -1 === a.inArray(e.name.toLowerCase(), ['style', 'contenteditable', 'hasfocus', 'tabindex']) &&
                null !== e.value &&
        ...
        (this.bind = function () {
              ...
              this.element.on(
                ...
                a.proxy(function (a, b) {
                  ...
                  for (f = 0, g = e.length; g > f; f++)
                    (c[e[f]].state.checked =
                      c[e[f]].state.checked || (c[e[f]].original && c[e[f]].original.state && c[e[f]].original.state.checked)),
                      ...
                      if (e.state[o ? 'selected' : 'checked']) {
                        ...
                        for (i = 0, j = f.length; j > i; i++)
                          if (d[f[i]].state[o ? 'selected' : 'checked']) {
                            ...
                            this._data[o ? 'core' : 'checkbox'].selected = this._data[o ? 'core' : 'checkbox'].selected.concat(
                              d[f[i]].children_d
                            );
                          }
                    if (-1 !== n.indexOf('up')) {
                    ...
                    while (h && h.id !== a.jstree.root) {
                      ...
                      if (i === k)
                        ...
                        (h.state[m ? 'selected' : 'checked'] = !1),
                          (this._data[m ? 'core' : 'checkbox'].selected = a.vakata.array_remove_item(
                    ...
                    if (c.state.loaded) {
                      for (d = 0, e = c.children_d.length; e > d; d++)
                        if (
                          ...
                          for (
                            h[j.id] === b && j.id !== a.jstree.root && ((h[j.id] = !0), l.push(j.id)), f = 0, g = j.parents.length;
                            g > f;
                            f++
                          )
                            h[j.parents[f]] === b && j.parents[f] !== a.jstree.root && ((h[j.parents[f]] = !0), l.push(j.parents[f]));
                    } else if (c.original && c.original.state && c.original.state.undetermined && c.original.state.undetermined === !0)
                      for (
                        h[c.id] === b && c.id !== a.jstree.root && ((h[c.id] = !0), l.push(c.id)), f = 0, g = c.parents.length;
                        g > f;
                        f++
                      )
                        h[c.parents[f]] === b && c.parents[f] !== a.jstree.root && ((h[c.parents[f]] = !0), l.push(c.parents[f]));
                }),
                d = 0,
                e = l.length;
              e > d;
          ...
          (this._undetermined = function () {
            if (null !== this.element) {
              var a = this.get_undetermined(!1),
                ...
                c,
                d;
              for (this.element.find('.jstree-undetermined').removeClass('jstree-undetermined'), b = 0, c = a.length; c > b; b++)
          ...
          (this.is_undetermined = function (b) {
            ...
            for (d = 0, e = b.children_d.length; e > d; d++)
              if (
                ...
                (!h[b.children_d[d]].state.loaded && h[b.children_d[d]].original.state.undetermined)
              )
                return !0;
            return !1;
          }),
          ...
          (this.activate_node = function (b, c) {
            return a(c.target).hasClass('jstree-checkbox-disabled')
              ? !1
              : (this.settings.checkbox.tie_selection &&
                  (this.settings.checkbox.whole_node || a(c.target).hasClass('jstree-checkbox')) &&
                  (c.ctrlKey = !0),
                this.settings.checkbox.tie_selection || (!this.settings.checkbox.whole_node && !a(c.target).hasClass('jstree-checkbox'))
                  ...
                  : this.is_disabled(b)
                  ? !1
                  : (this.is_checked(b) ? this.uncheck_node(b, c) : this.check_node(b, c),
                    void this.trigger('activate_node', { node: this.get_node(b) })));
          }),
          (this._cascade_new_checked_state = function (a, b) {
            var c = this,
              ...
              j;
            if (
              (!this.settings.checkbox.cascade_to_disabled && e.state.disabled) ||
              (!this.settings.checkbox.cascade_to_hidden && e.state.hidden)
            )
              (j = this.get_checked_descendants(a)), e.state[d ? 'selected' : 'checked'] && j.push(e.id), (f = f.concat(j));
            else {
              if (e.children)
          ...
          (this.check_all = function () {
            ...
            var b = this._data.checkbox.selected.concat([]),
              ...
              d;
            for (
              this._data.checkbox.selected = this._model.data[a.jstree.root].children_d.concat(),
                c = 0,
          ...
          (this.uncheck_all = function () {
            ...
            (this._data.checkbox.selected = []),
              ...
              this.trigger('uncheck_all', { selected: this._data.checkbox.selected, node: a });
          }),
            ...
            if (!a.isArray(b) && !this.settings.checkbox.tie_selection && ((j = this.get_node(b)), j && j.state.loaded))
              for (e = 0, f = j.children_d.length; f > e; e++)
                this._model.data[j.children_d[e]].state.checked &&
                  ((i = !0), (this._data.checkbox.selected = a.vakata.array_remove_item(this._data.checkbox.selected, j.children_d[e])));
            ...
            .on('touchmove.vakata.jstree', function (b) {
              c &&
                ...
                (Math.abs(e - b.originalEvent.changedTouches[0].clientX) > 10 ||
                  Math.abs(f - b.originalEvent.changedTouches[0].clientY) > 10) &&
        ...
        (a.vakata.context = {
          ...
          _execute: function (b) {
            return (
              (b = c.items[b]),
              b &&
              (!b._disabled || (a.isFunction(b._disabled) && !b._disabled({ item: b, reference: c.reference, element: c.element }))) &&
              b.action
                ? b.action.call(null, {
                    item: b,
                    reference: c.reference,
                  ...
                  ? (c.items.push(d),
                    !f &&
                      ...
                      (e +=
                        ...
                        (a.vakata.context.settings.icons ? '' : 'style="margin-left:0px;"') +
                        '>&#160;</a></li>'),
                    (f = !1),
                    (e +=
                      "<li class='" +
                      (d._class || '') +
                      (d._disabled === !0 ||
                      (a.isFunction(d._disabled) && d._disabled({ item: d, reference: c.reference, element: c.element }))
                    ...
                    a.vakata.context.settings.icons &&
                      ...
                      d.icon &&
                        (e +=
                          -1 !== d.icon.indexOf('/') || -1 !== d.icon.indexOf('.')
          ...
          _show_submenu: function (c) {
            if (((c = a(c)), c.length && c.children('ul').length)) {
              ...
              b
                ? c[f - (h + 10 + c.outerWidth()) < 0 ? 'addClass' : 'removeClass']('vakata-context-left')
                : c[f + h > j && e > j - f ? 'addClass' : 'removeClass']('vakata-context-right'),
          ...
          hide: function () {
            c.is_visible &&
              (c.element.hide().find('ul').hide().end().find(':focus').blur().end().detach(),
              (c.is_visible = !1),
            ...
            (c.element = a("<ul class='vakata-context'></ul>")),
              c.element
                ...
                .on('click', 'a', function (b) {
                  b.preventDefault(),
                    a(this).blur().parent().hasClass('vakata-context-disabled') ||
                    ...
                    case 38:
                      c.is_visible &&
                        ((d = c.element
                          ...
                          .first()),
                        d.length ||
                          (d = c.element.find('ul:visible').addBack().last().children('li:not(.vakata-context-separator)').last()),
                    ...
                    case 40:
                      c.is_visible &&
                        ((d = c.element
                          ...
                          .first()),
                        d.length ||
                          (d = c.element.find('ul:visible').addBack().last().children('li:not(.vakata-context-separator)').first()),
                        d.addClass('vakata-context-hover').children('a').focus(),
                        b.stopImmediatePropagation(),
                        b.preventDefault());
                      break;
                ...
                if (
                  ...
                  (!this.settings.dnd.touch ||
                    ('selected' === this.settings.dnd.touch &&
                      !a(b.currentTarget).closest('.jstree-node').children('.jstree-anchor').hasClass('jstree-clicked')))
                )
                  return !0;
                  ...
                  c &&
                    ...
                    (this.settings.dnd.is_draggable === !0 ||
                      (a.isFunction(this.settings.dnd.is_draggable) &&
                        this.settings.dnd.is_draggable.call(this, d > 1 ? this.get_top_selected(!0) : [c], b))))
                ) {
                  if (
                    ((m = { jstree: !0, origin: this, obj: this.get_node(c, !0), nodes: d > 1 ? this.get_top_selected() : [c.id] }),
                    (n = b.currentTarget),
      ...
      a(function () {
        ...
        a(i)
          ...
          .on('dnd_move.vakata.jstree', function (h, i) {
            ...
            if (
              (f && (!i.event || 'dragover' !== i.event.type || j) && clearTimeout(f),
              ...
              if (k && k._data && k._data.dnd)
                if (
                  ...
                  (D =
                    i.data.origin &&
                    (i.data.origin.settings.dnd.always_copy || (i.data.origin.settings.dnd.copy && (i.event.metaKey || i.event.ctrlKey)))),
                  i.helper
                    .children()
                    .attr(
                      'class',
                      'jstree-' +
                        ...
                        k.get_theme_variant() +
                        ' ' +
                        (k.settings.core.themes.responsive ? ' jstree-dnd-responsive' : '')
                    )
                    .find('.jstree-copy')
                    .first()
                    [D ? 'show' : 'hide'](),
                  (i.event.target !== k.element[0] && i.event.target !== k.get_container_ul()[0]) ||
                    0 !== k.get_container_ul().children().length)
                ) {
                  if (
                    ((l = k.settings.dnd.large_drop_target
                      ? a(i.event.target).closest('.jstree-node').children('.jstree-anchor')
                          ...
                          if (
                            ((y =
                              ...
                              (i.data.origin.settings.dnd.always_copy ||
                                (i.data.origin.settings.dnd.copy && (i.event.metaKey || i.event.ctrlKey)))
                                ? 'copy_node'
                                : 'move_node'),
                            (z = t),
                            'move_node' === y &&
                          ...
                          v
                            ? ((E = k.get_node(s, !0)),
                              E.hasClass('.jstree-dnd-parent') ||
                                (a('.jstree-dnd-parent').removeClass('jstree-dnd-parent'), E.addClass('jstree-dnd-parent')),
                              ...
                              i.event.originalEvent &&
                                ...
                                (i.event.originalEvent.dataTransfer.dropEffect = D ? 'copy' : 'move'),
                              (d = {}),
                              (u = !0),
                              !1)
                            : void 0
          ...
          .on('dnd_scroll.vakata.jstree', function (a, b) {
            b &&
              b.data &&
              b.data.jstree &&
              (g.hide(), (c = !1), (e = !1), b.helper.find('.jstree-icon').first().removeClass('jstree-ok').addClass('jstree-er'));
          })
          .on('dnd_stop.vakata.jstree', function (b, h) {
            if ((a('.jstree-dnd-parent').removeClass('jstree-dnd-parent'), f && clearTimeout(f), h && h.data && h.data.jstree)) {
              ...
              if (c) {
                ...
                c.ins[
                  h.data.origin &&
                  (h.data.origin.settings.dnd.always_copy || (h.data.origin.settings.dnd.copy && (h.event.metaKey || h.event.ctrlKey)))
                    ? 'copy_node'
                    : 'move_node'
                ](k, c.par, c.pos, !1, !1, !1, h.data.origin);
              } else
                (i = a(h.event.target).closest('.jstree')),
                  i.length && d && d.error && 'check' === d.error && ((i = i.jstree(!0)), i && i.settings.core.error.call(this, d));
              (e = !1), (c = !1);
            }
          })
              ...
              h &&
                ...
                ('keyup' === b.type && 27 === b.which
                  ...
                  : (h.helper
                      ...
                      [
                        h.data.origin &&
                        (h.data.origin.settings.dnd.always_copy || (h.data.origin.settings.dnd.copy && (b.metaKey || b.ctrlKey)))
                          ? 'show'
                          : 'hide'
                      ](),
            ...
            if (
              ...
              if (!c.is_drag) {
                if (
                  ...
                  return;
                c.helper && (c.helper.appendTo(i.body), (c.helper_w = c.helper.outerWidth())),
                  (c.is_drag = !0),
                  ...
                  .each(function () {
                    ...
                    return (
                      this.scrollHeight > this.offsetHeight &&
                        (e.top + d.height() - b.pageY < a.vakata.dnd.settings.scroll_proximity && (c.scroll_t = 1),
                        b.pageY - e.top < a.vakata.dnd.settings.scroll_proximity && (c.scroll_t = -1)),
                      this.scrollWidth > this.offsetWidth &&
                        (e.left + d.width() - b.pageX < a.vakata.dnd.settings.scroll_proximity && (c.scroll_l = 1),
          ...
          (this._load_nodes = function (b, d, e, f) {
            ...
            if (!e) {
              for (j = 0, k = b.length; k > j; j++)
                (!i[b[j]] || (!i[b[j]].state.loaded && !i[b[j]].state.failed) || f) &&
                  (h.push(b[j]), (l = this.get_node(b[j], !0)), l && l.length && l.addClass('jstree-loading').attr('aria-busy', !0));
                  ...
                  return g.call(
                    ...
                    a.proxy(function (a) {
                      ...
                      for (g = 0, h = b.length; h > g; g++)
                        (l = this.get_node(b[g], !0)), l && l.length && l.removeClass('jstree-loading').attr('aria-busy', !1);
                      ...
                      .done(
                        a.proxy(function (a, g, h) {
                          ...
                          for (i = 0, j = b.length; j > i; i++)
                            (l = this.get_node(b[i], !0)), l && l.length && l.removeClass('jstree-loading').attr('aria-busy', !1);
                          c._load_nodes.call(this, b, d, e, f);
                        }, this)
                      )
                      .fail(
                  ...
                  if (this._data.search.som && c.res.length) {
                    ...
                    for (e = 0, f = c.res.length; f > e; e++)
                      if (
                        ...
                        (g.push(c.res[e]), (g = g.concat(d[c.res[e]].parents)), this._data.search.smc)
                      )
                        for (h = 0, i = d[c.res[e]].children_d.length; i > h; h++)
          ...
          return (
            ...
            (l = function (a) {
              ...
              var c,
                ...
                x = [];
              for (
                -1 !== n && ((m = Math.min(k(0, n), m)), (n = a.lastIndexOf(b, e + h)), -1 !== n && (m = Math.min(k(0, n), m))),
                  n = -1,
                  c = 0;
                h > c;
                c++
                ...
                for (
                  q = p, s = Math.max(1, e - p + 1), t = Math.min(e + p, l) + h, u = new Array(t + 2), u[t + 1] = (1 << c) - 1, f = t;
                  f >= s;
                  f--
                )
                  if (
                    ...
                    0 === c
                      ? (u[f] = ((u[f + 1] << 1) | 1) & v)
                      : (u[f] = (((u[f + 1] << 1) | 1) & v) | (((r[f + 1] | r[f]) << 1) | 1) | r[f + 1]),
                    u[f] & i && ((w = k(c, f - 1)), m >= w))
                  ) {
                    ...
                    for (k in g[j].li_attr)
                      if (g[j].li_attr.hasOwnProperty(k)) {
                        ...
                        e[f[h]].li_attr[k] === b
                          ...
                          : 'class' === k && (e[f[h]].li_attr['class'] = g[j].li_attr['class'] + ' ' + e[f[h]].li_attr['class']);
                      }
            ...
            if (
              ...
              for (k in f[i].li_attr)
                if (f[i].li_attr.hasOwnProperty(k)) {
                  if ('id' === k) continue;
                  'class' === k
                    ? ((e[c.id].li_attr['class'] = (e[c.id].li_attr['class'] || '').replace(f[i].li_attr[k], '')),
            ...
            if (f[i] && f[i].a_attr !== b && 'object' == typeof f[i].a_attr)
              for (k in f[i].a_attr)
                if (f[i].a_attr.hasOwnProperty(k)) {
                  if ('id' === k) continue;
                  'class' === k
                    ? ((e[c.id].a_attr['class'] = (e[c.id].a_attr['class'] || '').replace(f[i].a_attr[k], '')),
                ...
                if (f[d].li_attr.hasOwnProperty(k)) {
                  ...
                  e[c.id].li_attr[k] === b
                    ? ((e[c.id].li_attr[k] = f[d].li_attr[k]),
                      l && ('class' === k ? l.addClass(f[d].li_attr[k]) : l.attr(k, f[d].li_attr[k])))
                    : 'class' === k &&
                      ((e[c.id].li_attr['class'] = f[d].li_attr[k] + ' ' + e[c.id].li_attr['class']), l && l.addClass(f[d].li_attr[k]));
                }
              ...
              for (k in f[d].a_attr)
                if (f[d].a_attr.hasOwnProperty(k)) {
                  ...
                  e[c.id].a_attr[k] === b
                    ...
                    : 'class' === k &&
                      ((e[c.id].a_attr['class'] = f[d].a_attr['class'] + ' ' + e[c.id].a_attr['class']), m && m.addClass(f[d].a_attr[k]));
                }
            return !0;
          });
      }),
      ...
      (a.jstree.plugins.unique = function (c, d) {
        (this.check = function (b, c, e, f, g) {
          ...
          switch ((j || (h = h.toLowerCase()), k && (h = h.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '')), b)) {
            ...
            case 'move_node':
              return (
                (m = (c.parent === e.id && (!g || !g.is_multi)) || -1 === a.inArray(h, i)),
                m ||
                  (this._data.core.last_error = {
                    error: 'check',
                    plugin: 'unique',
              ...
              .on(
                ...
                a.proxy(function (a, b) {
                  ('hover_node' === a.type && this.is_disabled(b.node)) ||
                    this.get_node(b.node, !0)
                      .children('.jstree-wholerow')
                      ['hover_node' === a.type ? 'addClass' : 'removeClass']('jstree-wholerow-hovered');
                }, this)
              )
              .on(
                'contextmenu.jstree',
      ...
      q.createdCallback = function () {
        ...
        for (c in a.jstree.plugins)
          a.jstree.plugins.hasOwnProperty(c) &&
            this.attributes[c] &&
            (b.plugins.push(c), this.getAttribute(c) && JSON.parse(this.getAttribute(c)) && (b[c] = JSON.parse(this.getAttribute(c))));
