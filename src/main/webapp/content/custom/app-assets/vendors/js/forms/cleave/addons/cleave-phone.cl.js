...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (R(n, n.a.toString()), B(n) ? V(n) : n.l ? L(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), L(n, t);
    }
    return '';
  }
  function L(n, t) {
...
*/
  var nn = { 56: ['CL'] },
    tn = {
      CL: [
        null,
        [null, null, '(?:1230|[2-57-9]\\d|6\\d{1,3})\\d{7}', null, null, null, null, null, null, [9, 10, 11]],
        [
          null,
          null,
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '44\\d{7}', null, null, null, '441234567', null, null, [9]],
        'CL',
        56,
        ...
        null,
        null,
        [null, null, '600\\d{7,8}', null, null, null, null, null, null, [10, 11]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
