...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = M(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? Z(n) : n.l ? D(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = M(n)), 0 < t.length ? t : R(n) ? Z(n) : n.i.toString();
    }
    return D(n, t);
  }
  function Z(n) {
...
*/
  var nn = { 260: ['ZM'] },
    tn = {
      ZM: [
        null,
        [null, null, '(?:(?:21|76|9\\d)\\d|800)\\d{6}', null, null, null, null, null, null, [9], [6]],
