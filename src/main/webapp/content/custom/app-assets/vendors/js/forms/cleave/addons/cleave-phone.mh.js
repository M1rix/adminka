    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = $(n)), 0 < r.length ? r : (C(n, n.a.toString()), F(n) ? V(n) : n.l ? D(n, e) : n.i.toString()))
          : H(n);
    }
  }
  function M(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), H(n);
  }
  function $(n) {
...
*/
  var nn = { 692: ['MH'] },
    tn = {
      MH: [
        null,
        [null, null, '(?:(?:[256]\\d|45)\\d|329)\\d{4}', null, null, null, null, null, null, [7]],
