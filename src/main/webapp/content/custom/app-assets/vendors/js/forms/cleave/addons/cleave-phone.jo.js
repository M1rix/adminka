...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = P(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? O(n) : n.l ? J(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), J(n, t);
    }
    return '';
  }
  function J(n, t) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = D(n)), 0 < t.length ? t : R(n) ? O(n) : n.i.toString();
    }
    return J(n, t);
  }
  function O(n) {
...
*/
  var nn = { 962: ['JO'] },
    tn = {
      JO: [
        null,
        [null, null, '(?:(?:(?:[268]|7\\d)\\d|32|53)\\d|900)\\d{5}', null, null, null, null, null, null, [8, 9]],
        [
          null,
          null,
        ...
        null,
        [null, null, '74(?:66|77)\\d{5}', null, null, null, '746612345', null, null, [9]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '8(?:10|8\\d)\\d{5}', null, null, null, '88101234', null, null, [8]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
