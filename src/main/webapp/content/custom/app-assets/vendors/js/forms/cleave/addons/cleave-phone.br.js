...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = D(n)), 0 < r.length ? r : (E(n, n.a.toString()), R(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return E(n, t), (t = D(n)), 0 < t.length ? t : R(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
  ...
  var nn = { 55: ['BR'] },
    tn = {
      BR: [
        ...
        null,
        null,
        [null, null, '(?:300\\d|40(?:0\\d|20))\\d{4}', null, null, null, null, null, null, [8]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
