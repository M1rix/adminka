!(function (e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define([], e)
    : (('undefined' != typeof window ? window : 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : this).dragula =
        e());
})(function () {
          ...
          (function (r) {
            ...
            t.exports = function (e, t) {
              ...
              function C(e) {
                ...
                (t = e.item),
                  (n = e.source),
                  ('boolean' == typeof y.copy ? y.copy : y.copy(t, n)) && ((h = e.item.cloneNode(!0)), w.emit('cloned', h, e.item, 'copy')),
                  (f = e.source),
                  (s = e.item),
                  (v = p = Z(e.item)),
                  (w.dragging = !0),
              ...
              function Y() {
                var e = h || s;
                I(),
                  l && (j.rm(y.mirrorContainer, 'gu-unselectable'), U(q, 'remove', 'mousemove', P), Q(l).removeChild(l), (l = null)),
                  e && j.rm(e, 'gu-transit'),
                  n && clearTimeout(n),
                  (w.dragging = !1),
                  g && w.emit('out', e, g, f),
