...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = P(n, t)), (l = D(n)), 0 < l.length ? l : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? T(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), M(n);
  }
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, r = 0; r < e; ++r) {
      var l = n.f[r],
        i = g(l, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(l, 4))), (t = t.replace(new RegExp(i, 'g'), h(l, 2))), T(n, t);
    }
    return '';
  }
  function T(n, t) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = D(n)), 0 < t.length ? t : R(n) ? V(n) : n.i.toString();
    }
    return T(n, t);
  }
  function V(n) {
...
*/
  var nn = { 255: ['TZ'] },
    tn = {
      TZ: [
        null,
        [null, null, '(?:[26-8]\\d|41|90)\\d{7}', null, null, null, null, null, null, [9]],
