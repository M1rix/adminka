...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = M(n)), 0 < r.length ? r : (F(n, n.a.toString()), $(n) ? G(n) : n.l ? D(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function M(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), D(n, t);
    }
    return '';
  }
  function D(n, t) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = M(n)), 0 < t.length ? t : $(n) ? G(n) : n.i.toString();
    }
    return D(n, t);
  }
  function G(n) {
...
*/
  var nn = { 382: ['ME'] },
    tn = {
      ME: [
        null,
        [null, null, '(?:20|[3-79]\\d|80\\d?)\\d{6}', null, null, null, null, null, null, [8, 9], [6]],
        [
          null,
          null,
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '78[1-49]\\d{5}', null, null, null, '78108780', null, null, [8]],
        'ME',
        382,
        '00',
        '0',
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '77[1-9]\\d{5}', null, null, null, '77273012', null, null, [8]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
