...
!(function (a) {
  a(['jquery'], function (a) {
    return (function () {
      ...
      function r(c) {
        return (
          (b = a('<div/>').attr('id', c.containerId).addClass('toast-container').addClass(c.positionClass)), b.appendTo(a(c.target)), b
        );
      }
      function s() {
        return {
      ...
      function u(c) {
        ...
        function x() {
          j.hide(),
            j[e.showMethod]({ duration: e.showDuration, easing: e.showEasing, complete: e.onShown }),
            e.timeOut > 0 &&
        ...
        if (
          ('undefined' != typeof c.optionsOverride && ((e = a.extend(e, c.optionsOverride)), (f = c.optionsOverride.iconClass || f)),
          !F(e, c))
        ) {
          d++, (b = i(e, !0));
          var h = null,
