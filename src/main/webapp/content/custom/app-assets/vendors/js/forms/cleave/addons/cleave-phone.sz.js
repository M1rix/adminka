...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), $(n) ? Z(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = D(n)), 0 < t.length ? t : $(n) ? Z(n) : n.i.toString();
    }
    return M(n, t);
  }
  function Z(n) {
...
*/
  var nn = { 268: ['SZ'] },
    tn = {
      SZ: [
        null,
        [null, null, '(?:0800|(?:[237]\\d|900)\\d\\d)\\d{4}', null, null, null, null, null, null, [8, 9]],
