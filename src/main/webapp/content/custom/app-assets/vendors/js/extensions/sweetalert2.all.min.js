...
!(function (e, t) {
  ...
  const S = () => f('.'.concat(h.loader)),
    ...
    M = () => y(h.close),
    D = () => {
      const e = a(v().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
        (e, t) => ((e = parseInt(e.getAttribute('tabindex'))), (t = parseInt(t.getAttribute('tabindex'))) < e ? 1 : e < t ? -1 : 0)
      );
      var t = a(
        v().querySelectorAll(
    ...
    ke.url =
      (e, t) => (
        'string' == typeof t.inputValue || 'number' == typeof t.inputValue
          ...
          : p(t.inputValue) ||
            s('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
        we(e, e, t),
        ve(e, t),
        (e.type = t.input),
        e
    ...
    (ke.textarea = (t, e) => {
      ...
      if ('MutationObserver' in window) {
        ...
        new MutationObserver(() => {
          var e,
            e =
              t.offsetWidth + ((e = t), parseInt(window.getComputedStyle(e).marginLeft) + parseInt(window.getComputedStyle(e).marginRight));
  ...
  const Ae = (e, t) => {
    ...
    Oe = (e, t) => {
      ...
      (e => {
        var t = b();
        const n = v();
        e.toast ? (Y(t, 'width', e.width), (n.style.width = '100%'), n.insertBefore(S(), w())) : Y(n, 'width', e.width),
      ...
      new Promise(e => {
        ...
        (Ie.restoreFocusTimeout = setTimeout(() => {
          Ie.previousActiveElement && Ie.previousActiveElement.focus
            ? (Ie.previousActiveElement.focus(), (Ie.previousActiveElement = null))
    ...
    Ze = e => {
      ...
      for (const o in e)
        (n = o),
          ...
          e.toast && ((t = o), _e.includes(t) && s('The parameter "'.concat(t, '" is incompatible with toasts'))),
          (t = o),
          Ye(t) && i(t, Ye(t));
      var t, n;
    };
      ...
      return (
        'object' != typeof n[0] || m(n[0])
          ? ['title', 'html', 'icon'].forEach((e, t) => {
              ...
              'string' == typeof t || m(t)
                ? (o[e] = t)
                : void 0 !== t && r('Unexpected type of '.concat(e, '! Expected "string" or "Element", got ').concat(typeof t));
            })
          : Object.assign(o, n[0]),
        o
      );
  ...
  const $e = () => {
    ...
    Ge = () => {
      navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) ||
        (v().scrollHeight > window.innerHeight - 44 && (b().style.paddingBottom = ''.concat(44, 'px')));
    },
    Qe = () => {
      const e = b();
      let t;
  ...
  function it(e, t, n, o) {
    H()
      ? rt(e, o)
      : (He(n).then(() => rt(e, o)),
        Ie.keydownTarget.removeEventListener('keydown', Ie.keydownHandler, { capture: Ie.keydownListenerCapture }),
      ...
      I() &&
        (null !== q.previousBodyPadding &&
          ((document.body.style.paddingRight = ''.concat(q.previousBodyPadding, 'px')), (q.previousBodyPadding = null)),
  ...
  var dt = {
    email: (e, t) =>
      /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(e) ? Promise.resolve() : Promise.resolve(t || 'Invalid email address'),
    url: (e, t) =>
  ...
  function pt(e) {
    ...
    (t = e).inputValidator ||
      ...
      ((n = e).target &&
        ...
        (s('Target parameter is not valid, defaulting to "body"'), (n.target = 'body')),
    ...
    _t = (e, t, n) => {
      t.isComposing ||
        (t.target &&
          ...
          (['textarea', 'file'].includes(n.input) || (je(), t.preventDefault())));
    },
    Kt = (e, t) => {
      var n = e.target,
        o = D();
  ...
  const en = (e, t, n) => {
    ...
    nn = (e, t) =>
      t.focusDeny && G(e.denyButton)
        ...
        : !(!t.focusConfirm || !G(e.confirmButton)) && (e.confirmButton.focus(), !0),
    on = () => {
  ...
  e = Object.freeze({
      ...
      Ze(Object.assign({}, t, e)),
        ...
        pt(
          (e = ((e, t) => {
            ...
            return (
              (o.showClass = Object.assign({}, Re.showClass, o.showClass)), (o.hideClass = Object.assign({}, Re.hideClass, o.hideClass)), o
            );
          })(e, t))
        ),
        Object.freeze(e),
      ...
      return (
        ...
        new Promise(e => {
          ...
          ot.swalPromiseResolve.set(s, e),
            ...
            (a = r),
            (e = t),
            he.innerParams.get(n).toast ? Jt(n, a, e) : ($t(a), Gt(a), Qt(n, a, e)),
            (o = s),
            (a = Ie),
            (e = c),
            (i = t),
    ...
    _destroy: function () {
      ...
      t &&
        (e.popup && Ie.swalCloseEventFinishedCallback && (Ie.swalCloseEventFinishedCallback(), delete Ie.swalCloseEventFinishedCallback),
        Ie.deferDisposalTimer && (clearTimeout(Ie.deferDisposalTimer), delete Ie.deferDisposalTimer),
