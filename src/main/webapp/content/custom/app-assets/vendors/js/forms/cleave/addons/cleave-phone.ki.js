...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = $(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? K(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function D(n) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = $(n)), 0 < t.length ? t : R(n) ? V(n) : n.i.toString();
    }
    return K(n, t);
  }
  function V(n) {
...
*/
  var nn = { 686: ['KI'] },
    tn = {
      KI: [
        null,
        [null, null, '(?:[37]\\d|6[0-79])\\d{6}|(?:[2-48]\\d|50)\\d{3}', null, null, null, null, null, null, [5, 8]],
        [
          null,
          null,
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '30(?:0[01]\\d\\d|12(?:11|20))\\d\\d', null, null, null, '30010000', null, null, [8]],
        'KI',
        686,
        '00',
        '0',
