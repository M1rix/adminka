    ...
    if (3 <= t.length) {
      for (var e = n.o && 0 == n.h.length && 0 < m(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], l = e.length, r = 0; r < l; ++r) {
        ...
        (0 < n.h.length && E(g(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || E(g(i, 4)) || h(i, 6)) && fn.test(g(i, 2)) && n.f.push(i));
      }
...
*/
  var nn = { 372: ['EE'] },
    tn = {
      EE: [
        null,
        [null, null, '8\\d{9}|[4578]\\d{7}|(?:[3-8]\\d\\d|900)\\d{4}', null, null, null, null, null, null, [7, 8, 10]],
        ...
        [
          [
            ...
            '(\\d{3})(\\d{4})',
            '$1 $2',
            ['[369]|4[3-8]|5(?:[0-2]|5[0-478]|6[45])|7[1-9]', '[369]|4[3-8]|5(?:[02]|1(?:[0-8]|95)|5[0-478]|6(?:4[0-4]|5[1-589]))|7[1-9]'],
          ],
