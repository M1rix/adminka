 ...
 * Original file: /npm/dropzone@5.9.2/dist/dropzone.js
 *
          ...
          e.exports = function (e, t, n, c, h, w, E) {
            ...
            if (
              (U &&
                ...
                d !== Object.prototype &&
                  k.next &&
                  (f || o(k) === d || (a ? a(k, d) : 'function' != typeof k[y] && s(k, y, x)), u(k, T, !0, !0), f && (p[T] = x))),
              h == m &&
                R &&
                R.name !== m &&
                ((C = !0),
          ...
          (u[f] = !0),
            (e.exports =
              ...
              function (e, t) {
                var n;
                return (
                  null !== e ? ((p.prototype = i(e)), (n = new p()), (p.prototype = null), (n[f] = e)) : (n = d()),
                  void 0 === t ? n : o(n, t)
                );
              });
        },
            ...
            { target: 'Array', proto: !0, forced: !c },
            {
              splice: function (e, t) {
                var n,
                  ...
                  x = i(e, b),
                  w = arguments.length;
                if ((0 === w ? (n = r = 0) : 1 === w ? ((n = 0), (r = b - x)) : ((n = w - 2), (r = p(f(o(t), 0), b - x))), b + n - r > h))
                  throw TypeError(d);
            ...
            D = function (e, t) {
              if (t)
                for (var n, r, i = t.split('&'), o = 0; o < i.length; )
                  (n = i[o++]).length && ((r = n.split('=')), e.push({ key: _(r.shift()), value: _(r.join('=')) }));
            },
            N = function (e) {
        ...
        285: function (e, t, n) {
          ...
          var r,
            ...
            B = function (e) {
              ...
              for (n = [], r = 0; r < t; r++) {
                if ('' == (i = s[r])) return e;
                if (((o = 10), i.length > 1 && '0' == i.charAt(0) && ((o = U.test(i) ? 16 : 8), (i = i.slice(8 == o ? 1 : 2))), '' === i))
                  a = 0;
                else {
            ...
            ee = function (e) {
              var t;
              return (
                e.length > 1 && J(e.slice(0, 2)) && (2 == e.length || '/' === (t = e.charAt(2)) || '\\' === t || '?' === t || '#' === t)
              );
            },
            te = function (e) {
              var t = e.path,
            ...
            Ae = function (e, t, n, i) {
              ...
              for (
                ...
                switch (((a = o[p]), c)) {
                    ...
                    if (a == r || '/' == a || ('\\' == a && X(e)) || (!n && ('?' == a || '#' == a))) {
                      if (
                        ('..' === (l = (l = d).toLowerCase()) || '%2e.' === l || '.%2e' === l || '%2e%2e' === l
                          ...
                          : ne(d)
                          ? '/' == a || ('\\' == a && X(e)) || e.path.push('')
                          : ('file' == e.scheme && !e.path.length && J(d) && (e.host && (e.host = ''), (d = d.charAt(0) + ':')),
                            e.path.push(d)),
                        (d = ''),
                  ...
                  case Ee:
                    n || '#' != a
                      ? a != r && ("'" == a && X(e) ? (e.query += '%27') : (e.query += '#' == a ? '%23' : $(a, H)))
                      : ((e.fragment = ''), (c = ke));
                    break;
                  case ke:
                    a != r && (e.fragment += $(a, Y));
            ...
            Te = function () {
              ...
              return (
                null !== i
                  ? ((l += '//'), K(e) && (l += n + (r ? ':' + r : '') + '@'), (l += W(i)), null !== o && (l += ':' + o))
                  : 'file' == t && (l += '//'),
      ...
      (function () {
        ...
        var s = {
          ...
          addedfile: function (e) {
            ...
            if (
              ...
              this.options.addRemoveLinks &&
                ((e._removeLink = x.createElement(
                  '<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, '</a>')
                )),
              ...
              var s,
                l = function (n) {
                  return (
                    n.preventDefault(),
                    n.stopPropagation(),
                    e.status === x.UPLOADING
                      ? x.confirm(t.options.dictCancelUploadConfirmation, function () {
                          return t.removeFile(e);
                        })
                      : t.options.dictRemoveFileConfirmation
                      ? x.confirm(t.options.dictRemoveFileConfirmation, function () {
                          return t.removeFile(e);
                        })
                      : t.removeFile(e)
                  );
          ...
          removedfile: function (e) {
            return (
              null != e.previewElement && null != e.previewElement.parentNode && e.previewElement.parentNode.removeChild(e.previewElement),
        ...
        var x = (function (e) {
          ...
          function n(e, r) {
            ...
            if (
              ((i.options = n.extend({}, s, u, null != r ? r : {})),
            ...
            if ((null == i.options.url && (i.options.url = i.element.getAttribute('action')), !i.options.url))
            ...
            return (
              ...
              !1 !== i.options.previewsContainer &&
                (i.options.previewsContainer
                  ? (i.previewsContainer = n.getElement(i.options.previewsContainer, 'previewsContainer'))
                  : (i.previewsContainer = i.element)),
              i.options.clickable &&
                (!0 === i.options.clickable
                  ? (i.clickableElements = [i.element])
                  : (i.clickableElements = n.getElements(i.options.clickable, 'clickable'))),
              i.init(),
              i
            );
          }
            ...
            d(
              ...
              [
                          ...
                          events: {
                            click: function (r) {
                              return (
                                (t !== e.element ||
                                  r.target === e.element ||
                                  n.elementInside(r.target, e.element.querySelector('.dz-message'))) &&
                  ...
                  value: function () {
                    return (
                      ...
                      (null != this.hiddenFileInput ? this.hiddenFileInput.parentNode : void 0) &&
                        (this.hiddenFileInput.parentNode.removeChild(this.hiddenFileInput), (this.hiddenFileInput = null)),
                ...
                },
                {
                  ...
                  value: function (e) {
                    return 'function' == typeof this.options.paramName
                      ...
                      : ''.concat(this.options.paramName).concat(this.options.uploadMultiple ? '['.concat(e, ']') : '');
                  },
                },
                {
                  key: '_renameFile',
                ...
                },
                {
                  ...
                  value: function () {
                    return null != this.options.maxFiles && this.getAcceptedFiles().length >= this.options.maxFiles
                      ? (this.getAcceptedFiles().length === this.options.maxFiles && this.emit('maxfilesreached', this.files),
                              ...
                              a.isFile
                                ? a.file(function (e) {
                                    if (!n.options.ignoreHiddenFiles || '.' !== e.name.substring(0, 1))
                                      return (e.fullPath = ''.concat(t, '/').concat(e.name)), n.addFile(e);
                                  })
                ...
                },
                {
                  ...
                  value: function (e) {
                    var t = this;
                    (e.upload = { uuid: n.uuidv4(), progress: 0, total: e.size, bytesSent: 0, filename: this._renameFile(e) }),
                      this.files.push(e),
                      (e.status = n.ADDED),
                      this.emit('addedfile', e),
                      this._enqueueThumbnail(e),
                      this.accept(e, function (n) {
                        n ? ((e.accepted = !1), t._errorProcessing([e], n)) : ((e.accepted = !0), t.options.autoQueue && t.enqueueFile(e)),
                      ...
                      if (e[0].upload.chunked) {
                        ...
                        var u = function () {
                          ...
                          if (!(r >= o.upload.totalChunkCount)) {
                            ...
                            (o.upload.chunks[r] = { file: o, index: r, dataBlock: s, status: n.UPLOADING, progress: 0, retries: 0 }),
                              t._uploadData(e, [s]);
                          }
                        };
                        if (
                          ((o.upload.finishedChunkUpload = function (r, i) {
                            var a = !0;
                        ...
                        for (var l = [], c = 0; c < e.length; c++)
                          l[c] = { name: t._getParamName(c), data: r[c], filename: e[c].upload.filename };
                        t._uploadData(e, l);
                      }
                    });
                  },
                  ...
                  value: function (e, t) {
                    ...
                    if (this.options.params) {
                      ...
                      for (var v in ('function' == typeof d &&
                        (d = d.call(this, e, o, e[0].upload.chunked ? this._getChunk(e[0], o) : null)),
                      d)) {
                        var y = d[v];
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    if (e[0].upload.chunked) {
                      ...
                      n
                        ? ((i.progress = (100 * n.loaded) / n.total), (i.total = n.total), (i.bytesSent = n.loaded))
                ...
                },
                {
                  ...
                  value: function (e, t, r) {
                    ...
                    if (
                      (this.options.uploadMultiple && (this.emit('successmultiple', e, t, r), this.emit('completemultiple', e)),
                ...
                },
                {
                  ...
                  value: function (e, t, r) {
                    ...
                    if (
                      (this.options.uploadMultiple && (this.emit('errormultiple', e, t, r), this.emit('completemultiple', e)),
                      this.options.autoProcessQueue)
                    )
                      return this.processQueue();
                  },
        ...
        (x.createElement = function (e) {
          ...
          (x.getElements = function (e, t) {
            ...
            if (null == r || !r.length)
              throw new Error(
                'Invalid `'.concat(t, '` option provided. Please provide a CSS selector, a plain HTML element or a list of those.')
              );
            return r;
          }),
            ...
            var n = !1,
              ...
              l = function r(o) {
                if ('readystatechange' !== o.type || 'complete' === i.readyState)
                  return ('load' === o.type ? e : i)[u](s + o.type, r, !1), !n && (n = !0) ? t.call(e, o.type || o) : void 0;
              };
