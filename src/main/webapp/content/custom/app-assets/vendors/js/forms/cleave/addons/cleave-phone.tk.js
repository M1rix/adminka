...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = P(n, t)), (r = T(n)), 0 < r.length ? r : (C(n, n.a.toString()), F(n) ? M(n) : n.l ? $(n, e) : n.i.toString()))
          : K(n);
    }
  }
  function D(n) {
  ...
  function T(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), $(n, t);
    }
    return '';
  }
  function $(n, t) {
  ...
  function K(n) {
    ...
    if (3 <= t.length) {
      ...
      return C(n, t), (t = T(n)), 0 < t.length ? t : F(n) ? M(n) : n.i.toString();
    }
    return $(n, t);
  }
  function M(n) {
...
*/
  var nn = { 690: ['TK'] },
    tn = {
      TK: [
        null,
        [null, null, '[2-47]\\d{3,6}', null, null, null, null, null, null, [4, 5, 6, 7]],
