...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = D(n)), 0 < r.length ? r : ($(n, n.a.toString()), R(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return $(n, t), (t = D(n)), 0 < t.length ? t : R(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
...
*/
  var nn = { 681: ['WF'] },
    tn = {
      WF: [
        null,
        [null, null, '(?:[45]0|68|72|8\\d)\\d{4}', null, null, null, null, null, null, [6]],
