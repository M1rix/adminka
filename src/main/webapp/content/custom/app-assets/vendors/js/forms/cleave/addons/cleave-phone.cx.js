!function () {
  function l(l, n) {
    ...
    for (var e; t.length && (e = t.shift()); ) t.length || void 0 === n ? (u = u[e] ? u[e] : (u[e] = {})) : (u[e] = n);
  }
  function n(l, n) {
    function t() {}
  ...
  function p(l, n) {
    for (var t = o(l.j()), u = 0; u < t.length; u++) {
      ...
      if (null != n.a[r]) {
        ...
        else (e = c(n, r)), i ? ((i = c(l, r)) ? p(i, e) : m(l, r, e.clone())) : m(l, r, e);
      }
    }
  }
  function c(l, n) {
...
*/
  ...
  function R(l, n) {
    for (var t = [], u = n.length - 3, e = l.f.length, r = 0; r < e; ++r) {
      var i = l.f[r];
      0 == d(i, 3) ? t.push(l.f[r]) : ((i = h(i, 3, Math.min(u, d(i, 3) - 1))), 0 == n.search(i) && t.push(l.f[r]));
    }
    l.f = t;
  }
  function F(l, n) {
    ...
    if (el.test(t) || (1 == l.i.b.length && ul.test(t))) {
      var e,
        t = n;
      '+' == t ? ((e = t), l.u.a(t)) : ((e = tl[t]), l.u.a(e), l.a.a(e)), (n = e);
    } else (l.l = !1), (l.F = !0);
    if (!l.l) {
      if (!l.F)
        if (H(l)) {
    ...
    switch (l.u.b.length) {
      ...
      default:
        return l.A
          ...
          : 0 < l.f.length
          ? ((t = q(l, n)), (e = D(l)), 0 < e.length ? e : (R(l, l.a.toString()), B(l) ? V(l) : l.l ? U(l, t) : l.i.toString()))
          : M(l);
    }
  }
  function I(l) {
    return (l.l = !0), (l.A = !1), (l.f = []), (l.s = 0), u(l.m), (l.w = ''), M(l);
  }
  function D(l) {
    for (var n = l.a.toString(), t = l.f.length, u = 0; u < t; ++u) {
      var e = l.f[u],
        r = g(e, 1);
      if (new RegExp('^(?:' + r + ')$').test(n)) return (l.B = fl.test(h(e, 4))), (n = n.replace(new RegExp(r, 'g'), h(e, 2))), U(l, n);
    }
    return '';
  }
  function U(l, n) {
    var t = l.b.b.length;
    return l.B && 0 < t && ' ' != l.b.toString().charAt(t - 1) ? l.b + ' ' + n : l.b + n;
  }
  function M(l) {
    var n = l.a.toString();
    if (3 <= n.length) {
      for (var t = l.o && 0 == l.h.length && 0 < d(l.g, 20) ? c(l.g, 20) || [] : c(l.g, 19) || [], u = t.length, e = 0; e < u; ++e) {
        var r = t[e];
        (0 < l.h.length && A(g(r, 4)) && !h(r, 6) && null == r.a[5]) ||
          ((0 != l.h.length || l.o || A(g(r, 4)) || h(r, 6)) && sl.test(g(r, 2)) && l.f.push(r));
      }
      return R(l, n), (n = D(l)), 0 < n.length ? n : B(l) ? V(l) : l.i.toString();
    }
    return U(l, n);
  }
  function V(l) {
    ...
    return (
      ...
      n
        ...
        : null != l.g.a[15] &&
          ...
          (n = t.match(n)),
          null != n && null != n[0] && 0 < n[0].length && ((l.o = !0), (e = n[0].length), l.b.a(t.substring(0, e)))),
      u(l.a),
      l.a.a(t.substring(e)),
      t.substring(0, e)
    );
  ...
  function H(l) {
    ...
    return (
      ...
      null != t[0] &&
      0 < t[0].length &&
      ((l.o = !0), (t = t[0].length), u(l.a), l.a.a(n.substring(t)), u(l.b), l.b.a(n.substring(0, t)), '+' != n.charAt(0) && l.b.a(' '), !0)
    );
  }
  function P(l) {
  ...
  (t.prototype.b = ''),
    ...
    (t.prototype.a = function (l, n, t) {
      if (((this.b += String(l)), null != n)) for (var u = 1; u < arguments.length; u++) this.b += arguments[u];
      return this;
    }),
  ...
  (y.prototype.j = function () {
    ...
    ($.prototype.b = function (l, n) {
      ...
      } else if (t === Number && 'string' == typeof n && ('Infinity' === n || '-Infinity' === n || 'NaN' === n || W.test(n)))
        return Number(n);
      return n;
    });
  var W = /^-?[0-9]+$/;
...
*/
  var ll = { 61: ['AU', 'CC', 'CX'] },
    nl = {
      AU: [
        null,
        [null, null, '1\\d{4,9}|(?:[2-478]\\d\\d|550)\\d{6}', null, null, null, null, null, null, [5, 6, 7, 8, 9, 10]],
        [
          null,
          null,
        ...
        [null, null, '(?:14(?:5\\d|71)|550\\d)\\d{5}', null, null, null, '550123456', null, null, [9]],
        'AU',
        61,
        ...
        [null, null, '16\\d{3,7}', null, null, null, '1612345', null, null, [5, 6, 7, 8, 9]],
        1,
        null,
        [null, null, '1[38]00\\d{6}|1(?:345[0-4]|802)\\d{3}|13\\d{4}', null, null, null, null, null, null, [6, 7, 8, 10]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ...
      CC: [
        null,
        [null, null, '1\\d{5,9}|(?:[48]\\d\\d|550)\\d{6}', null, null, null, null, null, null, [6, 7, 8, 9, 10]],
        [
          null,
          null,
