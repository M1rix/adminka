...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = D(n)), 0 < r.length ? r : (B(n, n.a.toString()), I(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function C(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return B(n, t), (t = D(n)), 0 < t.length ? t : I(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
...
*/
  var nn = { 98: ['IR'] },
    tn = {
      IR: [
        null,
        [null, null, '[1-9]\\d{9}|(?:[1-8]\\d\\d|9)\\d{3,4}', null, null, null, null, null, null, [4, 5, 6, 7, 10], [8]],
        [
          null,
          null,
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '993\\d{7}', null, null, null, '9932123456', null, null, [10]],
        'IR',
        98,
        '00',
        '0',
