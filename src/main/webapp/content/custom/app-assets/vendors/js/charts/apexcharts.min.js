          ...
          [
            {
              ...
              value: function (t, e) {
                var i = e.split(','),
                  ...
                  o = parseInt(i[2], 10);
                return (
                  'rgb(' + (Math.round((a - r) * s) + r) + ',' + (Math.round((a - n) * s) + n) + ',' + (Math.round((a - o) * s) + o) + ')'
                );
              },
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  '#' +
                  (16777216 + 65536 * (Math.round((a - r) * s) + r) + 256 * (Math.round((a - n) * s) + n) + (Math.round((a - o) * s) + o))
                    .toString(16)
                    .slice(1)
                );
              },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              e.globals.animationEnded ||
                ...
                'function' == typeof e.config.chart.events.animationEnd && e.config.chart.events.animationEnd(this.ctx, { el: t, w: e }));
            },
          },
          {
            key: 'morphSVG',
            ...
            },
            {
              ...
              value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                  a = null;
                return (
                  null === i ? (a = ['L', t, e].join(' ')) : 'H' === i ? (a = ['H', t].join(' ')) : 'V' === i && (a = ['V', e].join(' ')), a
                );
              },
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  ...
                  (!A.config.chart.dropShadow.enabledOnSeries ||
                    (A.config.chart.dropShadow.enabledOnSeries && -1 !== A.config.chart.dropShadow.enabledOnSeries.indexOf(a)))
                ) {
              ...
              var t = this,
                ...
                i = function (i, a, s) {
                  var r = e.globals.dom.baseEl.querySelector(
                    '.apexcharts-'.concat(s, '-annotations .apexcharts-').concat(s, "-annotation-label[rel='").concat(a, "']")
                  );
                  if (r) {
                    var n = r.parentNode,
                ...
                var p = 'top' === t.label.position ? 4 : a.globals.gridHeight,
                  ...
                  b = this.annoCtx.graphics.drawText({
                    ...
                    y:
                      p +
                      t.label.offsetY -
                      ('vertical' === t.label.orientation ? ('top' === t.label.position ? x.width / 2 - 12 : -x.width / 2) : 0),
                    text: l,
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              e = (e = (e = e.replace(/(^|[^\\])yyyy+/g, '$1' + h)).replace(/(^|[^\\])yy/g, '$1' + h.toString().substr(2, 2))).replace(
                /(^|[^\\])y/g,
                '$1' + h
              );
              ...
              e = (e = (e = (e = e.replace(/(^|[^\\])dddd+/g, '$1' + n[0])).replace(/(^|[^\\])ddd/g, '$1' + o[0])).replace(
                /(^|[^\\])dd/g,
                '$1' + l(d)
              )).replace(/(^|[^\\])d/g, '$1' + d);
              ...
              return (e = (e = (e = (e = (e = e.replace(new RegExp(n[0], 'g'), n[A])).replace(new RegExp(o[0], 'g'), o[A])).replace(
                new RegExp(s[0], 'g'),
                s[c]
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  o.push(-s.minY / r[0]), s.minY !== Number.MIN_VALUE && 0 !== Math.abs(s.minY) && ((l = -s.minY / t), (h = s.minX / e));
                return {
                  yRatio: r,
                  invertedYRatio: t,
                  zRatio: n,
            ...
            value: function (t, e) {
              ...
              if (this.annoCtx.invertAxis) {
                ...
                if (s.config.yaxis[e.yAxisIndex].logarithmic)
                  o = (a = new w(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex];
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              a.config.yaxis[t.yAxisIndex].logarithmic
                ? (o = (l = new w(this.annoCtx.ctx).getLogVal(l, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex])
              ...
              if (
                ...
                if ((u.attr({ rel: i }), e.appendChild(u.node), t.customSVG.SVG)) {
                  ...
                  p.attr({ transform: 'translate('.concat(s + t.customSVG.offsetX, ', ').concat(r + t.customSVG.offsetY, ')') }),
      ...
      return (
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              return (
                this.addAnnotationExternal({ params: t, pushToMemory: e, context: i, type: 'xaxis', contextMethod: i.addXaxisAnnotation }),
                i
              );
            },
          },
          {
            ...
            value: function (t, e, i) {
              return (
                this.addAnnotationExternal({ params: t, pushToMemory: e, context: i, type: 'yaxis', contextMethod: i.addYaxisAnnotation }),
                i
              );
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var u = o.globals.dom.baseEl.querySelector(
                  '.apexcharts-'.concat(s, '-annotations .apexcharts-').concat(s, "-annotation-label[rel='").concat(h, "']")
                ),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.w;
              return (
                (('bar' === e.config.chart.type || 'rangeBar' === e.config.chart.type) && e.config.plotOptions.bar.distributed) ||
        ...
        a(t, [
          {
            ...
            value: function () {
              var t = this.w;
              if (
                ((t.globals.markers.size = Array.isArray(t.config.markers.size) ? t.config.markers.size : [t.config.markers.size]),
                ...
                for (var d = 0; d < l.x.length; d++) {
                  ...
                  if (x || r) {
                    ...
                    n.config.series[o].data[g] &&
                      (n.config.series[o].data[g].fillColor && (m.pointFillColor = n.config.series[o].data[g].fillColor),
                    ...
                    void 0 === n.globals.pointsArray[e] && (n.globals.pointsArray[e] = []), n.globals.pointsArray[e].push([l.x[d], l.y[d]]);
                }
              return h;
            },
          },
            ...
            value: function (t, e, i, a, s, r, n) {
              ...
              if (o.globals.dataChanged)
                if (this.dynamicAnim) {
                  ...
                  0 === t && 0 === e && (a = 0), h.animateCircle(v, { cx: k, cy: A, r: S }, { cx: t, cy: e, r: a }, L, o.globals.easing);
                } else v.attr({ r: a });
              return (
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(r) < 0)) {
                ...
                f && (x = this.dataLabelsCorrection(a, s, o, r, n, u, parseInt(d.style.fontSize, 10))),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              f.globals.isXNumeric &&
                ...
                ((m = e + parseFloat(c * (g + 1))), (v = i + parseFloat(h * (g + 1)) - x));
              var y = e,
                w = i,
                k = {},
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                i.config.chart.stacked || (c < 0 ? (c = 0 + g) : c + h.height / 3 > i.globals.gridHeight && (c = i.globals.gridHeight - g)),
            ...
            value: function (t) {
              ...
              return (
                e.config.chart.stacked ||
                  (h < 0 ? (h = h + l.width + c) : h + l.width / 2 > e.globals.gridWidth && (h = e.globals.gridWidth - l.width - c)),
              ...
              if (c.enabled && !m) {
                ...
                d.config.chart.stacked &&
                  ...
                  (this.barCtx.isHorizontal
                    ? ((h > 0 && o.width / 1.6 > h) || (h < 0 && o.width / 1.6 < h)) && (v = '')
                    : o.height / 1.6 > l && (v = ''));
                var k = n({}, c);
                this.barCtx.isHorizontal &&
                  a < 0 &&
                  ('start' === c.textAnchor ? (k.textAnchor = 'end') : 'end' === c.textAnchor && (k.textAnchor = 'start')),
        ...
        a(t, [
              ...
              if ('mousemove' === t.type) {
                ...
                i.globals.axisCharts || 'radialBar' === i.config.chart.type
                  ? i.globals.axisCharts
                    ? ((r = i.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(s, "']"))),
          ...
          },
          {
            ...
            value: function () {
              ...
              function e(e, i, a) {
                for (
                  var s = e[i].childNodes, r = { type: a, paths: [], realIndex: e[i].getAttribute('data:realIndex') }, n = 0;
                  n < s.length;
                  n++
                )
              ...
              ['line', 'area', 'bar', 'candlestick', 'radar'].forEach(function (i) {
                for (
                  var a,
                    s = ((a = i), t.globals.dom.baseEl.querySelectorAll('.apexcharts-'.concat(a, '-series .apexcharts-series'))),
                    r = 0;
                  r < s.length;
                  r++
                )
                  ...
                  var a = function (e) {
                      for (
                        var i = t.globals.dom.baseEl.querySelectorAll(
                            '.apexcharts-'.concat(t.config.chart.type, " .apexcharts-series[data\\:realIndex='").concat(e, "'] rect")
                          ),
                          a = [],
                          s = function (t) {
                            var e = function (e) {
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              for (var i = 0; i < t.length; i++)
                if (
                  (t[i].length > 0 && ((this.barCtx.seriesLen = this.barCtx.seriesLen + 1), (this.barCtx.totalItems += t[i].length)),
              ...
              return (
                ...
                s.config.stroke.show &&
                  (this.barCtx.isNullValue ||
                    (a = Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[i] : this.barCtx.strokeWidth)),
                a
              );
            },
          },
        ...
        a(t, [
            ...
            value: function (t, e) {
              ...
              for (var o = 0, l = 0; o < t.length; o++, l++) {
                ...
                for (var C = a.group({ class: 'apexcharts-datalabels', 'data:realIndex': v }), L = 0; L < i.globals.dataPoints; L++) {
                  ...
                  this.isHorizontal
                    ? ((T = this.drawBarPaths(n(n({}, z), {}, { barHeight: k, zeroW: g, yDivision: c }))),
                      (A = this.series[o][L] / this.invertedYRatio))
                    : ((T = this.drawColumnPaths(n(n({}, z), {}, { xDivision: h, barWidth: A, zeroH: d }))),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var C =
                  ((s / A.config.chart.animations.animateGradually.delay) * (A.config.chart.animations.speed / A.globals.dataPoints)) / 2.4,
                L = S.renderPaths({
                  i: r,
                  j: s,
                  realIndex: e,
              ...
              L.attr('clip-path', 'url(#gridRectMask'.concat(A.globals.cuid, ')')),
                void 0 !== g && void 0 !== u && (L.attr('data-range-y1', g), L.attr('data-range-y2', u)),
            ...
            value: function (t) {
              ...
              r =
                void 0 === this.series[c][d] || null === this.series[c][d]
                  ? s
                  : s + this.series[c][d] / this.invertedYRatio - 2 * (this.isReversed ? this.series[c][d] / this.invertedYRatio : 0);
              ...
              return (
                ...
                this.barHelpers.barBackground({ j: d, i: c, y1: g - i * this.visibleI, y2: i * this.seriesLen, elSeries: l }),
        ...
        a(s, [
                ...
                for (var y = a.group({ class: 'apexcharts-datalabels', 'data:realIndex': u }), w = 0; w < i.globals.dataPoints; w++) {
                  ...
                  if (((g = v.yDivision), (x = v.barHeight), this.isHorizontal)) {
                    ...
                    m = (C = this.drawRangeBarPaths(
                      n({ indexes: { i: r, j: w, realIndex: u }, barHeight: x, barYPosition: L, zeroW: h, yDivision: g, y1: A, y2: S }, P)
                    )).barWidth;
                  } else
                    x = (C = this.drawRangeColumnPaths(
                      n({ indexes: { i: r, j: w, realIndex: u }, zeroH: l, barWidth: m, xDivision: o }, P)
                    )).barHeight;
                  (d = C.y), (c = C.x);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                n.globals.isXNumeric || (i += a), { pathTo: x.pathTo, pathFrom: x.pathFrom, barHeight: p, x: i, y: u, barXPosition: f }
              );
            },
          },
          {
        ...
        a(i, [
            ...
            value: function (e) {
              ...
              if (a && 'object' === t(a)) {
                ...
                (l =
                  ...
                  (((a = this.checkForCatToNumericXAxis(this.chartType, l, a)).chart.sparkline && a.chart.sparkline.enabled) ||
            ...
            value: function (t) {
              return (
                void 0 === t.annotations &&
                  ((t.annotations = {}), (t.annotations.yaxis = []), (t.annotations.xaxis = []), (t.annotations.points = [])),
          ...
          },
          {
            ...
            value: function (t) {
              var e = new C();
              return (
                (t.annotations.points = f.extendArray(void 0 !== t.annotations.points ? t.annotations.points : [], e.pointAnnotation)), t
              );
            },
          },
          {
              ...
              for (var n = 0; n < t[e].data.length; n++)
                void 0 !== t[e].data[n].y &&
                  (Array.isArray(t[e].data[n].y)
                    ? this.twoDSeries.push(f.parseNumber(t[e].data[n].y[t[e].data[n].y.length - 1]))
                ...
                if (l || c)
                  if (l || i.xaxis.convertedCatToNumeric) {
                    ...
                    'datetime' === i.xaxis.type
                      ...
                      : ((a.dataFormatXNumeric = !0), (a.isXNumeric = !0), this.twoDSeriesX.push(parseFloat(t[r].data[o].x)));
                else
                  h
                    ? ((this.fallbackToCategory = !0), this.twoDSeriesX.push(t[r].data[o].x))
            ...
            value: function (t, e, i) {
              ...
              if ('array' === t) {
                ...
                if (
                  ...
                  (a.globals.comboCharts && 'candlestick' === e[i].type && e[i].data.length && 4 !== e[i].data[0].y.length)
                )
                  throw new Error(l);
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                if (
                  (('rangeBar' !== a.chart.type && 'rangeArea' !== a.chart.type && 'rangeBar' !== t[l].type && 'rangeArea' !== t[l].type) ||
            ...
            value: function (t) {
              ...
              this.coreUtils.getSeriesTotals(),
                ...
                a.dataFormatXNumeric ||
                  (a.isXNumeric && ('numeric' !== i.xaxis.type || 0 !== i.labels.length || 0 !== i.xaxis.categories.length)) ||
        ...
        a(t, [
          {
            ...
            value: function (t, e, i, a) {
              var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                ...
                g = new W(this.ctx),
                u = o;
              (l = g.xLabelFormat(h, o, u, { i: a, dateFormatter: new y(this.ctx).formatDate, w: n })),
              ...
              x = n.globals.rotateXLabels
                ? p.getTextRects(l, parseInt(r, 10), null, 'rotate('.concat(n.config.xaxis.labels.rotate, ' 0 0)'), !1)
          ...
          },
          {
            ...
            value: function (t, e, i, a, s) {
              ...
              if (
                ...
                var n = s[s.length - 1];
                e.x < n.textRect.width / (r.globals.rotateXLabels ? Math.abs(r.config.xaxis.labels.rotate) / 12 : 1.01) + n.x &&
                  (e.text = '');
              }
              return e;
            },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (!e.config.yaxis[t].showForNullSeries && i.isSeriesNull(t) && -1 === e.globals.collapsedSeriesIndices.indexOf(t))
              );
            },
          },
          {
            ...
            value: function (t, e) {
              var i = this.w;
              return (
                Array.isArray(t) && i.globals.yAxisScale[e] && this.ctx.theme.pushExtraColors(t, i.globals.yAxisScale[e].result.length, !1),
                t
              );
            },
          },
                    ...
                    ? (function (t, e) {
                        if ((o.length && 0 === e && l.push(o.join(a)), t.data && t.data.length))
                          for (var s = 0; s < t.data.length; s++) {
                            ...
                            if (
                              (r ||
                                (c.isFormatXY() ? (r = i[e].data[s].x) : c.isFormat2DArray() && (r = i[e].data[s] ? i[e].data[s][0] : '')),
                              0 === e)
                            ) {
                              o.push(
                                ((d = r),
                                'datetime' === n.config.xaxis.type && String(d).length >= 10
                                  ? n.config.chart.toolbar.export.csv.dateFormatter(r)
                                  : r)
                              );
                            ...
                            ('candlestick' === n.config.chart.type || (t.type && 'candlestick' === t.type)) &&
                              ...
                              'rangeBar' === n.config.chart.type &&
                                (o.pop(), o.push(n.globals.seriesRangeStart[e][s]), o.push(n.globals.seriesRangeEnd[e][s])),
                              o.length && l.push(o.join(a));
                          }
                        var d;
                      })(t, e)
                    : ((o = []).push(n.globals.labels[e]), o.push(n.globals.series[e]), l.push(o.join(a)));
                }),
                (h += l.join(r)),
                  ...
                  var d = function (s) {
                      ...
                      var g = a.drawText({
                        ...
                        y:
                          ...
                          d -
                          ('top' === i.config.xaxis.position ? i.globals.xAxisHeight + i.config.xaxis.axisTicks.height - 2 : 0),
                        text: c.text,
                        textAnchor: 'middle',
            ...
            value: function (t) {
              ...
              return (
                s.config.yaxis[0].axisTicks.show &&
                  this.axesUtils.drawYAxisTicks(m, h.length, s.config.yaxis[0].axisBorder, s.config.yaxis[0].axisTicks, 0, e, o),
                o
              );
            },
          },
            ...
            value: function (t) {
              ...
              if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
                for (var a, s = i.globals.padHorizontal, r = i.globals.gridHeight, n = 0; n < e + 1; n++) {
                  i.config.grid.xaxis.lines.show && this._drawGridLine({ x1: s, y1: 0, x2: a, y2: r, parent: this.elgridLinesV }),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (void 0 !== i.config.grid.column.colors && i.config.grid.column.colors.length > 0)
                for (
                  var l =
                      i.globals.isBarHorizontal || ('category' !== i.config.xaxis.type && !i.config.xaxis.convertedCatToNumeric)
                        ? t
                        : t - 1,
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              l < 1 &&
                s &&
                ('candlestick' === r.config.chart.type || 'candlestick' === r.config.series[a].type || r.globals.isRangeData) &&
                (e *= 1.01);
              var h = i + 1;
              h < 2 ? (h = 2) : h > 2 && (h -= 2);
              var c = l / h,
            ...
            value: function () {
              ...
              i.yaxis.forEach(function (e, n) {
                ...
                i.series.forEach(function (t, i) {
                  t.name === e.seriesName &&
                    ((o = i), n !== i ? r.push({ index: i, similarIndex: n, alreadyExists: !0 }) : r.push({ index: i }));
                });
                var l = a[o],
                  h = s[o];
            ...
            value: function (t, e, i) {
              ...
              t.forEach(function (t, i) {
                l.forEach(function (a, s) {
                  a.indexOf(i) > -1 &&
                    (void 0 === c[s] && ((c[s] = []), (d[s] = [])), c[s].push({ key: i, value: t }), d[s].push({ key: i, value: e[i] }));
                });
              });
                ...
                for (var g = 0; g < r.series[d].length; g++) {
                  ...
                  null !== u && f.isNumber(u)
                    ? ((n = Math.max(n, c[d][g])),
                      ...
                      f.isFloat(u) &&
                        ((u = f.noExponents(u)), (r.yValueDecimal = Math.max(r.yValueDecimal, u.toString().split('.')[1].length))),
            ...
            value: function () {
              ...
              if (
                (e.yaxis.forEach(function (e, i) {
                  void 0 !== e.max &&
                    ('number' == typeof e.max ? (t.maxYArr[i] = e.max) : 'function' == typeof e.max && (t.maxYArr[i] = e.max(t.maxY)),
                    (t.maxY = t.maxYArr[i])),
                    void 0 !== e.min &&
                      ('number' == typeof e.min ? (t.minYArr[i] = e.min) : 'function' == typeof e.min && (t.minYArr[i] = e.min(t.minY)),
                      (t.minY = t.minYArr[i]));
                }),
                t.isBarHorizontal)
              ) {
              ...
              if (
                ...
                if (
                  ...
                  (t.xAxisScale = this.scales.linearScale(1, a, a)),
                    t.noLabelsProvided &&
                      t.labels.length > 0 &&
                      ((t.xAxisScale = this.scales.linearScale(1, t.labels.length, a - 1)), (t.seriesX = t.labels.slice()));
                ...
                for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++)
                  for (var s = 0, r = 0, n = 0; n < t.series.length; n++)
                    null !== t.series[n][a] &&
                      ...
                      (t.series[n][a] > 0 ? (s = s + parseFloat(t.series[n][a]) + 1e-4) : (r += parseFloat(t.series[n][a]))),
                ...
                for (
                  var x = function (l) {
                      ...
                      if ((l === c && (p = v), h.add(v), 0 !== i.config.yaxis[t].labels.rotate)) {
                        ...
                        v.node.setAttribute(
                          'transform',
                          'rotate('.concat(i.config.yaxis[t].labels.rotate, ' ').concat(y.x, ' ').concat(w.y, ')')
                        );
                      }
                      g += d;
                    },
                ...
                for (var g = d ? 0 : r; d ? g < d : g >= 0; d ? g++ : g--) {
                  ...
                  var x = i.drawText({
                    ...
                    y:
                      ...
                      30 -
                      ('top' === e.config.xaxis.position ? e.globals.xAxisHeight + e.config.xaxis.axisTicks.height - 2 : 0),
                    text: u,
                    textAnchor: 'middle',
              ...
              return void 0 === s.config.yaxis[t].title.text || t < 0
                ...
                : (a
                    ...
                    : ((n = -1 * e.width + s.config.yaxis[t].title.offsetX + o / 2 + i.width / 2),
                      s.globals.isBarHorizontal && ((o = 25), (n = -1 * e.width - s.config.yaxis[t].title.offsetX - o))),
                  { xPos: n, padd: o });
            },
          },
          {
                  ...
                  n = function () {
                    ...
                    if (n > a) {
                      ...
                      for (var l = 0; l < s.length; l++)
                        n < s[l].breakpoint &&
                          ((t = w.extendArrayProps(r, s[l].options, i)), (t = f.extend(i.config, t)), e.overrideResponsiveOptions(t));
                  };
                if (t) {
      ...
      function t(i) {
        ...
        (this.isColorFn = !1),
          ...
          (this.isBarDistributed =
            a.config.plotOptions.bar.distributed && ('bar' === a.config.chart.type || 'rangeBar' === a.config.chart.type));
      }
      return (
        a(t, [
          {
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.w,
                ...
                r = 'middle';
              if (
                ('left' === i.align ? ((a = 10), (r = 'start')) : 'right' === i.align && ((a = e.globals.svgWidth - 10), (r = 'end')),
                (a += i.offsetX),
            ...
            value: function () {
              ...
              return (
                ...
                ('left' !== t.config.legend.position && 'right' !== t.config.legend.position) ||
                  (1.5 * this.dCtx.lgRect.width > t.globals.svgWidth && (this.dCtx.lgRect.width = t.globals.svgWidth / 1.5)),
                this.dCtx.lgRect
              );
            },
          },
            ...
            value: function () {
              ...
              if (
                ...
                this.dCtx.lgWidthForSideLegends =
                  ('left' !== e.config.legend.position && 'right' !== e.config.legend.position) || e.config.legend.floating
                    ? 0
                ...
                if (
                  ...
                  ((t = { width: c.width >= d.width ? c.width : d.width, height: c.height >= d.height ? c.height : d.height }).width *
                    i.length >
                    e.globals.svgWidth -
                      this.dCtx.lgWidthForSideLegends -
            ...
            value: function () {
              ...
              var i = this.dCtx.timescaleLabels.map(function (t) {
                ...
                a = i.reduce(function (t, e) {
                  return void 0 === t
                    ? (console.error('You have possibly supplied invalid Date format. Please supply a valid JavaScript Date'), 0)
                    : t.length > e.length
                    ? t
                    : e;
                }, 0);
              return (
                1.05 * (t = new b(this.dCtx.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width * i.length >
                  e.globals.gridWidth &&
                  0 !== e.config.xaxis.labels.rotate &&
                ...
                e.config.yaxis.map(function (r, n) {
                  ...
                  if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                    ...
                    if (((void 0 !== c && 0 !== c.length) || (c = h), e.globals.isBarHorizontal)) {
                      ...
                      (c = l((c = f.getLargestStringFromArr(g)), { seriesIndex: n, dataPointIndex: -1, w: e })),
                    ...
                    c !== d && (x = u.getTextRects(d, r.labels.style.fontSize)),
                      i.push({ width: (x.width > p.width ? x.width : p.width) + a, height: x.height > p.height ? x.height : p.height });
                ...
                -1 !== i.globals.ignoreYAxisIndexes.indexOf(r) ||
                  ...
                  (s.opposite &&
                    (i.globals.translateX =
                      i.globals.translateX - (e[r].width + t[r].width) - parseInt(i.config.yaxis[r].labels.style.fontSize, 10) / 1.2 - 12),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              this.conditionalChecksForAxisCoords(r, n),
                ...
                (i.translateXAxisX =
                  e.globals.rotateXLabels && e.globals.isXNumeric && e.config.xaxis.labels.rotate <= -45 ? -this.xAxisWidth / 4 : 0),
                e.globals.isBarHorizontal &&
                  ((i.rotateXLabels = !1), (i.translateXAxisY = (parseInt(e.config.xaxis.labels.style.fontSize, 10) / 1.5) * -1)),
              ...
              switch (
                ('top' === e.config.xaxis.position && (h = i.xAxisHeight - e.config.xaxis.axisTicks.height - 5), e.config.legend.position)
              ) {
                case 'bottom':
                  (i.translateY = h), c();
                  break;
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.w;
              (this.xAxisHeight =
                (t.height + e.height) * (i.globals.isMultiLineX ? 1.2 : i.globals.LINE_HEIGHT_RATIO) + (i.globals.rotateXLabels ? 22 : 10)),
              ...
              if (a.globals.axisCharts || 'radialBar' === a.config.chart.type) {
                ...
                if (
                  ...
                  a.globals.axisCharts
                    ? ((s = a.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(t, "']"))),
            ...
            value: function (t) {
              ...
              if (a.globals.axisCharts) {
                ...
                if (
                  ...
                  a.globals.collapsedSeries.push({ index: i, data: s[i].data.slice(), type: e.parentNode.className.baseVal.split('-')[1] }),
            ...
            value: function (t, e, i) {
              ...
              if (t.length > 0) {
                for (var r = 0; r < t.length; r++)
                  t[r].index === i &&
                    (a.globals.axisCharts
                      ? ((s[i].data = t[r].data.slice()), t.splice(r, 1), e.splice(r, 1), a.globals.risingSeries.push(i))
      ...
      function t(i, a) {
        e(this, t),
          ...
          (this.isBarsDistributed =
            'bar' === this.w.config.chart.type && this.w.config.plotOptions.bar.distributed && 1 === this.w.config.series.length),
              ...
              for (
                ...
                (S.background = a[o]),
                  ...
                  void 0 !== t.globals.seriesColors[o] &&
                    ((S.background = t.globals.seriesColors[o]), (S.color = t.globals.seriesColors[o])),
                  (S.height = Array.isArray(m) ? parseFloat(m[o]) + 'px' : parseFloat(m) + 'px'),
                  (S.width = Array.isArray(v) ? parseFloat(v[o]) + 'px' : parseFloat(v) + 'px'),
                  ...
                  (S.borderRadius = Array.isArray(A) ? parseFloat(A[o]) + 'px' : parseFloat(A) + 'px'),
                ...
                P || (P = t.config.chart.foreColor),
                  (L.style.color = P),
                  (L.style.fontSize = parseFloat(t.config.legend.fontSize) + 'px'),
                  (L.style.fontWeight = t.config.legend.fontWeight),
                  (L.style.fontFamily = e || t.config.chart.fontFamily),
                  b.setAttrs(L, { rel: o + 1, i: o, 'data:default-text': encodeURIComponent(l), 'data:collapsed': h || c }),
                  C.appendChild(u),
                  C.appendChild(L);
                ...
                t.config.legend.showForNullSeries ||
                  ...
                  b.setAttrs(C, { rel: o + 1, seriesName: f.escapeString(i[o]), 'data:collapsed': h || c }),
          ...
          },
          {
            ...
            value: function () {
              ...
              'bottom' === t.config.legend.position
                ? (r = -e.clwh / 1.8)
                : 'top' === t.config.legend.position && (r = a.height + s.height + t.config.title.margin + t.config.subtitle.margin - 10),
        ...
        a(t, [
          {
            ...
            value: function () {
              ...
              for (var h = 0; h < r.length; h++)
                b.setAttrs(r[h].el, { class: r[h].class, title: r[h].title }), (r[h].el.innerHTML = r[h].icon), a.appendChild(r[h].el);
        ...
        a(s, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              e.shiftKey
                ? ((this.shiftWasPressed = !0), s.enableZoomPanFromToolbar('pan' === n ? 'zoom' : 'pan'))
                : this.shiftWasPressed && (s.enableZoomPanFromToolbar(n), (this.shiftWasPressed = !1));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (g =
                  'x' === i
                    ? { x: l ? n - c : n, y: 0, width: c, height: a.globals.gridHeight }
                    : 'y' === i
                    ? { x: 0, y: h ? o - d : o, width: a.globals.gridWidth, height: d }
                    : { x: l ? n - c : n, y: h ? o - d : o, width: c, height: d }),
                ...
                if (a.globals.zoomEnabled) {
                  ...
                  if (
                    ...
                    a.config.xaxis.convertedCatToNumeric &&
                      ((h = Math.floor(h)), (c = Math.floor(c)), h < 1 && ((h = 1), (c = a.globals.dataPoints)), c - h < 2 && (c = h + 1)),
            ...
            value: function (t) {
              ...
              return (
                ...
                r.globals.isXNumeric &&
                  ...
                  (g = x.j),
                  null !== p && ((b = r.globals.seriesXvalues[p]), (g = (x = this.closestInArray(c, b)).index))),
            ...
            value: function (t) {
              ...
              for (
                var p = function (t, r) {
                    ...
                    (u = i.getSeriesName({ fn: p.yLbTitleFormatter, index: a, seriesIndex: a, j: s })),
                      'treemap' === h.config.chart.type &&
                        (u = p.yLbTitleFormatter(String(h.config.series[a].data[s].x), {
                    ...
                    if (h.globals.axisCharts) {
                      ...
                      o
                        ? ((p = i.getFormatters(x)),
                          (u = i.getSeriesName({ fn: p.yLbTitleFormatter, index: x, seriesIndex: a, j: s })),
                          (f = h.globals.colors[x]),
                          (e = b(x)))
                        : (l && l.target && l.target.getAttribute('fill') && (f = l.target.getAttribute('fill')), (e = b(a)));
                    }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (u = i[e].children),
                ...
                l.showTooltipTitle &&
                  (null === l.tooltipTitle && (l.tooltipTitle = o.globals.dom.baseEl.querySelector('.apexcharts-tooltip-title')),
              ...
              r &&
                ...
                (null == h || o.globals.collapsedSeriesIndices.indexOf(e) > -1
                  ...
                  : (u[0].parentNode.style.display = o.config.tooltip.items.display));
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              Array.isArray(o) && o[e] && (o = o[e]),
                (n.innerHTML = o({ ctx: this.ctx, series: r.globals.series, seriesIndex: e, dataPointIndex: i, y1: a, y2: s, w: r }));
            },
          },
        ]),
        t
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var a = this.w;
              return (
                t.ttHeight / 2 + i > a.globals.gridHeight && (i = a.globals.gridHeight - t.ttHeight + a.globals.translateY),
                i < 0 && (i = 0),
                { x: e, y: i }
              );
            },
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (!l || ('column' !== l && 'candlestick' !== l)) {
                ...
                h && a < s.globals.gridHeight && a > 0 && (h.setAttribute('r', o), h.setAttribute('cx', i), h.setAttribute('cy', a)),
            ...
            value: function (t) {
              for (
                var e = this.w,
                  i = this.ttCtx,
                  a = t,
                  s = e.globals.dom.baseEl.querySelectorAll('.apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker'),
            ...
            value: function (t) {
              ...
              if (e.target.classList.contains('apexcharts-'.concat(r, '-rect'))) {
                ...
                if (
                  ...
                  (a = n.e.clientX - f.left + 10) > o.globals.gridWidth / 2 && (a = a - n.tooltipRect.ttWidth - 10),
            ...
            value: function (t) {
              ...
              if (
                ...
                r.config.tooltip.shared ||
                  (r.globals.comboBarCount > 0 ? n.tooltipPosition.moveXCrosshairs(l + i / 2) : n.tooltipPosition.moveXCrosshairs(l)),
                  ...
                  (a.length
                    ? a.forEach(function (a) {
                        ...
                        a.w.globals.minX === i.w.globals.minX &&
                          ...
                          a.w.globals.tooltip.seriesHoverByContext({ chartCtx: a, ttCtx: a.w.globals.tooltip, opt: r, e: e });
                      })
          ...
          },
          {
            ...
            value: function (t) {
              ...
              !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared) ||
                (this.tConfig.onDatasetHover.highlightDataSeries && new E(e).toggleSeriesOnHover(s, s.target.parentNode));
            ...
            value: function (t) {
              ...
              if (
                ...
                var c = this.getElTooltip(),
                  ...
                  g =
                    r.globals.xyCharts ||
                    ('bar' === r.config.chart.type && !r.globals.isBarHorizontal && this.tooltipUtil.hasBars() && this.tConfig.shared) ||
        ...
        a(s, [
                  ...
                  c = function (s, r) {
                    ...
                    for (var A = 0; A < a.globals.dataPoints; A++) {
                      var S = i.barHelpers.getStrokeWidth(s, A, b),
                        ...
                        L = null;
                      i.isHorizontal
                        ? ((L = i.drawStackedBarPaths(n(n({}, C), {}, { zeroW: u, barHeight: y, yDivision: d }))),
                          (w = i.series[s][A] / i.invertedYRatio))
                        : ((L = i.drawStackedColumnPaths(n(n({}, C), {}, { xDivision: c, barWidth: w, zeroH: g }))),
            ...
            value: function (t) {
              ...
              if (g > 0) {
                ...
                this.prevXVal[g - 1][u] < 0
                  ...
                  : this.prevXVal[g - 1][u] >= 0 &&
                    (x = this.series[g][u] >= 0 ? this.prevX[g - 1][u] : this.prevX[g - 1][u] - f + 2 * (this.isReversed ? f : 0)),
                  (e = x);
              } else e = r;
              (n =
                null === this.series[g][u]
                  ? e
                  : e + this.series[g][u] / this.invertedYRatio - 2 * (this.isReversed ? this.series[g][u] / this.invertedYRatio : 0)),
                this.xArrj.push(n),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                this.barHelpers.barBackground({ bc: d, j: c, i: h, x1: f, x2: r, elSeries: o }),
                (i += s),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              void 0 === this.series[h][c] || null === this.series[h][c]
                ? (y = r)
                : ((y = r - y / f), (w = r - w / f), (m = r - x.h / f), (v = r - x.l / f));
              var A = l.move(k, r),
                S = l.move(k, y);
              return (
                ...
                s.config.plotOptions[t].enableShades &&
                  ...
                  (l =
                    'dark' === this.w.config.theme.mode
                      ? f.hexToRgba(h.shadeColor(-1 * r, o.color), s.config.fill.opacity)
                      : f.hexToRgba(h.shadeColor(r, o.color), s.config.fill.opacity))),
                  ...
                  if (e.globals.dataChanged) {
                    ...
                    if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                      ...
                      C || (C = 'rgba(255, 255, 255, 0)'),
                        this.animateHeatColor(k, f.isColorHex(C) ? C : f.rgb2hex(C), f.isColorHex(v) ? v : f.rgb2hex(v), S);
                    }
                  }
      ...
      function t(i) {
        ...
        (this.chartType = this.w.config.chart.type),
          ...
          (a.globals.radialSize =
            this.defaultSize / 2.05 - a.config.stroke.width - (a.config.chart.sparkline.enabled ? 0 : a.config.chart.dropShadow.blur)),
              ...
              for (var l = 0; l < t.length; l++) {
                ...
                n.push(h),
                  'polarArea' === this.chartType
                    ? ((n[l] = this.fullAngle / t.length), this.sliceSizes.push((i.globals.radialSize * t[l]) / this.maxY))
            ...
            value: function (t, e) {
              ...
              for (var g = 0; g < t.length; g++) {
                ...
                this.addListeners(y, this.donutDataLabels),
                  b.setAttrs(y.node, { 'data:angle': x, 'data:startAngle': l, 'data:strokeWidth': this.strokeWidth, 'data:value': e[g] });
                var k = { x: 0, y: 0 };
                ...
                if (
                  (!this.initialAnim || i.globals.resized || i.globals.dataChanged
                    ...
                    : (0 === (A = (x / this.fullAngle) * i.config.chart.animations.speed) && (A = 1),
                  ...
                  ? t
                      ...
                      .afterAll(function () {
                        ('pie' !== o.chartType && 'donut' !== o.chartType && 'polarArea' !== o.chartType) ||
                          this.animate(l.config.chart.animations.dynamicAnimation.speed).attr({ 'stroke-width': o.strokeWidth }),
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              var s,
                r = this.w;
              a
                ? (s = void 0 === t.name.color ? r.globals.colors[parseInt(a.parentNode.getAttribute('rel'), 10) - 1] : t.name.color)
    ...
    St = (function () {
      function t(i) {
        ...
        (this.graphics = new b(this.ctx)),
          (this.lineColorArr = void 0 !== a.globals.stroke.colors ? a.globals.stroke.colors : a.globals.colors),
          (this.defaultSize =
            a.globals.svgHeight < a.globals.svgWidth ? a.globals.gridHeight + 1.5 * a.globals.goldenPadding : a.globals.gridWidth),
                ...
                a.forEach(function (t, a) {
                  if (0 === i) {
                    var r = e.graphics.drawLine(
                      ...
                      0,
                      0,
                      Array.isArray(e.polygons.connectorColors) ? e.polygons.connectorColors[a] : e.polygons.connectorColors
                    );
                    d.push(r);
                  }
        ...
        a(s, [
            ...
            value: function (t) {
              ...
              for (var m = x ? t.series.length - 1 : 0; x ? m >= 0 : m < t.series.length; x ? m-- : m++) {
                ...
                e.globals.dataChanged &&
                  ((k = this.startAngle), (C = Math.round((this.totalAngle * f.negToZero(e.globals.previousPaths[m])) / 100) + k)),
                ...
                if ((b.setAttrs(z.node, { 'data:angle': L, 'data:value': t.series[m] }), e.config.chart.dropShadow.enabled)) {
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              if (s.config.plotOptions.radialBar.hollow.imageClipped)
                r.clippedImgArea({ width: i, height: i, image: o, patternID: 'pattern'.concat(s.globals.cuid).concat(n) }),
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.w;
              return (
                (t.size * (100 - parseInt(e.config.plotOptions.radialBar.hollow.size, 10))) / 100 / (t.series.length + 1) - this.margin
              );
            },
          },
        ]),
            ...
            value: function (t) {
              for (
                ...
                (r = T
                  ...
                  : g - e[a][P + 1] / v[this.yaxisIndex] + 2 * (this.isReversed ? e[a][P + 1] / v[this.yaxisIndex] : 0)),
                  u.push(s),
                  p.push(r);
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.pointsPos,
                ...
                n = new I(this.ctx);
              if (this.pointsChart)
                this.scatter.draw(this.elSeries, a, { realIndex: s, pointsPos: e, zRatio: this.zRatio, elParent: this.elPointsMain });
              else {
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.series,
                ...
                m = this.areaBottomY;
              if (
                (Array.isArray(f.config.stroke.curve) && (x = Array.isArray(u) ? f.config.stroke.curve[u[i]] : f.config.stroke.curve[i]),
                'smooth' === x)
              ) {
                var v = 0.35 * (r - o);
                f.globals.hasNullValues
                  ? (null !== e[i][s] &&
                      (null !== e[i][s + 1]
                        ? ((h = p.move(o, l) + p.curve(o + v, l, r - v, n, r + 1, n)),
                          (c = p.move(o + 1, l) + p.curve(o + v, l, r - v, n, r + 1, n) + p.line(r, m) + p.line(o, m) + 'z'))
                  ...
                  (l = n),
                  s === e[i].length - 2 &&
                    ((c = c + p.curve(o, l, r, n, r, m) + p.move(r, n) + 'z'), f.globals.hasNullValues || (d.push(h), g.push(c)));
              } else {
                if (null === e[i][s + 1]) {
                  h += p.move(r, n);
                ...
                null === e[i][s] && ((h += p.move(r, n)), (c += p.move(r, m))),
                  'stepline' === x
                    ? ((h = h + p.line(r, null, 'H') + p.line(null, n, 'V')), (c = c + p.line(r, null, 'H') + p.line(null, n, 'V')))
                    : 'straight' === x && ((h += p.line(r, n)), (c += p.line(r, n))),
        ...
        (this.xoffset = e),
          ...
          (this.getCoordinates = function (t) {
            var e,
              ...
              n = s(t) / this.height,
              o = s(t) / this.width;
            if (this.width >= this.height) for (e = 0; e < t.length; e++) i.push([a, r, a + n, r + t[e] / n]), (r += t[e] / n);
            else for (e = 0; e < t.length; e++) i.push([a, r, a + t[e] / o, r + o]), (a += t[e] / o);
            return i;
          }),
              ...
              if (0 !== e.length)
                return (
                  ...
                  (function (t, e, a) {
                    ...
                    : ((h = r.cutArea(s(a), n)), n.push(r.getCoordinates(a)), t(e, [], h, n)),
                  n
                );
                  ...
                  n.forEach(function (r, n) {
                    var h = r[0],
                      ...
                      u = a.drawRect(
                        ...
                        1,
                        e.strokeWidth,
                        i.config.plotOptions.treemap.useFillColorAsStroke ? p : i.globals.stroke.colors[o]
                      );
                    ...
                    if (i.globals.dataChanged) {
                      ...
                      e.dynamicAnim.enabled &&
                        ...
                        i.globals.previousPaths[o][n] && i.globals.previousPaths[o][n].rect && (b = i.globals.previousPaths[o][n].rect),
            ...
            value: function (t) {
              ...
              if (e.minDate > 1 || e.minMonth > 0) {
                ...
                (o = (l.determineDaysOfYear(e.minYear) - h + 1) * s),
                  (n = e.minYear + 1),
                  this.timeScaleArray.push({ position: o, value: n, unit: 'year', year: n, month: f.monthMod(i + 1) });
              } else
                1 === e.minDate &&
                  0 === e.minMonth &&
                  this.timeScaleArray.push({ position: o, value: n, unit: 'year', year: a, month: f.monthMod(i + 1) });
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var m = g, v = 0; v < n; v++) {
                ...
                var k = 0 === p ? x : p;
                this.timeScaleArray.push({ position: m, value: k, unit: l, hour: p, day: x, year: w, month: f.monthMod(b) }), p++;
              }
            },
          },
          {
        ...
        a(t, [
          {
            ...
            value: function () {
              var t = this.w.globals,
                ...
                i = e.chart.type;
              (t.axisCharts =
                ['line', 'area', 'bar', 'rangeBar', 'candlestick', 'scatter', 'bubble', 'radar', 'heatmap', 'treemap'].indexOf(i) > -1),
              ...
              return (
                i.globals.axisCharts
                  ...
                  : void 0 === e &&
                    ...
                    ('pie' !== i.config.chart.type && 'polarArea' !== i.config.chart.type && 'donut' !== i.config.chart.type) ||
  ...
  (Tt = 'undefined' != typeof window ? window : void 0),
                  ...
                  null != t[e][1] &&
                    ...
                    null != t[e][2] &&
                      ...
                      null != t[e][3] &&
                        ...
                        (a += t[e][4]),
                        null != t[e][5] &&
                          ((a += ' '), (a += t[e][5]), (a += ' '), (a += t[e][6]), null != t[e][7] && ((a += ' '), (a += t[e][7]))))));
              return a + ' ';
            })(this.value);
          },
          move: function (t, e) {
        ...
        (a.Element = a.invent({
          create: function (t) {
            (this._stroke = a.defaults.attrs.stroke),
              ...
              (this.dom = {}),
              (this.node = t) &&
                ((this.type = t.nodeName), (this.node.instance = this), (this._stroke = t.getAttribute('stroke') || this._stroke));
          },
          extend: {
            x: function (t) {
                    ...
                    (1 == this.pos && !this.situation.reversed) || (this.situation.reversed && 0 == this.pos)
                      ? (this.stopAnimFrame(),
                        ...
                        this.situations.length ||
                          (this.target().fire('allfinished'), this.situations.length || (this.target().off('.fx'), (this.active = !1))),
              ...
              if (s.transforms.length) {
                ...
                for (var n = s.transforms.length; r < n; r++) {
                  ...
                  o instanceof a.Matrix
                    ? (t = o.relative ? t.multiply(new a.Matrix().morph(o).at(s.ease(this.pos))) : t.morph(o).at(s.ease(this.pos)))
        ...
        (a.Doc = a.invent({
          ...
          extend: {
            ...
            defs: function () {
              ...
              return (
                this._defs ||
                  ((t = this.node.getElementsByTagName('defs')[0]) ? (this._defs = a.adopt(t)) : (this._defs = new a.Defs()),
    ...
    (function () {
      function t(t, s, r, n, o, l, h) {
        for (
          var c = t.slice(s, r || h), d = n.slice(o, l || h), g = 0, u = { pos: [0, 0], start: [0, 0] }, f = { pos: [0, 0], start: [0, 0] };
          ;
        ...
        switch (t[0]) {
          ...
          case 'A':
            t = (e = (function (t, e) {
              ...
              !E && g < u && (u -= 2 * Math.PI);
              for (
                p = Math.ceil((2 * Math.abs(g - u)) / Math.PI), b = [], m = g, f = (u - g) / p, x = (4 * Math.tan(f / 4)) / 3, k = 0;
                k <= p;
                k++
              )
                (y = Math.cos(m)),
        ...
        (t.prototype.transformPoint = function (t, e, i) {
          ...
          (t.prototype.snapToGrid = function (t, e, i, a) {
            ...
            return (
              ...
              (t -=
                Math.abs(s[0]) < this.options.snapToGrid / 2 ? s[0] : s[0] - (t < 0 ? -this.options.snapToGrid : this.options.snapToGrid)),
              (e -=
                Math.abs(s[1]) < this.options.snapToGrid / 2 ? s[1] : s[1] - (e < 0 ? -this.options.snapToGrid : this.options.snapToGrid)),
        ...
        [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              new Yt(this).initModules();
              var a = this.w.globals;
              ((a.noData = !1), (a.animationEnded = !1), this.responsive.checkResponsiveConfig(e), i.config.xaxis.convertedCatToNumeric) &&
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var a = i.w.config.series.slice(), s = 0; s < a.length; s++)
                if (null !== t[s] && void 0 !== t[s]) for (var r = 0; r < t[s].data.length; r++) a[s].data.push(t[s].data[r]);
