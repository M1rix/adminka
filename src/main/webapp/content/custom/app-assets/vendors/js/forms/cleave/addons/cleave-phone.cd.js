...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = I(n)), 0 < r.length ? r : (D(n, n.a.toString()), B(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function F(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return D(n, t), (t = I(n)), 0 < t.length ? t : B(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
...
*/
  var nn = { 243: ['CD'] },
    tn = {
      CD: [
        null,
        [null, null, '[189]\\d{8}|[1-68]\\d{6}', null, null, null, null, null, null, [7, 9]],
