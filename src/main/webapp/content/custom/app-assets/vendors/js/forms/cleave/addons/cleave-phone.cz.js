...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (R(n, n.a.toString()), B(n) ? Z(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return R(n, t), (t = D(n)), 0 < t.length ? t : B(n) ? Z(n) : n.i.toString();
    }
    return M(n, t);
  }
  function Z(n) {
...
*/
  var nn = { 420: ['CZ'] },
    tn = {
      CZ: [
        null,
        [null, null, '(?:[2-578]\\d|60|9\\d{1,4})\\d{7}', null, null, null, null, null, null, [9, 10, 11, 12]],
        ...
        [null, null, '9[17]0\\d{6}', null, null, null, '910123456', null, null, [9]],
        'CZ',
        420,
        '00',
        null,
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '9(?:5\\d|7[2-4])\\d{6}', null, null, null, '972123456', null, null, [9]],
        null,
        null,
        [null, null, '9(?:3\\d{9}|6\\d{7,10})', null, null, null, '93123456789'],
      ],
    };
  A.b = function () {
