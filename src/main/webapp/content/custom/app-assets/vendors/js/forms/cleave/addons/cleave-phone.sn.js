...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (l = D(n)), 0 < l.length ? l : (F(n, n.a.toString()), R(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, r = 0; r < e; ++r) {
      var l = n.f[r],
        i = g(l, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(l, 4))), (t = t.replace(new RegExp(i, 'g'), h(l, 2))), M(n, t);
    }
    return '';
  }
  function M(n, t) {
...
*/
  var nn = { 221: ['SN'] },
    tn = {
      SN: [
        null,
        [null, null, '(?:[378]\\d{4}|93330)\\d{4}', null, null, null, null, null, null, [9]],
        ...
        [null, null, '(?:3(?:392|9[01]\\d)\\d|93330)\\d{4}', null, null, null, '933301234'],
        'SN',
        221,
        '00',
        null,
