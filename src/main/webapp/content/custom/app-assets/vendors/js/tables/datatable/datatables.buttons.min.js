...
(function (e) {
    ...
    _popover: function (a, b, c) {
        ...
        c.hasClass(f.rightAlignClassName) || c.hasClass(f.leftAlignClassName) || 'dt-container' === f.align
          ? ((l = 0),
            c.hasClass(f.rightAlignClassName)
              ? ((l = v - k), g > n + l && ((g -= n + l), (d -= k + l), (l = g > d ? l + d : l + g)))
              : ((l = g - n), d < k + l && ((g -= n + l), (d -= k + l), (l = g > d ? l + d : l + g))))
          : ((d = h.offset().top), (l = 0), (l = 'button-right' === f.align ? v - k : p - n));
      ...
      e('body')
        .on('click.dtb-collection', function (u) {
          ...
          ((!e(u.target).parents()[z]().filter(a).length && !e(F).hasClass('dt-buttons')) ||
      ...
      var c = [],
        d = function (g, n, k) {
          for (var p, l, v = 0, u = n.length; v < u; v++)
            if ((p = n[v]))
              (l = k !== r ? k + v : v + ''), g.push({ node: p.node, name: p.conf.name, idx: l }), p.buttons && d(g, p.buttons, l + '-');
        },
        f = function (g, n) {
          var k,
            p = [];
          ...
          if (Array.isArray(g) || g instanceof e) for (l = 0, k = g.length; l < k; l++) f(g[l], n);
          else if (null === g || g === r || '*' === g) for (l = 0, k = p.length; l < k; l++) c.push({ inst: n, node: p[l].node });
          else if ('number' === typeof g) c.push({ inst: n, node: n.s.buttons[g].node });
          else if ('string' === typeof g)
            if (-1 !== g.indexOf(',')) for (p = g.split(','), l = 0, k = p.length; l < k; l++) f(p[l].trim(), n);
            else if (g.match(/^\d+(\-\d+)*$/))
  ...
  q.Api.register('buttons.exportInfo()', function (a) {
    ...
    c === r || null === c
      ? (c = null)
      : (-1 !== c.indexOf('*') && (c = c.replace('*', e('head > title').text()).trim()),
