...
!(function (e, t) {
  ...
  function u(e) {
    ...
    return (u = function (e) {
      ...
      return (
        (s.prototype = Object.create(e.prototype, { constructor: { value: s, enumerable: !1, writable: !0, configurable: !0 } })), d(s, e)
      );
    })(e);
  }
  var c = (function (e) {
        ...
        for (var l = s.split(' '), o = 0; o < l.length; o += 1)
          for (var d = l[o], h = 0; h < this.length; h += 1) {
            var p = this[h],
              u = void 0;
            if (
              (!a && p.dom7Listeners ? (u = p.dom7Listeners[d]) : a && p.dom7LiveListeners && (u = p.dom7LiveListeners[d]), u && u.length)
            )
              for (var c = u.length - 1; c >= 0; c -= 1) {
                var f = u[c];
                (r && f.listener === r) || (r && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === r)
                  ? (p.removeEventListener(d, f.proxyListener, n), u.splice(c, 1))
                  : r || (p.removeEventListener(d, f.proxyListener, n), u.splice(c, 1));
              }
          }
        return this;
      },
        ...
        (w = (function (e) {
          ...
          return (
            !p &&
              ...
              ((p = r.match(/(Version)\/([\d.]+)/)) || (p = [0, 1, '13_0_0']), (v = !1)),
              ...
              if (
                ...
                f > 0 && i.currentTranslate > this.minTranslate()
                  ...
                  : f < 0 &&
                    ...
                    ((v = !1),
                    s.resistance &&
                      (i.currentTranslate = this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - i.startTranslate - f, g))),
  ...
  function D(e) {
    var t = this,
      ...
      d = e;
    if (
      (d.originalEvent && (d = d.originalEvent), i.allowTouchCallbacks && t.emit('touchEnd', d), (i.allowTouchCallbacks = !1), !i.isTouched)
    )
    ...
    if (
      (t.allowClick &&
        (t.updateClickedSlide(d), t.emit('tap click', d), u < 300 && p - i.lastClickTime < 300 && t.emit('doubleTap doubleClick', d)),
      (i.lastClickTime = x()),
      E(function () {
        ...
        if (s.freeModeMomentum) {
          ...
          if (y < t.maxTranslate())
            s.freeModeMomentumBounce
              ? (y + t.maxTranslate() < -S && (y = t.maxTranslate() - S), (b = t.maxTranslate()), (C = !0), (i.allowMomentumBounce = !0))
              : (y = t.maxTranslate()),
              s.loop && s.centeredSlides && (T = !0);
          else if (y > t.minTranslate())
            s.freeModeMomentumBounce
              ? (y - t.minTranslate() > S && (y = t.minTranslate() + S), (b = t.minTranslate()), (C = !0), (i.allowMomentumBounce = !0))
              : (y = t.minTranslate()),
              s.loop && s.centeredSlides && (T = !0);
              ...
              if (t.slidesPerColumn > 1) {
                ...
                if ('row' === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                  ...
                  'column' === t.slidesPerColumnFill
                    ? ((A = $ - (O = Math.floor($ / z)) * z), (O > k || (O === k && A === z - 1)) && (A += 1) >= z && ((A = 0), (O += 1)))
                    : (O = $ - (A = Math.floor($ / P)) * P);
            ...
            for (var r = 0; r < i.length; r += 1) {
              ...
              if (t.watchSlidesVisibility || (t.centeredSlides && t.autoHeight)) {
                ...
                ((o >= 0 && o < this.size - 1) || (d > 1 && d <= this.size) || (o <= 0 && d >= this.size)) &&
                  (this.visibleSlides.push(n), this.visibleSlidesIndexes.push(r), i.eq(r).addClass(t.slideVisibleClass));
              }
              n.progress = s ? -l : l;
            }
        ...
        attachEvents: function () {
          ...
          (t.preventClicks || t.preventClicksPropagation) && s.addEventListener('click', this.onClick, !0),
            ...
            t.updateOnWindowResize
              ? this.on(n.ios || n.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', G, !0)
        ...
        setBreakpoint: function () {
          ...
          if (n && (!n || 0 !== Object.keys(n).length)) {
            ...
            if (l && this.currentBreakpoint !== l) {
              ...
              h && !p
                ? (r.removeClass(a.containerModifierClass + 'multirow ' + a.containerModifierClass + 'multirow-column'),
      ...
      images: {
        loadImage: function (e, t, i, s, a, r) {
          ...
          m(e).parent('picture')[0] || (e.complete && a)
            ? d()
            : t
            ? (((n = new o.Image()).onload = d), (n.onerror = d), s && (n.sizes = s), i && (n.srcset = i), t && (n.src = t))
            : d();
        },
  ...
  var W = {
      update: function (e) {
        ...
        if ((S(t.virtual, { from: b, to: E, offset: x, slidesGrid: t.slidesGrid }), h === b && p === E && !e))
          return t.slidesGrid !== c && x !== v && t.slides.css(m, x + 'px'), void t.updateProgress();
      ...
      handle: function (e) {
        ...
        if (
          ...
          this.isHorizontal()
            ...
            : ((d || h || c || f) && (a.preventDefault ? a.preventDefault() : (a.returnValue = !1)),
              (h || f) && this.slideNext(),
              (d || c) && this.slidePrev()),
      ...
      handle: function (e) {
        ...
        if ((s.invert && (r = -r), i.params.freeMode)) {
          ...
          if (
            (b.push(y),
            T
              ? (y.direction !== T.direction || y.delta > T.delta || y.time > T.time + 150) && i.mousewheel.animateSlider(y)
      ...
      in: function (e) {
        ...
        (y.$slideEl ||
          (this.params.virtual && this.params.virtual.enabled && this.virtual
            ? (y.$slideEl = this.$wrapperEl.children('.' + this.params.slideActiveClass))
          ...
          e.pagination.bullets.each(function (i) {
            ...
            e.a11y.makeElFocusable(s),
              e.params.pagination.renderBullet ||
                (e.a11y.addElRole(s, 'button'), e.a11y.addElLabel(s, t.paginationBulletMessage.replace(/\{\{index\}\}/, s.index() + 1)));
          });
      },
      init: function () {
        var e = this,
        ...
        e.a11y.addElId(n, l),
          ...
          a &&
            ...
            'BUTTON' !== a[0].tagName && (e.a11y.addElRole(a, 'button'), a.on('keydown', e.a11y.onEnterKey)),
    ...
    ae = {
      ...
      setHistory: function (e, t) {
        ...
        if (this.history.initialized && this.params.history.enabled) {
          ...
          (n && n.value === r) ||
            (this.params.history.replaceState ? i.history.replaceState({ value: r }, null, r) : i.history.pushState({ value: r }, null, r));
        }
      },
      slugify: function (e) {
        return e
      ...
      setTranslate: function () {
        ...
        for (var c = 0; c < s.length; c += 1) {
          ...
          if ((y <= 1 && y > -1 && ((u = 90 * v + 90 * y), n && (u = 90 * -v - 90 * y)), f.transform(T), d.slideShadows)) {
            ...
            0 === C.length && ((C = m('<div class="swiper-slide-shadow-' + (h ? 'left' : 'top') + '"></div>')), f.append(C)),
              0 === S.length && ((S = m('<div class="swiper-slide-shadow-' + (h ? 'right' : 'bottom') + '"></div>')), f.append(S)),
      ...
      setTranslate: function () {
        for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
          ...
          if (
            ...
            0 === d.length &&
              ((d = m('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'left' : 'top') + '"></div>')), s.append(d)),
              0 === h.length &&
                ((h = m('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'right' : 'bottom') + '"></div>')), s.append(h)),
          ...
          if (this.realIndex !== t.realIndex || a) {
            ...
            a && (r += 'next' === n ? s : -1 * s),
              t.visibleSlidesIndexes &&
                ...
                (t.params.centeredSlides ? (r = r > l ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1) : r > l && (r = r - i + 1),
