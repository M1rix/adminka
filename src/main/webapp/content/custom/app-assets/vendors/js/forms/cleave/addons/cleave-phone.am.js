!function () {
  function n(n, t) {
    ...
    for (var l; e.length && (l = e.shift()); ) e.length || void 0 === t ? (r = r[l] ? r[l] : (r[l] = {})) : (r[l] = t);
  }
  function t(n, t) {
    function e() {}
    (e.prototype = t.prototype),
      ...
      (n.N = function (n, e, r) {
        for (var l = Array(arguments.length - 2), i = 2; i < arguments.length; i++) l[i - 2] = arguments[i];
  ...
  function p(n, t) {
    for (var e = o(n.j()), r = 0; r < e.length; r++) {
      ...
      if (null != t.a[i]) {
        ...
        else (l = c(t, i)), a ? ((a = c(n, i)) ? p(a, l) : b(n, i, l.clone())) : b(n, i, l);
      }
    }
  }
  function c(n, t) {
...
*/
  ...
  function R(n) {
    for (var t = n.f.length, e = 0; e < t; ++e) {
      ...
      if (-1 != o.indexOf('|')) a = !1;
        ...
        f.length < s.a.b.length ? (s = '') : ((s = f.replace(new RegExp(o, 'g'), u)), (s = s.replace(RegExp('9', 'g'), ' '))),
  ...
  function F(n, t) {
    for (var e = [], r = t.length - 3, l = n.f.length, i = 0; i < l; ++i) {
      var a = n.f[i];
      0 == m(a, 3) ? e.push(n.f[i]) : ((a = h(a, 3, Math.min(r, m(a, 3) - 1))), 0 == t.search(a) && e.push(n.f[i]));
    }
    n.f = e;
  }
  function C(n, t) {
    ...
    if (ln.test(e) || (1 == n.i.b.length && rn.test(e))) {
      var l,
        e = t;
      '+' == e ? ((l = e), n.u.a(e)) : ((l = en[e]), n.u.a(l), n.a.a(l)), (t = l);
    } else (n.l = !1), (n.F = !0);
    if (!n.l) {
      if (!n.F)
        if (P(n)) {
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (l = M(n)), 0 < l.length ? l : (F(n, n.a.toString()), R(n) ? G(n) : n.l ? D(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), V(n);
  }
  function M(n) {
    for (var t = n.a.toString(), e = n.f.length, r = 0; r < e; ++r) {
      var l = n.f[r],
        i = g(l, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(l, 4))), (t = t.replace(new RegExp(i, 'g'), h(l, 2))), D(n, t);
    }
    return '';
  }
  function D(n, t) {
  ...
  function V(n) {
    var t = n.a.toString();
    if (3 <= t.length) {
      for (var e = n.o && 0 == n.h.length && 0 < m(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], r = e.length, l = 0; l < r; ++l) {
        var i = e[l];
        (0 < n.h.length && $(g(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || $(g(i, 4)) || h(i, 6)) && fn.test(g(i, 2)) && n.f.push(i));
      }
      return F(n, t), (t = M(n)), 0 < t.length ? t : R(n) ? G(n) : n.i.toString();
    }
    return D(n, t);
  }
  function G(n) {
    ...
    return (
      ...
      t
        ...
        : null != n.g.a[15] &&
          ...
          (t = e.match(t)),
          null != t && null != t[0] && 0 < t[0].length && ((n.o = !0), (l = t[0].length), n.b.a(e.substring(0, l)))),
      r(n.a),
      n.a.a(e.substring(l)),
      e.substring(0, l)
    );
  ...
  function P(n) {
    ...
    return (
      ...
      null != e[0] &&
      0 < e[0].length &&
      ((n.o = !0), (e = e[0].length), r(n.a), n.a.a(t.substring(e)), r(n.b), n.b.a(t.substring(0, e)), '+' != t.charAt(0) && n.b.a(' '), !0)
    );
  }
  function q(n) {
  ...
  (e.prototype.b = ''),
    ...
    (e.prototype.a = function (n, t, e) {
      if (((this.b += String(n)), null != t)) for (var r = 1; r < arguments.length; r++) this.b += arguments[r];
      return this;
    }),
...
*/
  var nn = { 374: ['AM'] },
    tn = {
      AM: [
        null,
        [null, null, '(?:[1-489]\\d|55|60|77)\\d{6}', null, null, null, null, null, null, [8], [5, 6]],
        [
          null,
          null,
        ...
        [null, null, '60(?:2[78]|3[5-9]|4[02-9]|5[0-46-9]|[6-8]\\d|90)\\d{4}', null, null, null, '60271234'],
        'AM',
        374,
        '00',
        '0',
