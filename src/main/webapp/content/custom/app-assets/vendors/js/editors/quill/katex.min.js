    ...
    function (t, e, r) {
              ...
              if (('function' == typeof a && (a = a(t, e, r)), a && 'ignore' !== a)) {
                ...
                'warn' === a
                  ? 'undefined' != typeof console &&
                    console.warn("LaTeX-incompatible input and strict mode is set to 'warn': " + e + ' [' + t + ']')
                  : 'undefined' != typeof console &&
                    console.warn("LaTeX-incompatible input and strict mode is set to unrecognized '" + a + "': " + e + ' [' + t + ']');
              }
            }),
        ...
        O = (function () {
          ...
          return (
            ...
            (e.toNode = function () {
              ...
              for (var e in ((t.src = this.src), (t.alt = this.alt), (t.className = 'mord'), this.style))
          ...
          return (
            ...
            (e.havingSize = function (t) {
              return this.size === t && this.textSize === t
                ? this
                : this.extend({ style: this.style.text(), size: t, textSize: t, sizeMultiplier: yt[t - 1] });
            }),
      ...
      var St = kt,
        ...
        Et = function (t, e, r) {
          ...
          return (
            a + '-' + ('textbf' === e && 'textit' === r ? 'BoldItalic' : 'textbf' === e ? 'Bold' : 'textit' === e ? 'Italic' : 'Regular')
          );
        },
        Lt = {
        ...
        Dt = {
          ...
          makeLineSpan: function (t, e, r) {
            var a = It([t], [], e);
            return (
              (a.height = Math.max(r || e.fontMetrics().defaultRuleThickness, e.minRuleThickness)),
      ...
      function le(t, e) {
        ...
        for (var a, n = ee(t, e, 'root'), i = [], o = [], s = 0; s < n.length; s++)
          if ((o.push(n[s]), n[s].hasClass('mbin') || n[s].hasClass('mrel') || n[s].hasClass('allowbreak'))) {
            for (var l = !1; s < n.length - 1 && n[s + 1].hasClass('mspace') && !n[s + 1].hasClass('newline'); )
            ...
            (e.toMarkup = function () {
              ...
              for (var e in this.attributes)
                Object.prototype.hasOwnProperty.call(this.attributes, e) &&
                  ((t += ' ' + e + '="'), (t += c.escape(this.attributes[e])), (t += '"'));
              t += '>';
              for (var r = 0; r < this.children.length; r++) t += this.children[r].toMarkup();
              return (t += '</' + this.type + '>');
            }),
        ...
        pe = function (t, e, r) {
          return (
            !j[e][t] ||
              ...
              (rt.hasOwnProperty(t) &&
                r &&
                ((r.fontFamily && 'tt' === r.fontFamily.substr(4, 2)) || (r.font && 'tt' === r.font.substr(4, 2)))) ||
              (t = j[e][t].replace),
            new ue.TextNode(t)
          );
        },
              ...
              (l = Dt.makeVList(
                {
                  ...
                  children: [
                    { type: 'elem', elem: i },
                    {
                      ...
                      wrapperStyle: o > 0 ? { width: 'calc(100% - ' + 2 * o + 'em)', marginLeft: 2 * o + 'em' } : void 0,
                    },
                  ],
                },
                e
      ...
      _t({
        ...
        htmlBuilder: function (t, e) {
          ...
          i.classes.push('x-arrow-pad'),
            t.below && ((n = e.havingStyle(a.sub())), (r = Dt.wrapFragment(oe(t.below, n, e), e)).classes.push('x-arrow-pad'));
          var o,
            s = Be(t, e),
      ...
      var De = {
        ...
        Fe = function (t, e, r, a) {
          ...
          null == n && ((r.noexpand = !0), (n = { tokens: [r], numArgs: 0, unexpandable: !t.gullet.isExpandable(r.text) })),
      ...
      var Ve = function (t, e, r) {
        ...
        We = function (t, e, r) {
          ...
          return (
            ...
            { type: 'elem', elem: Dt.makeSpan(['delimsizinginner', a], [Dt.makeSpan([], [Dt.makeSymbol(t, e, r)])]) }
          );
        },
        ...
        _t({
          ...
          htmlBuilder: function (t, e) {
            ...
            if (
              ((i *= e.sizeMultiplier),
              (o *= e.sizeMultiplier),
              (r = '.' === t.left ? ie(e, ['mopen']) : lr(t.left, i, o, e, t.mode, ['mopen'])),
              n.unshift(r),
              s)
            )
      ...
      var pr = function (t, e) {
          ...
          if ('sout' === i)
            ...
            var h = 0,
              m = 0;
            /box/.test(i)
              ? ((m = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)), (h = e.fontMetrics().fboxsep + ('colorbox' === i ? 0 : m)))
              : (h = l ? 0.2 : 0),
              (r = Ae(n, i, h, e)),
      ...
      function xr(t) {
        ...
        for (var r = t.fetch().text; '\\hline' === r || '\\hdashline' === r; )
          t.consume(), e.push('\\hdashline' === r), t.consumeSpaces(), (r = t.fetch().text);
        return e;
      }
      function vr(t, e, r) {
      ...
      var yr = function (t, e) {
          ...
          t.colSeparationType &&
            ...
            (p = (e.havingStyle(w.SCRIPT).sizeMultiplier / e.sizeMultiplier) * 0.2778);
          var d = 12 * u,
            f = 3 * u,
            g = t.arraystretch * d,
            x = 0.7 * g,
          ...
          for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
            for (var R = I[q] || {}, E = !0; 'separator' === R.type; ) {
              if (
                (E || (((C = Dt.makeSpan(['arraycolsep'], [])).style.width = e.fontMetrics().doubleRuleSep + 'em'), O.push(C)),
            ...
            if (!(a >= s)) {
              ...
              (a > 0 || t.hskipBeforeAndAfter) &&
                ...
                (((C = Dt.makeSpan(['arraycolsep'], [])).style.width = D + 'em'), O.push(C));
              var H = [];
              for (r = 0; r < n; ++r) {
                var F = l[r],
                  V = F[a];
          ...
          if (((l = Dt.makeSpan(['mtable'], O)), h.length > 0)) {
            for (
              var G = Dt.makeLineSpan('hline', e, m), Y = Dt.makeLineSpan('hdashline', e, m), W = [{ type: 'elem', elem: l, shift: 0 }];
              h.length > 0;
      ...
      gr({
        ...
        gr({
          ...
          handler: function (t, e) {
            ...
            if ((a = vr(t.parser, a, 'script')).body.length > 0 && a.body[0].length > 1)
      ...
      var Ir = function (t, e) {
        ...
        Or = function (t, e) {
          ...
          if (
            (t.hasBarLine
              ? (t.barSize ? ((m = Tt(t.barSize, e)), (h = Dt.makeLineSpan('frac-line', e, m))) : (h = Dt.makeLineSpan('frac-line', e)),
                (m = h.height),
                (c = h.height))
            ...
            u - o.depth - (y + 0.5 * m) < p && (u += p - (u - o.depth - (y + 0.5 * m))),
              y - 0.5 * m - (b.height - d) < p && (d += p - (y - 0.5 * m - (b.height - d)));
            var k = -(y - 0.5 * m);
            f = Dt.makeVList(
              {
                positionType: 'individualShift',
      ...
      _t({
        ...
        _t({
          ...
          htmlBuilder: function (t, e) {
            var r;
            'clap' === t.alignment
              ? ((r = Dt.makeSpan([], [oe(t.body, e)])), (r = Dt.makeSpan(['inner'], [r], e)))
      ...
      var Xr = function (t, e) {
        var r,
          ...
          o = !1;
        if (
          ('supsub' === t.type ? ((r = t.sup), (a = t.sub), (n = Ce(t.base, 'operatorname')), (o = !0)) : (n = Ce(t, 'operatorname')),
          n.body.length > 0)
        ) {
          for (
      ...
      function _r(t, e, r) {
        for (var a = ee(t, e, !1), n = e.sizeMultiplier / r.sizeMultiplier, i = 0; i < a.length; i++) {
          ...
          o < 0
            ...
            : a[i].classes[o + 1] === 'reset-size' + e.size && (a[i].classes[o + 1] = 'reset-size' + r.size),
            (a[i].height *= n),
            (a[i].depth *= n);
        }
        return Dt.makeFragment(a);
      ...
      _t({
        ...
        _t({
          ...
          htmlBuilder: function (t, e) {
            ...
            return (
              (r = Dt.makeVList({ positionType: 'firstBaseline', children: [{ type: 'elem', elem: r }] }, e)), Dt.makeSpan(['mord'], [r], e)
            );
          },
          mathmlBuilder: function (t, e) {
            var r = ge($t(t.body), e),
          ...
          mathmlBuilder: function (t, e) {
            ...
            return (
              n >= 0
                ...
                : (s.setAttribute('height', n + 'em'), s.setAttribute('depth', '+' + -n + 'em')),
          ...
          mathmlBuilder: function (t, e) {
            ...
            if ('bin' === t.family) {
              ...
              'punct' === t.family
                ...
                : ('open' !== t.family && 'close' !== t.family) || r.setAttribute('stretchy', 'false');
            return r;
          },
        });
      ...
      jt({
        ...
        mathmlBuilder: function (t, e) {
          var r = new ue.MathNode('mtable', [
            new ue.MathNode('mtr', [Qr(), new ue.MathNode('mtd', [xe(t.body, e)]), Qr(), new ue.MathNode('mtd', [xe(t.tag, e)])]),
          ]);
      ...
      pa('\\dots', function (t) {
        ...
        return (
          r in ga
            ...
            : '\\not' === r.substr(0, 4)
            ? (e = '\\dotsb')
            : r in j.math && c.contains(['bin', 'rel'], j.math[r].group) && (e = '\\dotsb'),
          e
        );
      });
      var xa = {
        ...
        ya = (function () {
          ...
          return (
            ...
            (e.isDefined = function (t) {
              return (
                this.macros.has(t) || ia.hasOwnProperty(t) || j.math.hasOwnProperty(t) || j.text.hasOwnProperty(t) || ba.hasOwnProperty(t)
              );
            }),
          ...
          return (
              ...
              for (;;) {
                ...
                if ('\\limits' === n.text || '\\nolimits' === n.text) {
                  if (a && 'op' === a.type) {
                    ...
                    if (!a || 'operatorname' !== a.type || !a.alwaysHandleSupSub)
            ...
            (e.parseFunction = function (t, e, r) {
              ...
              if ((this.consume(), null != r && i.greediness <= r))
                throw new o("Got function '" + n + "' with no arguments" + (e ? ' as ' + e : ''), a);
            ...
            (e.parseRegexGroup = function (t, e) {
              var r = this.mode;
              this.mode = 'text';
              for (var a, n = this.fetch(), i = n, s = ''; 'EOF' !== (a = this.fetch()).text && t.test(s + a.text); )
            ...
            (e.parseGroup = function (e, r, n, i, s, l) {
              ...
              if (r ? '[' === u : '{' === u || '\\begingroup' === u) {
                ...
                this.expect(p),
                  ...
                  (m = { type: 'ordgroup', mode: this.mode, loc: a.range(c, f), body: d, semisimple: '\\begingroup' === u || void 0 });
              } else if (r) m = null;
            ...
            (e.formLigatures = function (t) {
              for (var e = t.length - 1, r = 0; r < e; ++r) {
                ...
                '-' === i &&
                  ...
                  ("'" !== i && '`' !== i) ||
                    t[r + 1].text !== i ||
                    (t.splice(r, 2, { type: 'textord', mode: 'text', loc: a.range(n, t[r + 1]), text: i + i }), (e -= 1));
              }
            }),
            (e.parseSymbol = function () {
              ...
              ka.hasOwnProperty(e[0]) &&
                ...
                (this.settings.strict &&
                  ...
                  this.settings.reportNonstrict(
                    ...
                    'Accented Unicode text character "' + e[0] + '" used in math mode',
                    t
                  ),
                (e = ka[e[0]] + e.substr(1)));
              var i,
              ...
              if ((s && ('i' === (e = e.substring(0, s.index)) ? (e = '\u0131') : 'j' === e && (e = '\u0237')), j[this.mode][e])) {
                this.settings.strict &&
                  ...
                  this.settings.reportNonstrict(
                    'unicodeTextInMathMode',
                    'Latin-1/Unicode text character "' + e[0] + '" used in math mode',
                    t
                  );
                var l,
                ...
                this.settings.strict &&
                  (M(e.charCodeAt(0))
                    ? 'math' === this.mode &&
                      this.settings.reportNonstrict('unicodeTextInMathMode', 'Unicode text character "' + e[0] + '" used in math mode', t)
                    : this.settings.reportNonstrict(
                        'unknownSymbol',
                        'Unrecognized Unicode character "' + e[0] + '" (' + e.charCodeAt(0) + ')',
                        t
                      )),
