...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (C(n, n.a.toString()), F(n) ? M(n) : n.l ? G(n, e) : n.i.toString()))
          : Y(n);
    }
  }
  function $(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), Y(n);
  }
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), G(n, t);
    }
    return '';
  }
  function G(n, t) {
  ...
  function Y(n) {
    ...
    if (3 <= t.length) {
      ...
      return C(n, t), (t = D(n)), 0 < t.length ? t : F(n) ? M(n) : n.i.toString();
    }
    return G(n, t);
  }
  function M(n) {
...
*/
  var nn = { 592: ['GY'] },
    tn = {
      GY: [
        null,
        [null, null, '(?:(?:(?:[2-46]\\d|77)\\d|862)\\d|9008)\\d{3}', null, null, null, null, null, null, [7]],
        [
          null,
          null,
