    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((l = T(n, t)), (r = V(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? G(n) : n.l ? D(n, l) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
    ...
    if (3 <= t.length) {
      for (var l = n.o && 0 == n.h.length && 0 < d(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], e = l.length, r = 0; r < e; ++r) {
        ...
        (0 < n.h.length && N(g(u, 4)) && !h(u, 6) && null == u.a[5]) ||
          ((0 != n.h.length || n.o || N(g(u, 4)) || h(u, 6)) && fn.test(g(u, 2)) && n.f.push(u));
      }
...
*/
  var nn = { 84: ['VN'] },
    tn = {
      VN: [
        null,
        [null, null, '[12]\\d{9}|[135-9]\\d{8}|(?:[16]\\d?|[78])\\d{6}', null, null, null, null, null, null, [7, 8, 9, 10]],
        [
          null,
          null,
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:67|99)2\\d{6}', null, null, null, '992012345', null, null, [9]],
        'VN',
        84,
        '00',
        '0',
        ...
        null,
        null,
        [null, null, '(?:[17]99|69\\d\\d?)\\d{4}', null, null, null, null, null, null, [7, 8]],
        [null, null, '(?:[17]99|69\\d\\d?|80\\d)\\d{4}', null, null, null, '1992000', null, null, [7, 8]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
