    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (C(n, n.a.toString()), F(n) ? M(n) : n.l ? T(n, e) : n.i.toString()))
          : $(n);
    }
  }
  function V(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), $(n);
  }
  function D(n) {
...
*/
  var nn = { 688: ['TV'] },
    tn = {
      TV: [
        null,
        [null, null, '(?:2|7\\d\\d|90)\\d{4}', null, null, null, null, null, null, [5, 6, 7]],
