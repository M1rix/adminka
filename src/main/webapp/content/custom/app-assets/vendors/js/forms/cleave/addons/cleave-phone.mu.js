...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = M(n)), 0 < r.length ? r : (F(n, n.a.toString()), $(n) ? V(n) : n.l ? D(n, e) : n.i.toString()))
          : U(n);
    }
  }
  function I(n) {
  ...
  function U(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = M(n)), 0 < t.length ? t : $(n) ? V(n) : n.i.toString();
    }
    return D(n, t);
  }
  function V(n) {
...
*/
  var nn = { 230: ['MU'] },
    tn = {
      MU: [
        null,
        [null, null, '(?:[2-468]|5\\d)\\d{6}', null, null, null, null, null, null, [7, 8]],
        [
          null,
          null,
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '3(?:20|9\\d)\\d{4}', null, null, null, '3201234', null, null, [7]],
        'MU',
        230,
        '0(?:0|[24-7]0|3[03])',
        null,
