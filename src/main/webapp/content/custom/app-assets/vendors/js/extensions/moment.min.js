            ...
            : (d(r)
                ...
                ? ((s = t),
                  null === (i = pt.exec(s._i))
                    ? (wt(s),
                      !1 === s._isValid &&
                        (delete s._isValid, Dt(s), !1 === s._isValid && (delete s._isValid, c.createFromInputFallback(s))))
                    : (s._d = new Date(+i[1])))
                : o(n)
  ...
  function jt(e, t) {
    ...
    return (
      Rt(e)
        ...
        : (a = It.exec(e))
        ? ((n = '-' === a[1] ? -1 : 1),
          (r = { y: 0, d: D(a[ye]) * n, h: D(a[ge]) * n, m: D(a[ve]) * n, s: D(a[pe]) * n, ms: D(Ut(1e3 * a[we])) * n }))
        : (a = At.exec(e))
        ? ((n = '-' === a[1] ? -1 : 1),
          (r = { y: Zt(a[2], n), M: Zt(a[3], n), w: Zt(a[4], n), d: Zt(a[5], n), h: Zt(a[6], n), m: Zt(a[7], n), s: Zt(a[8], n) }))
        : null == r
        ? (r = {})
        : 'object' == typeof r &&
          ('from' in r || 'to' in r) &&
