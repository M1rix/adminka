...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (l = $(n)), 0 < l.length ? l : (C(n, n.a.toString()), F(n) ? V(n) : n.l ? D(n, e) : n.i.toString()))
          : T(n);
    }
  }
  function M(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), T(n);
  }
  function $(n) {
  ...
  function T(n) {
    ...
    if (3 <= t.length) {
      ...
      return C(n, t), (t = $(n)), 0 < t.length ? t : F(n) ? V(n) : n.i.toString();
    }
    return D(n, t);
  }
  function V(n) {
...
*/
  var nn = { 356: ['MT'] },
    tn = {
      MT: [
        null,
        [null, null, '(?:(?:[2579]\\d\\d|800)\\d|3550)\\d{4}', null, null, null, null, null, null, [8]],
