...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : ($(n, n.a.toString()), F(n) ? M(n) : n.l ? H(n, e) : n.i.toString()))
          : T(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), T(n);
  }
  function D(n) {
  ...
  function T(n) {
    ...
    if (3 <= t.length) {
      ...
      return $(n, t), (t = D(n)), 0 < t.length ? t : F(n) ? M(n) : n.i.toString();
    }
    return H(n, t);
  }
  function M(n) {
  ...
  var nn = { 509: ['HT'] },
    tn = {
      HT: [
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '9(?:[67][0-4]|8[0-3589]|9\\d)\\d{5}', null, null, null, '98901234'],
        'HT',
        509,
        '00',
        null,
