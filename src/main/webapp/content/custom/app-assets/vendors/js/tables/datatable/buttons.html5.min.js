...
(function (f) {
  ...
  function E(a, b) {
    y === w &&
      (y = -1 === C.serializeToString(new g.DOMParser().parseFromString(F['xl/worksheets/sheet1.xml'], 'text/xml')).indexOf('xmlns:r'));
  ...
  v.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      for (y = k.header.length; x < y; x++)
        q.appendChild(r(h, 'col', { attr: { min: x + 1, max: x + 1, width: L(k, x), customWidth: 1 } }));
      q = a.xl['workbook.xml'];
