...
var FullCalendar = (function (e) {
  ...
  function N(e, t, n, r, o, i, a, s) {
    ...
    if (null === m) v === g || (s && e.data === g) || (e.data = g);
      ...
      if (
        ...
        ((y = t.props.children), C(e, Array.isArray(y) ? y : [y], t, n, r, o && 'foreignObject' !== m, i, a, e.firstChild, s), null != i)
      )
  ...
  i.__e = function (e, t, n) {
    if (e.then)
      for (var r, o = t; (o = o.__); ) if ((r = o.__c) && r.__c) return null == t.__e && ((t.__e = n.__e), (t.__k = n.__k)), r.__c(e, t);
    J(e, t, n);
  };
  var Q = i.unmount;
  function ee() {
  ...
  i.vnode = function (e) {
    ...
    t &&
      n.class != n.className &&
      ((fe.enumerable = 'className' in n), null != n.className && (r.class = n.className), Object.defineProperty(r, 'className', fe)),
      (e.$$typeof = ae),
      he && he(e);
  };
  var ve = i.__r;
  ...
  function Ve(e) {
    var t,
      ...
      o = [];
    for (
      'string' == typeof e ? (o = e.split(/\s*,\s*/)) : 'function' == typeof e ? (o = [e]) : Array.isArray(e) && (o = e), t = 0;
      t < o.length;
      t += 1
    )
      'string' == typeof (n = o[t])
  ...
  function et(e, t) {
    var n = rt(e),
      r = rt(t);
    return { years: 0, months: 0, days: Math.round(Qe(n, r)), milliseconds: t.valueOf() - r.valueOf() - (e.valueOf() - n.valueOf()) };
  }
  function tt(e, t) {
    var n = nt(e, t);
  ...
  function pt(e, t, n, r) {
    return { instanceId: Ne(), defId: e, range: t, forcedStartTzo: null == n ? null : n, forcedEndTzo: null == r ? null : r };
  }
  ...
  function At(e, t, n) {
    ...
    return (
      ...
      r.length > 10 && (null == t ? (r = r.replace('Z', '')) : 0 !== t && (r = r.replace('Z', Wt(t, !0)))),
      r
    );
  }
  function Ut(e) {
  ...
  var Bt = { week: 3, separator: 0, omitZeroMinute: 0, meridiem: 0, omitCommas: 0 },
    jt = { timeZoneName: 7, era: 6, year: 5, month: 4, day: 2, weekday: 2, hour: 1, minute: 1, second: 1 },
    Gt = /\s*([ap])\.?m\.?/i,
    qt = /,/g,
    Yt = /\s+/g,
    Zt = /\u200e/g,
    ...
    Kt = (function () {
      function e(e) {
        var t = {},
          n = {},
          r = 0;
        for (var o in e) o in Bt ? ((n[o] = e[o]), (r = Math.max(Bt[o], r))) : ((t[o] = e[o]), o in jt && (r = Math.max(jt[o], r)));
  ...
  function nn(e) {
    return 'object' == typeof e && e ? new Kt(e) : 'string' == typeof e ? new en(e) : 'function' == typeof e ? new tn(e) : null;
  }
  var rn = {
      navLinkDayClick: fn,
      navLinkWeekClick: fn,
    ...
    sn = { buttonText: fn, views: fn, plugins: fn, initialEvents: fn, events: fn, eventSources: fn },
    ln = { headerToolbar: un, footerToolbar: un, buttonText: un, buttonIcons: un };
  function un(e, t) {
  ...
  function Cn(e, t) {
    var n = (function (e, t) {
      return Array.isArray(e) ? hn(e, null, t, !0) : 'object' == typeof e && e ? hn([e], null, t, !0) : null != e ? String(e) : null;
    })(e.constraint, t);
    return {
  ...
  function xn(e, t, n, r, o) {
    ...
    if (u)
      return (
        ((c = Pn(a, s, t ? t.sourceId : '', u.allDay, Boolean(u.duration), n)).recurringDef = {
          typeId: u.typeId,
          typeData: u.typeData,
          duration: u.duration,
        }),
  ...
  function Hn(e, t) {
    ...
    return e.start && ((n = rt(e.start)), r && r <= n && (r = Ke(n, 1))), { start: n, end: r };
  }
  function On(e) {
    var t = Hn(e);
  ...
  function Un(e, t) {
    var n,
      ...
      o = [],
      i = t.start;
    for (e.sort(Ln), n = 0; n < e.length; n += 1) (r = e[n]).start > i && o.push({ start: i, end: r.start }), r.end > i && (i = r.end);
  ...
  function Jn(e, t) {
    for (
      var n = t.pluginHooks.isDraggableTransformers, r = e.eventRange, o = r.def, i = r.ui, a = i.startEditable, s = 0, l = n;
      s < l.length;
      s++
    ) {
      a = (0, l[s])(a, o, i, t);
  ...
  function tr(e, t, n, r, o, i, a) {
    ...
    return u && !d.allDay && (m || y)
      ? ((v = m ? f : v),
        (g = y ? h : g),
        c && d.hasEnd
          ? s.formatRange(v, g, t, { forcedStartTzo: i ? null : p.forcedStartTzo, forcedEndTzo: a ? null : p.forcedEndTzo })
          : s.format(v, t, { forcedTzo: i ? null : p.forcedStartTzo }))
      : '';
  }
  function nr(e, t, n) {
    var r = e.eventRange.range;
    return { isPast: r.end < (n || t.start), isFuture: r.start >= (n || t.end), isToday: t && Bn(t, r.start) };
  }
  function rr(e) {
    var t = ['fc-event'];
    return (
  ...
  function cr(e, t, n) {
    ...
    return { def: o, ui: Xn(o, t), instance: pt(o.defId, e.range), range: e.range, isStart: !0, isEnd: !0 };
  }
  function dr(e, t, n) {
    n.emitter.trigger('select', r(r({}, pr(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view }));
  }
  function pr(e, t) {
    ...
    return r(i, ((n = e), (o = t.dateEnv), r(r({}, ur(n.range, o, n.allDay)), { allDay: n.allDay }))), i;
  }
  function fr(e, t, n) {
    var r = n.dateEnv,
      o = n.options,
  ...
  function gr(e, t, n, o, i) {
    ...
    return (
      ...
      l && (u.range = { start: u.range.start, end: fr(t.allDay, u.range.start, i) }),
      t.allDay && (u.range = { start: rt(u.range.start), end: rt(u.range.end) }),
  ...
  var mr = (function () {
    ...
    yr = { id: String, defaultAllDay: Boolean, url: String, format: String, events: fn, eventDataTransform: fn, success: fn, failure: fn };
  function Er(e, t, n) {
    var r;
    if (
      (void 0 === n && (n = Sr(t)),
  ...
  var br = (function () {
      ...
      return (
        ...
        (e.prototype.today = function () {
          var e = this.getCurrentData();
          this.unselect(), this.dispatch({ type: 'CHANGE_DATE', dateMarker: Dr(e.calendarOptions.now, e.dateEnv) });
        }),
        ...
        (e.prototype.addEvent = function (e, t) {
          if (e instanceof Cr) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({ type: 'ADD_EVENTS', eventStore: vn({ def: n, instance: r }) }), this.triggerEventAdd(e)),
              e
            );
          }
          var o,
          ...
          if (s) {
            ...
            return this.dispatch({ type: 'ADD_EVENTS', eventStore: vn(s) }), this.triggerEventAdd(l), l;
          }
          return null;
        }),
    ...
    Cr = (function () {
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          var n, r;
          if (e in Tn) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead.");
          else if ('id' === e) (t = _n[e](t)), this.mutate({ standardProps: { publicId: t } });
          else if (e in _n) (t = _n[e](t)), this.mutate({ standardProps: ((n = {}), (n[e] = t), n) });
          else if (e in Dn) {
            var o = Dn[e](t);
            'color' === e
        ...
        (e.prototype.formatRange = function (e) {
          ...
          return this._def.hasEnd
            ? t.formatRange(n.range.start, n.range.end, r, { forcedStartTzo: n.forcedStartTzo, forcedEndTzo: n.forcedEndTzo })
      ...
      return (
        ...
        (e.prototype.createMarkerMeta = function (e) {
          ...
          return (
            ...
            null !== t && ct(t) ? { marker: t, isTimeUnspecified: !1, forcedTzo: null } : null
          );
        }),
        (e.prototype.parse = function (e) {
          ...
          return (
            null !== t.timeZoneOffset &&
              (this.canComputeOffset ? (n = this.timestampToMarker(n.valueOf() - 60 * t.timeZoneOffset * 1e3)) : (r = t.timeZoneOffset)),
        ...
        (e.prototype.diffWholeYears = function (e, t) {
          ...
          return dt(e) === dt(t) && n.getMarkerDay(e) === n.getMarkerDay(t) && n.getMarkerMonth(e) === n.getMarkerMonth(t)
        ...
        (e.prototype.format = function (e, t, n) {
          return (
            void 0 === n && (n = {}),
            t.format({ marker: e, timeZoneOffset: null != n.forcedTzo ? n.forcedTzo : this.offsetForMarker(e) }, this)
          );
        }),
        (e.prototype.formatRange = function (e, t, n, r) {
          return (
        ...
        (e.prototype.toDate = function (e, t) {
          return 'local' === this.timeZone
            ...
            ? new Date(e.valueOf())
            : this.namedTimeZoneImpl
            ? new Date(e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(lt(e)) * 60)
  ...
  function Hr(e) {
    for (var t = e.length > 0 ? e[0].code : 'en', n = Pr.concat(e), r = { en: Nr }, o = 0, i = n; o < i.length; o++) {
      var a = i[o];
      r[a.code] = a;
    }
  ...
  function Ur(e) {
    ...
    return new Ir(r(r({ timeZone: on.timeZone, calendarSystem: 'gregory' }, e), { locale: t }));
  }
  var Lr,
    Wr = {
      startTime: '09:00',
        ...
        (e.prototype._splitInteraction = function (e) {
          ...
          if (e) {
            var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents)),
              ...
              i = function (r) {
                t[r] || (t[r] = { affectedEvents: n[r] || Yr, mutatedEvents: o[r] || Yr, isEvent: e.isEvent });
              };
            for (var a in n) i(a);
            for (var a in o) i(a);
          }
  ...
  function to() {
    return (
      null === eo &&
        (eo = (function () {
          var e = document.createElement('div');
          we(e, { position: 'absolute', top: -1e3, left: 0, border: 0, padding: 0, overflow: 'scroll', direction: 'rtl' }),
            (e.innerHTML = '<div></div>'),
            document.body.appendChild(e);
  ...
  function oo(e, t) {
    ...
    return (
      to() && 'rtl' === n.direction ? (u.scrollbarLeft = l) : (u.scrollbarRight = l),
      t &&
  ...
  var uo = (function () {
    ...
    return (
      ...
      (e.prototype.trigger = function (e) {
        ...
        for (
          var r = this.handlers[e] || [], o = this.options && this.options[e], i = [].concat(o || [], r), a = 0, s = i;
          a < s.length;
          a++
        ) {
          var l = s[a];
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            t = this.props,
            n = t.hookProps;
          return mo(zo, { hookProps: n, didMount: t.didMount, willUnmount: t.willUnmount, elRef: this.handleRootEl }, function (r) {
            return mo(
              Vo,
  ...
  var qo = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return mo(zo, { hookProps: r, didMount: n.viewDidMount, willUnmount: n.viewWillUnmount, elRef: e.elRef }, function (t) {
          ...
          return mo(_o.Consumer, null, function (n) {
            return mo(qo, { viewSpec: n.viewSpec }, function (o, i) {
              ...
              return mo(
                ...
                function (e, t, n, r) {
                  return mo('div', { className: i.concat(t).join(' '), ref: e }, r);
                }
              );
            });
          });
    ...
    return (
      ...
      (e.prototype.buildCurrentRangeInfo = function (e, t) {
        ...
        return (
          r.duration
            ...
            : ((i = Ot((o = this.getFallbackDuration())).unit), (a = this.buildRangeFromDuration(e, t, o, i))),
      ...
      (e.prototype.adjustActiveRange = function (e) {
        var t = this.props,
          ...
          s = e.end;
        return (
          r && (Pt(o) < 0 && ((a = rt(a)), (a = n.add(a, o))), Pt(i) > 1 && ((s = Ke((s = rt(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
      (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
        ...
        return (
          Pt(n) <= 1 && this.isHiddenDay(o) && (o = rt((o = this.skipHiddenDays(o, t)))),
          d(),
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return n || ((t = this.props.dateAlignment) ? kt(1, t) : e || kt({ days: 1 }));
      }),
      ...
      s.fetch(
        ...
        function (n) {
          console.warn(n.message, n),
            ...
            o.dispatch({ type: 'RECEIVE_EVENT_ERROR', sourceId: e.sourceId, fetchId: l, fetchRange: t, error: n });
        }
      ),
  ...
  var Ei = [
    ...
    Ho({
      eventSourceRefiners: { method: String, extraParams: fn, startParam: String, endParam: String, timeZoneParam: String },
      eventSourceDefs: [
        {
          parseMeta: function (e) {
    ...
    Ho({
      ...
      eventRefiners: { daysOfWeek: fn, startTime: kt, endTime: kt, duration: kt, startRecur: fn, endRecur: fn },
    }),
    Ho({
      optionChangeHandlers: {
        events: function (e, t) {
    ...
    Ho({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger('datesSet', r(r({}, lr(e.activeRange, t.dateEnv)), { view: t.viewApi }));
        },
  ...
  var bi = (function () {
      ...
      return (
        (e.prototype.request = function (e) {
          (this.isDirty = !0),
            this.isPaused() ||
              (this.clearTimeout(), null == e ? this.tryDrain() : (this.timeoutId = setTimeout(this.tryDrain.bind(this), e)));
        }),
  ...
  var Ri = (function () {
    function e(e) {
      ...
      (this.computeOptionsData = Ft(this._computeOptionsData)),
        ...
        (this.emitter = new uo()),
        (this.actionRunner = new Ci(this._handleAction.bind(this), this.updateData.bind(this))),
    ...
    return (
        ...
        this.data && this.data.dateProfileGenerator !== u.dateProfileGenerator && (p = u.dateProfileGenerator.build(d)),
          (p = (function (e, t, n, r) {
            ...
            switch (t.type) {
              ...
              case 'CHANGE_DATE':
                if (!e.activeRange || !Bn(e.currentRange, t.dateMarker)) return r.build(t.dateMarker);
                break;
              case 'PREV':
        ...
        if (m && m !== y)
          for (var E in (m.timeZone !== y.timeZone &&
            ((d.eventSources = v.eventSources =
              ((a = v.eventSources), (s = d.dateProfile), (l = v), (u = s ? s.activeRange : null), ri(a, ii(a, l), u, !0, l))),
      ...
      (e.prototype.processRawCalendarOptions = function (e, t) {
        var n = dn([on, e, t]),
          ...
          c = (this.currentCalendarOptionsRefiners = r(r(r(r(r({}, rn), an), sn), u.listenerRefiners), u.optionRefiners)),
          d = {},
          p = dn([on, l, e, t]),
          f = {},
      ...
      (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
        ...
        for (var f in a)
          a[f] === u[f]
            ...
            : (a[f] === this.currentCalendarOptionsInput[f]
                ? f in this.currentCalendarOptionsRefined && (l[f] = this.currentCalendarOptionsRefined[f])
                : s[f]
                ? (l[f] = s[f](a[f]))
                : (p[f] = a[f]),
              (d = !0));
        return (
          ...
          { rawOptions: this.currentViewOptionsInput, refinedOptions: this.currentViewOptionsRefined, extra: p }
        );
      }),
      e
    );
  ...
  function Pi(e) {
    ...
    return {
      ...
      selectionConfig: Cn(
        { constraint: t.selectConstraint, overlap: 'boolean' == typeof t.selectOverlap ? t.selectOverlap : void 0, allow: t.selectAllow },
        e
      ),
    };
  }
  ...
  var Ai = (function (e) {
    function t(t) {
      ...
      return (
        ...
        (n.dataManager = new Ri({ optionOverrides: t.optionOverrides, calendarApi: t.calendarApi, onData: n.handleData })),
        n
      );
    }
    return (
    ...
    Li = (function () {
      ...
      return (
        (e.prototype.addSegs = function (e) {
          for (var t = [], n = 0, r = e; n < r.length; n++) {
            var o = r[n];
            this.insertEntry({ segInput: o, spanStart: o.spanStart, spanEnd: o.spanEnd, thickness: o.thickness }, t);
          }
          return t;
        }),
        ...
        (e.prototype.splitEntry = function (e, t, n) {
          var i = 0,
            a = [];
          return (
            e.spanStart < t.spanStart && (i += this.insertEntry(r(r({}, e), { spanStart: e.spanStart, spanEnd: t.spanStart }), a)),
            t.spanEnd < e.spanEnd && (i += this.insertEntry(r(r({}, e), { spanStart: t.spanEnd, spanEnd: e.spanEnd }), a)),
            i
              ? (n.push.apply(
                  n,
                  o([r(r({}, e), { spanStart: Math.max(t.spanStart, e.spanStart), spanEnd: Math.min(t.spanEnd, e.spanEnd) })], a)
                ),
                i)
              : (n.push(e), 0)
          );
        ...
        (e.prototype.insertEntryAt = function (e, t) {
          ...
          !n || this.levelCoords[n - 1] < t.levelCoord
            ? (zi(this.levelCoords, n, t.levelCoord), zi(this.entriesByLevel, n, [e]))
        ...
        (e.prototype.findInsertion = function (e) {
          ...
          for (t = 0; t < l && ((n = o[t]), s || !(n >= d + e.thickness)); t += 1) {
            ...
            for (c = u = v[0] + v[1]; (h = f[c]) && h.spanStart < e.spanEnd; )
              (s || (d < n + h.thickness && d + e.thickness > n)) && ((p = h), (d = n + h.thickness)), (c += 1);
          }
          return { levelCoord: d, nextLevel: t, lateralStart: u, lateralEnd: c, touchingEntry: p, stackCnt: p ? a[Vi(p)] + 1 : 0 };
        }),
  ...
  function Fi(e) {
    for (var t = [], n = 0, r = e; n < r.length; n++) {
      for (var o = r[n], i = [], a = { spanStart: o.spanStart, spanEnd: o.spanEnd, entries: [o] }, s = 0, l = t; s < l.length; s++) {
        var u = l[s];
  ...
  var Ji = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo.apply(void 0, o(['div', { className: 'fc-toolbar-chunk' }], t));
        }),
        (t.prototype.renderWidgetGroup = function (e) {
          for (var t = this.props, n = this.context.theme, i = [], a = !0, s = 0, l = e; s < l.length; s++) {
            var u = l[s],
              ...
              p = u.buttonText,
              f = u.buttonIcon;
            if ('title' === c) (a = !1), i.push(mo('h2', { className: 'fc-toolbar-title' }, t.title));
            else {
              ...
              i.push(
                mo(
                  'button',
                  r({ disabled: g, className: v.join(' '), onClick: d, type: 'button' }, h),
      ...
      return (
        ...
        (t.prototype.triggerEvent = function (e, t, n) {
          ...
          (t && !r.isValidSegDownEl(t.target)) ||
            o.emitter.trigger(e, { el: n, event: new Cr(o, i.eventRange.def, i.eventRange.instance), jsEvent: t, view: o.viewApi });
        }),
        t
      );
    })(ji),
      ...
      function t() {
        ...
        return (
          ...
          (t.registerInteractiveComponent = function (e, n) {
            var r = Gi(e, n),
              o = [ta, na].concat(t.props.pluginHooks.componentInteractions).map(function (e) {
                return new e(r);
              });
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(
            _o.Provider,
            { value: l },
            n.headerToolbar && mo(Qi, r({ ref: this.headerRef, extraClassName: 'fc-header-toolbar', model: n.headerToolbar }, i)),
            mo(
              ea,
            ...
            n.footerToolbar && mo(Qi, r({ ref: this.footerRef, extraClassName: 'fc-footer-toolbar', model: n.footerToolbar }, i))
          );
        }),
        (t.prototype.componentDidMount = function () {
          var e = this.props;
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.context,
            ...
            p = n.navLinks && !u.isDisabled && a.colCnt > 1 ? { 'data-navlink': Jr(s), tabIndex: 0 } : {},
          ...
          return mo(
            ...
            function (e, t, n, o) {
              return mo(
                'th',
                r(
                  { ref: e, className: c.concat(t).join(' '), 'data-date': u.isDisabled ? void 0 : Ut(s), colSpan: a.colSpan },
                  a.extraDataAttrs
                ),
                mo(
                  'div',
                  ...
                  !u.isDisabled &&
                    mo('a', r({ ref: n, className: ['fc-col-header-cell-cushion', a.isSticky ? 'fc-sticky' : ''].join(' ') }, p), o)
                )
              );
            }
          );
            ...
            function (t, n, o, i) {
              return mo(
                ...
                mo(
                  'div',
                  { className: 'fc-scrollgrid-sync-inner' },
                  mo('a', { className: ['fc-col-header-cell-cushion', e.isSticky ? 'fc-sticky' : ''].join(' '), ref: o }, i)
                )
              );
            }
          );
    ...
    pa = (function (e) {
      ...
      return (
        ...
        (t.prototype.computeTiming = function () {
          ...
          return (
            (i = Math.min(864e5, i)),
            { currentState: { nowDate: r, todayRange: fa(r) }, nextState: { nowDate: o, todayRange: fa(o) }, waitMs: i }
          );
        }),
      ...
      (t.prototype.render = function () {
        ...
        return mo(pa, { unit: 'day' }, function (e, t) {
          return mo(
            ...
            n.map(function (e) {
              return o
                ? mo(ca, { key: e.toISOString(), date: e, dateProfile: r, todayRange: t, colCnt: n.length, dayHeaderFormat: a })
                : mo(da, { key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a });
            })
          );
        });
      }),
        ...
        (e.prototype.sliceRange = function (e) {
          ...
          if (n)
            for (var o = n.firstIndex, i = n.lastIndex, a = o; a <= i; ) {
              ...
              r.push({ row: s, firstCol: a % t, lastCol: (l - 1) % t, isStart: n.isStart && a === o, isEnd: n.isEnd && l - 1 === i }),
                (a = l);
            }
          return r;
        }),
    ...
    ya = (function () {
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(this, o([{ range: { start: e, end: $e(e, 1) }, allDay: !1 }, {}, t], n));
        }),
        (e.prototype._sliceBusinessHours = function (e, t, n, r) {
          for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a];
          return e ? this._sliceEventStore.apply(this, o([wt(e, Ea(t, Boolean(n)), r), {}, t, n], i)).bg : [];
        }),
        ...
        (e.prototype.sliceEventRange = function (e, t) {
          var n = e.range;
          this.forceDayIfListItem && 'list-item' === e.ui.display && (n = { start: n.start, end: Ke(n.start, 1) });
  ...
  function Ea(e, t) {
    var n = e.activeRange;
    return t ? n : { start: $e(n.start, e.slotMinTime.milliseconds), end: $e(n.end, e.slotMaxTime.milliseconds - 864e5) };
  }
  function Sa(e, t, n) {
          ...
          for (var m in u) {
            ...
            for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
              var x = k[T],
                ...
                P = _.instances[m],
                N = void 0;
              if (((N = I ? new Cr(t, I, P) : new Cr(t, D)), !x(pr(M, t), N))) return !1;
            }
          }
          return !0;
        })(e, t, n, o)
    ...
    xa = (function (e) {
      ...
      return (
        ...
        (t.prototype.needsXScrolling = function () {
          ...
          for (
            var e = this.el, t = this.el.getBoundingClientRect().width - this.getYScrollbarWidth(), n = e.children, r = 0;
            r < n.length;
            r += 1
          ) {
        ...
        (t.prototype.needsYScrolling = function () {
          ...
          for (
            var e = this.el, t = this.el.getBoundingClientRect().height - this.getXScrollbarWidth(), n = e.children, r = 0;
            r < n.length;
            r += 1
          ) {
        ...
        (t.prototype.getXScrollbarWidth = function () {
          return ka.test(this.props.overflowX) ? 0 : this.el.offsetHeight - this.el.clientHeight;
        }),
        (t.prototype.getYScrollbarWidth = function () {
          return ka.test(this.props.overflowY) ? 0 : this.el.offsetWidth - this.el.clientWidth;
        }),
        t
      );
    })(xo),
  ...
  function Ha(e, t, n) {
    ...
    return 'function' == typeof t.content
      ...
      : mo(
          ...
          n.tableColGroupNode,
          mo('tbody', {}, 'function' == typeof t.rowContent ? t.rowContent(n) : t.rowContent)
        );
  }
  function Oa(e, t) {
    return Vt(e, t, Et);
  ...
  function Aa(e, t) {
    for (var n = [], r = 0, i = e; r < i.length; r++)
      for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
        n.push(mo('col', { style: { width: 'shrink' === a.width ? Ua(t) : a.width || '', minWidth: a.minWidth || '' } }));
  ...
  function Fa(e) {
    return mo('div', { className: 'fc-scrollgrid-sticky-shim', style: { width: e.clientWidth, minWidth: e.tableMinWidth } });
  }
  function za(e) {
    ...
    return (
      ...
      (t.prototype.renderSection = function (e, t) {
        return 'outerContent' in e
          ...
          : mo('tr', { key: e.key, className: Va(e, this.props.liquid).join(' ') }, this.renderChunkTd(e, t, e.chunk));
      }),
          ...
          return mo(
            ...
            function (t, o, i, a, s) {
              return mo(
                ...
                mo('div', { className: 'fc-event-main', ref: i, style: { color: s.textColor } }, a),
  ...
  function Ya(e) {
    return mo(
      ...
      mo(
        ...
        mo('div', { className: 'fc-event-title fc-sticky' }, e.event.title || mo(So, null, ' '))
      )
    );
  }
  var Za = function (e) {
    ...
    Ka = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(Vo, { hookProps: r, content: n.dayCellContent, defaultContent: e.defaultContent }, e.children);
        }),
        t
      );
    })(xo);
  function $a(e) {
    ...
    return r(r(r({ date: n.toDate(t), view: e.viewApi }, o), { dayNumberText: e.showDayNumber ? n.format(t, Xa) : '' }), e.extraProps);
  }
  var Ja = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return mo(zo, { hookProps: r, didMount: n.dayCellDidMount, willUnmount: n.dayCellWillUnmount, elRef: e.elRef }, function (t) {
  ...
  var es = function (e) {
    return mo(
      ...
      function (e, t, n, r, o) {
        return mo('div', { ref: e, className: ['fc-bg-event'].concat(t).join(' '), style: { backgroundColor: o.backgroundColor } }, r);
      }
    );
  };
  function ts(e) {
    return e.event.title && mo('div', { className: 'fc-event-title' }, e.event.title);
  }
  var ns = function (e) {
    return mo(_o.Consumer, null, function (t) {
      var n = t.dateEnv,
          ...
          return bo(
            mo(
              ...
              mo(
                ...
                mo('span', { className: 'fc-popover-close ' + e.getIconClass('close'), onClick: this.handleCloseClick })
              ),
              mo('div', { className: 'fc-popover-body ' + e.getClass('popoverContent') }, t.children)
            ),
            t.parentEl
          );
        }),
    ...
    is = (function (e) {
      function t() {
        ...
        return (
          (t.handleRootEl = function (e) {
            (t.rootEl = e),
              e ? t.context.registerInteractiveComponent(t, { el: e, useEventCenter: !1 }) : t.context.unregisterInteractiveComponent(t);
          }),
          t
        );
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(Ja, { date: o, dateProfile: a, todayRange: i, elRef: this.handleRootEl }, function (e, t, n) {
            return mo(
              os,
              {
                elRef: e,
              ...
              mo(Ka, { date: o, dateProfile: a, todayRange: i }, function (e, t) {
                return t && mo('div', { className: 'fc-more-popover-misc', ref: e }, t);
              }),
              r.children
            );
          });
      ...
      return (
        ...
        (o.handleRenderRequest = function () {
          if (o.isRendering) {
            ...
            var e = o.currentData;
            yo(
              mo(aa, { options: e.calendarOptions, theme: e.theme, emitter: e.emitter }, function (t, n, i, a) {
                return (
                  o.setClassNames(t),
                  o.setHeight(n),
                  mo(Wo.Provider, { value: o.customContentRenderId }, mo(ra, r({ isHeightAuto: i, forPrint: a }, e)))
                );
              }),
              o.el
            );
        ...
        new Ri({ optionOverrides: n, calendarApi: o, onAction: o.handleAction, onData: o.handleData }),
        o
      );
    }
    return (
    ...
    gs = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (hs += 1) && window.addEventListener('touchmove', ms, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener('mousedown', this.handleMouseDown),
            this.containerEl.removeEventListener('touchstart', this.handleTouchStart, { passive: !0 }),
            (hs -= 1) || window.removeEventListener('touchmove', ms, { passive: !1 });
        }),
        ...
        (e.prototype.cleanup = function () {
          (vs = !1), (this.isDragging = !1), (this.subjectEl = null), this.destroyScrollWatch();
        }),
  ...
  var ys = (function () {
      ...
      return (
        ...
        (e.prototype.updateElPosition = function () {
          this.sourceEl &&
            this.isVisible &&
            we(this.getMirrorEl(), { left: this.sourceElRect.left + this.deltaX, top: this.sourceElRect.top + this.deltaY });
        }),
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0 ? (this.everMovedUp = !0) : o > 0 && (this.everMovedDown = !0),
              ...
              this.isAnimating || ((this.isAnimating = !0), this.requestAnimation(bs()));
          }
        }),
        ...
        (r.delay = null),
          ...
          (r.onPointerMove = function (e) {
            if (r.isInteracting) {
              ...
              r.isDragging &&
                ('scroll' !== e.origEvent.type && (r.mirror.handleMove(e.pageX, e.pageY), r.autoScroller.handleMove(e.pageX, e.pageY)),
  ...
  var _s = (function () {
    ...
    return (
      ...
      (e.prototype.handleMove = function (e, t) {
        ...
        (!t && Ts(this.movingHit, n)) || ((this.movingHit = n), this.emitter.trigger('hitupdate', n, !1, e));
      }),
  ...
  function ks(e, t) {
    ...
    return (
      r(
        i,
        ((n = e),
        { date: (o = t.dateEnv).toDate(n.range.start), dateStr: o.formatIso(n.range.start, { omitTime: n.allDay }), allDay: n.allDay })
      ),
      i
    );
  }
        ...
        (n.handlePointerDown = function (e) {
          ...
          (n.handleDragEnd = function (e) {
            ...
            if (!n.dragging.pointer.wasTouchScroll) {
              ...
              if (i && a && Ts(i, a)) {
                var s = t.context,
                  l = r(r({}, ks(i.dateSpan, s)), { dayEl: i.dayEl, jsEvent: e.origEvent, view: s.viewApi || s.calendarApi.view });
      ...
      function t(t) {
        ...
        (n.dragSelection = null),
          ...
          (n.handleHitUpdate = function (e, t) {
            ...
            i ? o.dispatch({ type: 'SELECT_DATES', selection: i }) : t || o.dispatch({ type: 'UNSELECT_DATES' }),
              a ? He() : Oe(),
              t || (n.dragSelection = i);
          }),
              ...
              i === a || (d.editable && d.droppable)
                ? (s = (function (e, t, n) {
                    var r = e.dateSpan,
                      ...
                      s = {};
                    r.allDay !== o.allDay &&
                      ((s.allDay = o.allDay), (s.hasEnd = t.context.options.allDayMaintainDuration), o.allDay && (i = rt(i)));
                  ...
                  (c.mutatedEvents = l),
                  Sa(c, e.dateProfile, a) || ((u = !0), (s = null), (l = null), (c.mutatedEvents = { defs: {}, instances: {} })))
                : (a = null);
            }
            o.displayDrag(a, c),
              u ? He() : Oe(),
          ...
          if (o.isDragging) {
            ...
            if ((o.clearDrag(), t.emitter.trigger('eventDragStop', { el: o.subjectEl, event: c, jsEvent: e.origEvent, view: n }), s)) {
              if (a === t) {
                ...
                t.emitter.trigger('eventDrop', r(r(r({}, v), g), { el: e.subjectEl, delta: s.datesDelta, jsEvent: e.origEvent, view: n })),
                ...
                a.emitter.trigger('eventAdd', w),
                  ...
                  a.emitter.trigger(
                    'drop',
                    r(r({}, ks(f.dateSpan, a)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: f.context.viewApi })
                  ),
      ...
      (n.draggingSegEl = null),
        ...
        (n.handleDragStart = function (e) {
          ...
          (n.draggingSegEl = o),
            ...
            t.emitter.trigger('eventResizeStart', { el: o, event: new Cr(t, r.def, r.instance), jsEvent: e.origEvent, view: t.viewApi });
        }),
        (n.handleHitUpdate = function (e, t, r) {
          ...
          l &&
            ...
            (d.mutatedEvents = u),
            Sa(d, e.dateProfile, o) || ((c = !0), (l = null), (u = null), (d.mutatedEvents = null))),
            u ? o.dispatch({ type: 'SET_EVENT_RESIZE', state: d }) : o.dispatch({ type: 'UNSET_EVENT_RESIZE' }),
            c ? He() : Oe(),
            t || (l && Ts(a, e) && (l = null), (n.validMutation = l), (n.mutatedRelevantEvents = u));
        }),
        (n.handleDragEnd = function (e) {
          var t = n.component.context,
            o = n.eventRange.def,
          ...
          if (
            (t.emitter.trigger('eventResizeStop', { el: n.draggingSegEl, event: a, jsEvent: e.origEvent, view: t.viewApi }),
            n.validMutation)
          ) {
        ...
        (this.context = e),
          ...
          (this.onDocumentPointerDown = function (e) {
            var n = t.context.options.unselectCancel,
              r = e.origEvent.target;
            (t.matchesCancel = !!Se(r, n)), (t.matchesEvent = !!Se(r, Is.SELECTOR));
          }),
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ((s = (function (e, t, n) {
                  ...
                  var l = Mn(o, n),
                    u = l.refined,
                    c = l.extra,
                    d = Pn(u, c, t.sourceId, e.allDay, n.options.forceEventDuration || Boolean(t.duration), n),
                    p = e.range.start;
                ...
                (l = !Sa(u, e.dateProfile, a)) && ((u.mutatedEvents = { defs: {}, instances: {} }), (s = null)))),
              n.displayDrag(a, u),
          ...
          (this.handleDragEnd = function (e) {
            ...
            if ((n.clearDrag(), o && i)) {
              var a = n.hitDragging.finalHit,
                ...
                l = n.dragMeta;
              if (
                (o.emitter.trigger('drop', r(r({}, ks(a.dateSpan, o)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: s })),
                l.create)
              ) {
                var u = vn(i);
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              o = r.minDistance,
              i = r.longPressDelay;
            (t.minDistance = null != o ? o : e.isTouch ? 0 : on.eventDragMinDistance),
      ...
      return (
          ...
          return (
            ...
            mo(qo, { viewSpec: r.viewSpec }, function (e, t) {
              return mo(
                ...
                mo(ja, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: o })
              );
            })
          );
        }),
        (t.prototype.renderHScrollLayout = function (e, t, n, r) {
          ...
          return (
            ...
            l && u.push({ type: 'footer', key: 'footer', isSticky: !0, chunks: [{ key: 'main', content: Fa }] }),
  ...
  var Gs = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this.props,
          t = this.context.options.navLinks ? { 'data-navlink': Jr(e.date), tabIndex: 0 } : {};
        return mo(
          Ka,
          {
            date: e.date,
          ...
          function (n, o) {
            return (
              ...
              mo(
                ...
                mo('a', r({ className: 'fc-daygrid-day-number' }, t), o || mo(So, null, ' '))
              )
            );
          }
        );
  ...
  var Ys = nn({ hour: 'numeric', minute: '2-digit', omitZeroMinute: !0, meridiem: 'narrow' });
  function Zs(e) {
          ...
          return mo(
            ...
            function (t, n, o, i) {
              return mo(
                'a',
                r(
                  { className: ['fc-daygrid-event', 'fc-daygrid-dot-event'].concat(n).join(' '), ref: t },
  ...
  function $s(e) {
    return mo(
      So,
      null,
      mo('div', { className: 'fc-daygrid-event-dot', style: { borderColor: e.borderColor || e.backgroundColor } }),
      e.timeText && mo('div', { className: 'fc-event-time' }, e.timeText),
      mo('div', { className: 'fc-event-title' }, e.event.title || mo(So, null, ' '))
    );
  }
  var Js = (function (e) {
    function t() {
        ...
        return mo(
          as,
          {
            ...
            popoverContent: function () {
              var t =
                (e.eventDrag ? e.eventDrag.affectedInstances : null) || (e.eventResize ? e.eventResize.affectedInstances : null) || {};
              return mo(
                So,
                null,
                n.map(function (n) {
                  ...
                  return mo(
                    ...
                    Zs(n)
                      ? mo(
                          Ks,
                          r({ seg: n, isDragging: !1, isSelected: o === e.eventSelection, defaultDisplayEventEnd: !1 }, nr(n, e.todayRange))
                        )
                      : mo(
                          Xs,
                          r(
          ...
          function (e, t, n, r, o) {
            return mo('a', { ref: e, className: ['fc-daygrid-more-link'].concat(t).join(' '), onClick: o }, r);
          }
        );
      }),
      t
            ...
            function (e, n, i, u) {
              return mo(
                ...
                mo(
                  ...
                  t.showWeekNumber &&
                    mo(ns, { date: a, defaultFormat: el }, function (e, t, n, o) {
                      return mo('a', r({ ref: e, className: ['fc-daygrid-week-number'].concat(t).join(' ') }, l), o);
                    }),
                  !u &&
                    mo(Gs, {
                      date: a,
  ...
  function nl(e, t, n, r, o, i, a) {
    ...
    for (var l = [], u = [], c = 0; c < e.length; c += 1) {
      ...
      null != d ? l.push({ index: c, spanStart: R.firstCol, spanEnd: R.lastCol + 1, thickness: d }) : u.push(R);
    }
    for (
      var p = s.addSegs(l),
        f = (function (e, t, n) {
          for (
            ...
            for (var l = r[s], u = [], c = 0, d = 0, p = 0, f = l; p < f.length; p++) {
              ...
              u.push({ seg: rl(h, s, s + 1, n), isVisible: !0, isAbsolute: !1, absoluteTop: 0, marginTop: y.levelCoord - c }),
            ...
            for (var g = 0, m = l; g < m.length; g++) {
              ...
              (d += y.levelCoord - c),
                ...
                E
                  ...
                  : S &&
                    (v.push({ seg: rl(h, y.spanStart, y.spanEnd, n), isVisible: !0, isAbsolute: !1, absoluteTop: 0, marginTop: d }),
                    (d = 0));
            }
      ...
      for (var D = R.firstCol; D <= R.lastCol; D += 1)
        h[D].push({ seg: rl(R, D, D + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
    }
    for (D = 0; D < a.length; D += 1) m.push(0);
    for (var b = 0, C = p; b < C.length; b++) {
      var w = C[b],
        R = e[w.segInput.index];
      v[w.spanStart].push({ seg: R, isVisible: !1, isAbsolute: !0, absoluteTop: 0, marginTop: 0 });
      for (D = w.spanStart; D < w.spanEnd; D += 1)
        (m[D] += 1), h[D].push({ seg: rl(R, D, D + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
    }
          ...
          if (this.hiddenConsumes && s >= 0)
            for (var l = t.lateralStart; l < t.lateralEnd; l += 1) {
              ...
              if (this.allowReslicing) {
                var c = r(r({}, u), { spanStart: Math.max(u.spanStart, n.spanStart), spanEnd: Math.min(u.spanEnd, n.spanEnd) });
              ...
              D &&
                ...
                f.push(
                  mo(
                    ...
                    Zs(m)
                      ? mo(Ks, r({ seg: m, isDragging: i, isSelected: y === u, defaultDisplayEventEnd: d }, nr(m, n)))
                      : mo(
                          Xs,
                          r(
                            { seg: m, isDragging: i, isResizing: a, isDateSelecting: s, isSelected: y === u, defaultDisplayEventEnd: d },
                            nr(m, n)
                          )
                        )
                  )
          ...
          if (a)
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                mo(
                  'div',
                  { key: or(c.eventRange), className: 'fc-daygrid-bg-harness', style: d },
    ...
    function t() {
      ...
      return (
        ...
        (t.handleRootEl = function (e) {
          (t.rootEl = e),
            e
              ? t.context.registerInteractiveComponent(t, { el: e, isHitComboAllowed: t.props.isHitComboAllowed })
    ...
    return (
      ...
      (t.prototype.prepareHits = function () {
        (this.rowPositions = new co(
          ...
          (this.colPositions = new co(this.rootEl, this.rowRefs.currentMap[0].getCellEls(), !0, !1));
      }),
  ...
  var ll = (function (e) {
    ...
    cl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.buildDayTableModel = Ft(dl)), (t.headerRef = Eo()), (t.tableRef = Eo()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
          var e = this,
            ...
            a =
              n.dayHeaders &&
              mo(ha, { ref: this.headerRef, dateProfile: o.dateProfile, dates: i.headerDates, datesRepDistinctDays: 1 === i.rowCnt }),
            s = function (t) {
              return mo(ul, {
                ref: e.tableRef,
  ...
  var pl = Ho({
            ...
            return (
              ...
              (t.prototype.buildRenderRange = function (t, n, r) {
                var o,
                  ...
                  s = a.start,
                  l = a.end;
                (/^(year|month)$/.test(n) && ((s = i.startOfWeek(s)), (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = Xe(o, 1))),
                this.props.monthMode && this.props.fixedWeekCount) && (l = Xe(l, 6 - Math.ceil(Je(s, l))));
    ...
    hl = nn({ hour: 'numeric', minute: '2-digit', omitZeroMinute: !0, meridiem: 'short' });
  function vl(e) {
    var t = ['fc-timegrid-slot', 'fc-timegrid-slot-label', e.isLabeled ? 'fc-scrollgrid-shrink' : 'fc-timegrid-slot-minor'];
    return mo(_o.Consumer, null, function (n) {
      if (!e.isLabeled) return mo('td', { className: t.join(' '), 'data-time': e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a = null == o.slotLabelFormat ? hl : Array.isArray(o.slotLabelFormat) ? nn(o.slotLabelFormat[0]) : nn(o.slotLabelFormat),
        ...
        function (n, r, o, i) {
          return mo(
            ...
            mo(
              ...
              mo('div', { className: 'fc-timegrid-slot-label-cushion fc-scrollgrid-shrink-cushion', ref: o }, i)
            )
          );
        }
      );
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              a = Qe(i.start, i.end),
              s = o.navLinks && 1 === a ? { 'data-navlink': Jr(i.start, 'week'), tabIndex: 0 } : {};
            return o.weekNumbers && 'day' === e
              ? mo(ns, { date: i.start, defaultFormat: yl }, function (e, t, o, i) {
                  return mo(
                    'th',
                    ...
                    mo(
                      ...
                      mo(
                        'a',
                        r({ ref: o, className: 'fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner' }, s),
                        i
                      )
                    )
                  );
                })
              : mo('th', { className: 'fc-timegrid-axis' }, mo('div', { className: 'fc-timegrid-axis-frame', style: { height: n } }));
          }),
              ...
              function (t, n, r, o) {
                return mo(
                  ...
                  mo(
                    ...
                    mo('span', { className: 'fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner', ref: r }, o)
                  )
                );
              }
            );
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t, n) {
          ...
          return (
            ...
            t &&
              ...
              i.push({
                ...
                outerContent: mo(
                  ...
                  mo('td', { className: 'fc-timegrid-divider ' + r.theme.getClass('tableCellShaded') })
                ),
              })),
            i.push({
              type: 'body',
            ...
            mo(qo, { viewSpec: r.viewSpec, elRef: this.rootElRef }, function (e, t) {
              return mo(
                'div',
                { className: ['fc-timegrid'].concat(t).join(' '), ref: e },
                mo(ja, { liquid: !o.isHeightAuto && !o.forPrint, collapsibleWidth: o.forPrint, cols: [{ width: 'shrink' }], sections: i })
              );
            })
          );
        }),
        (t.prototype.renderHScrollLayout = function (e, t, n, r, o, i, a) {
            ...
            t &&
              ...
              f.push({
                ...
                outerContent: mo(
                  'tr',
                  { className: 'fc-scrollgrid-section' },
                  mo('td', { colSpan: 2, className: 'fc-timegrid-divider ' + u.theme.getClass('tableCellShaded') })
                ),
              }));
          ...
          return (
                      ...
                      mo(
                        ...
                        mo(pa, { unit: h ? 'minute' : 'day' }, function (e) {
                          ...
                          return 'number' == typeof t
                            ? mo(Za, { isAxis: !0, date: e }, function (e, n, r, o) {
                                return mo(
                                  'div',
                                  { ref: e, className: ['fc-timegrid-now-indicator-arrow'].concat(n).join(' '), style: { top: t } },
                                  o
                                );
                              })
                            : null;
            ...
            mo(qo, { viewSpec: u.viewSpec, elRef: this.rootElRef }, function (e, t) {
              return mo(
                'div',
                { className: ['fc-timegrid'].concat(t).join(' '), ref: e },
                mo(l, {
            ...
            e.slatMetas.map(function (i, a) {
              ...
              return mo(
                ...
                mo(
                  ...
                  function (e, t, n, r) {
                    return mo('td', { ref: e, className: l.concat(t).join(' '), 'data-time': i.isoTimeStr }, r);
                  }
                )
              );
            })
        ...
        (t.prototype.render = function () {
          ...
          return mo(
            ...
            mo(
              ...
              e.tableColGroupNode,
              mo(bl, { slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas })
            )
          );
        }),
        (t.prototype.componentDidMount = function () {
        ...
        return mo(
          ...
          function (n, r, o, i, a) {
            return mo(
              ...
              mo('div', { ref: o, className: 'fc-timegrid-more-link-inner fc-sticky' }, i)
            );
          }
        );
      }),
  ...
  function kl(e, t, n) {
    ...
    var i,
      ...
      u = (function (e) {
          ...
          n = Pl(
            ...
            function (o, i) {
              var a = xl(
                  (function (e, t, n) {
                    for (
                      var r = e.levelCoords, o = e.entriesByLevel, i = o[t][n], a = r[t] + i.thickness, s = r.length, l = t;
                      l < s && r[l] < a;
                      l += 1
                    );
                    for (; l < s; l += 1) {
                      for (
                        var u = o[l], c = void 0, d = Bi(u, i.spanStart, Wi), p = d[0] + d[1], f = p;
        ...
        return xl(t.length ? { level: 0, lateralStart: 0, lateralEnd: t[0].length } : null, n)[0];
      })(o);
    return (
      (i = u),
      (a = 1),
  ...
  var Nl = nn({ hour: 'numeric', minute: '2-digit', meridiem: !1 }),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            mo(qa, r({}, this.props, { defaultTimeFormat: Nl, extraClassNames: e }))
          );
        }),
        t
      );
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(
            ...
            function (e, t) {
              return t && mo('div', { className: 'fc-timegrid-col-misc', ref: e }, t);
            }
          );
        }),
        t
    ...
    Al = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.sortEventSegs = Ft(Kn)), (t.computeFgSegPlacements = Ft(kl)), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
            ...
            function (n, l, u) {
              return mo(
                ...
                mo(
                  ...
                  mo('div', { className: 'fc-timegrid-col-events' }, e.renderFgSegs(s, a)),
                  mo(
                    'div',
                    { className: 'fc-timegrid-col-events' },
                    e.renderFgSegs(i, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(o))
                  ),
                  mo('div', { className: 'fc-timegrid-now-indicator-container' }, e.renderNowIndicator(t.nowIndicatorSegs)),
                  mo(Ol, { date: t.date, dateProfile: t.dateProfile, todayRange: t.todayRange, extraHookProps: t.extraHookProps })
                )
              );
            }
          );
        ...
        (t.prototype.renderFgSegs = function (e, t, n, r, o) {
          var i = this.props;
          return i.forPrint ? Ul(e, i) : i.slatCoords ? this.renderPositionedFgSegs(e, t, n, r, o) : null;
        }),
          ...
          return mo(
            ...
            y.map(function (s) {
              var l = e[s.segInput.index],
                ...
                d = r(r({}, a.computeSegTopBottomCss(s.segInput)), v ? { left: 0, right: 0 } : a.computeSegLeftRightCss(s));
              return mo(
                'div',
                {
                ...
                mo(
                  Hl,
                  r(
                    { seg: l, isDragging: n, isResizing: o, isDateSelecting: i, isSelected: c === p, isShort: s.spanEnd - s.spanStart < u },
                    nr(l, f, h)
                  )
                )
              );
        ...
        (t.prototype.buildSegInputs = function (e) {
          for (
            var t = this.props, n = t.date, r = t.slatCoords, o = this.context.options.eventMinHeight, i = [], a = 0;
            a < e.length;
            a += 1
          ) {
            var s = e[a],
            ...
            i.push({ index: a, spanStart: Math.round(l), spanEnd: Math.round(u), thickness: 1 });
          }
          return i;
        }),
        (t.prototype.renderFillSegs = function (e, t) {
          ...
          var i = this.buildSegInputs(e).map(function (i) {
            ...
            return mo(
              'div',
              { key: or(a.eventRange), className: 'fc-timegrid-bg-harness', style: n.computeSegTopBottomCss(i) },
              'bg-event' === t ? mo(es, r({ seg: a }, nr(a, o.todayRange, o.nowDate))) : Qa(t)
            );
          });
          return mo(So, null, i);
        }),
        (t.prototype.renderNowIndicator = function (e) {
          ...
          return n
            ? e.map(function (e, t) {
                return mo(Za, { isAxis: !1, date: r, key: t }, function (t, o, i, a) {
                  return mo(
                    'div',
                    {
                      ref: t,
    ...
    return mo(
      ...
      e.map(function (e) {
        ...
        return mo(
          ...
          mo(Hl, r({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: t === i, isShort: !1 }, nr(e, n, o)))
        );
      })
    );
  }
                  ...
                  mo(
                    ...
                    mo(
                      ...
                      mo(
                        ...
                        { className: 'fc-timegrid-now-indicator-container' },
                        'number' == typeof n &&
                          mo(Za, { isAxis: !0, date: t.nowDate }, function (e, t, r, o) {
                            return mo(
                              'div',
                              { ref: e, className: ['fc-timegrid-now-indicator-arrow'].concat(t).join(' '), style: { top: n } },
                              o
                            );
                          })
                      )
  ...
  var Fl = (function (e) {
    ...
    zl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.buildDayRanges = Ft(Bl)), (t.slicer = new Fl()), (t.timeColsRef = Eo()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  var jl = [{ hours: 1 }, { minutes: 30 }, { minutes: 15 }, { seconds: 30 }, { seconds: 15 }];
    ...
    for (
      var i = new Date(0),
        ...
        l =
          ...
          (function (e) {
            var t, n, r;
            for (t = jl.length - 1; t >= 0; t -= 1) if (null !== (r = Ht((n = kt(jl[t])), e)) && r > 1) return n;
            return e;
          })(r),
        u = [];
      Nt(a) < Nt(t);
      ...
      var c = o.add(i, a),
        d = null !== Ht(s, l);
      u.push({ date: c, time: a, key: c.toISOString(), isoTimeStr: Lt(c), isLabeled: d }), (a = Mt(a, r)), (s = Mt(s, r));
    }
    return u;
  }
  var ql = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this,
          ...
          h =
            n.dayHeaders &&
            mo(ha, { dates: l.headerDates, dateProfile: s, datesRepDistinctDays: !0, renderIntro: p ? this.renderHeadAxis : null }),
          v =
            !1 !== n.allDaySlot &&
            function (t) {
              return mo(
  ...
  var Zl = Ho({
      ...
      views: {
        timeGrid: { component: ql, usesMinMaxTime: !0, allDaySlot: !0, slotDuration: '00:30:00', slotEventOverlap: !0 },
        ...
        (t.prototype.render = function () {
          ...
          return mo(
            ...
            function (e, n, r, o) {
              return mo(
                'tr',
                { ref: e, className: h.concat(n).join(' '), 'data-date': Ut(t) },
                mo('th', { colSpan: 3 }, mo('div', { className: 'fc-list-day-cushion ' + i.getClass('tableCellShaded'), ref: r }, o))
              );
            }
          );
        }),
  ...
  function Kl(e) {
    ...
    return mo(
      ...
      e.sideText && mo('a', r({ className: 'fc-list-day-side-text' }, t), e.sideText)
    );
  }
            ...
            function (e, o, i, a, s) {
              return mo(
                  ...
                  if (!1 !== r.displayEventTime) {
                    ...
                    if (
                      ...
                      return mo(
                        ...
                        function (e, t, n, r) {
                          return mo('td', { className: ['fc-list-event-time'].concat(t).join(' '), ref: e }, r);
                        }
                      );
                    }
                ...
                mo(
                  ...
                  mo('span', { className: 'fc-list-event-dot', style: { borderColor: s.borderColor || s.backgroundColor } })
                ),
  ...
  var tu = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return mo(qo, { viewSpec: n.viewSpec, elRef: this.setRootEl }, function (n, o) {
          return mo(
            'div',
            { ref: n, className: r.concat(o).join(' ') },
            mo(
              xa,
              { liquid: !t.isHeightAuto, overflowX: t.isHeightAuto ? 'visible' : 'hidden', overflowY: t.isHeightAuto ? 'visible' : 'auto' },
      ...
      (t.prototype.renderSegList = function (e, t) {
        ...
        return mo(pa, { unit: 'day' }, function (e, n) {
          ...
          return mo('table', { className: 'fc-list-table ' + o.getClass('table') }, mo('tbody', null, s));
        });
      }),
  ...
  var iu = Ho({
      ...
      views: {
        list: { component: tu, buttonTextKey: 'list', listDayFormat: { month: 'long', day: 'numeric', year: 'numeric' } },
  ...
  var uu = Ho({
          ...
          if (l) {
            var u = (function (e) {
              ...
              p = (function (e, t, n, o) {
                ...
                (i = r(r({}, n || {}), { key: t, timeMin: a, timeMax: s, singleEvents: !0, maxResults: 9999 })),
    ...
    eventSourceRefiners: { googleCalendarApiKey: String, googleCalendarId: String, googleCalendarApiBase: String, extraParams: fn },
  });
  return (
