    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), B(n) ? V(n) : n.l ? H(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
...
*/
  var nn = { 385: ['HR'] },
    tn = {
      HR: [
        null,
        [null, null, '(?:[24-69]\\d|3[0-79])\\d{7}|80\\d{5,7}|[1-79]\\d{7}|6\\d{5,6}', null, null, null, null, null, null, [6, 7, 8, 9]],
        [null, null, '1\\d{7}|(?:2[0-3]|3[1-5]|4[02-47-9]|5[1-3])\\d{6,7}', null, null, null, '12345678', null, null, [8, 9], [6, 7]],
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:62\\d?|72)\\d{6}', null, null, null, '62123456', null, null, [8, 9]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
