...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = M(n)), 0 < r.length ? r : (R(n, n.a.toString()), B(n) ? G(n) : n.l ? D(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return R(n, t), (t = M(n)), 0 < t.length ? t : B(n) ? G(n) : n.i.toString();
    }
    return D(n, t);
  }
  function G(n) {
...
*/
  var nn = { 377: ['MC'] },
    tn = {
      MC: [
        null,
        [null, null, '(?:(?:[349]|6\\d)\\d\\d|870)\\d{5}', null, null, null, null, null, null, [8, 9]],
