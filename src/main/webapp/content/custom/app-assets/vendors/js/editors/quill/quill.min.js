  ...
  return (function (t) {
          ...
          if (null != (e = arguments[h]))
            for (n in e)
              (r = u(f, n)),
                ...
                f !== o &&
                  (d && o && (a(o) || (i = l(o)))
                    ? (i ? ((i = !1), (c = r && l(r) ? r : [])) : (c = r && a(r) ? r : {}), s(f, { name: n, newValue: t(d, c, o) }))
              ...
              value: function (t, n, r, o) {
                n <= 0 ||
                  (y.default.query(r, y.default.Scope.BLOCK)
                    ...
                    : u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'formatAt', this).call(
                        this,
                        t,
                ...
                if (0 !== n.length) {
                  ...
                  i.length > 0 &&
                    (t < this.length() - 1 || null == this.children.tail
                      ? u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'insertAt', this).call(
                          this,
    ...
    function (t, e, n) {
      ...
      (s.prototype.insert = function (t, e) {
        ...
        return 0 === t.length
          ? this
          : ((n.insert = t), null != e && 'object' == typeof e && Object.keys(e).length > 0 && (n.attributes = e), this.push(n));
      }),
    ...
    function (t, e, n) {
      ...
      function l(t, e) {
        if (
          ((e = (0, N.default)(!0, { container: t, modules: { clipboard: !0, keyboard: !0, history: !0 } }, e)),
          ...
          return (
            ...
            (t.prototype.canAdd = function (t, e) {
              return (
                ...
                (null == this.whitelist ||
                  ('string' == typeof e ? this.whitelist.indexOf(e.replace(/["']/g, '')) > -1 : this.whitelist.indexOf(e) > -1))
              );
            }),
          ...
          return (
            ...
            (e.prototype.format = function (t, e) {
              ...
              n instanceof o.default
                ...
                : e && (null == n || (t === this.statics.blotName && this.formats()[t] === e) || this.replaceWith(t, e));
            }),
            ...
            s(t, [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    r instanceof Text
                      ? (s < r.data.length ? (f.setStart(r, s), f.setEnd(r, s + 1)) : (f.setStart(r, s - 1), f.setEnd(r, s), (v = 'right')),
              ...
              },
              {
                ...
                value: function () {
                  var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : v.default.sources.USER,
                    ...
                    i = r[1];
                  if (
                    ((this.lastRange = o), null != this.lastRange && (this.savedRange = this.lastRange), !(0, d.default)(e, this.lastRange))
                  ) {
                    var l;
              ...
              (s = 0),
                h.forEach(function (e, i) {
                  t
                    ...
                    : e.startsWith(n.TAB) &&
                      (a.deleteAt(c + s, n.TAB.length), (s -= n.TAB.length), 0 === i ? (r -= n.TAB.length) : (o -= n.TAB.length)),
                    (s += e.length + 1);
                }),
            ...
            (t.prototype.attribute = function (t, e) {
              e
                ? t.add(this.domNode, e) &&
                  (null != t.value(this.domNode) ? (this.attributes[t.attrName] = t) : delete this.attributes[t.attrName])
      ...
      var a = (function () {
        ...
        d = (function (t) {
          function e(t, n) {
            ...
            return (
              (r.selection = n), (r.textNode = document.createTextNode(e.CONTENTS)), r.domNode.appendChild(r.textNode), (r._length = 0), r
            );
          }
          return (
            l(e, t),
            ...
            u(e, [
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  null != r &&
                    ((this._length = e.CONTENTS.length), r.optimize(), r.formatAt(o, e.CONTENTS.length, t, n), (this._length = 0));
                },
              },
              {
                key: 'index',
                value: function (t, n) {
                  return t === this.textNode
                    ? 0
                    : s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'index', this).call(this, t, n);
                },
              },
              {
                key: 'length',
                ...
                value: function (t, e) {
                  ...
                  this.pickers = t.map(function (t) {
                    ...
                    if (t.classList.contains('ql-background') || t.classList.contains('ql-color')) {
                      ...
                      return (
                        null == t.querySelector('option') && s(t, T, 'background' === n ? '#ffffff' : '#000000'), new w.default(t, e[n])
                      );
                    }
                    return (
                    ...
                    if (null != e.files && null != e.files[0]) {
                      ...
                      (n.onload = function (n) {
                        ...
                        t.quill.updateContents(
                          new d.default().retain(r.index).delete(r.length).insert({ image: n.target.result }),
              ...
              value: function () {
                ...
                switch (this.root.getAttribute('data-mode')) {
                  case 'link':
                    ...
                    this.linkRange
                      ? (this.quill.formatText(this.linkRange, 'link', t, v.default.sources.USER), delete this.linkRange)
                ...
                var a = function (t, e) {
                    void 0 === e && (e = !0),
                      null != t &&
                        ...
                        (null == t.domNode[i.DATA_KEY].mutations && (t.domNode[i.DATA_KEY].mutations = []), e && a(t.parent));
                  },
                  s = function (t) {
    ...
    function (t, e) {
      ...
      function o(t, e) {
        for (
          var n = t.length, r = e.length, o = Math.ceil((n + r) / 2), l = o, a = 2 * o, s = new Array(a), u = new Array(a), c = 0;
          c < a;
          c++
        )
          (s[c] = -1), (u[c] = -1);
      ...
      function a(t, e) {
        ...
        for (var n = 0, r = Math.min(t.length, e.length), o = r, i = 0; n < o; )
          t.substring(t.length - o, t.length - i) == e.substring(e.length - o, e.length - i) ? ((n = o), (i = n)) : (r = o),
        ...
        return t.reduce(function (t, e) {
          ...
          if (
            (null == e.attributes ||
              ...
              ((e = (0, N.default)(e)),
              e.attributes.list ? (e.attributes.list = 'ordered') : ((e.attributes.list = 'bullet'), delete e.attributes.bullet)),
            'string' == typeof e.insert)
          ) {
    ...
    function (t, e) {
      ...
      Object.create && ((n.prototype = Object.create(null)), new n().__proto__ || (l = !1)),
        ...
        (o.prototype.removeAllListeners = function (t) {
          ...
          return (
            t
              ? ((e = l ? l + t : t), this._events[e] && (0 == --this._eventsCount ? (this._events = new n()) : delete this._events[e]))
              : ((this._events = new n()), (this._eventsCount = 0)),
            this
          );
        }),
            ...
            return (
              ...
              r.quill.on(p.default.events.EDITOR_CHANGE, function (t, e, n, o) {
                t !== p.default.events.TEXT_CHANGE ||
                  r.ignoreChange ||
                  (r.options.userOnly && o !== p.default.sources.USER ? r.transform(e) : r.record(e, n));
              }),
            ...
            l(e, [
              {
                ...
                value: function (t, n) {
                  ...
                  return 0 === n
                    ? (this.remove(t), !0)
                    : a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'add', this).call(this, t, n);
                },
              },
              {
                key: 'canAdd',
              ...
              [
                {
                  ...
                  value: function (t) {
                    var n = a(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(this, t);
                    return (
                      n.setAttribute('frameborder', '0'), n.setAttribute('allowfullscreen', !0), n.setAttribute('src', this.sanitize(t)), n
                    );
                  },
                },
                {
            ...
            a(e, null, [
              {
                ...
                value: function (t) {
                  ...
                  return (
                    'string' == typeof t &&
                      (window.katex.render(t, n, { throwOnError: !1, errorColor: '#f00' }), n.setAttribute('data-value', t)),
                    n
                  );
                },
              },
            ...
            h(e, [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (n) {
                    if (
                      ((n = n.slice('ql-'.length)), 'BUTTON' === t.tagName && t.setAttribute('type', 'button'), null == this.handlers[n])
                    ) {
                    ...
                    t.addEventListener(r, function (r) {
                      ...
                      if (null != e.handlers[n]) e.handlers[n].call(e, i);
                        ...
                        e.quill.updateContents(
                          new d.default().retain(u.index).delete(u.length).insert(o({}, n, i)),
