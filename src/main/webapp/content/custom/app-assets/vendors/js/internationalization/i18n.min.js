...
!(function (e, t) {
  ...
  var S = 'undefined' != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf('MSIE') > -1,
    L = (function (e) {
      function t(e) {
        var n,
          i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { ns: ['translation'], defaultNS: 'translation' };
        return (
          o(this, t),
              ...
              i
                ? (function e(t, n, o) {
                    for (var i in n)
                      '__proto__' !== i &&
                        (i in t
                          ? 'string' == typeof t[i] || t[i] instanceof String || 'string' == typeof n[i] || n[i] instanceof String
                            ? o && (t[i] = n[i])
                            : e(t[i], n[i], o)
                          : (t[i] = n[i]));
                    return t;
          ...
          },
          {
            ...
            value: function (t, o, i) {
              ...
              var a = void 0 !== o.keySeparator ? o.keySeparator : this.options.keySeparator,
                ...
                f = o.appendNamespaceToCIMode || this.options.appendNamespaceToCIMode;
              ...
              if (
                ...
                'boolean' != typeof d &&
                'number' != typeof d &&
                ['[object Number]', '[object Function]', '[object RegExp]'].indexOf(m) < 0 &&
                ...
                if (a) {
                  ...
                  for (var L in d)
                    if (Object.prototype.hasOwnProperty.call(d, L)) {
                      ...
                      (w[L] = this.translate(O, n({}, o, { joinArrays: !1, ns: l }))), w[L] === O && (w[L] = d[L]);
                    }
                  d = w;
                }
                ...
                if (C || R || j) {
                  ...
                  if ('fallback' === this.options.saveMissingTo && F && F[0]) for (var V = 0; V < F.length; V++) P.push(F[V]);
                  else
                    'all' === this.options.saveMissingTo
                      ? (P = this.languageUtils.toResolveHierarchy(o.lng || this.language))
                      : P.push(o.lng || this.language);
                  var T = function (e, t) {
                    r.options.missingKeyHandler
                      ? r.options.missingKeyHandler(e, c, t, j ? o.defaultValue : d, j, o)
                      : r.backendConnector &&
                        r.backendConnector.saveMissing &&
                        r.backendConnector.saveMissing(e, c, t, j ? o.defaultValue : d, j, o),
                ...
                (d = this.extendTranslation(d, t, o, h, i)),
                  C && d === u && this.options.appendNamespaceToMissingKey && (d = ''.concat(c, ':').concat(u)),
          ...
          },
          {
            ...
            value: function (e, t, o, i, r) {
              ...
              if (this.i18nFormat && this.i18nFormat.parse)
                e = this.i18nFormat.parse(e, o, i.usedLng, i.usedNS, i.usedKey, { resolved: i });
              else if (!o.skipInterpolation) {
                o.interpolation && this.interpolator.init(n({}, o, { interpolation: n({}, this.options.interpolation, o.interpolation) }));
                var s,
                  u = (o.interpolation && o.interpolation.skipOnVariables) || this.options.interpolation.skipOnVariables;
                if (u) {
                ...
                if (
                  (this.options.interpolation.defaultVariables && (c = n({}, this.options.interpolation.defaultVariables, c)),
              ...
              return (
                null != e &&
                  ...
                  (e = O.handle(g, e, t, this.options && this.options.postProcessPassResolved ? n({ i18nResolved: i }, o) : o, this)),
                e
              );
            },
          },
                        ...
                        !R[''.concat(g[0], '-').concat(e)] &&
                          ...
                          a.logger.warn(
                            'key "'
                              ...
                              .concat(g.join(', '), '" won\'t get resolved as namespace "')
                          ...
                          if (!a.isValidLookup(t)) {
                            ...
                            if (a.i18nFormat && a.i18nFormat.addLookupKeys) a.i18nFormat.addLookupKeys(g, l, n, e, s);
                              ...
                              p && (r = a.pluralResolver.getSuffix(n, s.count)),
                                p && f && g.push(c + r),
                                f && g.push((c += ''.concat(a.options.contextSeparator).concat(s.context))),
                                p && g.push((c += r));
            ...
            value: function (e, t) {
              ...
              function u(e, t) {
                ...
                try {
                  ...
                  return (
                    this.logger.warn('failed parsing options string in nesting for key '.concat(e), t), ''.concat(e).concat(o).concat(r)
                  );
                }
              ...
              for (s.applyPostProcessor = !1, delete s.defaultValue; (o = this.nestingRegexp.exec(e)); ) {
                ...
                'string' != typeof i && (i = d(i)),
                  i || (this.logger.warn('missed to resolve '.concat(o[1], ' for nesting ').concat(e)), (i = '')),
                  c &&
      ...
      r(t, [
        {
          ...
          value: function (e, t, n, o) {
            ...
            return (
              ...
              (r.length || a.length) && this.queue.push({ pending: a, loaded: {}, errors: [], callback: o }),
        ...
        },
        {
          ...
          value: function (e) {
            ...
            this.read(i, r, 'read', void 0, void 0, function (o, a) {
              o && t.logger.warn(''.concat(n, 'loading namespace ').concat(r, ' for language ').concat(i, ' failed'), o),
                !o && a && t.logger.log(''.concat(n, 'loaded namespace ').concat(r, ' for language ').concat(i), a),
                t.loaded(e, o, a);
            });
          },
        },
        {
          ...
          value: function (e, t, o, i, r) {
            ...
            this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(t)
              ? this.logger.warn(
                  'did not save key "'.concat(o, '" as the namespace "').concat(t, '" was not yet loaded'),
                  'This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!'
                )
              : null != o &&
                '' !== o &&
                (this.backend && this.backend.create && this.backend.create(e, t, o, i, null, n({}, a, { isUpdate: r })),
          ...
          value: function () {
            ...
            if (
              ...
              (s.logger = f),
                ...
                (s.backendConnector = new T(r(this.modules.backend), s.resourceStore, s, this.options)),
