    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = M(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? D(n, e) : n.i.toString()))
          : G(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), G(n);
  }
  function M(n) {
...
*/
  var nn = { 261: ['MG'] },
    tn = {
      MG: [
        null,
        [null, null, '[23]\\d{8}', null, null, null, null, null, null, [9], [7]],
        [
          null,
          null,
