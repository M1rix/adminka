    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (R(n, n.a.toString()), B(n) ? V(n) : n.l ? M(n, e) : n.i.toString()))
          : O(n);
    }
  }
  function I(n) {
...
*/
  var nn = { 57: ['CO'] },
    tn = {
      CO: [
        null,
        [null, null, '(?:1\\d|3)\\d{9}|[124-8]\\d{7}', null, null, null, null, null, null, [8, 10, 11], [7]],
        [null, null, '[124-8][2-9]\\d{6}', null, null, null, '12345678', null, null, [8], [7]],
