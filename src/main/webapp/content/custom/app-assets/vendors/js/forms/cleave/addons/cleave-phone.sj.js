!function () {
  function n(n, l) {
    ...
    for (var u; t.length && (u = t.shift()); ) t.length || void 0 === l ? (e = e[u] ? e[u] : (e[u] = {})) : (e[u] = l);
  }
  function l(n, l) {
    function t() {}
  ...
  function p(n, l) {
    for (var t = o(n.j()), e = 0; e < t.length; e++) {
      ...
      if (null != l.a[r]) {
        ...
        else (u = c(l, r)), i ? ((i = c(n, r)) ? p(i, u) : b(n, r, u.clone())) : b(n, r, u);
      }
    }
  }
  function c(n, l) {
...
*/
  ...
  function F(n, l) {
    for (var t = [], e = l.length - 3, u = n.f.length, r = 0; r < u; ++r) {
      var i = n.f[r];
      0 == m(i, 3) ? t.push(n.f[r]) : ((i = h(i, 3, Math.min(e, m(i, 3) - 1))), 0 == l.search(i) && t.push(n.f[r]));
    }
    n.f = t;
  }
  function C(n, l) {
    ...
    if (un.test(t) || (1 == n.i.b.length && en.test(t))) {
      var u,
        t = l;
      '+' == t ? ((u = t), n.u.a(t)) : ((u = tn[t]), n.u.a(u), n.a.a(u)), (l = u);
    } else (n.l = !1), (n.F = !0);
    if (!n.l) {
      if (!n.F)
        if (G(n)) {
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((t = P(n, l)), (u = D(n)), 0 < u.length ? u : (F(n, n.a.toString()), R(n) ? O(n) : n.l ? J(n, t) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var l = n.a.toString(), t = n.f.length, e = 0; e < t; ++e) {
      var u = n.f[e],
        r = g(u, 1);
      if (new RegExp('^(?:' + r + ')$').test(l)) return (n.B = pn.test(h(u, 4))), (l = l.replace(new RegExp(r, 'g'), h(u, 2))), J(n, l);
    }
    return '';
  }
  function J(n, l) {
  ...
  function M(n) {
    var l = n.a.toString();
    if (3 <= l.length) {
      for (var t = n.o && 0 == n.h.length && 0 < m(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], e = t.length, u = 0; u < e; ++u) {
        var r = t[u];
        (0 < n.h.length && A(g(r, 4)) && !h(r, 6) && null == r.a[5]) ||
          ((0 != n.h.length || n.o || A(g(r, 4)) || h(r, 6)) && fn.test(g(r, 2)) && n.f.push(r));
      }
      return F(n, l), (l = D(n)), 0 < l.length ? l : R(n) ? O(n) : n.i.toString();
    }
    return J(n, l);
  }
  function O(n) {
  ...
  function V(n) {
    var l,
      ...
      u = 0;
    return (
      1 != h(n.g, 10) ? (l = !1) : ((l = n.a.toString()), (l = '1' == l.charAt(0) && '0' != l.charAt(1) && '1' != l.charAt(1))),
      l
        ? ((u = 1), n.b.a('1').a(' '), (n.o = !0))
        : null != n.g.a[15] &&
          ((l = new RegExp('^(?:' + h(n.g, 15) + ')')),
          (l = t.match(l)),
          null != l && null != l[0] && 0 < l[0].length && ((n.o = !0), (u = l[0].length), n.b.a(t.substring(0, u)))),
      e(n.a),
      n.a.a(t.substring(u)),
      t.substring(0, u)
    );
  ...
  function G(n) {
    ...
    return (
      ...
      null != t[0] &&
      0 < t[0].length &&
      ((n.o = !0), (t = t[0].length), e(n.a), n.a.a(l.substring(t)), e(n.b), n.b.a(l.substring(0, t)), '+' != l.charAt(0) && n.b.a(' '), !0)
    );
  }
  function H(n) {
  ...
  (t.prototype.b = ''),
    ...
    (t.prototype.a = function (n, l, t) {
      if (((this.b += String(n)), null != l)) for (var e = 1; e < arguments.length; e++) this.b += arguments[e];
      return this;
    }),
  ...
  (y.prototype.j = function () {
    ...
    (S.prototype.b = function (n, l) {
      ...
      } else if (t === Number && 'string' == typeof l && ('Infinity' === l || '-Infinity' === l || 'NaN' === l || X.test(l)))
        return Number(l);
      return l;
    });
  var X = /^-?[0-9]+$/;
...
*/
  var nn = { 47: ['NO', 'SJ'] },
    ln = {
      NO: [
        null,
        [null, null, '(?:0|[2-9]\\d{3})\\d{4}', null, null, null, null, null, null, [5, 8]],
        ...
        [null, null, '85[0-5]\\d{5}', null, null, null, '85012345', null, null, [8]],
        'NO',
        47,
        '00',
        null,
        ...
        '[02-689]|7[0-8]',
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:0\\d|81(?:0(?:0[7-9]|1\\d)|5\\d\\d))\\d{3}', null, null, null, '01234'],
        null,
        null,
        [null, null, '81[23]\\d{5}', null, null, null, '81212345', null, null, [8]],
      ],
      SJ: [
        null,
        [null, null, '(?:0|(?:[4589]\\d|79)\\d\\d)\\d{4}', null, null, null, null, null, null, [5, 8]],
