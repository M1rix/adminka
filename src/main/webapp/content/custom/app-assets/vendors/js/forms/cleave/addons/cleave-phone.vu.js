...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = $(n)), 0 < r.length ? r : (C(n, n.a.toString()), F(n) ? M(n) : n.l ? D(n, e) : n.i.toString()))
          : U(n);
    }
  }
  function V(n) {
  ...
  function U(n) {
    ...
    if (3 <= t.length) {
      ...
      return C(n, t), (t = $(n)), 0 < t.length ? t : F(n) ? M(n) : n.i.toString();
    }
    return D(n, t);
  }
  function M(n) {
...
*/
  var nn = { 678: ['VU'] },
    tn = {
      VU: [
        null,
        [null, null, '(?:(?:[23]|(?:[57]\\d|90)\\d)\\d|[48]8)\\d{3}', null, null, null, null, null, null, [5, 7]],
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '90[1-9]\\d{4}', null, null, null, '9010123', null, null, [7]],
        'VU',
        678,
        '00',
        null,
