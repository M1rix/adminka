...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = $(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function D(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = $(n)), 0 < t.length ? t : R(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
...
*/
  var nn = { 247: ['AC'] },
    tn = {
      AC: [
        null,
        [null, null, '(?:[01589]\\d|[46])\\d{4}', null, null, null, null, null, null, [5, 6]],
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '[01589]\\d{5}', null, null, null, '542011', null, null, [6]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
