...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (l = D(n)), 0 < l.length ? l : (R(n, n.a.toString()), C(n) ? V(n) : n.l ? M(n, e) : n.i.toString()))
          : O(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), O(n);
  }
  function D(n) {
  ...
  function O(n) {
    ...
    if (3 <= t.length) {
      ...
      return R(n, t), (t = D(n)), 0 < t.length ? t : C(n) ? V(n) : n.i.toString();
    }
    return M(n, t);
  }
  function V(n) {
...
*/
  var nn = { 298: ['FO'] },
    tn = {
      FO: [
        null,
        [null, null, '(?:[2-8]\\d|90)\\d{4}', null, null, null, null, null, null, [6]],
