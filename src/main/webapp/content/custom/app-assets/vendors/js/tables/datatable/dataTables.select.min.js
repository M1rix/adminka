...
(function (h) {
        ...
        g = function (f, k, l) {
          f.append(
            h('<span class="select-item"/>').append(
              a.i18n('select.' + k + 's', { _: '%d ' + k + 's selected', 0: '', 1: '1 ' + k + ' selected' }, l)
            )
          );
        };
  ...
  function x(a, b) {
    if (b || 'single' === a._select.style)
      (a = new m.Api(a)), a.rows({ selected: !0 }).deselect(), a.columns({ selected: !0 }).deselect(), a.cells({ selected: !0 }).deselect();
  }
    ...
    if (!k || f)
      'os' === g
        ? a.ctrlKey || a.metaKey
          ...
          : ((a = b[d + 's']({ selected: !0 })), k && 1 === a.flatten().length ? b[d](e).deselect() : (a.deselect(), b[d](e).select()))
        : 'multi+shift' == g
        ? a.shiftKey
          ? 'cell' === d
            ? E(b, e, c._select_lastCell || null)
  ...
  function K(a, b) {
    return (-1 !== h.inArray('rows', b.limitTo) && a.rows({ selected: !0 }).any()) ||
      (-1 !== h.inArray('columns', b.limitTo) && a.columns({ selected: !0 }).any()) ||
  ...
  m.ext.selector.cell.push(function (a, b, c) {
    ...
    for (var e = 0, g = c.length; e < g; e++) {
      ...
      ((!0 === b && f._selected_cells && !0 === f._selected_cells[c[e].column]) ||
