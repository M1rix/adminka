    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((t = P(n, l)), (u = D(n)), 0 < u.length ? u : (F(n, n.a.toString()), B(n) ? M(n) : n.l ? T(n, t) : n.i.toString()))
          : Y(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), e(n.m), (n.w = ''), Y(n);
  }
  function D(n) {
    for (var l = n.a.toString(), t = n.f.length, e = 0; e < t; ++e) {
      var u = n.f[e],
        r = g(u, 1);
      if (new RegExp('^(?:' + r + ')$').test(l)) return (n.B = pn.test(h(u, 4))), (l = l.replace(new RegExp(r, 'g'), h(u, 2))), T(n, l);
    }
    return '';
  }
  function T(n, l) {
...
*/
  var nn = { 262: ['RE', 'YT'] },
    ln = {
      RE: [
        null,
        [null, null, '(?:26|[68]\\d)\\d{7}', null, null, null, null, null, null, [9]],
      ...
      YT: [
        null,
        [null, null, '(?:(?:26|63)9|80\\d)\\d{6}', null, null, null, null, null, null, [9]],
