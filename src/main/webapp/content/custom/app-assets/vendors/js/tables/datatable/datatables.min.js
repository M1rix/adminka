...
(function (k) {
  ...
  function O(a, b, c) {
    ...
    k.each(b, function (e, f) {
      ...
      d === q ||
        (!c && b[d] !== q) ||
        ('o' === d.charAt(0) ? (b[d] || (b[d] = {}), k.extend(!0, b[d], b[e]), O(a[d], b[d], c)) : (b[d] = b[e]));
    });
  }
  function ma(a) {
  ...
  function Fb(a) {
    ...
    for (b = h.length; l < b; l++) {
      ...
      a.oFeatures.bSort &&
        ...
        !1 !== n.bSortable && (m.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), eb(a, n.nTh, l)));
      ...
      if (0 !== n.length)
        ...
        (d = g.sZeroRecords),
          ...
          (c[0] = k('<tr/>', { class: f ? e[0] : '' }).append(
            k('<td />', { valign: 'top', colSpan: na(a), class: a.oClasses.sRowEmpty }).html(d)
          )[0]);
  ...
  function Ma(a, b, c) {
    ...
    n = {
      ...
      error: function (m, p, t) {
        ...
        -1 === k.inArray(!0, t) &&
          ('parsererror' == p ? ca(a, 0, 'Invalid JSON response', 1) : 4 === m.readyState && ca(a, 0, 'Ajax error', 7));
        U(a, !1);
      },
    };
    a.oAjaxData = b;
  ...
  function Kb(a) {
    ...
    var l = function () {
      ...
      m != e.sSearch &&
        (ya(a, { sSearch: m, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive }), (a._iDisplayStart = 0), fa(a));
    };
  ...
  function Fa(a) {
    ...
    if (a.scrollBarVis !== ha && a.scrollBarVis !== q) (a.scrollBarVis = ha), ra(a);
      ...
      '' === c
        ? ((D.width = '100%'),
          M && (r.find('tbody').height() > h.offsetHeight || 'scroll' == m.css('overflow-y')) && (D.width = K(r.outerWidth() - b)),
          (f = r.outerWidth()))
  ...
  function Ya(a) {
    ...
    if (d || (!t && !f && !e && h == na(a) && h == n.length))
      ...
      f && g
        ? h.width(g)
        : f
        ? (h.css('width', 'auto'), h.removeAttr('width'), h.width() < p.clientWidth && m && h.width(p.clientWidth))
        : e
  ...
  function ac(a, b) {
    for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++)
      (c = S(a, f, b, 'display') + ''), (c = c.replace(sc, '')), (c = c.replace(/&nbsp;/g, ' ')), c.length > d && ((d = c.length), (e = f));
    return e;
  }
  function K(a) {
    ...
    for (var d = 0, e = b.length; d < e; d++) {
      ...
      f.bSortable &&
        (0 < c.length && c[0].col == d
          ? (l.setAttribute('aria-sort', 'asc' == c[0].dir ? 'ascending' : 'descending'), (f = g[c[0].index + 1] || g[0]))
          : (f = g[0]),
  ...
  function ob(a, b, c, d) {
    ...
    c && a.oFeatures.bSortMulti
      ? ((c = k.inArray(b, T(e, '0'))),
        -1 !== c
          ? ((b = g(e[c], !0)), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : ((e[c][1] = f[b]), (e[c]._idx = b)))
  ...
  function dc(a, b, c) {
    ...
    b = function (h) {
      if (h && h.time) {
        ...
        if (
          -1 === k.inArray(!1, l) &&
          ((l = a.iStateDuration), !((0 < l && h.time < +new Date() - 1e3 * l) || (h.columns && f.length !== h.columns.length)))
        ) {
  ...
  function Ca(a, b) {
    ...
    b <= c
      ...
      : (a >= b - 1 - d ? (a = qa(b - (c - 2), b)) : ((a = qa(a - d + 2, a + d - 1)), a.push('ellipsis'), a.push(b - 1)),
      ...
      for (f = h.length; m < f; m++) {
        ...
        if ('table' === b) {
          ...
          for (g = v.length; x < g; x++)
            (t = v[x]), (t = 'cell' === b ? c.call(p, h[m], t.row, t.column, m, x) : c.call(p, h[m], t, m, x, l)), t !== q && e.push(t);
        }
      }
      return e.length || d
        ? ((a = new C(h, a ? e.concat.apply([], e) : e)), (b = a.selector), (b.rows = n.rows), (b.cols = n.cols), (b.opts = n.opts), a)
        : this;
    },
    lastIndexOf:
      N.lastIndexOf ||
  ...
  C.register = w = function (a, b) {
    if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) C.register(a[c], b);
      ...
      for (c = d.length; a < c; a++) {
        ...
        a === c - 1
          ? ((h.val = b), (h.type = 'function' === typeof b ? 'function' : k.isPlainObject(b) ? 'object' : 'other'))
    ...
    Va = function (a, b) {
      ...
      if ('current' == b) for (g = a._iDisplayStart, a = a.fnDisplayEnd(); g < a; g++) c.push(d[g]);
        ...
        for (g = 0, a = a.aoData.length; g < a; g++)
          'none' == f ? c.push(g) : ((e = k.inArray(g, d)), ((-1 === e && 'removed' == f) || (0 <= e && 'applied' == f)) && c.push(g));
      return c;
    },
    wc = function (a, b, c) {
      var d;
  ...
  var xc = function (a, b, c, d) {
        ...
        f = function (g, h) {
          if (Array.isArray(g) || g instanceof k) for (var l = 0, n = g.length; l < n; l++) f(g[l], h);
            ...
            g.nodeName && 'tr' === g.nodeName.toLowerCase()
              ? e.push(g)
              : ((l = k('<tr><td></td></tr>').addClass(h)), (k('td', l).addClass(h).html(g)[0].colSpan = na(a)), e.push(l[0]));
        };
      f(c, d);
    ...
    pc = function (a, b) {
      ...
      c.length &&
        a.length &&
        ((a = c[0].aoData[a[0]]), a._details && ((a._detailsShow = b) ? a._details.insertAfter(a.nTr) : a._details.detach(), yc(c[0])));
    },
    yc = function (a) {
      var b = new C(a),
        c = a.aoData;
      ...
      function (r) {
        ...
        if (null === r || r === q || A) {
          ...
          for (p = e.length; m < p; m++)
            for (h = e[m], t = 0; t < l; t++)
              (v = { row: h, column: t }), A ? ((x = d[h]), r(v, S(a, h, t), x.anCells ? x.anCells[t] : null) && n.push(v)) : n.push(v);
          return n;
        }
        ...
        k(a.nTable).on('order.dt.DT', function (e, f, g, h) {
          a === f &&
            ...
            b
              ...
              .removeClass(
                d.sSortJUIAsc + ' ' + d.sSortJUIDesc + ' ' + d.sSortJUI + ' ' + d.sSortJUIAscAllowed + ' ' + d.sSortJUIDescAllowed
              )
