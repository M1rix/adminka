...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (l = I(n)), 0 < l.length ? l : (R(n, n.a.toString()), D(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function C(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return R(n, t), (t = I(n)), 0 < t.length ? t : D(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
...
*/
  var nn = { 373: ['MD'] },
    tn = {
      MD: [
        null,
        [null, null, '(?:[235-7]\\d|[89]0)\\d{6}', null, null, null, null, null, null, [8]],
