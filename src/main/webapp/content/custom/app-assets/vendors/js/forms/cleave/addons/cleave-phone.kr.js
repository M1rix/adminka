  ...
  function p(n, t) {
    for (var e = o(n.j()), l = 0; l < e.length; l++) {
      ...
      if (null != t.a[i]) {
        ...
        else (r = c(t, i)), u ? ((u = c(n, i)) ? p(u, r) : $(n, i, r.clone())) : $(n, i, r);
      }
    }
  }
  function c(n, t) {
...
*/
  ...
  function B(n, t) {
    for (var e = [], l = t.length - 3, r = n.f.length, i = 0; i < r; ++i) {
      var u = n.f[i];
      0 == d(u, 3) ? e.push(n.f[i]) : ((u = h(u, 3, Math.min(l, d(u, 3) - 1))), 0 == t.search(u) && e.push(n.f[i]));
    }
    n.f = e;
  }
  function F(n, t) {
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (B(n, n.a.toString()), E(n) ? V(n) : n.l ? K(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), K(n, t);
    }
    return '';
  }
  function K(n, t) {
  ...
  function M(n) {
    var t = n.a.toString();
    if (3 <= t.length) {
      for (var e = n.o && 0 == n.h.length && 0 < d(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], l = e.length, r = 0; r < l; ++r) {
        var i = e[r];
        (0 < n.h.length && x(g(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || x(g(i, 4)) || h(i, 6)) && fn.test(g(i, 2)) && n.f.push(i));
      }
      return B(n, t), (t = D(n)), 0 < t.length ? t : E(n) ? V(n) : n.i.toString();
    }
    return K(n, t);
  }
  function V(n) {
      ...
      KR: [
        ...
        [
          ...
          [
            ...
            '(\\d{4})(\\d{4})',
            '$1-$2',
            ['1(?:5[246-9]|6[046-8]|8[03579])', '1(?:5(?:22|44|66|77|88|99)|6(?:[07]0|44|6[16]|88)|8(?:00|33|55|77|99))'],
            '$1',
            '0$CC-$1',
          ],
        ...
        [null, null, '15\\d{7,8}', null, null, null, '1523456789', null, null, [9, 10]],
        null,
        null,
        [null, null, '00(?:3(?:08|68\\d)|798\\d{1,3})\\d{6}', null, null, null, null, null, null, [11, 12, 13, 14]],
        [
          null,
          null,
