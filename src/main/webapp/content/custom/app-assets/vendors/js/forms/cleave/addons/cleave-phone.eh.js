...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((t = T(n, l)), (u = M(n)), 0 < u.length ? u : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? D(n, t) : n.i.toString()))
          : H(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), e(n.m), (n.w = ''), H(n);
  }
  function M(n) {
  ...
  function H(n) {
    ...
    if (3 <= l.length) {
      ...
      return F(n, l), (l = M(n)), 0 < l.length ? l : R(n) ? V(n) : n.i.toString();
    }
    return D(n, l);
  }
  function V(n) {
