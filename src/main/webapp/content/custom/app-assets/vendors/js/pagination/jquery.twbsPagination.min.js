...
!(function (o, e, t, s) {
  ...
  var i = o.fn.twbsPagination,
    r = function (t, s) {
      ...
      if (
        (this.options.beforePageClick instanceof Function && this.$element.first().on('beforePage', this.options.beforePageClick),
        ...
        return this.options.initiateStartPageClick && this.$element.trigger('page', 1), this;
      if (
        (this.options.href &&
          ((this.options.startPage = this.getPageFromQueryString()), this.options.startPage || (this.options.startPage = 1)),
      ...
      return (
        ...
        this.options.initiateStartPageClick
          ...
          : ((this.currentPage = this.options.startPage), this.render(this.getPages(this.options.startPage)), this.setupEvents()),
        this
      );
    };
  (r.prototype = {
    ...
    buildItem: function (t, s) {
      ...
      return (
        ...
        e.data('page', s),
        e.data('page-type', t),
        e.append(i.attr('href', this.makeHref(s)).addClass(this.options.anchorClass).html(a)),
        e
      );
    },
    getPages: function (t) {
      ...
      n > this.options.totalPages && (n = this.options.totalPages),
        i <= 0 && ((i = 1), (a = n)),
        a > this.options.totalPages && ((i = this.options.totalPages - n + 1), (a = this.options.totalPages));
