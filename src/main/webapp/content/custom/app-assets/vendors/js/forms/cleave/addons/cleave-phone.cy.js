...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (l = D(n)), 0 < l.length ? l : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? Y(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function $(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, r = 0; r < e; ++r) {
      var l = n.f[r],
        i = g(l, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(l, 4))), (t = t.replace(new RegExp(i, 'g'), h(l, 2))), Y(n, t);
    }
    return '';
  }
  function Y(n, t) {
...
*/
  var nn = { 357: ['CY'] },
    tn = {
      CY: [
        null,
        [null, null, '(?:[279]\\d|[58]0)\\d{6}', null, null, null, null, null, null, [8]],
