    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? M(n) : n.l ? H(n, e) : n.i.toString()))
          : U(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), U(n);
  }
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), H(n, t);
    }
    return '';
  }
  function H(n, t) {
...
*/
  var nn = { 36: ['HU'] },
    tn = {
      HU: [
        null,
        [null, null, '[2357]\\d{8}|[1-9]\\d{7}', null, null, null, null, null, null, [8, 9], [6, 7]],
        [
          null,
          null,
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '21\\d{7}', null, null, null, '211234567', null, null, [9]],
        'HU',
        36,
        '00',
        '06',
        ...
        [null, null, '38\\d{7}', null, null, null, '381234567', null, null, [9]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
