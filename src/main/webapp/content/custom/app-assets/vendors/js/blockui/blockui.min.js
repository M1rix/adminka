  ...
  function e(e) {
    function t(t, n) {
      ...
      if (((n = e.extend({}, e.blockUI.defaults, n || {})), !n.ignoreIfBlocked || !e(t).data('blockUI.isBlocked'))) {
        ...
        (g = e(
          ...
          n.theme && k
            ? ((U =
              ...
              n.title &&
                (U += '<div class="ui-widget-header ui-dialog-titlebar ui-corner-all blockTitle">' + (n.title || '&nbsp;') + '</div>'),
        ...
        if (
          (y && (n.theme ? w.find('.ui-widget-content').append(y) : w.append(y), (y.jquery || y.nodeType) && e(y).show()),
        ...
        if (
          (i(1, t, n),
          k ? ((p = w[0]), (b = e(n.focusableElements, p)), n.focusInput && setTimeout(l, 20)) : a(w[0], n.centerX, n.centerY),
          n.timeout)
        ) {
