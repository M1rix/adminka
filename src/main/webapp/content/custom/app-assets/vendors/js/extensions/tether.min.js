    ...
    var t = null,
      ...
      n = function i() {
        return 'undefined' != typeof e && e > 16
          ...
          : void (('undefined' != typeof t && b() - t < 10) || (null != o && (clearTimeout(o), (o = null)), (t = b()), D(), (e = b() - t)));
      };
            ...
            value: function () {
              ...
              if ('scroll-handle' === this.targetModifier) {
                ...
                var s = t.height - parseFloat(n.borderTopWidth) - parseFloat(n.borderBottomWidth) - r,
                  e = { width: 15, height: 0.975 * s * (s / o.scrollHeight), left: t.left + t.width - parseFloat(n.borderLeftWidth) - 15 },
                  f = 0;
                408 > s && this.target === document.body && (f = -11e-5 * Math.pow(s, 2) - 0.00727 * s + 22.58),
                  this.target !== document.body && (e.height = Math.max(e.height, 24));
                var l = this.target.scrollTop / (o.scrollHeight - s);
                return (
                  (e.top = l * (s - e.height - f) + t.top + parseFloat(n.borderTopWidth)),
                  this.target === document.body && (e.height = Math.max(e.height, 24)),
                  e
                );
              }
            ...
            value: function () {
              ...
              if (this.enabled) {
                ...
                var E = {
                  ...
                  S = void 0;
                return (
                  A.body.scrollWidth > T.innerWidth && ((S = this.cache('scrollbar-size', l)), (E.viewport.bottom -= S.height)),
                  A.body.scrollHeight > T.innerHeight && ((S = this.cache('scrollbar-size', l)), (E.viewport.right -= S.width)),
                  (-1 === ['', 'static'].indexOf(A.body.style.position) ||
                    -1 === ['', 'static'].indexOf(A.body.parentElement.style.position)) &&
                    ((E.page.bottom = A.body.scrollHeight - v - r), (E.page.right = A.body.scrollWidth - m - i)),
              ...
              if ('undefined' != typeof this.element.parentNode) {
                ...
                if (
                  ((o.page.top || o.page.bottom) && (o.page.left || o.page.right)
                    ...
                    : ((l.position = 'absolute'), u({ top: !0, left: !0 }, t.page)),
                  !d)
                ) {
        ...
        this.options.constraints.forEach(function (t) {
          ...
          ('target' === u || 'both' === u) &&
            ...
            'together' === u &&
              ('top' === v.top &&
                ('bottom' === y.top && o < b[1]
                  ...
                  : 'top' === y.top && o + s > b[3] && o - (s - d) >= b[1] && ((o -= s - d), (v.top = 'bottom'), (y.top = 'bottom'))),
              'bottom' === v.top &&
                ('top' === y.top && o + s > b[3]
                  ? ((o -= d), (v.top = 'top'), (o -= s), (y.top = 'bottom'))
                  : 'bottom' === y.top && o < b[1] && o + (2 * s - d) <= b[3] && ((o += s - d), (v.top = 'top'), (y.top = 'top'))),
              'middle' === v.top &&
                (o + s > b[3] && 'top' === y.top
                  ? ((o -= s), (y.top = 'bottom'))
            ...
            ('target' === h || 'both' === h) &&
              ...
              n + f > b[2] && 'right' === v.left && ((n -= p), (v.left = 'left'))),
            'together' === h &&
              (n < b[0] && 'left' === v.left
                ? 'right' === y.left
                ...
                : 'center' === v.left &&
                  (n + f > b[2] && 'left' === y.left
                    ? ((n -= f), (y.left = 'right'))
                    : n < b[0] && 'right' === y.left && ((n += f), (y.left = 'left')))),
            ('element' === u || 'both' === u) &&
              (o < b[1] && 'bottom' === y.top && ((o += s), (y.top = 'top')),
            ...
            ('element' === h || 'both' === h) &&
              ...
              n + f > b[2] &&
                ('left' === y.left ? ((n -= f), (y.left = 'right')) : 'center' === y.left && ((n -= f / 2), (y.left = 'right')))),
            'string' == typeof l
          ...
          o < b[1] && (l.indexOf('top') >= 0 ? ((o = b[1]), w.push('top')) : C.push('top')),
            ...
            (v.top !== i.top || v.left !== i.left || y.top !== e.attachment.top || y.left !== e.attachment.left) &&
