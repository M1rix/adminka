...
!(function (t, e) {
  ...
  function vt(e) {
    var r = { margin: null, limit: null, padding: null, animate: !0, animationDuration: 300, ariaFormat: l, format: l },
      n = {
        step: { r: !1, t: h },
  ...
  function j(t, b, o) {
    ...
    function N(t, e) {
      ...
      return (
            ...
            return (function (t, e) {
              ...
              if ((t.preventDefault(), p || c)) {
                var h = b.keyboardPageMultiplier,
                  ...
                  v = g[m];
                if (null === v) return !1;
                !1 === v && (v = y.getDefaultStep(x[e], c, b.keyboardDefaultStep)),
                  (u || l) && (v *= h),
                  (v = Math.max(v, 1e-7)),
                  (v *= c ? -1 : 1),
                  (s = S[e] + v);
        ...
        0 === e ? dt(n, b.cssClasses.handleLower) : e === b.handles - 1 && dt(n, b.cssClasses.handleUpper),
        r
      );
    }
    function V(t, e) {
    ...
    function L(m) {
      ...
      return (
        ...
        g.forEach(function (t, e) {
          ...
          for (
            h && (r = y.xNumSteps[e]), r || (r = d - f), void 0 === d && (d = f), r = Math.max(r, 1e-7), n = f;
            n <= d;
            ...
            (l = -1 < g.indexOf(n) ? st.PipsType.LargeValue : h ? st.PipsType.SmallValue : st.PipsType.NoValue),
              !e && b && n !== d && (l = 0),
    ...
    function T(e, i, o) {
      ...
      return (
        ...
        dt(s, 0 === b.ort ? b.cssClasses.pipsHorizontal : b.cssClasses.pipsVertical),
        Object.keys(e).forEach(function (t) {
          !(function (t, e, r) {
      ...
      var e = function (t) {
          ...
          return (
            ...
            !((e.classList ? e.classList.contains(r) : new RegExp('\\b' + r + '\\b').test(e.className)) && !a.doNotReject) &&
              ...
              (!a.hover || !n.buttons) &&
              (f || n.preventDefault(), (n.calcPoint = n.points[b.ort]), void s(n, a)))
          );
        },
        r = [];
      return (
    ...
    function B(t, e) {
      e.handle && (ht(e.handle, b.cssClasses.active), (m -= 1)),
        ...
        0 === m && (ht(d, b.cssClasses.drag), Q(), t.cursor && ((E.style.cursor = ''), E.removeEventListener('selectstart', ut))),
    ...
    function q(t, e) {
      if (!e.handleNumbers.some(U)) {
        ...
        var n = [],
          ...
          o = H(p.end, w, B, { target: t.target, handle: r, listeners: n, doNotReject: !0, handleNumbers: e.handleNumbers }),
    ...
    function $(t, e, r, n, i, o) {
      ...
      return (
        1 < u.length &&
          ...
          (n && 0 < e && ((s = y.getAbsoluteDistance(t[e - 1], b.margin, !1)), (r = Math.max(r, s))),
          i && e < u.length - 1 && ((s = y.getAbsoluteDistance(t[e + 1], b.margin, !0)), (r = Math.min(r, s)))),
        1 < u.length &&
          b.limit &&
          (n && 0 < e && ((s = y.getAbsoluteDistance(t[e - 1], b.limit, !1)), (r = Math.min(r, s))),
          i && e < u.length - 1 && ((s = y.getAbsoluteDistance(t[e + 1], b.limit, !0)), (r = Math.max(r, s)))),
        b.padding &&
          (0 === e && ((s = y.getAbsoluteDistance(0, b.padding[0], !1)), (r = Math.max(r, s))),
          e === u.length - 1 && ((s = y.getAbsoluteDistance(100, b.padding[1], !0)), (r = Math.min(r, s)))),
    ...
    dt((e = d), b.cssClasses.target),
      ...
      0 === b.ort ? dt(e, b.cssClasses.horizontal) : dt(e, b.cssClasses.vertical),
      dt(e, 'rtl' === getComputedStyle(e).direction ? b.cssClasses.textDirectionRtl : b.cssClasses.textDirectionLtr),
      (l = C(e, b.cssClasses.base)),
      (function (t, e) {
        var r = C(e, b.cssClasses.connects);
        (u = []), (s = []).push(V(r, t[0]));
        for (var n = 0; n < b.handles; n++) u.push(N(e, n)), (h[n] = n), s.push(V(r, t[n + 1]));
      })(b.connect, l),
      (c = b.events).fixed ||
        u.forEach(function (t, e) {
          ...
          if (!1 !== e && 0 !== r && r !== s.length - 1) {
            ...
            dt(e, b.cssClasses.draggable),
              ...
              t.forEach(function (t) {
                H(p.start, t, q, { handles: [n, i], handleNumbers: [r - 1, r], connect: e });
              });
          }
        }),
      rt(b.start),
  ...
  (st.create = z), (st.cssClasses = u), (st.default = H), Object.defineProperty(st, '__esModule', { value: !0 });
});
