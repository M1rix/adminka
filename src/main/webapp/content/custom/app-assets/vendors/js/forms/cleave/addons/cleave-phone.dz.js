...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = I(n)), 0 < r.length ? r : (R(n, n.a.toString()), D(n) ? Z(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function C(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return R(n, t), (t = I(n)), 0 < t.length ? t : D(n) ? Z(n) : n.i.toString();
    }
    return M(n, t);
  }
  function Z(n) {
...
*/
  var nn = { 213: ['DZ'] },
    tn = {
      DZ: [
        null,
        [null, null, '(?:[1-4]|[5-79]\\d|80)\\d{7}', null, null, null, null, null, null, [8, 9]],
        ...
        [null, null, '98[23]\\d{6}', null, null, null, '983123456', null, null, [9]],
        'DZ',
        213,
        '00',
        '0',
