...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((t = Q(n, l)), (u = D(n)), 0 < u.length ? u : (R(n, n.a.toString()), $(n) ? G(n) : n.l ? M(n, t) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var l = n.a.toString(), t = n.f.length, e = 0; e < t; ++e) {
      var u = n.f[e],
        r = g(u, 1);
      if (new RegExp('^(?:' + r + ')$').test(l)) return (n.B = pn.test(h(u, 4))), (l = l.replace(new RegExp(r, 'g'), h(u, 2))), M(n, l);
    }
    return '';
  }
  function M(n, l) {
    ...
    if (3 <= l.length) {
      for (var t = n.o && 0 == n.h.length && 0 < m(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], e = t.length, u = 0; u < e; ++u) {
        ...
        (0 < n.h.length && N(g(r, 4)) && !h(r, 6) && null == r.a[5]) ||
          ((0 != n.h.length || n.o || N(g(r, 4)) || h(r, 6)) && fn.test(g(r, 2)) && n.f.push(r));
      }
      return R(n, l), (l = D(n)), 0 < l.length ? l : $(n) ? G(n) : n.i.toString();
    }
    return M(n, l);
  }
  function G(n) {
...
*/
  var nn = { 599: ['CW', 'BQ'] },
    ln = {
      BQ: [
        null,
        [null, null, '(?:[34]1|7\\d)\\d{5}', null, null, null, null, null, null, [7]],
      ...
      CW: [
        null,
        [null, null, '(?:[34]1|60|(?:7|9\\d)\\d)\\d{5}', null, null, null, null, null, null, [7, 8]],
        ...
        null,
        [null, null, '955\\d{5}', null, null, null, '95581234', null, null, [8]],
        1,
        '[69]',
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
