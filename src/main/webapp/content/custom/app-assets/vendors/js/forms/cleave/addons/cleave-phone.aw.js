...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (l = D(n)), 0 < l.length ? l : (C(n, n.a.toString()), F(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function $(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return C(n, t), (t = D(n)), 0 < t.length ? t : F(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
...
*/
  var nn = { 297: ['AW'] },
    tn = {
      AW: [
        null,
        [null, null, '(?:[25-79]\\d\\d|800)\\d{4}', null, null, null, null, null, null, [7]],
