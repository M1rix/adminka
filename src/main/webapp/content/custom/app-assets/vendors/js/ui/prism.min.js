            ...
            for (var l in e)
              e.hasOwnProperty(l) &&
                ...
                'Object' !== n.util.type(e[l]) || r[n.util.objId(e[l])]
                  ? 'Array' !== n.util.type(e[l]) || r[n.util.objId(e[l])] || ((r[n.util.objId(e[l])] = !0), n.languages.DFS(e[l], t, l, r))
...
(Prism.languages.css = {
  ...
  Prism.languages.markup &&
    (Prism.languages.insertBefore('markup', 'tag', {
      style: { pattern: /(<style[\w\W]*?>)[\w\W]*?(?=<\/style>)/i, lookbehind: !0, inside: Prism.languages.css, alias: 'language-css' },
    }),
...
!(function (e) {
  ...
  e.languages.insertBefore('ruby', 'keyword', {
    regex: [
      { pattern: /%r([^a-zA-Z0-9\s\{\(\[<])(?:[^\\]|\\[\s\S])*?\1[gim]{0,3}/, inside: { interpolation: n } },
      { pattern: /%r\((?:[^()\\]|\\[\s\S])*\)[gim]{0,3}/, inside: { interpolation: n } },
      { pattern: /%r\{(?:[^#{}\\]|#(?:\{[^}]+\})?|\\[\s\S])*\}[gim]{0,3}/, inside: { interpolation: n } },
      { pattern: /%r\[(?:[^\[\]\\]|\\[\s\S])*\][gim]{0,3}/, inside: { interpolation: n } },
      { pattern: /%r<(?:[^<>\\]|\\[\s\S])*>[gim]{0,3}/, inside: { interpolation: n } },
      { pattern: /(^|[^\/])\/(?!\/)(\[.+?]|\\.|[^\/\r\n])+\/[gim]{0,3}(?=\s*($|[\r\n,.;})]))/, lookbehind: !0 },
    ...
    (e.languages.ruby.string = [
      { pattern: /%[qQiIwWxs]?([^a-zA-Z0-9\s\{\(\[<])(?:[^\\]|\\[\s\S])*?\1/, inside: { interpolation: n } },
      { pattern: /%[qQiIwWxs]?\((?:[^()\\]|\\[\s\S])*\)/, inside: { interpolation: n } },
      { pattern: /%[qQiIwWxs]?\{(?:[^#{}\\]|#(?:\{[^}]+\})?|\\[\s\S])*\}/, inside: { interpolation: n } },
      { pattern: /%[qQiIwWxs]?\[(?:[^\[\]\\]|\\[\s\S])*\]/, inside: { interpolation: n } },
      { pattern: /%[qQiIwWxs]?<(?:[^<>\\]|\\[\s\S])*>/, inside: { interpolation: n } },
...
(Prism.languages.css.selector = {
  ...
  Prism.languages.insertBefore('css', 'function', { hexcode: /#[\da-f]{3,6}/i, entity: /\\[\da-f]{1,8}/i, number: /[\d%\.]+/ });
Prism.languages.git = {
  comment: /^#.*/m,
  deleted: /^[-–].*/m,
  inserted: /^\+.*/m,
...
(Prism.languages.php = Prism.languages.extend('clike', {
  ...
  Prism.languages.markup &&
    ...
    Prism.hooks.add('wrap', function (e) {
      'php' === e.language &&
        'markup' === e.type &&
        (e.content = e.content.replace(/(\{\{\{PHP[0-9]+\}\}\})/g, '<span class="token php">$1</span>'));
    }),
...
!(function (e) {
  ...
  e.languages.insertBefore('sass', 'property', {
    'variable-line': { pattern: /^[ \t]*\$.+/m, inside: { punctuation: /:/, variable: a, operator: t } },
    'property-line': {
      pattern: /^[ \t]*(?:[^:\s]+ *:.*|:[^:\s]+.*)/m,
      inside: {
...
(Prism.languages.scss = Prism.languages.extend('css', {
  ...
  Prism.languages.insertBefore('scss', 'property', { variable: /\$[-_\w]+|#\{\$[-_\w]+\}/ }),
      ...
      a.grammar &&
        ...
        (Prism.languages.DFS(a.grammar, function (a, r, l) {
          t.indexOf(l) > -1 &&
            ...
            'attr-value' == l ? Prism.languages.insertBefore('inside', 'punctuation', { 'url-link': i }, r) : (r.inside['url-link'] = i),
            ...
            (i.onreadystatechange = function () {
              4 == i.readyState &&
                (i.status < 400 && i.responseText
                  ? ((l.textContent = i.responseText), Prism.highlightElement(l))
                  : (l.textContent =
                      i.status >= 400
                        ? '✖ Error ' + i.status + ' while fetching file: ' + i.statusText
...
!(function () {
    ...
    Array.prototype.slice.call(document.querySelectorAll('pre[data-jsonp]')).forEach(function (t) {
      ...
      (d.src = f.href),
        (window[u] = function (n) {
          ...
          null === o
            ? (e.textContent = 'Cannot parse response (perhaps you need an adapter function?)')
  ...
  if (self.Prism && self.document && document.querySelectorAll && [].filter) {
    var r = [];
    (Prism.plugins.jsonphighlight = { registerAdapter: t, removeAdapter: n, highlight: a }),
      t(function (t) {
        if (t && t.meta && t.data) {
    ...
    var e = {
      ...
      t = function (a, n, t) {
        var u = function () {
            ...
            if (
              (i || (i = c[a] = {}),
              n && (i.success_callbacks || (i.success_callbacks = []), i.success_callbacks.push(n)),
              t && (i.error_callbacks || (i.error_callbacks = []), i.error_callbacks.push(t)),
              !e && Prism.languages[a])
            )
              l(a);
...
!(function () {
  ...
  if ('undefined' != typeof self && self.Prism && self.document) {
    ...
    (e.prototype = {
      ...
      (Prism.plugins.NormalizeWhitespace = new e({ 'remove-trailing': !0, 'remove-indent': !0, 'left-trim': !0, 'right-trim': !0 })),
      Prism.hooks.add('before-highlight', function (e) {
        var n = e.element.parentNode;
        ...
        var n = function (e, o) {
          for (var t = 0, d = e.childNodes.length; d > t; t++) {
            ...
            if (1 === r.nodeType) {
              ...
              3 === r.nodeType &&
                (!o.nodeStart && o.pos + r.data.length > o.node.posOpen && ((o.nodeStart = r), (o.nodeStartPos = o.node.posOpen - o.pos)),
                o.nodeStart && o.pos + r.data.length >= o.node.posClose && ((o.nodeEnd = r), (o.nodeEndPos = o.node.posClose - o.pos)),
                (o.pos += r.data.length));
