...
var hljs = (function () {
  ...
  const d = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)',
    ...
    b = function (e, n, t = {}) {
      ...
      return (
        a.contains.push(m), a.contains.push({ className: 'doctag', begin: '(?:TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):', relevance: 0 }), a
      );
    },
    v = b('//', '$'),
    x = b('/\\*', '\\*/'),
      ...
      computed: {
        ...
        highlighted() {
          if (!this.autoDetect && !hljs.getLanguage(this.language))
            return (
              console.warn(`The language "${this.language}" you specified could not be found.`), (this.unknownLanguage = !0), t(this.code)
            );
          let e;
          return (
            this.autoDetect
              ? ((e = hljs.highlightAuto(this.code)), (this.detectedLanguage = e.language))
              : ((e = hljs.highlight(this.language, this.code, this.ignoreIllegals)), (this.detectectLanguage = this.language)),
            e.value
          );
        },
        autoDetect() {
        ...
        if (((m = r), 'begin' === r.type))
          return (function (e) {
            ...
            return (
              ...
              r.skip ? (L += t) : (r.excludeBegin && (L += t), u(), r.returnBegin || r.excludeBegin || (L = t)),
              h(r),
    ...
    function E(e) {
      ...
      const t = (function (e) {
        ...
        if (t) {
          var r = y(t[1]);
          return (
            r || (console.warn(d.replace('{}', t[1])), console.warn('Falling back to no-highlight mode for this block.', e)),
            r ? t[1] : 'no-highlight'
          );
        }
      ...
      (a.value = x(a.value)),
        ...
        a.second_best &&
          (e.second_best = { language: a.second_best.language, re: a.second_best.relevance, relavance: a.second_best.relevance });
    }
    const w = () => {
      if (!w.called) {
        w.called = !0;
          ...
          },
          {
            ...
            starts: {
              ...
              contains: [
                ...
                { className: 'variable', begin: '[\\$%]\\{', end: '\\}', contains: ['self', { className: 'number', begin: '[\\$%]\\d+' }] },
                n,
...
hljs.registerLanguage(
  ...
  (function () {
    ...
    return function (e) {
      ...
      Object.assign(s, {
        className: 'variable',
        variants: [{ begin: /\$[\w\d#@][\w\d_]*/ }, { begin: /\$\{/, end: /\}/, contains: [{ begin: /:-/, contains: [s] }] }],
      });
      ...
      t.contains.push(n);
      const a = { begin: /\$\(\(/, end: /\)\)/, contains: [{ begin: /\d+#[0-9a-f]+/, className: 'number' }, e.NUMBER_MODE, s] },
      ...
      return {
        ...
        contains: o.concat([
          ...
          },
          {
            begin: /[:\(,=]\s*/,
            relevance: 0,
            contains: [{ className: 'function', begin: '(\\(.*\\))?\\s*\\B[-=]>', end: '[-=]>', returnBegin: !0, contains: [l] }],
          },
          {
            className: 'class',
            beginKeywords: 'class',
  ...
  (function () {
    ...
    return function (e) {
      var n = {
        ...
        o = { className: 'string', begin: /\$@"/, end: '"', contains: [{ begin: '{{' }, { begin: '}}' }, { begin: '""' }, l] },
      ...
      (l.contains = [o, c, s, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.C_BLOCK_COMMENT_MODE]),
        (r.contains = [g, c, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.inherit(e.C_BLOCK_COMMENT_MODE, { illegal: /\n/ })]);
      ...
      return {
        ...
        contains: [
          e.COMMENT('///', '$', {
            returnBegin: !0,
            contains: [
              { className: 'doctag', variants: [{ begin: '///', relevance: 0 }, { begin: '\x3c!--|--\x3e' }, { begin: '</?', end: '>' }] },
            ],
          }),
          e.C_LINE_COMMENT_MODE,
          e.C_BLOCK_COMMENT_MODE,
          ...
          { beginKeywords: 'namespace', end: /[{;=]/, illegal: /[^\s:]/, contains: [i, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE] },
          { beginKeywords: 'record', end: /[{;=]/, illegal: /[^\s:]/, contains: [i, E, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE] },
          {
            className: 'meta',
            begin: '^\\s*\\[',
            excludeBegin: !0,
  ...
  (function () {
    ...
    return function (e) {
      var t =
        ...
        i = { className: 'meta', begin: '@[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*', contains: [{ begin: /\(/, end: /\)/, contains: ['self'] }] },
        r = e => a('[', e, ']+([', e, '_]*[', e, ']+)?'),
        c = {
          className: 'number',
          variants: [
  ...
  (function () {
    ...
    return function (t) {
      ...
      var b = E.contains.concat([
          { begin: /\(/, end: /\)/, contains: ['self'].concat(E.contains, [t.C_BLOCK_COMMENT_MODE, t.C_LINE_COMMENT_MODE]) },
            ...
            l,
            {
              ...
              contains: [
                ...
                { className: 'type', begin: /</, end: />/, keywords: 'reified', relevance: 0 },
                {
                  ...
                  relevance: 0,
                  contains: [
                    { begin: /:/, end: /[=,\/]/, endsWithParent: !0, contains: [o, e.C_LINE_COMMENT_MODE, c], relevance: 0 },
                    e.C_LINE_COMMENT_MODE,
                    c,
                    r,
                    l,
    ...
    return function (e) {
      ...
      return {
        ...
        contains: [
          ...
          a,
          r,
          { className: 'meta', begin: /^\.PHONY:/, end: /$/, keywords: { $pattern: /[\.\w]+/, 'meta-keyword': '.PHONY' } },
          s,
        ],
      };
    };
              ...
              contains: [
                {
                  className: 'string',
                  endsParent: !0,
                  variants: [{ begin: /"/, end: /"/, contains: [n] }, { begin: /'/, end: /'/, contains: [n] }, { begin: /[^\s"'=<>`]+/ }],
                },
              ],
            },
          ],
        ...
        contains: [
          {
            ...
            contains: [
              ...
              t,
              s,
              { begin: '\\[', end: '\\]', contains: [{ className: 'meta', begin: '<![a-z]', end: '>', contains: [a, s, i, t] }] },
            ],
          },
        ...
        t = {
          ...
          variants: [
            ...
            { begin: /\B\?(\\\d{1,3}|\\x[A-Fa-f0-9]{1,2}|\\u[A-Fa-f0-9]{4}|\\?\S)\b/ },
            {
              begin: /<<[-~]?'?(\w+)(?:.|\n)*?\n\s*\1\b/,
              returnBegin: !0,
              contains: [{ begin: /<<[-~]?'?/ }, e.END_SAME_AS_BEGIN({ begin: /(\w+)/, end: /(\w+)/, contains: [e.BACKSLASH_ESCAPE, c] })],
            },
          ],
        },
        ...
        e.C_BLOCK_COMMENT_MODE,
        {
          ...
          contains: [
            ...
            },
            {
              ...
              contains: [t, i, e.CSS_NUMBER_MODE, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, { className: 'meta', begin: '!important' }],
            },
            { begin: '@(page|font-face)', lexemes: '@[a-z-]+', keywords: '@page @font-face' },
            {
              begin: '@',
              ...
              returnBegin: !0,
              keywords: 'and or not only',
              contains: [{ begin: '@[a-z-]+', className: 'keyword' }, t, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, i, e.CSS_NUMBER_MODE],
            },
          ],
        }
      );
  ...
  (function () {
    ...
    return function (r) {
      var t = {
        ...
        c = { begin: 'html`', end: '', starts: { end: '`', returnEnd: !1, contains: [r.BACKSLASH_ESCAPE, o], subLanguage: 'xml' } },
        l = { begin: 'css`', end: '', starts: { end: '`', returnEnd: !1, contains: [r.BACKSLASH_ESCAPE, o], subLanguage: 'css' } },
      ...
      var d = { begin: '\\(', end: /\)/, keywords: t, contains: ['self', r.QUOTE_STRING_MODE, r.APOS_STRING_MODE, r.NUMBER_MODE] },
        u = {
          className: 'params',
          begin: /\(/,
          end: /\)/,
