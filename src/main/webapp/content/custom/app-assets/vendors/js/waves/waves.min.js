...
!(function (t, e) {
  ...
  function l(t) {
    ...
    return '[object String]' === n
      ? o(t)
      : a(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(n) && t.hasOwnProperty('length')
      ? t
      : a((e = t)) && 0 < e.nodeType
      ? [t]
      : [];
  ...
  function d(t) {
    ...
    return (
      ...
      { top: a.top + e.pageYOffset - r.clientTop, left: a.left + e.pageXOffset - r.clientLeft }
    );
  }
  function m(t) {
    var e = '';
  ...
  var f = {
      ...
      hide: function (t, e) {
        ...
        s && (e.removeEventListener('touchend', f.hide), e.removeEventListener('touchcancel', f.hide)),
    ...
    u = {
      ...
      img: function (t) {
        ...
        ('i' === n.tagName.toLowerCase() && n.classList.contains('waves-effect')) ||
          ((e = document.createElement('i')), n.replaceChild(e, t), e.appendChild(t));
      },
    };
  function i(t, e, n) {
    var o, a, i, r, s, u;
    n &&
      ...
      (s = 350 - (Date.now() - Number(n.getAttribute('data-hold')))) < 0 && (s = 0),
    ...
    if (null !== r) {
      ...
      c.registerEvent(e),
        'touchstart' === e.type && f.delay
          ...
          : (f.show(e, r),
            s && (r.addEventListener('touchend', f.hide, !1), r.addEventListener('touchcancel', f.hide, !1)),
    ...
    (e.attach = function (t, e) {
      ...
      for (var a = 0, i = t.length; a < i; a++)
        (o = (n = t[a]).tagName.toLowerCase()),
          -1 !== ['input', 'img'].indexOf(o) && (u[o](n), (n = n.parentElement)),
      ...
      if ((((e = e || {}).wait = e.wait || 0), (e.position = e.position || null), n))
        for (
          ...
          (o.x = c.left + u.x),
            ...
            (i.pageY = o.y),
            f.show(i, s),
            0 <= e.wait && null !== e.wait && setTimeout(r({ type: 'mouseup', button: 1 }, s), e.wait);
        }
    }),
    (e.calm = function (t) {
      for (var e = { type: 'mouseup', button: 1 }, n = 0, o = (t = l(t)).length; n < o; n++) f.hide(e, t[n]);
    }),
