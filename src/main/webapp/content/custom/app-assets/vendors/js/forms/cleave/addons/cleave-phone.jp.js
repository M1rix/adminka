  ...
  function p(n, t) {
    for (var e = o(n.j()), l = 0; l < e.length; l++) {
      ...
      if (null != t.a[i]) {
        ...
        else (r = c(t, i)), u ? ((u = c(n, i)) ? p(u, r) : m(n, i, r.clone())) : m(n, i, r);
      }
    }
  }
  function c(n, t) {
...
*/
  ...
  function F(n, t) {
    for (var e = [], l = t.length - 3, r = n.f.length, i = 0; i < r; ++i) {
      var u = n.f[i];
      0 == g(u, 3) ? e.push(n.f[i]) : ((u = h(u, 3, Math.min(l, g(u, 3) - 1))), 0 == t.search(u) && e.push(n.f[i]));
    }
    n.f = e;
  }
  function C(n, t) {
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? M(n) : n.l ? P(n, e) : n.i.toString()))
          : J(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), J(n);
  }
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = d(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), P(n, t);
    }
    return '';
  }
  function P(n, t) {
    ...
    if (3 <= t.length) {
      for (var e = n.o && 0 == n.h.length && 0 < g(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], l = e.length, r = 0; r < l; ++r) {
        ...
        (0 < n.h.length && A(d(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || A(d(i, 4)) || h(i, 6)) && fn.test(d(i, 2)) && n.f.push(i));
      }
  ...
  var nn = { 81: ['JP'] },
    tn = {
      JP: [
        ...
        [null, null, '50[1-9]\\d{7}', null, null, null, '5012345678', null, null, [10]],
        'JP',
        81,
        '010',
        '0',
        ...
        [null, null, '20\\d{8}', null, null, null, '2012345678', null, null, [10]],
        null,
        null,
        [null, null, '00(?:(?:37|66)\\d{4,11}|777(?:[01]|(?:5|8\\d)\\d)|882[1245]\\d\\d)\\d\\d'],
        [null, null, '570\\d{6}', null, null, null, '570123456', null, null, [9]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
