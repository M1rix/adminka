...
*/
  ...
  function I(l, n) {
    for (var u = [], t = n.length - 3, e = l.f.length, r = 0; r < e; ++r) {
      var i = l.f[r];
      0 == g(i, 3) ? u.push(l.f[r]) : ((i = h(i, 3, Math.min(t, g(i, 3) - 1))), 0 == n.search(i) && u.push(l.f[r]));
    }
    l.f = u;
  }
  function R(l, n) {
    ...
    switch (l.u.b.length) {
      ...
      default:
        return l.A
          ...
          : 0 < l.f.length
          ? ((u = q(l, n)), (e = C(l)), 0 < e.length ? e : (I(l, l.a.toString()), G(l) ? J(l) : l.l ? M(l, u) : l.i.toString()))
          : D(l);
    }
  }
  function F(l) {
    return (l.l = !0), (l.A = !1), (l.f = []), (l.s = 0), t(l.m), (l.w = ''), D(l);
  }
  function C(l) {
    for (var n = l.a.toString(), u = l.f.length, t = 0; t < u; ++t) {
      var e = l.f[t],
        r = d(e, 1);
      if (new RegExp('^(?:' + r + ')$').test(n)) return (l.B = fl.test(h(e, 4))), (n = n.replace(new RegExp(r, 'g'), h(e, 2))), M(l, n);
    }
    return '';
  }
  function M(l, n) {
  ...
  function D(l) {
    var n = l.a.toString();
    if (3 <= n.length) {
      for (var u = l.o && 0 == l.h.length && 0 < g(l.g, 20) ? c(l.g, 20) || [] : c(l.g, 19) || [], t = u.length, e = 0; e < t; ++e) {
        var r = u[e];
        (0 < l.h.length && A(d(r, 4)) && !h(r, 6) && null == r.a[5]) ||
          ((0 != l.h.length || l.o || A(d(r, 4)) || h(r, 6)) && sl.test(d(r, 2)) && l.f.push(r));
      }
      return I(l, n), (n = C(l)), 0 < n.length ? n : G(l) ? J(l) : l.i.toString();
    }
    return M(l, n);
  }
  function J(l) {
...
*/
  var ll = { 44: ['GB', 'GG', 'IM', 'JE'] },
    nl = {
      GB: [
        null,
        [null, null, '[1-357-9]\\d{9}|[18]\\d{8}|8\\d{6}', null, null, null, null, null, null, [7, 9, 10], [4, 5, 6, 8]],
        [
          null,
          null,
        ...
        [null, null, '56\\d{8}', null, null, null, '5612345678', null, null, [10]],
        'GB',
        44,
        '00',
        '0',
        ...
        null,
        [null, null, '76(?:0[0-2]|2[356]|4[0134]|5[49]|6[0-369]|77|81|9[39])\\d{6}', null, null, null, '7640123456', null, null, [10]],
        1,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:3[0347]|55)\\d{8}', null, null, null, '5512345678', null, null, [10]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
      GG: [
        null,
        [null, null, '(?:1481|[357-9]\\d{3})\\d{6}|8\\d{6}(?:\\d{2})?', null, null, null, null, null, null, [7, 9, 10], [6]],
        [null, null, '1481[25-9]\\d{5}', null, null, null, '1481256789', null, null, [10], [6]],
      ...
      IM: [
        null,
        [null, null, '(?:1624|(?:[3578]\\d|90)\\d\\d)\\d{6}', null, null, null, null, null, null, [10], [6]],
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:3(?:(?:08162|3\\d{4}|7(?:0624|2299))\\d|4(?:40[49]06|5624\\d))|55\\d{5})\\d{3}', null, null, null, '5512345678'],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
      JE: [
        null,
        [null, null, '(?:1534|(?:[3578]\\d|90)\\d\\d)\\d{6}', null, null, null, null, null, null, [10], [6]],
        ...
        null,
        null,
        [null, null, '76(?:0[0-2]|2[356]|4[0134]|5[49]|6[0-369]|77|81|9[39])\\d{6}', null, null, null, '7640123456'],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [
