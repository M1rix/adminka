...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (R(n, n.a.toString()), E(n) ? V(n) : n.l ? M(n, e) : n.i.toString()))
          : O(n);
    }
  }
  function I(n) {
  ...
  function O(n) {
    ...
    if (3 <= t.length) {
      ...
      return R(n, t), (t = D(n)), 0 < t.length ? t : E(n) ? V(n) : n.i.toString();
    }
    return M(n, t);
  }
  function V(n) {
...
*/
  var nn = { 591: ['BO'] },
    tn = {
      BO: [
        null,
        [null, null, '(?:[2-467]\\d{3}|80017)\\d{4}', null, null, null, null, null, null, [8, 9], [7]],
        [
          null,
          null,
