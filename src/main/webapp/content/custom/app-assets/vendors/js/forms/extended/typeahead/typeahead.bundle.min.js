    ...
    var b = (function () {
      ...
      c = (function () {
        ...
        function e() {
          ...
          return (
            b.isMsie() &&
              b.mixin(a.input, { backgroundImage: 'url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)' }),
            a
          );
        }
        var f = {
            ...
            update: function (b) {
              ...
              function d(c) {
                (c = c || []),
                  !f &&
                    h < e.limit &&
                    ((e.cancel = a.noop), (h += c.length), e._append(b, c.slice(0, e.limit - h)), e.async && e.trigger('asyncReceived', b));
              }
              var e = this,
                f = !1,
                g = !1,
      ...
      j = (function () {
        ...
        return (
          b.mixin(a.prototype, i.prototype, {
            ...
            setLanguageDirection: function (a) {
              return (
                this.$node.css('ltr' === a ? this.css.ltr : this.css.rtl), c.setLanguageDirection.apply(this, [].slice.call(arguments, 0))
              );
            },
            _hide: function () {
              this.$node.hide();
            ...
            close: function () {
              return (
                this.isOpen() &&
                  ...
                  (this.menu.close(), this.input.clearHint(), this.input.resetInputValue(), this.eventBus.trigger('close')),
                !this.isOpen()
              );
            },
            setVal: function (a) {
