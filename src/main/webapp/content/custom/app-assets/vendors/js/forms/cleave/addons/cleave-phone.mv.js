    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = M(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? G(n) : n.l ? V(n, e) : n.i.toString()))
          : D(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), D(n);
  }
  function M(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), V(n, t);
    }
    return '';
  }
  function V(n, t) {
...
*/
  var nn = { 960: ['MV'] },
    tn = {
      MV: [
        null,
        [null, null, '(?:800|9[0-57-9]\\d)\\d{7}|[34679]\\d{6}', null, null, null, null, null, null, [7, 10]],
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '4[05]0\\d{4}', null, null, null, '4001234', null, null, [7]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
