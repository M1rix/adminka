...
*/
  ...
  function F(n, t) {
    for (var e = [], l = t.length - 3, r = n.f.length, u = 0; u < r; ++u) {
      var i = n.f[u];
      0 == d(i, 3) ? e.push(n.f[u]) : ((i = h(i, 3, Math.min(l, d(i, 3) - 1))), 0 == t.search(i) && e.push(n.f[u]));
    }
    n.f = e;
  }
  function C(n, t) {
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), B(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        u = g(r, 1);
      if (new RegExp('^(?:' + u + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(u, 'g'), h(r, 2))), M(n, t);
    }
    return '';
  }
  function M(n, t) {
    ...
    if (3 <= t.length) {
      for (var e = n.o && 0 == n.h.length && 0 < d(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], l = e.length, r = 0; r < l; ++r) {
        ...
        (0 < n.h.length && A(g(u, 4)) && !h(u, 6) && null == u.a[5]) ||
          ((0 != n.h.length || n.o || A(g(u, 4)) || h(u, 6)) && fn.test(g(u, 2)) && n.f.push(u));
      }
      return F(n, t), (t = D(n)), 0 < t.length ? t : B(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
...
*/
  var nn = { 54: ['AR'] },
    tn = {
      AR: [
        null,
        [null, null, '(?:11|(?:[2368]|9\\d)\\d)\\d{8}', null, null, null, null, null, null, [10, 11], [6, 7, 8]],
        [
          null,
          null,
        ...
        [null, null, '810\\d{7}', null, null, null, '8101234567', null, null, [10]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
