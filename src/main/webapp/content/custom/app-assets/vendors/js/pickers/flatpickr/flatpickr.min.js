  ...
  function E(p, v) {
        ...
        (function (e) {
          ...
          if (void 0 !== a.value && 2 === a.value.length) {
            var f = a === w.hourElement,
              m = a === w.minuteElement;
            u < i
              ? ((u = l + u + r(!f) + (r(f) && r(!w.amPM))), m && j(void 0, -1, w.hourElement))
              : u > l && ((u = a === w.hourElement ? u - l - r(!w.amPM) : i), m && j(void 0, 1, w.hourElement)),
              w.amPM &&
                f &&
    ...
    function S() {
      if (void 0 !== w.hourElement && void 0 !== w.minuteElement) {
        ...
        var o =
          ...
          (w.config.minDate && w.minDateHasTime && w.latestSelectedDateObj && 0 === M(w.latestSelectedDateObj, w.config.minDate, !0));
        if (
          void 0 !== w.config.maxTime ||
          (w.config.maxDate && w.maxDateHasTime && w.latestSelectedDateObj && 0 === M(w.latestSelectedDateObj, w.config.maxDate, !0))
        ) {
    ...
    function H(e, t, n, a) {
      ...
      return (
        ...
        i
          ? ((o.tabIndex = -1),
            ve(t) &&
              ...
              'range' === w.config.mode &&
                (d(o, 'startRange', w.selectedDates[0] && 0 === M(t, w.selectedDates[0], !0)),
        ...
        'range' === w.config.mode &&
          (function (e) {
            return (
              !('range' !== w.config.mode || w.selectedDates.length < 2) && M(e, w.selectedDates[0]) >= 0 && M(e, w.selectedDates[1]) <= 0
            );
          })(t) &&
          !ve(t) &&
        ...
        w.weekNumbers &&
          ...
          'prevMonthDay' !== e &&
          n % 7 == 1 &&
          w.weekNumbers.insertAdjacentHTML('beforeend', "<span class='flatpickr-day'>" + w.config.getWeek(t) + '</span>'),
        pe('onDayCreate', o),
        o
      );
    }
    ...
    function W(e) {
      for (var t = e > 0 ? 0 : w.config.showMonths - 1, n = e > 0 ? w.config.showMonths : -1, a = t; a != n; a += e)
        for (
          var i = w.daysContainer.children[a], o = e > 0 ? 0 : i.children.length - 1, r = e > 0 ? i.children.length : -1, l = o;
          l != r;
          l += e
        ) {
          var c = i.children[l];
    ...
    function R(e, t) {
      ...
      void 0 === a
        ...
        ? (function (e, t) {
            for (
              var n = -1 === e.className.indexOf('Month') ? e.dateObj.getMonth() : w.currentMonth,
              ...
              for (
                var r = w.daysContainer.children[o],
                  l = n - w.currentMonth === o ? e.$i + t : t < 0 ? r.children.length - 1 : 0,
                  c = r.children.length,
                  d = l;
                d >= 0 && d < c && d != (t > 0 ? c : -1);
                d += i
    ...
    function G(e, t) {
      ...
      (n < 0 && !0 === w._hidePrevMonthArrow) ||
        ...
        (w.currentMonth < 0 || w.currentMonth > 11) &&
          ((w.currentYear += w.currentMonth > 11 ? 1 : -1), (w.currentMonth = (w.currentMonth + 12) % 12), pe('onYearChange'), K()),
        J(),
        pe('onMonthChange'),
        De());
    }
      ...
      if (w.isOpen && !w.config.inline) {
        ...
        i &&
          ...
          (void 0 !== w.timeContainer &&
            ...
            I(),
          w.close(),
          w.config && 'range' === w.config.mode && 1 === w.selectedDates.length && (w.clear(!1), w.redraw()));
      }
    }
    function Q(e) {
    ...
    function X(e, t) {
      ...
      if (
        (w.config.minDate && a && M(a, w.config.minDate, void 0 !== t ? t : !w.minDateHasTime) < 0) ||
        (w.config.maxDate && a && M(a, w.config.maxDate, void 0 !== t ? t : !w.maxDateHasTime) > 0)
      )
        return !1;
      if (!w.config.enable && 0 === w.config.disable.length) return !0;
      if (void 0 === a) return !1;
      for (
        var i = !!w.config.enable, o = null !== (n = w.config.enable) && void 0 !== n ? n : w.config.disable, r = 0, l = void 0;
        r < o.length;
        r++
      ) {
        ...
        switch (e.keyCode) {
          ...
          case 39:
            if (r || n) w.hourElement && w.hourElement.focus();
              ...
              (e.preventDefault(), void 0 !== w.daysContainer && (!1 === a || (document.activeElement && ee(document.activeElement))))
            ) {
          ...
          case 40:
            ...
            (w.daysContainer && void 0 !== t.$i) || t === w.input || t === w.altInput
              ...
              ? Q(w.currentYear - c)
              : w.config.enableTime && (!r && w.hourElement && w.hourElement.focus(), I(e), w._debouncedChange());
            break;
          case 9:
            if (r) {
                ...
                return g
                  ...
                  : (['startRange', 'inRange', 'endRange', 'notAllowed'].forEach(function (e) {
                    ...
                    void (
                      ...
                      m >= r &&
                        (0 === l || m <= l) &&
                        ((d = n), (u = t), (c = m) > Math.min(d, u) && c < Math.max(d, u)) &&
    ...
    function oe(e) {
      return function (t) {
        ...
        void 0 !== n &&
          (w['min' === e ? 'minDateHasTime' : 'maxDateHasTime'] = n.getHours() > 0 || n.getMinutes() > 0 || n.getSeconds() > 0),
          w.selectedDates &&
    ...
    function le() {
      'object' != typeof w.config.locale &&
        ...
        (w.l10n = e(
          e({}, T.l10ns.default),
          'object' == typeof w.config.locale ? w.config.locale : 'default' !== w.config.locale ? T.l10ns[w.config.locale] : void 0
        )),
      ...
      if (void 0 !== t) {
        ...
        if (
          ...
          i || 'range' === w.config.mode || 1 !== w.config.showMonths
            ? void 0 !== w.selectedDateElem && void 0 === w.hourElement && w.selectedDateElem && w.selectedDateElem.focus()
            : L(n),
      ...
      w.config.noCalendar ||
        ...
        (w.yearElements.forEach(function (e, t) {
          ...
          n.setMonth(w.currentMonth + t),
            w.config.showMonths > 1 || 'static' === w.config.monthSelectorType
              ? (w.monthElements[t].textContent = h(n.getMonth(), w.config.shorthandCurrentMonth, w.l10n) + ' ')
    ...
    function be(e) {
      void 0 === e && (e = !0),
        void 0 !== w.mobileInput &&
          w.mobileFormatStr &&
          (w.mobileInput.value = void 0 !== w.latestSelectedDateObj ? w.formatDate(w.latestSelectedDateObj, w.mobileFormatStr) : ''),
        ...
        (w.element = w.input = p),
          ...
          (function () {
            ...
            if (i.altInput && (i.enableTime || r) && !i.altFormat) {
              ...
              o.altFormat =
                i.noCalendar || r ? 'h:i' + (i.enableSeconds ? ':S K' : ' K') : d + ' h:i' + (i.enableSeconds ? ':S' : '') + ' K';
            }
          ...
          (function () {
            ...
            (w.minDateHasTime =
              !!w.config.minDate &&
              (w.config.minDate.getHours() > 0 || w.config.minDate.getMinutes() > 0 || w.config.minDate.getSeconds() > 0)),
              (w.maxDateHasTime =
                !!w.config.maxDate &&
                (w.config.maxDate.getHours() > 0 || w.config.maxDate.getMinutes() > 0 || w.config.maxDate.getSeconds() > 0));
          })(),
          (w.utils = {
          ...
          w.isMobile ||
            (function () {
              ...
              w.config.static ||
                w.config.inline ||
                (void 0 !== w.config.appendTo ? w.config.appendTo : window.document.body).appendChild(w.calendarContainer);
            })(),
          (function () {
            w.config.wrap &&
            ...
            if (w.isMobile)
              return void (function () {
                ...
                (w.mobileInput = s('input', w.input.className + ' flatpickr-mobile')),
                  ...
                  w.selectedDates.length > 0 &&
                    (w.mobileInput.defaultValue = w.mobileInput.value = w.formatDate(w.selectedDates[0], w.mobileFormatStr));
            ...
            void 0 !== w.daysContainer &&
              (A(w.monthNav, 'click', Ce), A(w.monthNav, ['keyup', 'increment'], F), A(w.daysContainer, 'click', ue));
          ...
          (w.selectedDates.length || w.config.noCalendar) &&
            (w.config.enableTime && _(w.config.noCalendar ? w.latestSelectedDateObj : void 0), be(!1)),
          k();
