...
!function () {
  ...
  for (
    g = {
      ...
      P = function () {
        ...
        return null !=
          (t =
            'undefined' != typeof performance && null !== performance && 'function' == typeof performance.now ? performance.now() : void 0)
          ? t
          : +new Date();
      },
      R =
      ...
      d = function () {
        for (var t, e, n, r = arguments[0], s = 2 <= arguments.length ? J.call(arguments, 1) : [], o = 0, i = s.length; o < i; o++)
          if ((e = s[o]))
            for (t in e)
              K.call(e, t) &&
                ((n = e[t]), null != r[t] && 'object' == typeof r[t] && null != n && 'object' == typeof n ? d(r[t], n) : (r[t] = n));
        return r;
      },
      h = function (t) {
  ...
  (B = Error),
      ...
      if (((this.progress = 0), null != window.ProgressEvent))
        ...
        (s = e.onreadystatechange),
          (e.onreadystatechange = function () {
            var t;
            return (
              0 === (t = e.readyState) || 4 === t ? (n(i), (i.progress = 100)) : 3 === e.readyState && (i.progress = 50),
    ...
    (it.prototype.tick = function (t, e) {
      return (
        100 <= (e = null == e ? j(this.source, 'progress') : e) && (this.done = !0),
        e === this.last
      ...
      return (
        ...
        (e = O(function (t, e) {
          ...
          for (var n, r, s, o, i, a, u, c, l, p, h = (a = 0), f = !0, g = (u = 0), d = N.length; u < d; g = ++u)
            for (
              C = N[g], i = null != E[g] ? E[g] : (E[g] = []), s = c = 0, l = (r = null != (p = C.elements) ? p : [C]).length;
              c < l;
              s = ++c
            )
