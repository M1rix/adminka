...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? Z(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = D(n)), 0 < t.length ? t : R(n) ? Z(n) : n.i.toString();
    }
    return M(n, t);
  }
  function Z(n) {
...
*/
  var nn = { 64: ['NZ'] },
    tn = {
      NZ: [
        null,
        [null, null, '[28]\\d{7,9}|[346]\\d{7}|(?:508|[79]\\d)\\d{6,7}', null, null, null, null, null, null, [8, 9, 10], [7]],
        [null, null, '(?:24099|(?:3[2-79]|[49][2-9]|6[235-9]|7[2-57-9])\\d{3})\\d{3}', null, null, null, '32345678', null, null, [8], [7]],
        ...
        null,
        [null, null, '[28]6\\d{6,7}', null, null, null, '26123456', null, null, [8, 9]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
