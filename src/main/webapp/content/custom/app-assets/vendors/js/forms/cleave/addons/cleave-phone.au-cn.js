  ...
  function f(l, n) {
    for (var u = d(l.j()), t = 0; t < u.length; t++) {
      ...
      if (null != n.a[r]) {
        ...
        else (e = p(n, r)), i ? ((i = p(l, r)) ? f(i, e) : g(l, r, e.clone())) : g(l, r, e);
      }
    }
  }
  function p(l, n) {
...
*/
  ...
  function R(l, n) {
    for (var u = [], t = n.length - 3, e = l.f.length, r = 0; r < e; ++r) {
      var i = l.f[r];
      0 == $(i, 3) ? u.push(l.f[r]) : ((i = c(i, 3, Math.min(t, $(i, 3) - 1))), 0 == n.search(i) && u.push(l.f[r]));
    }
    l.f = u;
  }
  function F(l, n) {
    ...
    switch (l.u.b.length) {
      ...
      default:
        return l.A
          ...
          : 0 < l.f.length
          ? ((u = q(l, n)), (e = D(l)), 0 < e.length ? e : (R(l, l.a.toString()), B(l) ? V(l) : l.l ? U(l, u) : l.i.toString()))
          : M(l);
    }
  }
  function I(l) {
    return (l.l = !0), (l.A = !1), (l.f = []), (l.s = 0), t(l.m), (l.w = ''), M(l);
  }
  function D(l) {
    for (var n = l.a.toString(), u = l.f.length, t = 0; t < u; ++t) {
      var e = l.f[t],
        r = h(e, 1);
      if (new RegExp('^(?:' + r + ')$').test(n)) return (l.B = sl.test(c(e, 4))), (n = n.replace(new RegExp(r, 'g'), c(e, 2))), U(l, n);
    }
    return '';
  }
  function U(l, n) {
  ...
  function M(l) {
    var n = l.a.toString();
    if (3 <= n.length) {
      for (var u = l.o && 0 == l.h.length && 0 < $(l.g, 20) ? p(l.g, 20) || [] : p(l.g, 19) || [], t = u.length, e = 0; e < t; ++e) {
        var r = u[e];
        (0 < l.h.length && x(h(r, 4)) && !c(r, 6) && null == r.a[5]) ||
          ((0 != l.h.length || l.o || x(h(r, 4)) || c(r, 6)) && ol.test(h(r, 2)) && l.f.push(r));
      }
