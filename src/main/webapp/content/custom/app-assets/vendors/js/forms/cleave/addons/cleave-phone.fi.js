...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((t = T(n, l)), (u = D(n)), 0 < u.length ? u : (B(n, n.a.toString()), I(n) ? G(n) : n.l ? M(n, t) : n.i.toString()))
          : V(n);
    }
  }
  function C(n) {
  ...
  function V(n) {
    ...
    if (3 <= l.length) {
      ...
      return B(n, l), (l = D(n)), 0 < l.length ? l : I(n) ? G(n) : n.i.toString();
    }
    return M(n, l);
  }
  function G(n) {
  ...
  (y.prototype.j = function () {
    ...
    (S.prototype.b = function (n, l) {
      ...
      } else if (t === Number && 'string' == typeof l && ('Infinity' === l || '-Infinity' === l || 'NaN' === l || W.test(l)))
        return Number(l);
      return l;
    });
  var W = /^-?[0-9]+$/;
