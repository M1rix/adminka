...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = I(n)), 0 < r.length ? r : (R(n, n.a.toString()), B(n) ? G(n) : n.l ? D(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function C(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return R(n, t), (t = I(n)), 0 < t.length ? t : B(n) ? G(n) : n.i.toString();
    }
    return D(n, t);
  }
  function G(n) {
  ...
  var nn = { 95: ['MM'] },
    tn = {
      MM: [
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '(?:1(?:333|468)|2468)\\d{4}', null, null, null, '13331234', null, null, [8]],
        'MM',
        95,
        '00',
        '0',
