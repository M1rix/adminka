            ...
            function l(t) {
              ...
              if (e.options.itemHandleOptions.enabled) {
                if (void 0 !== (e.options.itemHandleOptions.customHandler || void 0))
                  return (n =
                    '<div> ' +
                    e.options.itemHandleOptions.customHandler.replace(/%([^%]+)%/g, (e, n) => (void 0 !== t[n] ? t[n] : '')) +
                    ' </div>');
            ...
            arguments[0] &&
              ...
              (this.init = function () {
                !(function () {
                  ...
                  t.classList.add('kanban-container'),
                    (e.container = t),
                    document.querySelector(e.options.element).dataset.hasOwnProperty('board')
                  ...
                  window.innerWidth > e.options.responsive &&
                      ...
                      .dragula([e.container], {
                        moves: function (t, n, o, i) {
                          return (
                            ...
                            (o.classList.contains('kanban-board-header') || o.classList.contains('kanban-title-board'))
                          );
                        },
                    ...
                    (e.drake = e
                      ...
                      .on('drag', function (t, n) {
                        ...
                        if ('' !== o && o.indexOf('not-draggable') > -1) e.drake.cancel(!0);
                        else {
              ...
              (this.addBoards = function (t, n) {
                if (e.options.responsivePercentage)
                  if (((e.container.style.width = '100%'), (e.options.gutter = '1%'), window.innerWidth > e.options.responsive))
                ...
                for (var p in t) {
                  ...
                  n || e.options.boards.push(v),
                    e.options.responsivePercentage ||
                      ('' === e.container.style.width
                        ? (e.container.style.width = parseInt(o) + 2 * parseInt(e.options.gutter) + 'px')
                        : (e.container.style.width =
                            parseInt(e.container.style.width) + parseInt(o) + 2 * parseInt(e.options.gutter) + 'px'));
                  var m = document.createElement('div');
                  (m.dataset.id = v.id),
                    (m.dataset.order = e.container.childNodes.length + 1),
                    m.classList.add('kanban-board'),
                    e.options.responsivePercentage ? (m.style.width = o + '%') : (m.style.width = o),
                  ...
                  if (i) {
                    ...
                    C.setAttribute('class', u || 'kanban-title-button btn btn-default btn-xs'),
                      C.appendChild(O),
              ...
              (this.getParentBoardID = function (t) {
                return (
                  'string' == typeof t && (t = e.element.querySelector('[data-eid="' + t + '"]')),
              ...
              (this.replaceElement = function (t, n) {
                var o = t;
                return (
                  'string' == typeof o && (o = e.element.querySelector('[data-eid="' + t + '"]')),
                  (o.innerHTML = l(n)),
                  (o.clickfn = n.click),
          ...
          (function () {
            ...
            function d(e, t, o, r) {
              n.navigator.pointerEnabled
                ? i[t](e, { mouseup: 'pointerup', mousedown: 'pointerdown', mousemove: 'pointermove' }[o], r)
                : n.navigator.msPointerEnabled
                ? i[t](e, { mouseup: 'MSPointerUp', mousedown: 'MSPointerDown', mousemove: 'MSPointerMove' }[o], r)
                : (i[t](e, { mouseup: 'touchend', mousedown: 'touchstart', mousemove: 'touchmove' }[o], r), i[t](e, o, r));
            }
            function s(e) {
            ...
            t.exports = function (e, t) {
              ...
              void 0 === A.moves && (A.moves = p),
                ...
                void 0 === A.ignoreInputTextSelection && (A.ignoreInputTextSelection = !0),
              ...
              function j(e) {
                if (!((_.dragging && n) || H(e))) {
                  ...
                  var o = h(e);
                  if (o && !A.invalid(e, t) && A.moves(e, o, t, y(e))) return { item: e, source: o };
                }
              }
              function F(e) {
                var t, n;
                (t = e.item),
                  (n = e.source),
                  ('boolean' == typeof A.copy ? A.copy : A.copy(t, n)) && ((L = e.item.cloneNode(!0)), _.emit('cloned', L, e.item, 'copy')),
                  (w = e.source),
                  (E = e.item),
                  (k = S = y(e.item)),
                  (_.dragging = !0),
              ...
              function W(e) {
                if (_.dragging) {
                  var t = arguments.length > 0 ? e : A.revertOnSpill,
                    ...
                    o = h(n),
                    i = $(o);
                  !1 === i && t && (L ? o && o.removeChild(L) : w.insertBefore(n, k)),
                    i || t ? _.emit('cancel', n, w, w) : _.emit('drop', n, o, w, S),
                    G();
                }
              }
              function G() {
                var e = L || E;
                U(),
                  n && (r.rm(A.mirrorContainer, 'gu-unselectable'), d(c, 'remove', 'mousemove', Q), h(n).removeChild(n), (n = null)),
                  e && r.rm(e, 'gu-transit'),
                  B && clearTimeout(B),
                  (_.dragging = !1),
                  I && _.emit('out', e, I, w),
              ...
              function ee(e, t, n, o) {
                ...
                return t !== e
                  ? ((i = t.getBoundingClientRect()), a(r ? n > i.left + v(i) / 2 : o > i.top + m(i) / 2))
                  : (function () {
                      var t,
                        i,
                        a,
