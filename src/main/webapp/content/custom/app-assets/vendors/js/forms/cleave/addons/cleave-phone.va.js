  ...
  function p(n, l) {
    for (var t = o(n.j()), e = 0; e < t.length; e++) {
      ...
      if (null != l.a[r]) {
        ...
        else (u = c(l, r)), i ? ((i = c(n, r)) ? p(i, u) : m(n, r, u.clone())) : m(n, r, u);
      }
    }
  }
  function c(n, l) {
...
*/
  ...
  function R(n, l) {
    for (var t = [], e = l.length - 3, u = n.f.length, r = 0; r < u; ++r) {
      var i = n.f[r];
      0 == d(i, 3) ? t.push(n.f[r]) : ((i = h(i, 3, Math.min(e, d(i, 3) - 1))), 0 == l.search(i) && t.push(n.f[r]));
    }
    n.f = t;
  }
  function F(n, l) {
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((t = q(n, l)), (u = V(n)), 0 < u.length ? u : (R(n, n.a.toString()), B(n) ? M(n) : n.l ? D(n, t) : n.i.toString()))
          : T(n);
    }
  }
  function C(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), e(n.m), (n.w = ''), T(n);
  }
  function V(n) {
    for (var l = n.a.toString(), t = n.f.length, e = 0; e < t; ++e) {
      var u = n.f[e],
        r = g(u, 1);
      if (new RegExp('^(?:' + r + ')$').test(l)) return (n.B = pn.test(h(u, 4))), (l = l.replace(new RegExp(r, 'g'), h(u, 2))), D(n, l);
    }
    return '';
  }
  function D(n, l) {
  ...
  function T(n) {
    var l = n.a.toString();
    if (3 <= l.length) {
      for (var t = n.o && 0 == n.h.length && 0 < d(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], e = t.length, u = 0; u < e; ++u) {
        var r = t[u];
        (0 < n.h.length && A(g(r, 4)) && !h(r, 6) && null == r.a[5]) ||
          ((0 != n.h.length || n.o || A(g(r, 4)) || h(r, 6)) && fn.test(g(r, 2)) && n.f.push(r));
      }
      return R(n, l), (l = V(n)), 0 < l.length ? l : B(n) ? M(n) : n.i.toString();
    }
    return D(n, l);
  }
  function M(n) {
  ...
  var nn = { 39: ['IT', 'VA'] },
    ln = {
      IT: [
        ...
        [null, null, '55\\d{8}', null, null, null, '5512345678', null, null, [10]],
        'IT',
        39,
        '00',
        null,
