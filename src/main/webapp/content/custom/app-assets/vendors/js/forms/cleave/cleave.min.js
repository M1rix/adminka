          ...
          onInput: function (e) {
            ...
            return (
              ...
              r.phone
                ...
                : r.numeral
                ? (r.prefix && r.noImmediatePrefix && 0 === e.length ? (r.result = '') : (r.result = r.numeralFormatter.format(e)),
                  void t.updateValueState())
          ...
          format: function (e) {
            ...
            switch (
              ...
              e.indexOf(o.numeralDecimalMark) >= 0 &&
                ((t = e.split(o.numeralDecimalMark)), (a = t[0]), (l = o.numeralDecimalMark + t[1].slice(0, o.numeralDecimalScale))),
              '-' === i && (a = a.slice(1)),
        ...
        var r = {
          assign: function (e, r) {
            return (
              ...
              (e.delimiter =
                r.delimiter || '' === r.delimiter ? r.delimiter : r.date ? '/' : r.time ? ':' : r.numeral ? ',' : (r.phone, ' ')),
