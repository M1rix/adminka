    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? M(n, e) : n.i.toString()))
          : O(n);
    }
  }
  function I(n) {
...
*/
  var nn = { 252: ['SO'] },
    tn = {
      SO: [
        null,
        [null, null, '[346-9]\\d{8}|[12679]\\d{7}|(?:[1-4]\\d|59)\\d{5}|[1348]\\d{5}', null, null, null, null, null, null, [6, 7, 8, 9]],
        [
          null,
          null,
