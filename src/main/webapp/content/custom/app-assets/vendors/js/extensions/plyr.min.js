  ...
  (function (e, t) {
    ...
    const de = {
      ...
      me = {
        ...
        pip: !(
          Y.isIPhone ||
          (!q(Z('video').webkitSetPresentationMode) && (!document.pictureInPictureEnabled || Z('video').disablePictureInPicture))
        ),
    ...
    function ge(e, t, i, s = !1, n = !0, a = !1) {
      ...
      pe && (o = { passive: n, capture: a }),
        l.forEach(t => {
          this && this.eventListeners && s && this.eventListeners.push({ element: e, type: t, callback: i, options: o }),
    ...
    function Ne(e) {
      ...
      const [s, n] = xe(i),
        a = (100 / s) * n;
      if (
        (Se(`aspect-ratio: ${s}/${n}`) ? (t.style.aspectRatio = `${s}/${n}`) : (t.style.paddingBottom = `${a}%`),
    ...
    const We = {
      ...
      createButton(e, t) {
        ...
        return (
          ...
          G(a, i),
          'play' === s
            ? (j(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(a))
      ...
      createProgress(e, t) {
        const i = Z(
          'progress',
          X(ne(this.config.selectors.display[e]), { min: 0, max: 100, value: 0, role: 'progressbar', 'aria-hidden': !0 }, t)
        );
        if ('volume' !== e) {
      ...
      setCaptionsMenu() {
        ...
        n.unshift({ value: -1, checked: !this.captions.toggled, title: He.get('disabled', this.config), list: t, type: 'language' }),
        ...
        return (
          Ce(j(this.config.controls) ? this.config.controls : []).forEach(l => {
            ...
            if (
              ...
              if (
                ((H(t) && c.contains(t)) ||
                  ((t = Z('div', X({}, h, { class: `${h.class} plyr__volume`.trim() }))), (this.elements.volume = t), c.appendChild(t)),
            ...
            if (('captions' === l && c.appendChild(i.call(this, 'captions', h)), 'settings' === l && !W(this.config.settings))) {
              ...
              s.appendChild(
                i.call(this, 'settings', { 'aria-haspopup': !0, 'aria-controls': `plyr-settings-${e.id}`, 'aria-expanded': !1 })
              );
            ...
            if (
              ...
              !U(t) && this.isEmbed && X(e, { icon: `logo-${this.provider}`, label: this.provider }),
    ...
    class st {
      constructor(t) {
        e(this, 'onChange', () => {
          ...
          fe.call(this.player, this.player.elements.container, 'dblclick', e => {
            (H(this.player.elements.controls) && this.player.elements.controls.contains(e.target)) ||
      ...
      static get prefix() {
        ...
        let e = '';
        return (
          ['webkit', 'moz', 'ms'].some(t => !(!q(document[`${t}ExitFullscreen`]) && !q(document[`${t}CancelFullScreen`])) && ((e = t), !0)),
          e
        );
      }
      static get property() {
    ...
    class lt {
          ...
          e(this, 'container', () => {
            ...
            const n = () => {
                ...
                l
                  ...
                  : ((t.style.maxWidth = c ? (r / a) * n + 'px' : null), (t.style.margin = c ? '0 auto' : null));
              },
              a = () => {
      ...
      handleKey(e) {
        ...
        if (n) {
          ...
          switch (
            ([32, 37, 38, 39, 40, 48, 49, 50, 51, 52, 53, 54, 56, 57, 67, 70, 73, 75, 76, 77, 79].includes(s) &&
    ...
    function ct(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e && ((this.media.paused = !e), ve.call(this, this.media, e ? 'play' : 'pause'));
    }
    const ht = {
      setup() {
        const e = this;
                  ...
                  case 1:
                    t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed
                      ...
                      : (ut.call(e, !0),
                        ...
                        e.media.duration !== s.getDuration() &&
                          ((e.media.duration = s.getDuration()), ve.call(e, e.media, 'durationchange')));
                    break;
                  case 2:
      ...
      constructor(t) {
        e(this, 'load', () => {
            ...
            this.managerPromise || this.resumeContent(),
              this.managerPromise
                .then(() => {
                  ...
                  try {
                    this.initialized ||
                      (this.manager.init(e.offsetWidth, e.offsetHeight, google.ima.ViewMode.NORMAL), this.manager.start()),
                      (this.initialized = !0);
                  } catch (e) {
                    this.onAdError(e);
                  }
          ...
          e(this, 'clearSafetyTimer', e => {
            I(this.safetyTimer) ||
              (this.player.debug.log(`Safety timer cleared from: ${e}`), clearTimeout(this.safetyTimer), (this.safetyTimer = null));
          }),
          (this.player = t),
    ...
    class wt {
      constructor(t, i) {
        if (
          (e(this, 'play', () =>
            q(this.media.play)
              ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(() => this.ads.play()).catch(() => ke(this.media.play())),
                this.media.play())
              : null
          ),
      ...
      static setup(e, t = {}) {
        let i = null;
        return (
          _(e) ? (i = Array.from(document.querySelectorAll(e))) : D(e) ? (i = Array.from(e)) : j(e) && (i = e.filter(H)),
