  ...
  function p(n, t) {
    for (var e = o(n.j()), l = 0; l < e.length; l++) {
      ...
      if (null != t.a[i]) {
        ...
        else (r = c(t, i)), a ? ((a = c(n, i)) ? p(a, r) : b(n, i, r.clone())) : b(n, i, r);
      }
    }
  }
  function c(n, t) {
...
*/
  ...
  function F(n, t) {
    for (var e = [], l = t.length - 3, r = n.f.length, i = 0; i < r; ++i) {
      var a = n.f[i];
      0 == m(a, 3) ? e.push(n.f[i]) : ((a = h(a, 3, Math.min(l, m(a, 3) - 1))), 0 == t.search(a) && e.push(n.f[i]));
    }
    n.f = e;
  }
  function C(n, t) {
  ...
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), L(n);
  }
  function D(n) {
...
*/
  var nn = { 48: ['PL'] },
    tn = {
      PL: [
        null,
        [null, null, '[1-9]\\d{6}(?:\\d{2})?|6\\d{5}(?:\\d{2})?', null, null, null, null, null, null, [6, 7, 8, 9]],
        [
          null,
          null,
        ...
        [null, null, '39\\d{7}', null, null, null, '391234567', null, null, [9]],
        'PL',
        48,
        '00',
        null,
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '804\\d{6}', null, null, null, '804123456', null, null, [9]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
      ],
