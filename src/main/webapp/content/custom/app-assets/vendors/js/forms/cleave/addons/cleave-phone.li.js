...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (B(n, n.a.toString()), I(n) ? V(n) : n.l ? L(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function F(n) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      ...
      return B(n, t), (t = D(n)), 0 < t.length ? t : I(n) ? V(n) : n.i.toString();
    }
    return L(n, t);
  }
  function V(n) {
...
*/
  var nn = { 423: ['LI'] },
    tn = {
      LI: [
        null,
        [null, null, '(?:(?:[2378]|6\\d\\d)\\d|90)\\d{5}', null, null, null, null, null, null, [7, 9]],
        [
          null,
          null,
        ...
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '870(?:28|87)\\d\\d', null, null, null, '8702812', null, null, [7]],
        null,
        null,
        [null, null, '697(?:42|56|[78]\\d)\\d{4}', null, null, null, '697861234', null, null, [9]],
      ],
    };
  $.b = function () {
    return $.a ? $.a : ($.a = new $());
