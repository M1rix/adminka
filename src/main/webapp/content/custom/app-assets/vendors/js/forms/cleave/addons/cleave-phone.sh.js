...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((t = q(n, l)), (u = H(n)), 0 < u.length ? u : (C(n, n.a.toString()), F(n) ? M(n) : n.l ? T(n, t) : n.i.toString()))
          : $(n);
    }
  }
  function D(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), e(n.m), (n.w = ''), $(n);
  }
  function H(n) {
  ...
  function $(n) {
    ...
    if (3 <= l.length) {
      ...
      return C(n, l), (l = H(n)), 0 < l.length ? l : F(n) ? M(n) : n.i.toString();
    }
    return T(n, l);
  }
  function M(n) {
...
*/
  var nn = { 290: ['SH', 'TA'] },
    ln = {
      SH: [
        null,
        [null, null, '(?:[256]\\d|8)\\d{3}', null, null, null, null, null, null, [4, 5]],
