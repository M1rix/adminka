  ...
  !(function () {
    if (
      (window.Element.prototype.matches ||
        (e = window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector),
    ...
    a = function (t, e, n, s) {
      ...
      if (!o._steps[e].classList.contains(r.ACTIVE) && !o._stepsContents[e].classList.contains(r.ACTIVE)) {
        ...
        a.defaultPrevented ||
          ...
          d.length &&
            (d[0].classList.remove(r.ACTIVE), t.classList.contains(r.VERTICAL) || o.options.animation || d[0].classList.remove(r.BLOCK)),
