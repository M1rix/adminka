...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (l = V(n)), 0 < l.length ? l : ($(n, n.a.toString()), F(n) ? M(n) : n.l ? D(n, e) : n.i.toString()))
          : L(n);
    }
  }
  function I(n) {
  ...
  function L(n) {
    ...
    if (3 <= t.length) {
      ...
      return $(n, t), (t = V(n)), 0 < t.length ? t : F(n) ? M(n) : n.i.toString();
    }
    return D(n, t);
  }
  function M(n) {
...
*/
  var nn = { 371: ['LV'] },
    tn = {
      LV: [
        null,
        [null, null, '(?:[268]\\d|90)\\d{6}', null, null, null, null, null, null, [8]],
