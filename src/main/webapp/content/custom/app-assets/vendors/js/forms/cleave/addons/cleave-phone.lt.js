...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = P(n, t)), (l = D(n)), 0 < l.length ? l : (F(n, n.a.toString()), R(n) ? M(n) : n.l ? T(n, e) : n.i.toString()))
          : L(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), r(n.m), (n.w = ''), L(n);
  }
  function D(n) {
  ...
  function L(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = D(n)), 0 < t.length ? t : R(n) ? M(n) : n.i.toString();
    }
    return T(n, t);
  }
  function M(n) {
...
*/
  var nn = { 370: ['LT'] },
    tn = {
      LT: [
        null,
        [null, null, '(?:[3469]\\d|52|[78]0)\\d{6}', null, null, null, null, null, null, [8]],
