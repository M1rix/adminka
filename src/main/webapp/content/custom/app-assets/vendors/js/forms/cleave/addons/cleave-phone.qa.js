...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = Q(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), $(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function I(n) {
  ...
  function V(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = D(n)), 0 < t.length ? t : $(n) ? G(n) : n.i.toString();
    }
    return M(n, t);
  }
  function G(n) {
...
*/
  var nn = { 974: ['QA'] },
    tn = {
      QA: [
        null,
        [null, null, '(?:(?:2|[3-7]\\d)\\d\\d|800)\\d{4}', null, null, null, null, null, null, [7, 8]],
        ...
        null,
        [null, null, '2(?:[12]\\d|61)\\d{4}', null, null, null, '2123456', null, null, [7]],
        null,
        null,
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
