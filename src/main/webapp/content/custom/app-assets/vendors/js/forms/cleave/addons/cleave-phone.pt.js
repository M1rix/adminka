...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (l = D(n)), 0 < l.length ? l : (F(n, n.a.toString()), R(n) ? M(n) : n.l ? P(n, e) : n.i.toString()))
          : T(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, r = 0; r < e; ++r) {
      var l = n.f[r],
        i = g(l, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(l, 4))), (t = t.replace(new RegExp(i, 'g'), h(l, 2))), P(n, t);
    }
    return '';
  }
  function P(n, t) {
...
*/
  var nn = { 351: ['PT'] },
    tn = {
      PT: [
        null,
        [null, null, '(?:[26-9]\\d|30)\\d{7}', null, null, null, null, null, null, [9]],
