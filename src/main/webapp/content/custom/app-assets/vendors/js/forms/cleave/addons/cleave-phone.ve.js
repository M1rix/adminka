...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = V(n)), 0 < r.length ? r : (R(n, n.a.toString()), C(n) ? G(n) : n.l ? D(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      ...
      return R(n, t), (t = V(n)), 0 < t.length ? t : C(n) ? G(n) : n.i.toString();
    }
    return D(n, t);
  }
  function G(n) {
...
*/
  var nn = { 58: ['VE'] },
    tn = {
      VE: [
        null,
        [null, null, '(?:(?:[24]\\d|50)\\d|[89]00)\\d{7}', null, null, null, null, null, null, [10], [7]],
