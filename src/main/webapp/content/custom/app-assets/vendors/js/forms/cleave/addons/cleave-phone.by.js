...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = q(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? Y(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function I(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, l = 0; l < e; ++l) {
      var r = n.f[l],
        i = g(r, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(r, 4))), (t = t.replace(new RegExp(i, 'g'), h(r, 2))), Y(n, t);
    }
    return '';
  }
  function Y(n, t) {
  ...
  var nn = { 375: ['BY'] },
    tn = {
      BY: [
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '249\\d{6}', null, null, null, '249123456', null, null, [9]],
        'BY',
        375,
        '810',
        '8',
