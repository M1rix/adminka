...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), $(n) ? M(n) : n.l ? G(n, e) : n.i.toString()))
          : P(n);
    }
  }
  function I(n) {
    return (n.l = !0), (n.A = !1), (n.f = []), (n.s = 0), l(n.m), (n.w = ''), P(n);
  }
  function D(n) {
  ...
  function P(n) {
    ...
    if (3 <= t.length) {
      ...
      return F(n, t), (t = D(n)), 0 < t.length ? t : $(n) ? M(n) : n.i.toString();
    }
    return G(n, t);
  }
  function M(n) {
...
*/
  var nn = { 675: ['PG'] },
    tn = {
      PG: [
        null,
        [null, null, '(?:180|[78]\\d{3})\\d{4}|(?:[2-589]\\d|64)\\d{5}', null, null, null, null, null, null, [7, 8]],
        ...
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, null, null, null, null, null, null, null, [-1]],
        [null, null, '2(?:0[0-47]|7[568])\\d{4}', null, null, null, '2751234', null, null, [7]],
        'PG',
        675,
        '00|140[1-3]',
        null,
