    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = P(n, t)), (r = D(n)), 0 < r.length ? r : (R(n, n.a.toString()), B(n) ? M(n) : n.l ? U(n, e) : n.i.toString()))
          : L(n);
    }
  }
  function I(n) {
    ...
    if (3 <= t.length) {
      for (var e = n.o && 0 == n.h.length && 0 < m(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], l = e.length, r = 0; r < l; ++r) {
        ...
        (0 < n.h.length && C(g(i, 4)) && !h(i, 6) && null == i.a[5]) ||
          ((0 != n.h.length || n.o || C(g(i, 4)) || h(i, 6)) && fn.test(g(i, 2)) && n.f.push(i));
      }
      return R(n, t), (t = D(n)), 0 < t.length ? t : B(n) ? M(n) : n.i.toString();
    }
    return U(n, t);
  }
  function M(n) {
  ...
  var nn = { 352: ['LU'] },
    tn = {
      LU: [
        ...
        [null, null, '20(?:1\\d{5}|[2-689]\\d{1,7})', null, null, null, '20201234', null, null, [4, 5, 6, 7, 8, 9, 10]],
        'LU',
        352,
        '00',
        null,
