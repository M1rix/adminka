    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = P(n, t)), (r = D(n)), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? M(n) : n.l ? U(n, e) : n.i.toString()))
          : Y(n);
    }
  }
  function I(n) {
...
*/
  var nn = { 598: ['UY'] },
    tn = {
      UY: [
        null,
        [null, null, '(?:[249]\\d\\d|80)\\d{5}|9\\d{6}', null, null, null, null, null, null, [7, 8]],
        [null, null, '(?:2\\d|4[2-7])\\d{6}', null, null, null, '21231234', null, null, [8], [7]],
