...
*/
    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = T(n, t)), (l = D(n)), 0 < l.length ? l : (C(n, n.a.toString()), F(n) ? V(n) : n.l ? H(n, e) : n.i.toString()))
          : M(n);
    }
  }
  function $(n) {
  ...
  function D(n) {
    for (var t = n.a.toString(), e = n.f.length, r = 0; r < e; ++r) {
      var l = n.f[r],
        i = g(l, 1);
      if (new RegExp('^(?:' + i + ')$').test(t)) return (n.B = pn.test(h(l, 4))), (t = t.replace(new RegExp(i, 'g'), h(l, 2))), H(n, t);
    }
    return '';
  }
  function H(n, t) {
  ...
  function M(n) {
    ...
    if (3 <= t.length) {
      ...
      return C(n, t), (t = D(n)), 0 < t.length ? t : F(n) ? V(n) : n.i.toString();
    }
    return H(n, t);
  }
  function V(n) {
