    ...
    switch (n.u.b.length) {
      ...
      default:
        return n.A
          ...
          : 0 < n.f.length
          ? ((e = Q(n, t)), (r = D(n)), 0 < r.length ? r : (R(n, n.a.toString()), B(n) ? G(n) : n.l ? M(n, e) : n.i.toString()))
          : V(n);
    }
  }
  function C(n) {
...
*/
  var nn = { 964: ['IQ'] },
    tn = {
      IQ: [
        null,
        [null, null, '(?:1|[2-6]\\d?|7\\d\\d)\\d{7}', null, null, null, null, null, null, [8, 9, 10], [6, 7]],
        [null, null, '1\\d{7}|(?:2[13-5]|3[02367]|4[023]|5[03]|6[026])\\d{6,7}', null, null, null, '12345678', null, null, [8, 9], [6, 7]],
